...
// NOTE: This class is a clone of RockColor.cs
// This is here as we can't use the RockColor.cs in Rock.Common as we need to use Rock.DownhillCss in the 
// v1.x.x codebase. Rock.Common has deplicates of all of the extension methods in Rock.dll so it can't be placed
