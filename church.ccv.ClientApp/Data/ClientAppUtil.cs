...
using church.ccv.ClientApp.Models;
using System.Net;

namespace church.ccv.ClientApp
{
    ...
    public static class GroupFinder
    {
        ...
        // The Coach Role Type ID for the various groups you can join thru the Client App
        ...
        // Returns the info for a joinable Group in the Client App
