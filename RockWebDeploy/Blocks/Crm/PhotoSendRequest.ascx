<%@ control language="C#" autoeventwireup="true" inherits="RockWeb.Blocks.Crm.PhotoSendRequest, RockWeb" %>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlForm" runat="server" Visible="true" CssClass="js-send-request">
                    ...
                    <Rock:NumberBox ID="nbAge" runat="server" Label="Age is more than" NumberType="Integer" Text="16" />
                    ...
                    <Rock:NumberBox ID="nbUpdatedLessThan" runat="server" Label="Exclude people with a photo updated in the last (years)" Text="3" ></Rock:NumberBox>
