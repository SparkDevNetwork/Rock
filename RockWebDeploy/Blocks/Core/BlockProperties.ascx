<%@ control language="C#" autoeventwireup="true" inherits="RockWeb.Blocks.Core.BlockProperties, RockWeb" %>
            ...
            <asp:PlaceHolder ID="phContent" runat="server">
                ...
                <div class="tabContent" >
                    ...
                    <asp:Panel ID="pnlAdvancedSettings" runat="server" Visible="false" >
                        ...
                        <Rock:CodeEditor ID="cePreHtml" runat="server" Label="Pre-HTML" Help="HTML Content to render before the block" EditorMode="Html" EditorTheme="Rock" EditorHeight="400" />
                        <Rock:CodeEditor ID="cePostHtml" runat="server" Label="Post-HTML" Help="HTML Content to render after the block" EditorMode="Html" EditorTheme="Rock" EditorHeight="400" />
