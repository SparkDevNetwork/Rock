...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.InteractionChannel ) )]
    public partial class InteractionChannelViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.InteractionChannel model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static InteractionChannelViewModel From( Rock.Model.InteractionChannel model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new InteractionChannelViewModel();
