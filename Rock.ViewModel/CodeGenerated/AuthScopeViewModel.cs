...
{
    /// <summary>
    /// AuthScope View Model
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.AuthScope ) )]
    public partial class AuthScopeViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.AuthScope model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static AuthScopeViewModel From( Rock.Model.AuthScope model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new AuthScopeViewModel();
