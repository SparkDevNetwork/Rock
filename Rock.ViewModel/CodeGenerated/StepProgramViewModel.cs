...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.StepProgram ) )]
    public partial class StepProgramViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.StepProgram model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static StepProgramViewModel From( Rock.Model.StepProgram model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new StepProgramViewModel();
