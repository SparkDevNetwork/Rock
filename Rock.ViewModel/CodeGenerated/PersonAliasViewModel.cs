...
namespace Rock.ViewModel
{
    ...
    public partial class PersonAliasViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.PersonAlias model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
            ...
            Id = model.Id;
            Guid = model.Guid;
            AliasPersonGuid = model.AliasPersonGuid;
            AliasPersonId = model.AliasPersonId;
            Name = model.Name;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static PersonAliasViewModel From( Rock.Model.PersonAlias model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new PersonAliasViewModel();
