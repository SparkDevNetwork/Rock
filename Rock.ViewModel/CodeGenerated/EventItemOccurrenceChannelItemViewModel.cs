...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.EventItemOccurrenceChannelItem ) )]
    public partial class EventItemOccurrenceChannelItemViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.EventItemOccurrenceChannelItem model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static EventItemOccurrenceChannelItemViewModel From( Rock.Model.EventItemOccurrenceChannelItem model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new EventItemOccurrenceChannelItemViewModel();
