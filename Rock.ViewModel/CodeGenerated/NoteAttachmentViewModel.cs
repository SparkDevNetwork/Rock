...
namespace Rock.ViewModel
{
    ...
    public partial class NoteAttachmentViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.NoteAttachment model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static NoteAttachmentViewModel From( Rock.Model.NoteAttachment model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new NoteAttachmentViewModel();
