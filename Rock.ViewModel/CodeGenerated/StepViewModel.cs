...
namespace Rock.ViewModel
{
    ...
    public partial class StepViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.Step model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static StepViewModel From( Rock.Model.Step model, Person currentPerson = null, bool loadAttributes = true )
        {
