...
{
    /// <summary>
    /// StreakTypeExclusion View Model
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.StreakTypeExclusion ) )]
    public partial class StreakTypeExclusionViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.StreakTypeExclusion model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static StreakTypeExclusionViewModel From( Rock.Model.StreakTypeExclusion model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new StreakTypeExclusionViewModel();
