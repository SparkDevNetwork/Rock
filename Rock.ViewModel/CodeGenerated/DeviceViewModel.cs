...
namespace Rock.ViewModel
{
    ...
    public partial class DeviceViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.Device model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static DeviceViewModel From( Rock.Model.Device model, Person currentPerson = null, bool loadAttributes = true )
        {
