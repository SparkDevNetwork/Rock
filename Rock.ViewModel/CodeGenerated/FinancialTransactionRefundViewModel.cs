...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.FinancialTransactionRefund ) )]
    public partial class FinancialTransactionRefundViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.FinancialTransactionRefund model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static FinancialTransactionRefundViewModel From( Rock.Model.FinancialTransactionRefund model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new FinancialTransactionRefundViewModel();
