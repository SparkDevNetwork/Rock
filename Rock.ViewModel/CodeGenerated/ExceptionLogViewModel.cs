...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.ExceptionLog ) )]
    public partial class ExceptionLogViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ExceptionLog model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ExceptionLogViewModel From( Rock.Model.ExceptionLog model, Person currentPerson = null, bool loadAttributes = true )
        {
