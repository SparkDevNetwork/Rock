...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.GroupMemberScheduleTemplate ) )]
    public partial class GroupMemberScheduleTemplateViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.GroupMemberScheduleTemplate model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static GroupMemberScheduleTemplateViewModel From( Rock.Model.GroupMemberScheduleTemplate model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new GroupMemberScheduleTemplateViewModel();
