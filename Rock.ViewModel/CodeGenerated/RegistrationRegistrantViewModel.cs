...
namespace Rock.ViewModel
{
    ...
    public partial class RegistrationRegistrantViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.RegistrationRegistrant model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static RegistrationRegistrantViewModel From( Rock.Model.RegistrationRegistrant model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new RegistrationRegistrantViewModel();
