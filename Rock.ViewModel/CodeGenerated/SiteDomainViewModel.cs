...
{
    /// <summary>
    /// SiteDomain View Model
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.SiteDomain ) )]
    public partial class SiteDomainViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.SiteDomain model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static SiteDomainViewModel From( Rock.Model.SiteDomain model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new SiteDomainViewModel();
