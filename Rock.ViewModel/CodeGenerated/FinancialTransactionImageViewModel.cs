...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.FinancialTransactionImage ) )]
    public partial class FinancialTransactionImageViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.FinancialTransactionImage model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static FinancialTransactionImageViewModel From( Rock.Model.FinancialTransactionImage model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new FinancialTransactionImageViewModel();
