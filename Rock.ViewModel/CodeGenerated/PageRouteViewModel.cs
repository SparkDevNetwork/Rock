...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.PageRoute ) )]
    public partial class PageRouteViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.PageRoute model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static PageRouteViewModel From( Rock.Model.PageRoute model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new PageRouteViewModel();
