...
namespace Rock.ViewModel
{
    ...
    public partial class WorkflowTypeViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.WorkflowType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static WorkflowTypeViewModel From( Rock.Model.WorkflowType model, Person currentPerson = null, bool loadAttributes = true )
        {
