...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.ConnectionRequest ) )]
    public partial class ConnectionRequestViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ConnectionRequest model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ConnectionRequestViewModel From( Rock.Model.ConnectionRequest model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new ConnectionRequestViewModel();
