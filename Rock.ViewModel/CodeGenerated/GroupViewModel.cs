...
namespace Rock.ViewModel
{
    ...
    /// Group View Model
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.Group ) )]
    public partial class GroupViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.Group model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static GroupViewModel From( Rock.Model.Group model, Person currentPerson = null, bool loadAttributes = true )
        {
