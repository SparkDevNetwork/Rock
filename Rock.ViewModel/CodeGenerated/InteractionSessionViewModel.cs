...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.InteractionSession ) )]
    public partial class InteractionSessionViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.InteractionSession model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static InteractionSessionViewModel From( Rock.Model.InteractionSession model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new InteractionSessionViewModel();
