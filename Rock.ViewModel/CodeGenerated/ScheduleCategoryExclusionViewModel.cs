...
namespace Rock.ViewModel
{
    ...
    public partial class ScheduleCategoryExclusionViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ScheduleCategoryExclusion model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ScheduleCategoryExclusionViewModel From( Rock.Model.ScheduleCategoryExclusion model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new ScheduleCategoryExclusionViewModel();
