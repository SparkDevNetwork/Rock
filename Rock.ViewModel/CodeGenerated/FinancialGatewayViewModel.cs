...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.FinancialGateway ) )]
    public partial class FinancialGatewayViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.FinancialGateway model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static FinancialGatewayViewModel From( Rock.Model.FinancialGateway model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new FinancialGatewayViewModel();
