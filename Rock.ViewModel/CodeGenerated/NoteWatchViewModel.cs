...
namespace Rock.ViewModel
{
    ...
    public partial class NoteWatchViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.NoteWatch model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
            ...
            WatcherGroupId = model.WatcherGroupId;
            WatcherPersonAliasId = model.WatcherPersonAliasId;
            WatchReplies = model.WatchReplies;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static NoteWatchViewModel From( Rock.Model.NoteWatch model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new NoteWatchViewModel();
