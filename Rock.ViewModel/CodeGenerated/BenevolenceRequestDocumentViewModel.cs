...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.BenevolenceRequestDocument ) )]
    public partial class BenevolenceRequestDocumentViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.BenevolenceRequestDocument model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static BenevolenceRequestDocumentViewModel From( Rock.Model.BenevolenceRequestDocument model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new BenevolenceRequestDocumentViewModel();
