...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.EntityCampusFilter ) )]
    public partial class EntityCampusFilterViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.EntityCampusFilter model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static EntityCampusFilterViewModel From( Rock.Model.EntityCampusFilter model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new EntityCampusFilterViewModel();
