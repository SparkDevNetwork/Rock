...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.RegistrationTemplateForm ) )]
    public partial class RegistrationTemplateFormViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.RegistrationTemplateForm model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static RegistrationTemplateFormViewModel From( Rock.Model.RegistrationTemplateForm model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new RegistrationTemplateFormViewModel();
