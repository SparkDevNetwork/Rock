...
namespace Rock.ViewModel
{
    ...
    public partial class ConnectionWorkflowViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ConnectionWorkflow model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ConnectionWorkflowViewModel From( Rock.Model.ConnectionWorkflow model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new ConnectionWorkflowViewModel();
