...
namespace Rock.ViewModel
{
    ...
    public partial class ConnectionRequestActivityViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ConnectionRequestActivity model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ConnectionRequestActivityViewModel From( Rock.Model.ConnectionRequestActivity model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new ConnectionRequestActivityViewModel();
