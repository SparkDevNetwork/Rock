...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.ConnectionOpportunityCampus ) )]
    public partial class ConnectionOpportunityCampusViewModel : ViewModelBase
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>
        /// The DefaultConnectorPersonAliasId.
        /// </value>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ConnectionOpportunityCampus model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ConnectionOpportunityCampusViewModel From( Rock.Model.ConnectionOpportunityCampus model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new ConnectionOpportunityCampusViewModel();
