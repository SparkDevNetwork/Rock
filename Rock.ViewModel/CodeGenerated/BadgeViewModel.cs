...
namespace Rock.ViewModel
{
    ...
    /// Badge View Model
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.Badge ) )]
    public partial class BadgeViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.Badge model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static BadgeViewModel From( Rock.Model.Badge model, Person currentPerson = null, bool loadAttributes = true )
        {
