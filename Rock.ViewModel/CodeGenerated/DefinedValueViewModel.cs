...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.DefinedValue ) )]
    public partial class DefinedValueViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.DefinedValue model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static DefinedValueViewModel From( Rock.Model.DefinedValue model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new DefinedValueViewModel();
