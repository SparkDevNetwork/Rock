...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.MetricPartition ) )]
    public partial class MetricPartitionViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.MetricPartition model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static MetricPartitionViewModel From( Rock.Model.MetricPartition model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new MetricPartitionViewModel();
