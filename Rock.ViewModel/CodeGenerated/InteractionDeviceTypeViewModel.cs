...
namespace Rock.ViewModel
{
    ...
    public partial class InteractionDeviceTypeViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.InteractionDeviceType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static InteractionDeviceTypeViewModel From( Rock.Model.InteractionDeviceType model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new InteractionDeviceTypeViewModel();
