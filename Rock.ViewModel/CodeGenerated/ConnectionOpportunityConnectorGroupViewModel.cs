...
{
    /// <summary>
    /// ConnectionOpportunityConnectorGroup View Model
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.ConnectionOpportunityConnectorGroup ) )]
    public partial class ConnectionOpportunityConnectorGroupViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ConnectionOpportunityConnectorGroup model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ConnectionOpportunityConnectorGroupViewModel From( Rock.Model.ConnectionOpportunityConnectorGroup model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new ConnectionOpportunityConnectorGroupViewModel();
