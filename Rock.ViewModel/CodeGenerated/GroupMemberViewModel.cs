...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.GroupMember ) )]
    public partial class GroupMemberViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.GroupMember model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static GroupMemberViewModel From( Rock.Model.GroupMember model, Person currentPerson = null, bool loadAttributes = true )
        {
