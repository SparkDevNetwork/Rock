...
namespace Rock.ViewModel
{
    ...
    public partial class FollowingSuggestedViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.FollowingSuggested model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static FollowingSuggestedViewModel From( Rock.Model.FollowingSuggested model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new FollowingSuggestedViewModel();
