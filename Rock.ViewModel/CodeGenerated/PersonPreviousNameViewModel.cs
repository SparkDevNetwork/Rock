...
namespace Rock.ViewModel
{
    ...
    public partial class PersonPreviousNameViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.PersonPreviousName model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static PersonPreviousNameViewModel From( Rock.Model.PersonPreviousName model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new PersonPreviousNameViewModel();
