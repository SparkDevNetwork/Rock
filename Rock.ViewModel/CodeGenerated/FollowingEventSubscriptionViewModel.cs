...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.FollowingEventSubscription ) )]
    public partial class FollowingEventSubscriptionViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.FollowingEventSubscription model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static FollowingEventSubscriptionViewModel From( Rock.Model.FollowingEventSubscription model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new FollowingEventSubscriptionViewModel();
