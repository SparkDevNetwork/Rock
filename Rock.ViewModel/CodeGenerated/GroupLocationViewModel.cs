...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.GroupLocation ) )]
    public partial class GroupLocationViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.GroupLocation model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static GroupLocationViewModel From( Rock.Model.GroupLocation model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new GroupLocationViewModel();
