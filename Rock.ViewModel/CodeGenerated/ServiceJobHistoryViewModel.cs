...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.ServiceJobHistory ) )]
    public partial class ServiceJobHistoryViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ServiceJobHistory model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ServiceJobHistoryViewModel From( Rock.Model.ServiceJobHistory model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new ServiceJobHistoryViewModel();
