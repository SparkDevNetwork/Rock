...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.EventCalendarItem ) )]
    public partial class EventCalendarItemViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.EventCalendarItem model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static EventCalendarItemViewModel From( Rock.Model.EventCalendarItem model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new EventCalendarItemViewModel();
