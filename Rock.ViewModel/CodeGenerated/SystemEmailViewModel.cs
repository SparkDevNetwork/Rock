...
namespace Rock.ViewModel
{
    ...
    public partial class SystemEmailViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.SystemEmail model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static SystemEmailViewModel From( Rock.Model.SystemEmail model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new SystemEmailViewModel();
