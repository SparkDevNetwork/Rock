...
{
    /// <summary>
    /// ConnectionOpportunityGroup View Model
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.ConnectionOpportunityGroup ) )]
    public partial class ConnectionOpportunityGroupViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ConnectionOpportunityGroup model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ConnectionOpportunityGroupViewModel From( Rock.Model.ConnectionOpportunityGroup model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new ConnectionOpportunityGroupViewModel();
