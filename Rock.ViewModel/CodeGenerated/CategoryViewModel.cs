...
namespace Rock.ViewModel
{
    ...
    public partial class CategoryViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.Category model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static CategoryViewModel From( Rock.Model.Category model, Person currentPerson = null, bool loadAttributes = true )
        {
