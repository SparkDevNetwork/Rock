...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.DefinedType ) )]
    public partial class DefinedTypeViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.DefinedType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static DefinedTypeViewModel From( Rock.Model.DefinedType model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new DefinedTypeViewModel();
