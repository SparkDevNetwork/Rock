...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.RegistrationTemplateFeeItem ) )]
    public partial class RegistrationTemplateFeeItemViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.RegistrationTemplateFeeItem model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
            ...
            MaximumUsageCount = model.MaximumUsageCount;
            Name = model.Name;
            Order = model.Order;
            RegistrationTemplateFeeId = model.RegistrationTemplateFeeId;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static RegistrationTemplateFeeItemViewModel From( Rock.Model.RegistrationTemplateFeeItem model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new RegistrationTemplateFeeItemViewModel();
