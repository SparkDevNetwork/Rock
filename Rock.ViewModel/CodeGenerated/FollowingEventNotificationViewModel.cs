...
namespace Rock.ViewModel
{
    ...
    public partial class FollowingEventNotificationViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.FollowingEventNotification model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static FollowingEventNotificationViewModel From( Rock.Model.FollowingEventNotification model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new FollowingEventNotificationViewModel();
