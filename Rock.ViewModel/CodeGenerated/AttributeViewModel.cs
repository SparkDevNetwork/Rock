...
namespace Rock.ViewModel
{
    ...
    public partial class AttributeViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.Attribute model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static AttributeViewModel From( Rock.Model.Attribute model, Person currentPerson = null, bool loadAttributes = true )
        {
