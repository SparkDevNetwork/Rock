...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.ConnectionOpportunity ) )]
    public partial class ConnectionOpportunityViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ConnectionOpportunity model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ConnectionOpportunityViewModel From( Rock.Model.ConnectionOpportunity model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new ConnectionOpportunityViewModel();
