...
namespace Rock.ViewModel
{
    ...
    public partial class ConnectionActivityTypeViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ConnectionActivityType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ConnectionActivityTypeViewModel From( Rock.Model.ConnectionActivityType model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new ConnectionActivityTypeViewModel();
