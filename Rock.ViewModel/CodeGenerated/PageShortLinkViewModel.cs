...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.PageShortLink ) )]
    public partial class PageShortLinkViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.PageShortLink model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static PageShortLinkViewModel From( Rock.Model.PageShortLink model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new PageShortLinkViewModel();
