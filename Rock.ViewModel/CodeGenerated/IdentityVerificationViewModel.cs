...
namespace Rock.ViewModel
{
    ...
    public partial class IdentityVerificationViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.IdentityVerification model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static IdentityVerificationViewModel From( Rock.Model.IdentityVerification model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new IdentityVerificationViewModel();
