...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.StepTypePrerequisite ) )]
    public partial class StepTypePrerequisiteViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.StepTypePrerequisite model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static StepTypePrerequisiteViewModel From( Rock.Model.StepTypePrerequisite model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new StepTypePrerequisiteViewModel();
