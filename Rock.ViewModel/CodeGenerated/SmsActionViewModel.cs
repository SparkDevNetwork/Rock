...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.SmsAction ) )]
    public partial class SmsActionViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.SmsAction model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static SmsActionViewModel From( Rock.Model.SmsAction model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new SmsActionViewModel();
