...
namespace Rock.ViewModel
{
    ...
    public partial class SystemCommunicationViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.SystemCommunication model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static SystemCommunicationViewModel From( Rock.Model.SystemCommunication model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new SystemCommunicationViewModel();
