...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.CommunicationTemplateAttachment ) )]
    public partial class CommunicationTemplateAttachmentViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.CommunicationTemplateAttachment model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static CommunicationTemplateAttachmentViewModel From( Rock.Model.CommunicationTemplateAttachment model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new CommunicationTemplateAttachmentViewModel();
