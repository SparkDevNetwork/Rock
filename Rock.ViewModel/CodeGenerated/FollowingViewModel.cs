...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.Following ) )]
    public partial class FollowingViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.Following model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static FollowingViewModel From( Rock.Model.Following model, Person currentPerson = null, bool loadAttributes = true )
        {
