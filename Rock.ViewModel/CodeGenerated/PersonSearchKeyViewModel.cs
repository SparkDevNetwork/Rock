...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.PersonSearchKey ) )]
    public partial class PersonSearchKeyViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.PersonSearchKey model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static PersonSearchKeyViewModel From( Rock.Model.PersonSearchKey model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new PersonSearchKeyViewModel();
