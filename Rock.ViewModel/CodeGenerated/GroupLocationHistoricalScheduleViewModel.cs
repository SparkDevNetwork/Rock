...
namespace Rock.ViewModel
{
    ...
    public partial class GroupLocationHistoricalScheduleViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.GroupLocationHistoricalSchedule model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
            ...
            GroupLocationHistoricalId = model.GroupLocationHistoricalId;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static GroupLocationHistoricalScheduleViewModel From( Rock.Model.GroupLocationHistoricalSchedule model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new GroupLocationHistoricalScheduleViewModel();
