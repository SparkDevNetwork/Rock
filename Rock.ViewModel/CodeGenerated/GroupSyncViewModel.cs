...
namespace Rock.ViewModel
{
    ...
    public partial class GroupSyncViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.GroupSync model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static GroupSyncViewModel From( Rock.Model.GroupSync model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new GroupSyncViewModel();
