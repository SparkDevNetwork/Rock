...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.PrayerRequest ) )]
    public partial class PrayerRequestViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.PrayerRequest model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static PrayerRequestViewModel From( Rock.Model.PrayerRequest model, Person currentPerson = null, bool loadAttributes = true )
        {
