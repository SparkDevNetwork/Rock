...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.GroupRequirement ) )]
    public partial class GroupRequirementViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.GroupRequirement model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static GroupRequirementViewModel From( Rock.Model.GroupRequirement model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new GroupRequirementViewModel();
