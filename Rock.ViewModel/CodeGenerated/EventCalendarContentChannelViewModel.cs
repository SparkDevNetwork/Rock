...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.EventCalendarContentChannel ) )]
    public partial class EventCalendarContentChannelViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.EventCalendarContentChannel model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static EventCalendarContentChannelViewModel From( Rock.Model.EventCalendarContentChannel model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new EventCalendarContentChannelViewModel();
