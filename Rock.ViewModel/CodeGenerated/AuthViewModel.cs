...
namespace Rock.ViewModel
{
    ...
    /// Auth View Model
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.Auth ) )]
    public partial class AuthViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.Auth model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static AuthViewModel From( Rock.Model.Auth model, Person currentPerson = null, bool loadAttributes = true )
        {
