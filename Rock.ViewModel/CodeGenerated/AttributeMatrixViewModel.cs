...
{
    /// <summary>
    /// AttributeMatrix View Model
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.AttributeMatrix ) )]
    public partial class AttributeMatrixViewModel : ViewModelBase
    {
        /// <summary>
        /// Gets or sets the AttributeMatrixTemplateId.
        /// </summary>
        /// <value>
        /// The AttributeMatrixTemplateId.
        /// </value>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.AttributeMatrix model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static AttributeMatrixViewModel From( Rock.Model.AttributeMatrix model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new AttributeMatrixViewModel();
