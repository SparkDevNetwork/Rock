...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.WorkflowActivity ) )]
    public partial class WorkflowActivityViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.WorkflowActivity model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static WorkflowActivityViewModel From( Rock.Model.WorkflowActivity model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new WorkflowActivityViewModel();
