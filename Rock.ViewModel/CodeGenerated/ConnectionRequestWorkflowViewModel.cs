...
namespace Rock.ViewModel
{
    ...
    public partial class ConnectionRequestWorkflowViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ConnectionRequestWorkflow model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ConnectionRequestWorkflowViewModel From( Rock.Model.ConnectionRequestWorkflow model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new ConnectionRequestWorkflowViewModel();
