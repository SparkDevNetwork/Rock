...
{
    /// <summary>
    /// MetricValuePartition View Model
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.MetricValuePartition ) )]
    public partial class MetricValuePartitionViewModel : ViewModelBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the MetricPartitionId.
        /// </summary>
        /// <value>
        /// The MetricPartitionId.
        /// </value>
        public int? MetricPartitionId { get; set; }

        /// <summary>
        /// Gets or sets the MetricValueId.
        /// </summary>
        /// <value>
        /// The MetricValueId.
        /// </value>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.MetricValuePartition model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static MetricValuePartitionViewModel From( Rock.Model.MetricValuePartition model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new MetricValuePartitionViewModel();
