...
namespace Rock.ViewModel
{
    ...
    public partial class AttributeValueHistoricalViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.AttributeValueHistorical model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static AttributeValueHistoricalViewModel From( Rock.Model.AttributeValueHistorical model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new AttributeValueHistoricalViewModel();
