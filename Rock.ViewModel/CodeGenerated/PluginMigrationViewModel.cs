...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.PluginMigration ) )]
    public partial class PluginMigrationViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.PluginMigration model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static PluginMigrationViewModel From( Rock.Model.PluginMigration model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new PluginMigrationViewModel();
