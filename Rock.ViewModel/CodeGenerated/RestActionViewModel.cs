...
namespace Rock.ViewModel
{
    ...
    public partial class RestActionViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.RestAction model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static RestActionViewModel From( Rock.Model.RestAction model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new RestActionViewModel();
