...
namespace Rock.ViewModel
{
    ...
    public partial class CampusViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.Campus model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static CampusViewModel From( Rock.Model.Campus model, Person currentPerson = null, bool loadAttributes = true )
        {
