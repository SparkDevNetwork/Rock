...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.AuthClaim ) )]
    public partial class AuthClaimViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.AuthClaim model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static AuthClaimViewModel From( Rock.Model.AuthClaim model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new AuthClaimViewModel();
