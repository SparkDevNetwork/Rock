...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.CommunicationAttachment ) )]
    public partial class CommunicationAttachmentViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.CommunicationAttachment model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static CommunicationAttachmentViewModel From( Rock.Model.CommunicationAttachment model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new CommunicationAttachmentViewModel();
