...
namespace Rock.ViewModel
{
    ...
    public partial class RegistrationRegistrantFeeViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.RegistrationRegistrantFee model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static RegistrationRegistrantFeeViewModel From( Rock.Model.RegistrationRegistrantFee model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new RegistrationRegistrantFeeViewModel();
