...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.ContentChannelItemSlug ) )]
    public partial class ContentChannelItemSlugViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ContentChannelItemSlug model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ContentChannelItemSlugViewModel From( Rock.Model.ContentChannelItemSlug model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new ContentChannelItemSlugViewModel();
