...
namespace Rock.ViewModel
{
    ...
    public partial class WorkflowActivityTypeViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.WorkflowActivityType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static WorkflowActivityTypeViewModel From( Rock.Model.WorkflowActivityType model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new WorkflowActivityTypeViewModel();
