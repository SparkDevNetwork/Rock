...
namespace Rock.ViewModel
{
    ...
    public partial class PersonDuplicateViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.PersonDuplicate model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static PersonDuplicateViewModel From( Rock.Model.PersonDuplicate model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new PersonDuplicateViewModel();
