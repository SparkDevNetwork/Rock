...
{
    /// <summary>
    /// RestController View Model
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.RestController ) )]
    public partial class RestControllerViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.RestController model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static RestControllerViewModel From( Rock.Model.RestController model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new RestControllerViewModel();
