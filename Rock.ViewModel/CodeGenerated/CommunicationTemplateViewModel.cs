...
namespace Rock.ViewModel
{
    ...
    public partial class CommunicationTemplateViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.CommunicationTemplate model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static CommunicationTemplateViewModel From( Rock.Model.CommunicationTemplate model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new CommunicationTemplateViewModel();
