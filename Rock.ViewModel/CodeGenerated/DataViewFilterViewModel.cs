...
namespace Rock.ViewModel
{
    ...
    public partial class DataViewFilterViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.DataViewFilter model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static DataViewFilterViewModel From( Rock.Model.DataViewFilter model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new DataViewFilterViewModel();
