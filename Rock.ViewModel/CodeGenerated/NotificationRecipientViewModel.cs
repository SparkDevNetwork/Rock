...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.NotificationRecipient ) )]
    public partial class NotificationRecipientViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.NotificationRecipient model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static NotificationRecipientViewModel From( Rock.Model.NotificationRecipient model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new NotificationRecipientViewModel();
