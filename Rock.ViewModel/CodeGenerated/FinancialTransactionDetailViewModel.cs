...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.FinancialTransactionDetail ) )]
    public partial class FinancialTransactionDetailViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.FinancialTransactionDetail model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static FinancialTransactionDetailViewModel From( Rock.Model.FinancialTransactionDetail model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new FinancialTransactionDetailViewModel();
