...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.PhoneNumber ) )]
    public partial class PhoneNumberViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.PhoneNumber model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static PhoneNumberViewModel From( Rock.Model.PhoneNumber model, Person currentPerson = null, bool loadAttributes = true )
        {
