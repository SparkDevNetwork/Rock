...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.SmsPipeline ) )]
    public partial class SmsPipelineViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.SmsPipeline model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static SmsPipelineViewModel From( Rock.Model.SmsPipeline model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new SmsPipelineViewModel();
