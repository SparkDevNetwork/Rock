...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.FollowingSuggestionType ) )]
    public partial class FollowingSuggestionTypeViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.FollowingSuggestionType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static FollowingSuggestionTypeViewModel From( Rock.Model.FollowingSuggestionType model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new FollowingSuggestionTypeViewModel();
