...
namespace Rock.ViewModel
{
    ...
    public partial class GroupMemberAssignmentViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.GroupMemberAssignment model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static GroupMemberAssignmentViewModel From( Rock.Model.GroupMemberAssignment model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new GroupMemberAssignmentViewModel();
