...
namespace Rock.ViewModel
{
    ...
    public partial class AchievementTypePrerequisiteViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.AchievementTypePrerequisite model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static AchievementTypePrerequisiteViewModel From( Rock.Model.AchievementTypePrerequisite model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new AchievementTypePrerequisiteViewModel();
