...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.StepStatus ) )]
    public partial class StepStatusViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.StepStatus model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static StepStatusViewModel From( Rock.Model.StepStatus model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new StepStatusViewModel();
