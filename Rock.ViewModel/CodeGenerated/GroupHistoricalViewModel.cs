...
namespace Rock.ViewModel
{
    ...
    public partial class GroupHistoricalViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.GroupHistorical model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static GroupHistoricalViewModel From( Rock.Model.GroupHistorical model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new GroupHistoricalViewModel();
