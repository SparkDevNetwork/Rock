...
namespace Rock.ViewModel
{
    ...
    public partial class WebFarmNodeLogViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.WebFarmNodeLog model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static WebFarmNodeLogViewModel From( Rock.Model.WebFarmNodeLog model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new WebFarmNodeLogViewModel();
