...
namespace Rock.ViewModel
{
    ...
    /// Layout View Model
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.Layout ) )]
    public partial class LayoutViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.Layout model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static LayoutViewModel From( Rock.Model.Layout model, Person currentPerson = null, bool loadAttributes = true )
        {
