...
namespace Rock.ViewModel
{
    ...
    public partial class FinancialPledgeViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.FinancialPledge model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static FinancialPledgeViewModel From( Rock.Model.FinancialPledge model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new FinancialPledgeViewModel();
