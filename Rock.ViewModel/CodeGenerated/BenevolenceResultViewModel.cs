...
namespace Rock.ViewModel
{
    ...
    public partial class BenevolenceResultViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.BenevolenceResult model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
            ...
            ResultTypeValueId = model.ResultTypeValueId;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static BenevolenceResultViewModel From( Rock.Model.BenevolenceResult model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new BenevolenceResultViewModel();
