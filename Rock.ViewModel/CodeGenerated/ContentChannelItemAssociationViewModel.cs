...
namespace Rock.ViewModel
{
    ...
    public partial class ContentChannelItemAssociationViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ContentChannelItemAssociation model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ContentChannelItemAssociationViewModel From( Rock.Model.ContentChannelItemAssociation model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new ContentChannelItemAssociationViewModel();
