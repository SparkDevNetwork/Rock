...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.ServiceLog ) )]
    public partial class ServiceLogViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.ServiceLog model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static ServiceLogViewModel From( Rock.Model.ServiceLog model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new ServiceLogViewModel();
