...
namespace Rock.ViewModel
{
    ...
    public partial class StepWorkflowViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.StepWorkflow model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static StepWorkflowViewModel From( Rock.Model.StepWorkflow model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new StepWorkflowViewModel();
