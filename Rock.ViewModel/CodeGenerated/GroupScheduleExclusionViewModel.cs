...
namespace Rock.ViewModel
{
    ...
    public partial class GroupScheduleExclusionViewModel : ViewModelBase
    {
        ...
        public virtual void SetPropertiesFrom( Rock.Model.GroupScheduleExclusion model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static GroupScheduleExclusionViewModel From( Rock.Model.GroupScheduleExclusion model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new GroupScheduleExclusionViewModel();
