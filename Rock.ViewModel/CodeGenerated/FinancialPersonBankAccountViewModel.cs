...
namespace Rock.ViewModel
{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.FinancialPersonBankAccount ) )]
    public partial class FinancialPersonBankAccountViewModel : ViewModelBase
    {
        /// <summary>
        ...
        public virtual void SetPropertiesFrom( Rock.Model.FinancialPersonBankAccount model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return;
        ...
        /// <param name="loadAttributes" >if set to <c>true</c> [load attributes].</param>
        /// <returns></returns>
        public static FinancialPersonBankAccountViewModel From( Rock.Model.FinancialPersonBankAccount model, Person currentPerson = null, bool loadAttributes = true )
        {
            var viewModel = new FinancialPersonBankAccountViewModel();
