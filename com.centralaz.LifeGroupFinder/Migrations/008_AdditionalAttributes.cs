...
namespace com.centralaz.LifeGroupFinder.Migrations
{
    ...
    public class AdditionalAttributes : Migration
    {
        ...
        public override void Up()
        {
            ...
            RockMigrationHelper.AddBlockTypeAttribute( "33677897-2A3C-46BF-81C7-F5A61788B63C", "46A03F59-55D3-4ACE-ADD5-B4642225DD20", "Workflow Actions", "WorkflowActions", "", "The workflows to make available as actions.", 1, @"", "B662ADD2-96DE-43CA-91F4-B2B2EE431B71" );
            RockMigrationHelper.AddBlockTypeAttribute( "33677897-2A3C-46BF-81C7-F5A61788B63C", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Button Text", "ButtonText", "", "The text the button will have.", 0, @"", "96DF2C04-8977-4D49-A1EB-5935849BE436" );
