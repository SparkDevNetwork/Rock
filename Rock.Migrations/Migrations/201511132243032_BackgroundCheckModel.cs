...
namespace Rock.Migrations
{
    ...
    ///
    /// </summary>
    public partial class BackgroundCheckModel : Rock.Migrations.RockMigration
    {
        /// <summary>
        ...
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        BackgroundCheckStatus = c.Int(nullable: false),
            ...
            RockMigrationHelper.UpdateDefinedValue( "BC2FDF9A-93B8-4325-8DE9-2F7B1943BFDF", "Seven Year Automatic",
                "The Seven Year Automatic package is the premier screening option for volunteer and staff screenings and is the recommended package for all staff and pastors serving at your organization.", "8470F648-58B6-405A-8C4D-CD661F6678DB", false );
            ...
            RockMigrationHelper.AddDefinedValueAttributeValue( "C542EFC7-1D22-4DBD-AF09-5C583FCD4FEF", "39AEB614-BA28-485D-B033-3DD52055DC20", "Maricopa" );
            RockMigrationHelper.AddDefinedValueAttributeValue( "C542EFC7-1D22-4DBD-AF09-5C583FCD4FEF", "EC942623-3B32-4EF4-A371-D4312A7AF3F8", "True" );
            ...
            // Remove the previous qualifiers on the workflow 'package type' attribute and update values to be defined value guids instead of specific single-select values
            Sql( @"
...
" );
            ...
            RockMigrationHelper.UpdateBlockType( "Schedule Context Setter", "Block that can be used to set the default schedule context for the site.", "~/Blocks/Core/ScheduleContextSetter.ascx", "Core", "7A4EED4F-8CB6-418B-A4D4-E1DAEFD8AE1F" );
        ...
        {
            RockMigrationHelper.DeleteBlockType( "7A4EED4F-8CB6-418B-A4D4-E1DAEFD8AE1F" ); // Schedule Context Setter
