...
INSERT INTO [BinaryFileData] ([Id], [Content], [Guid])
  VALUES ( 
    @BinaryFileId
    ,{MigrationSQL._202105122159281_StatementGenerator_RockDefaultTemplateLogo}
...
" );
        ...
        private void AddRockDefaultTemplate()
        {
            ...
            var reportSettingsJson = MigrationSQL._202105122159281_StatementGenerator_RockDefaultTemplateReportSettings.Replace( "'", "''" );
            var footerSettingsJson = MigrationSQL._202105122159281_StatementGenerator_RockDefaultTemplateFooter.Replace( "'", "''" );
