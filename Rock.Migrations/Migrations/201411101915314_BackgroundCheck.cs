...
" );
            ...
            RockMigrationHelper.AddEntityAttribute( "Rock.Security.BackgroundCheck.ProtectMyMinistry", "C0D0D7E2-C3B0-4004-ABEA-4BBFAD10D5D2", "", "", "Return URL", "", "The Web Hook URL for Protect My Ministry to send results to (e.g. 'http://www.mysite.com/Webhooks/ProtectMyMinistry.ashx').", 4, "", "B875B054-6046-496A-A521-D0D3DD62BDD0" );
            ...
            RockMigrationHelper.AddAttributeValue( "B875B054-6046-496A-A521-D0D3DD62BDD0", 0, "https://www.yourchurch.org/ProtectMyMinistry.ashx", "B3A0CD1B-E2A9-47FA-B05B-D171405AFDEA" );
            ...
            RockMigrationHelper.UpdateWorkflowActionEntityAttribute("320622DA-52E0-41AE-AF90-2BF78B488552","3B1D93D7-9414-48F9-80E5-6A3FC8F94C20","Value|Attribute Value","Value","The value or attribute value to set the person attribute to. <span class='tip tip-liquid'></span>",2,@"","94689BDE-493E-4869-A614-2D54822D747C"); // Rock.Workflow.Action.SetPersonAttribute:Value|Attribute Value
            ...
            RockMigrationHelper.UpdateWorkflowActionEntityAttribute("96D371A7-A291-4F8F-8B38-B8F72CE5407E","9C204CD0-1233-41C5-818A-C5DA439445AA","Status","Status","The status to set workflow to. <span class='tip tip-liquid'></span>",0,@"","91A9F4BE-4A8E-430A-B466-A88DB2D33B34"); // Rock.Workflow.Action.SetStatus:Status
            ...
            RockMigrationHelper.AddAttributeQualifier("E6E5CF21-5A49-4630-9E18-531FF354380E","binaryFileType",@"","90C87FF1-F201-4C0B-9D48-F53B81BB57D9"); // Background Check:Report:binaryFileType
...
<hr>",@"","Pass^c88fef94-95b9-444a-bc93-58e983f3c047^^The request has been marked as passed. Requester will be notified.|Fail^d6b809a9-c1cc-4ebb-816e-33d8c1e53ea4^^The request has been marked as failed. Requester will be notified.|","88C7D1CC-3478-4562-A301-AE7D4D7FFF6D",true,"E0166CA1-200E-4506-A3E7-B10FF0471C90","F59CF4C6-8AA6-4AEF-BC21-DE48FA5DA6DD"); // Background Check:Review Result:Review Results
    ...
    WHERE AV.[ValueAsDateTime] IS NOT NULL
        ...
        AND P.[Guid] = '{{ Workflow.Person_unformatted }}'
            ...
            RockMigrationHelper.AddActionTypeAttributeValue("CBD767B5-23CF-460F-B3B6-4D848DDE95D7","8F4BB00F-7FA2-41AD-8E90-81F4DFE2C762",@"0547ed2e-8d0b-4009-b359-c28304f4d298"); // Background Check:Complete Request:Background Check Passed:Person Attribute
            ...
            RockMigrationHelper.AddActionTypeAttributeValue("2C90CDF2-6F01-42AC-96BB-1C7433A30537","8F4BB00F-7FA2-41AD-8E90-81F4DFE2C762",@"0547ed2e-8d0b-4009-b359-c28304f4d298"); // Background Check:Complete Request:Background Check Failed:Person Attribute
