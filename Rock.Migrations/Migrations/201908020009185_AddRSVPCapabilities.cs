...
namespace Rock.Migrations
{
    ...
    public partial class AddRSVPCapabilities : Rock.Migrations.RockMigration
    {
        ...
        {
            AddColumn("dbo.GroupType", "EnableRsvp", c => c.Boolean());
            AddColumn("dbo.Attribute", "IsPublic", c => c.Boolean());
            ...
            AddColumn("dbo.AttendanceOccurrence", "ShowDeclineReasons", c => c.Boolean());
