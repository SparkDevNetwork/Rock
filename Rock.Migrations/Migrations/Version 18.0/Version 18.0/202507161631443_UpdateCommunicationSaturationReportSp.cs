...
namespace Rock.Migrations
{
    ...
    ///
    /// </summary>
    public partial class UpdateCommunicationSaturationReportSp : Rock.Migrations.RockMigration
    {
        /// <summary>
...
IF EXISTS (SELECT * FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[spCommunication_SaturationReport]') AND TYPE IN (N'P', N'PC'))
    DROP PROCEDURE [dbo].[spCommunication_SaturationReport];" );
            ...
            Sql( RockMigrationSQL._202507161631443_UpdateCommunicationSaturationReportSp_spCommunication_SaturationReport );
