...
namespace Rock.Migrations
{
    ...
    public partial class UpdateCommunicationFlowModels : Rock.Migrations.RockMigration
    {
        ...
        {
            UpdateCommunicationFlowModelsUp();
            AddProcessCommunicationFlowsJobUp();
            AddCommunicationFlowBlocksAndPagesUp();
        }
        ...
        {
            AddCommunicationFlowBlocksAndPagesDown();
            AddProcessCommunicationFlowsJobDown();
            UpdateCommunicationFlowModelsDown();
        }

        private void UpdateCommunicationFlowModelsUp()
        {
            RockMigrationHelper.DeleteEntityType( "726B5B81-B4B2-4E74-9069-0409A3D19753" );
            ...
            DropIndex( "dbo.CommunicationFlowInstanceConversionHistory", new[] { "CreatedByPersonAliasIdP" } );
            ...
            CreateTable(
                "dbo.CommunicationFlowInstanceCommunicationConversion",
                c => new
                {
                    Id = c.Int( nullable: false, identity: true ),
                    CommunicationFlowInstanceCommunicationId = c.Int( nullable: false ),
                ...
                .PrimaryKey( t => t.Id )
                .ForeignKey( "dbo.CommunicationFlowInstanceCommunication", t => t.CommunicationFlowInstanceCommunicationId, cascadeDelete: true )
                .ForeignKey( "dbo.CommunicationRecipient", t => t.CommunicationRecipientId )
                .ForeignKey( "dbo.PersonAlias", t => t.CreatedByPersonAliasId )
                .ForeignKey( "dbo.PersonAlias", t => t.ModifiedByPersonAliasId )
                .ForeignKey( "dbo.PersonAlias", t => t.PersonAliasId )
                .Index( t => t.CommunicationFlowInstanceCommunicationId )
            ...
            AddColumn( "dbo.CommunicationFlowInstanceRecipient", "WasConversionGoalPreMet", c => c.Boolean( nullable: false ) );
            AddForeignKey( "dbo.CommunicationFlowInstance", "CommunicationFlowId", "dbo.CommunicationFlow", "Id", cascadeDelete: true );
            AddForeignKey( "dbo.CommunicationFlowInstanceCommunication", "CommunicationFlowInstanceId", "dbo.CommunicationFlowInstance", "Id", cascadeDelete: true );
            AddForeignKey( "dbo.CommunicationFlowInstanceRecipient", "CommunicationFlowInstanceId", "dbo.CommunicationFlowInstance", "Id", cascadeDelete: true );
            DropColumn( "dbo.CommunicationFlowInstanceRecipient", "UnsubscribeScope" );
            DropTable( "dbo.CommunicationFlowInstanceConversionHistory" );
        }

        private void UpdateCommunicationFlowModelsDown()
        {
            CreateTable(
            ...
            AddColumn( "dbo.CommunicationFlowInstanceRecipient", "UnsubscribeScope", c => c.Int() );
            DropForeignKey( "dbo.CommunicationFlowInstanceRecipient", "CommunicationFlowInstanceId", "dbo.CommunicationFlowInstance" );
            DropForeignKey( "dbo.CommunicationFlowInstanceCommunication", "CommunicationFlowInstanceId", "dbo.CommunicationFlowInstance" );
            DropForeignKey( "dbo.CommunicationFlowInstance", "CommunicationFlowId", "dbo.CommunicationFlow" );
            DropForeignKey( "dbo.CommunicationFlowInstanceCommunicationConversion", "PersonAliasId", "dbo.PersonAlias" );
            DropForeignKey( "dbo.CommunicationFlowInstanceCommunicationConversion", "ModifiedByPersonAliasId", "dbo.PersonAlias" );
            DropForeignKey( "dbo.CommunicationFlowInstanceCommunicationConversion", "CreatedByPersonAliasId", "dbo.PersonAlias" );
            DropForeignKey( "dbo.CommunicationFlowInstanceCommunicationConversion", "CommunicationRecipientId", "dbo.CommunicationRecipient" );
            DropForeignKey( "dbo.CommunicationFlowInstanceCommunicationConversion", "CommunicationFlowInstanceCommunicationId", "dbo.CommunicationFlowInstanceCommunication" );
            DropIndex( "dbo.CommunicationFlowInstanceCommunicationConversion", new[] { "Guid" } );
            DropIndex( "dbo.CommunicationFlowInstanceCommunicationConversion", new[] { "ModifiedByPersonAliasId" } );
            DropIndex( "dbo.CommunicationFlowInstanceCommunicationConversion", new[] { "CreatedByPersonAliasId" } );
            DropIndex( "dbo.CommunicationFlowInstanceCommunicationConversion", new[] { "CommunicationRecipientId" } );
            DropIndex( "dbo.CommunicationFlowInstanceCommunicationConversion", new[] { "PersonAliasId" } );
            DropIndex( "dbo.CommunicationFlowInstanceCommunicationConversion", new[] { "CommunicationFlowInstanceCommunicationId" } );
            DropColumn( "dbo.CommunicationFlowInstanceRecipient", "WasConversionGoalPreMet" );
            DropColumn( "dbo.CommunicationFlowInstanceRecipient", "InactiveReason" );
            DropTable( "dbo.CommunicationFlowInstanceCommunicationConversion" );
            CreateIndex( "dbo.CommunicationFlowInstanceConversionHistory", "Guid", unique: true );
            CreateIndex( "dbo.CommunicationFlowInstanceConversionHistory", "ModifiedByPersonAliasId" );
            CreateIndex( "dbo.CommunicationFlowInstanceConversionHistory", "CreatedByPersonAliasId" );
            CreateIndex( "dbo.CommunicationFlowInstanceConversionHistory", "CommunicationFlowCommunicationId" );
            CreateIndex( "dbo.CommunicationFlowInstanceConversionHistory", "PersonAliasId" );
            CreateIndex( "dbo.CommunicationFlowInstanceConversionHistory", "CommunicationFlowInstanceId" );
            AddForeignKey( "dbo.CommunicationFlowInstanceRecipient", "CommunicationFlowInstanceId", "dbo.CommunicationFlowInstance", "Id" );
            AddForeignKey( "dbo.CommunicationFlowInstanceCommunication", "CommunicationFlowInstanceId", "dbo.CommunicationFlowInstance", "Id" );
            AddForeignKey( "dbo.CommunicationFlowInstance", "CommunicationFlowId", "dbo.CommunicationFlow", "Id" );
            AddForeignKey( "dbo.CommunicationFlowInstanceConversionHistory", "PersonAliasId", "dbo.PersonAlias", "Id" );
            AddForeignKey( "dbo.CommunicationFlowInstanceConversionHistory", "ModifiedByPersonAliasId", "dbo.PersonAlias", "Id" );
            AddForeignKey( "dbo.CommunicationFlowInstanceConversionHistory", "CreatedByPersonAliasId", "dbo.PersonAlias", "Id" );
        ...
        private void AddProcessCommunicationFlowsJobUp()
        {
            Sql( $@"
...
(
    SELECT [Id]
    FROM [ServiceJob]
    WHERE [Guid] = '{Rock.SystemGuid.ServiceJob.PROCESS_COMMUNICATION_FLOWS}'
)
BEGIN
    UPDATE [ServiceJob]
    SET [Name] = 'Process Communication Flows'
        , [Description] = 'This job processes Communication Flows creating new communications as needed and tracks conversions for flows that have goals.'
        , [Class] = 'Rock.Jobs.ProcessCommunicationFlows'
...
BEGIN
    ...
    (
        ...
        , 'This job processes Communication Flows creating new communications as needed and tracks conversions for flows that have goals.'
        , 'Rock.Jobs.ProcessCommunicationFlows'
        , '0 0/5 * 1/1 * ? *'
        , '{Rock.SystemGuid.ServiceJob.PROCESS_COMMUNICATION_FLOWS}'
        , @Now
        , @Now
        , 500
        , 1
...
END" );
        ...
        private void AddProcessCommunicationFlowsJobDown()
        {
            Sql( $@"DELETE FROM [ServiceJob] WHERE [Guid] = '{Rock.SystemGuid.ServiceJob.PROCESS_COMMUNICATION_FLOWS}'" );
        }

        private void AddCommunicationFlowBlocksAndPagesUp()
        {
            // Add Page 
        ...
        private void AddCommunicationFlowBlocksAndPagesDown()
        {
            // Attribute for BlockType
            //   BlockType: Communication Flow Performance
            //   Category: Communication
