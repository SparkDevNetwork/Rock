...
namespace Rock.Migrations
{
    ...
    ///
    /// </summary>
    public partial class UpdateGetGroupPlacementPeopleStoredProcedure : Rock.Migrations.RockMigration
    {
        /// <summary>
        ...
        {
            #region Update GroupPlacement Stored Procedure
...
IF EXISTS (SELECT * FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[spGetGroupPlacementPeople]') AND TYPE IN (N'P', N'PC'))
    DROP PROCEDURE [dbo].[spGetGroupPlacementPeople];" );
            ...
            Sql( RockMigrationSQL._202511051918499_UpdateGetGroupPlacementPeopleStoredProcedure_spGetGroupPlacementPeople );
