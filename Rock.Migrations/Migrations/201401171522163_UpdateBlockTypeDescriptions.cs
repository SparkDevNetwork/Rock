...
namespace Rock.Migrations
{
    ...
    ///
    /// </summary>
    public partial class UpdateBlockTypeDescriptions : Rock.Migrations.RockMigration
    {
        /// <summary>
        ...
        public override void Up()
        {
            ...
            UPDATE [BlockType] SET [Name]='Transaction List', [Description]='Builds a list of all financial transactions which can be filtered by date, account/fund, transaction type, etc.', [Category]='Finance' WHERE [Guid]='E04320BC-67C3-452D-9EF6-D74D8C177154'
            UPDATE [BlockType] SET [Name]='Create Pledge', [Description]='Allows a website visitor to create pledge for the configured account funds, start and end date. This block also creates a new person record if a matching person could not be found.', [Category]='Finance' WHERE [Guid]='20B5568E-A010-4E15-9127-E63CF218D6E5'
            ...
            UPDATE [BlockType] SET [Name]='Giving Profile List', [Description]='Lists scheduled transactions for current or selected user (if context for person is not configured, will display for currently logged in person).', [Category]='Financial' WHERE [Guid]='694FF260-8C6F-4A59-93C9-CF3793FE30E6'
            ...
            UPDATE [BlockType] SET [Name]='Add Transaction', [Description]='Creates a new financial transaction or scheduled transaction.', [Category]='Financial' WHERE [Guid]='74EE3481-3E5A-4971-A02E-D463ABB45591'
            ...
            UPDATE [BlockType] SET [Name]='Giving Profile Detail', [Description]='Edit an existing scheduled transaction.', [Category]='Financial' WHERE [Guid]='5171C4E5-7698-453E-9CC8-088D362296DE'
