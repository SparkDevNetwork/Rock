...
<ul>
    ...
    <li><strong>valueformat</strong> (number) – Format numbers on tooltips and chart axis labels. Valid options include: number (formats to the browser''s locale, in the US adds a thousands comma), currency (adds a comma and currency symbol from the global attribute), none (no formatting applied).</li>
    <li><strong>gridlinecolor</strong> – The color of the grid lines on a chart.</li>
</ul>
...
</ul>', [Markup]=N'{% javascript url:''~/Scripts/moment.min.js'' id:''moment''%}{% endjavascript %}
...
', [Parameters]=N'fillcolor^rgba(5,155,255,.6)|bordercolor^#059BFF|borderwidth^0|legendposition^bottom|legendshow^false|chartheight^400px|chartwidth^100%|tooltipshow^true|fontcolor^#777|fontfamily^sans-serif|tooltipbackgroundcolor^#000|type^bar|pointradius^3|pointcolor^#059BFF|pointbordercolor^#059BFF|pointborderwidth^0|pointhovercolor^rgba(5,155,255,.6)|pointhoverbordercolor^rgba(5,155,255,.6)|borderdash^|curvedlines^true|filllinearea^false|labels^|tooltipfontcolor^#fff|pointhoverradius^3|xaxistype^linear|yaxislabels^|yaxismin^|yaxismax^|yaxisstepsize^|valueformat^number|gridlinecolor^' WHERE ([Guid]='43819A34-4819-4507-8FEA-2E406B5474EA');
