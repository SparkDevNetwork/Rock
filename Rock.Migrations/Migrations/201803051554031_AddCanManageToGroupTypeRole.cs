...
namespace Rock.Migrations
{
    ...
    ///
    /// </summary>
    public partial class AddCanManageToGroupTypeRole : Rock.Migrations.RockMigration
    {
        /// <summary>
...
", 9, @"", "579F1F5E-1393-4476-895D-FED8CC2343CA" );
        ...
        {
            DropColumn("dbo.GroupTypeRole", "CanManageMembers");
            ...
            // Remove Block: Page Menu, from Page: Family Pre-Registration, Site: External Website
            RockMigrationHelper.DeleteBlock( "91742CE0-FC1B-4E1B-B046-24748DD5F6CC" );
            // Remove Block: HTML Content, from Page: Family Pre-Registration, Site: External Website
            RockMigrationHelper.DeleteBlock( "DC006503-C69E-49CC-B384-EB199AFED5BD" );
            // Remove Block: Family Pre-Registration, from Page: Family Pre-Registration, Site: External Website
            ...
            RockMigrationHelper.DeletePage( "B37D22BE-D2A8-4EFA-8B2B-2E0EFF6EDB44" ); //  Page: Family Pre-Registration, Layout: LeftSidebar, Site: External Website
            RockMigrationHelper.DeletePage( "3B31B9A2-DE35-4407-8E7D-3633F93906CD" ); //  Page: Family Pre-Registration, Layout: LeftSidebar, Site: External Website
