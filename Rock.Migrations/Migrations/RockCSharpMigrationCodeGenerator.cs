...
namespace Rock.Migrations
{
    ...
    public class RockCSharpMigrationCodeGenerator<T> : CSharpMigrationCodeGenerator where T : System.Data.Entity.DbContext, new()
    {
        ...
        private RockSqlServerMigrationSqlGenerator rockSqlServerMigrationSqlGenerator = new RockSqlServerMigrationSqlGenerator();
...
";
            ...
            var generatedSQLUp = rockSqlServerMigrationSqlGenerator.Generate( operations, "2008" );
            var generatedSQLDown = rockSqlServerMigrationSqlGenerator.Generate( operations.Select(a => a.Inverse).Reverse(), "2008" );

            var upCode = generatedSQLUp.Select( a => $@"                 Sql(@""{a.Sql}"");
" ).JoinStrings(Environment.NewLine);

            var downCode = generatedSQLDown.Select( a => $@"                 Sql(@""{a.Sql}"");
" ).JoinStrings( Environment.NewLine );

            operations = new List<System.Data.Entity.Migrations.Model.MigrationOperation>();
...
//
    ...
    {{
        ...
        ///
        /// </summary>
        public partial class {className} : Rock.Migrations.RockMigration
        {{
            /// <summary>
