...
WHERE [Guid] = '2C42B2D4-1C5F-4AD5-A9AD-08631B872AC4'" );
        ...
        private void PagesBlocksUp()
        {
            ...
            RockMigrationHelper.UpdateBlockType( "Group Member Schedule Template Detail", "Displays the details of a group member schedule template.", "~/Blocks/GroupScheduling/GroupMemberScheduleTemplateDetail.ascx", "Groups", "B5EB66A1-7391-49D5-B613-5ED804A31E7B" );
            RockMigrationHelper.UpdateBlockType( "Group Member Schedule Template List", "Lists group member schedule templates.", "~/Blocks/GroupScheduling/GroupMemberScheduleTemplateList.ascx", "Groups", "D930E08B-ACD3-4ADD-9FAC-3B61C021D0F7" );
            RockMigrationHelper.UpdateBlockType( "Group Scheduler", "Allows schedules for groups and locations to be managed by a scheduler.", "~/Blocks/GroupScheduling/GroupScheduler.ascx", "Groups", "37D43C21-1A4D-4B13-9555-EF0B7304EB8A" );
            RockMigrationHelper.UpdateBlockType( "Group Schedule Confirmation", "Allows a person to confirm a schedule RSVP and view pending schedules.", "~/Blocks/GroupScheduling/GroupScheduleConfirmation.ascx", "Groups", "B783DEC7-E2B7-4805-B2DD-B5EDF6495A2C" );
            RockMigrationHelper.UpdateBlockType( "Group Scheduler Analytics", "Provides some visibility into scheduling accountability. Shows check-ins, missed confirmations, declines, and decline reasons with ability to filter by group, date range, data view, and person.", "~/Blocks/GroupScheduling/GroupSchedulerAnalytics.ascx", "Groups", "3037D2F8-C9B0-40BF-B2E3-8C5CBA7F4900" );
            RockMigrationHelper.UpdateBlockType( "Group Schedule Status Board", "Scheduler can see overview of current schedules by groups and dates.", "~/Blocks/GroupScheduling/GroupScheduleStatusBoard.ascx", "Groups", "1BFB72CC-A224-4A0B-B291-21733597738A" );
            RockMigrationHelper.UpdateBlockType( "Group Schedule Toolbox", "Allows management of group scheduling for a specific person (worker).", "~/Blocks/GroupScheduling/GroupScheduleToolbox.ascx", "Groups", "7F9CEA6F-DCE5-4F60-A551-924965289F1D" );
