...
namespace Rock.Migrations
{
    ...
    public partial class Assessments : Rock.Migrations.RockMigration
    {
        ...
        private void AddEmotionalIntelligenceDefinedTypeAndAttributes()
        {
            ...
            AddSecurityToAttribute( Rock.SystemGuid.Attribute.PERSON_EQ_CONSTRUCTS_SELF_AWARENESS );
            ...
            AddSecurityToAttribute( Rock.SystemGuid.Attribute.PERSON_EQ_CONSTRUCTS_SELF_REGULATING );
            ...
            AddSecurityToAttribute( Rock.SystemGuid.Attribute.PERSON_EQ_CONSTRUCTS_OTHERS_AWARENESS );
            ...
            AddSecurityToAttribute( Rock.SystemGuid.Attribute.PERSON_EQ_CONSTRUCTS_OTHERS_REGULATING );
            ...
            AddSecurityToAttribute( Rock.SystemGuid.Attribute.PERSON_EQ_SCALES_PROBLEM_SOLVING );
...
<p>
    Your motivators will no doubt shift and morph throughout your life.For instance, #4 may drop to #7 and vice versa.  However, it is very doubtful that #22 would ever become #1. For that reason, read through all of the motivators and appreciate the ones that you have. Seek input from those who know you to see if they agree or disagree with these results.
        ...
        private void AddMotivatorDefinedType()
        {
            ...
            RockMigrationHelper.UpdateDefinedValue( "1DFF1804-0055-491E-9559-54EA3F8F89D1", "Learning", "You bring others together to accomplish a task. You have the capacity to take responsibility for others to achieve something together. You understand what needs to happen in most situations and can mobilize others to work together to undertake it. You enjoy when others follow your lead, and you have a desire to make an impact working together with others.", "7EA44A56-58CB-4E40-9779-CC0A79772926", false );
