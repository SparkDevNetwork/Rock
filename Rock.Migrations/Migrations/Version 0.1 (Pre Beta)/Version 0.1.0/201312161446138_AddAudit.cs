...
namespace Rock.Migrations
{
    ...
    ///
    /// </summary>
    public partial class AddAudit : Rock.Migrations.RockMigration1
    {
        /// <summary>
        ...
        {
            // Add a page for the Audit Information List
            AddPage( "C831428A-6ACD-4D49-9B2D-046D399E3123", "D65F783D-87A9-4CC9-8110-E83466A0EADB", "Audit Information", "Manage the audit information.", "4D7F3953-0BD9-4B4B-83F9-5FCC6B2BBE30", "fa fa-check" );
            ...
            // Add a block type for the Audit Information List
            AddBlockType( "Core - Audit Information List", "Audit Information List", "~/Blocks/Core/AuditInformationList.ascx", "D3B7C96B-DF1F-40AF-B09F-AB468E0E726D" );
            ...
            // Add a block for the Audit Information List
            AddBlock( "4D7F3953-0BD9-4B4B-83F9-5FCC6B2BBE30", "", "D3B7C96B-DF1F-40AF-B09F-AB468E0E726D", "Audit Information List", "Main", 0, "73C2CC25-6D78-4B08-B4B1-95254C3F66BF" );
        ...
        public override void Down()
        {
            ...
            // Delete the Audit Information List block
            DeleteBlock( "73C2CC25-6D78-4B08-B4B1-95254C3F66BF" );
            // Delete the Audit Information Detail block type
            DeleteBlockType( "0B1409F3-7A09-4573-A995-B98599A28CB8" );
            // Delete the Audit Information List block type
            DeleteBlockType( "D3B7C96B-DF1F-40AF-B09F-AB468E0E726D" );
            // Delete the Audit Information Detail page
            DeletePage( "25A45244-11A7-42BD-BC10-D81963A720B2" );
            // Delete the Audit Information List page
            DeletePage( "4D7F3953-0BD9-4B4B-83F9-5FCC6B2BBE30" );
        }
    }
}
