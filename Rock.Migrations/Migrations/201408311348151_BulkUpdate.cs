...
" );
            ...
            RockMigrationHelper.UpdateWorkflowActionEntityAttribute( "A41216D6-6FB0-4019-B222-2C29B4519CF4", "1D0D3794-C210-48A8-8C68-3FBEC08A6BA5", "SQLQuery", "SQLQuery", "The SQL query to run. <span class='tip tip-liquid'></span>", 0, @"", "F3B9908B-096F-460B-8320-122CF046D1F9" ); // Rock.Workflow.Action.RunSQL:SQLQuery
            ...
            RockMigrationHelper.UpdateWorkflowActivityType( "036F2F0B-C2DC-49D0-A17B-CCDAC7FC71E2", true, "Launch From Person Profile", "When this workflow is initiated from the Person Profile page, the \"Entity\" will have a value so the first action will run successfully, and the workflow will then be persisted.  If the workflow is launched from the Workflows page, the entity will be null so the first action will not run successfully and workflow will not be persisted until user enters information in the next activity.", true, 0, "BBDA3B74-44A2-41C0-849B-3D8939C027FA" ); // Photo Request:Launch From Person Profile
            RockMigrationHelper.UpdateWorkflowActivityType( "036F2F0B-C2DC-49D0-A17B-CCDAC7FC71E2", true, "Entry", "Prompts the sender to see if they want to add a custom message to the email that will be sent.", true, 1, "DCE1F8D6-34C7-4E9D-9E59-99BE8E98036D" ); // Photo Request:Entry
            RockMigrationHelper.UpdateWorkflowActivityType( "036F2F0B-C2DC-49D0-A17B-CCDAC7FC71E2", true, "Send Email", "Sends the photo request email.", false, 2, "2885B6AF-F059-465B-947F-E3D36578F67D" ); // Photo Request:Send Email
            RockMigrationHelper.UpdateWorkflowActionForm( @"{{ Workflow.WarningMessage }}
", @"", "Send^fdc397cd-8b4a-436e-bea1-bce2e6717c03^2885B6AF-F059-465B-947F-E3D36578F67D^Your information has been submitted successfully.|", "", true, "", "61DCBFB1-9CE8-4356-82D8-D69AFE68A58C" ); // Photo Request:Entry:Custom Message
            RockMigrationHelper.UpdateWorkflowActionFormAttribute( "61DCBFB1-9CE8-4356-82D8-D69AFE68A58C", "282D67EF-73FE-42A7-A248-F2901873E758", 0, false, true, false, "ED031AF5-62BD-4DB8-A41B-9FD7EB0C150C" ); // Photo Request:Entry:Custom Message:Person
            RockMigrationHelper.UpdateWorkflowActionFormAttribute( "61DCBFB1-9CE8-4356-82D8-D69AFE68A58C", "55A64AF1-E65C-4CE0-9542-9B79B256977E", 1, true, false, false, "EF3FF3B9-3C4C-4D44-BFF3-3D81E6115884" ); // Photo Request:Entry:Custom Message:Custom Message
            RockMigrationHelper.UpdateWorkflowActionFormAttribute( "61DCBFB1-9CE8-4356-82D8-D69AFE68A58C", "FA5530D4-9580-4C1F-8278-37E2EA19C01B", 2, false, true, false, "167769BA-114D-4325-8298-C86DF00A4007" ); // Photo Request:Entry:Custom Message:Sender
            RockMigrationHelper.UpdateWorkflowActionFormAttribute( "61DCBFB1-9CE8-4356-82D8-D69AFE68A58C", "26C30D02-3B89-4EA3-AAA7-08DB2E8EE0C3", 3, false, true, false, "C940FCCE-C024-450A-9075-6EE9B327F12A" ); // Photo Request:Entry:Custom Message:OptOut
            RockMigrationHelper.UpdateWorkflowActionFormAttribute( "61DCBFB1-9CE8-4356-82D8-D69AFE68A58C", "6B90C8F4-885C-4549-BABA-E734AC36F8F4", 4, false, true, false, "B2EC0C36-1ECE-4E29-9501-843D4FBE82D0" ); // Photo Request:Entry:Custom Message:Warning Message
            ...
            RockMigrationHelper.UpdateWorkflowActionType( "DCE1F8D6-34C7-4E9D-9E59-99BE8E98036D", "Set Warning", 0, "C789E457-0783-44B3-9D8F-2EBAB5F11110", true, false, "", "26C30D02-3B89-4EA3-AAA7-08DB2E8EE0C3", 1, "True", "9CFAA39B-C076-4E57-8A33-9F0DC9060F53" ); // Photo Request:Entry:Set Warning
            RockMigrationHelper.UpdateWorkflowActionType( "DCE1F8D6-34C7-4E9D-9E59-99BE8E98036D", "Custom Message", 1, "486DC4FA-FCBC-425F-90B0-E606DA8A9F68", true, false, "61DCBFB1-9CE8-4356-82D8-D69AFE68A58C", "", 1, "", "222809BA-16AD-45D1-B1E2-EFC319359321" ); // Photo Request:Entry:Custom Message
            RockMigrationHelper.UpdateWorkflowActionType( "2885B6AF-F059-465B-947F-E3D36578F67D", "Send Email Action", 0, "66197B01-D1F0-4924-A315-47AD54E030DE", true, false, "", "", 1, "", "2C88DD58-40D3-4927-8A12-7968092C4929" ); // Photo Request:Send Email:Send Email Action
...
SELECT  CASE
   WHEN EXISTS ( SELECT 1
    ...
    END" ); // Photo Request:Launch From Person Profile:Check for Opt Out:SQLQuery
            ...
            RockMigrationHelper.AddActionTypeAttributeValue( "9CFAA39B-C076-4E57-8A33-9F0DC9060F53", "D7EAA859-F500-4521-9523-488B12EAA7D2", @"False" ); // Photo Request:Entry:Set Warning:Active
            RockMigrationHelper.AddActionTypeAttributeValue( "9CFAA39B-C076-4E57-8A33-9F0DC9060F53", "57093B41-50ED-48E5-B72B-8829E62704C8", @"" ); // Photo Request:Entry:Set Warning:Order
            RockMigrationHelper.AddActionTypeAttributeValue( "9CFAA39B-C076-4E57-8A33-9F0DC9060F53", "44A0B977-4730-4519-8FF6-B0A01A95B212", @"6b90c8f4-885c-4549-baba-e734ac36f8f4" ); // Photo Request:Entry:Set Warning:Attribute
            RockMigrationHelper.AddActionTypeAttributeValue( "9CFAA39B-C076-4E57-8A33-9F0DC9060F53", "E5272B11-A2B8-49DC-860D-8D574E2BC15C", @"<div class=""alert alert-warning"">{{ Workflow.Person }} has previously opted out from photo requests.  Make sure you want to override this preference.</div>" ); // Photo Request:Entry:Set Warning:Text Value|Attribute Value
            RockMigrationHelper.AddActionTypeAttributeValue( "222809BA-16AD-45D1-B1E2-EFC319359321", "C178113D-7C86-4229-8424-C6D0CF4A7E23", @"" ); // Photo Request:Entry:Custom Message:Order
            RockMigrationHelper.AddActionTypeAttributeValue( "222809BA-16AD-45D1-B1E2-EFC319359321", "234910F2-A0DB-4D7D-BAF7-83C880EF30AE", @"False" ); // Photo Request:Entry:Custom Message:Active
            RockMigrationHelper.AddActionTypeAttributeValue( "2C88DD58-40D3-4927-8A12-7968092C4929", "36197160-7D3D-490D-AB42-7E29105AFE91", @"False" ); // Photo Request:Send Email:Send Email Action:Active
            RockMigrationHelper.AddActionTypeAttributeValue( "2C88DD58-40D3-4927-8A12-7968092C4929", "D1269254-C15A-40BD-B784-ADCC231D3950", @"" ); // Photo Request:Send Email:Send Email Action:Order
            RockMigrationHelper.AddActionTypeAttributeValue( "2C88DD58-40D3-4927-8A12-7968092C4929", "9F5F7CEC-F369-4FDF-802A-99074CE7A7FC", @"fa5530d4-9580-4c1f-8278-37e2ea19c01b" ); // Photo Request:Send Email:Send Email Action:From Email Address|Attribute Value
            RockMigrationHelper.AddActionTypeAttributeValue( "2C88DD58-40D3-4927-8A12-7968092C4929", "0C4C13B8-7076-4872-925A-F950886B5E16", @"282d67ef-73fe-42a7-a248-f2901873e758" ); // Photo Request:Send Email:Send Email Action:Send To Email Address|Attribute Value
            RockMigrationHelper.AddActionTypeAttributeValue( "2C88DD58-40D3-4927-8A12-7968092C4929", "5D9B13B6-CD96-4C7C-86FA-4512B9D28386", @"Photo Request from {{ Workflow.Sender }}" ); // Photo Request:Send Email:Send Email Action:Subject
...
{{ GlobalAttribute.EmailFooter }}" ); // Photo Request:Send Email:Send Email Action:Body
