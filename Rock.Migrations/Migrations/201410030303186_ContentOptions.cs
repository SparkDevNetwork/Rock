...
namespace Rock.Migrations
{
    ...
    public partial class ContentOptions : Rock.Migrations.RockMigration
    {
        ...
        public override void Up()
        {
            ...
            RockMigrationHelper.AddBlockTypeAttribute( "143A2345-3E26-4ED0-A2FE-42AAF11B4C0F", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Merge Content", "MergeContent", "", "Should the content data and attribute values be merged using the liquid template engine.", 9, @"false", "20BE4E0A-E84C-4AA1-9368-9732A834E1DE" );

            RockMigrationHelper.AddBlockTypeAttribute( "143A2345-3E26-4ED0-A2FE-42AAF11B4C0F", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Set Page Title", "SetPageTitle", "", "Determines the block should set the page title with the channel name or content item.", 10, @"false", "97161D67-EF24-4F21-9E6A-74B696DD33DE" );
            RockMigrationHelper.AddBlockTypeAttribute( "143A2345-3E26-4ED0-A2FE-42AAF11B4C0F", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Rss Autodiscover", "RssAutodiscover", "", "Determines if a RSS autodiscover link should be added to the page head.", 11, @"false", "ABA69AFC-2C5E-4CF6-A156-EDA2752CCC86" );
            RockMigrationHelper.AddBlockTypeAttribute( "143A2345-3E26-4ED0-A2FE-42AAF11B4C0F", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Meta Description Attribute", "MetaDescriptionAttribute", "", "Attribute to use for storing the description attribute.", 12, @"", "E01AE3A7-2607-4DA5-AC98-3A368C900B64" );
            RockMigrationHelper.AddBlockTypeAttribute( "143A2345-3E26-4ED0-A2FE-42AAF11B4C0F", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Meta Image Attribute", "MetaImageAttribute", "", "Attribute to use for storing the image attribute.", 13, @"", "A3510474-86E5-4AD2-BD4C-3C89E85795F5" );
