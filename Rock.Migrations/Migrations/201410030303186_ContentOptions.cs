...
namespace Rock.Migrations
{
    ...
    public partial class ContentOptions : Rock.Migrations.RockMigration
    {
        ...
        public override void Up()
        {
            ...
            RockMigrationHelper.AddBlockTypeAttribute( "143A2345-3E26-4ED0-A2FE-42AAF11B4C0F", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "RSS Autodiscover", "RssAutodiscover", "", "Determines if a RSS autodiscover link should be added to the page head.", 9, @"false", "ABA69AFC-2C5E-4CF6-A156-EDA2752CCC86" );
            RockMigrationHelper.AddBlockTypeAttribute( "143A2345-3E26-4ED0-A2FE-42AAF11B4C0F", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Meta Description Attribute", "MetaDescriptionAttribute", "", "Attribute to use for storing the description attribute.", 10, @"", "E01AE3A7-2607-4DA5-AC98-3A368C900B64" );
            RockMigrationHelper.AddBlockTypeAttribute( "143A2345-3E26-4ED0-A2FE-42AAF11B4C0F", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Meta Image Attribute", "MetaImageAttribute", "", "Attribute to use for storing the image attribute.", 10, @"", "A3510474-86E5-4AD2-BD4C-3C89E85795F5" );
