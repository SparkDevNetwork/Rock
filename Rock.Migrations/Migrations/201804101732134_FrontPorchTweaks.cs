...
namespace Rock.Migrations
{
    ...
    public partial class FrontPorchTweaks : Rock.Migrations.RockMigration
    {
        ...
        public void CorrectBlockTypeAttributes()
        {
            ...
            RockMigrationHelper.UpdateBlockTypeAttribute( "CCFCD227-C8F9-4952-8AC5-E427D519EE47", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Show Acceptance Checkbox", "ShowAccept", "", @"Show or hide the ""I Accept"" checkbox. If it is visible then it will be required. This should be visible if the ""Terms And Conditions"" are also visible.", 5, @"True", "792D8022-9565-4067-9EFD-1A97B8659725" );
            ...
            RockMigrationHelper.UpdateBlockTypeAttribute( "CCFCD227-C8F9-4952-8AC5-E427D519EE47", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Button Text", "ButtonText", "", @"Text to display on the button", 7, @"Connect To WiFi", "13DA26CB-8155-4B2F-B476-6622FEE46D23" );
