...
namespace Rock.Migrations
{
    ...
    public partial class Rollup_0605 : Rock.Migrations.RockMigration
    {
        ...
        private void AddEventWizardPage()
        {
            RockMigrationHelper.AddPage( true, "F7105BFE-B28C-41B6-9CE6-F1018D77DD8F", "D65F783D-87A9-4CC9-8110-E83466A0EADB", "Registration Wizard", "", "56DCED11-C24D-4286-ADE0-57F5D9A0687E", "", "63990874-0DFF-45FC-9F09-81B0B0D375B4" ); // Site:Rock RMS
            RockMigrationHelper.UpdateBlockType( "Event Registration Wizard", "A wizard to simplify creation of Event Registrations.", "~/Blocks/Event/EventRegistrationWizard.ascx", "Event", "C1AF639D-7DD9-4042-BBB9-A0E31E93613A" );
            RockMigrationHelper.AddBlock( true, "56DCED11-C24D-4286-ADE0-57F5D9A0687E".AsGuid(), null, "C2D29296-6A87-47A9-A753-EE4E9159C4C4".AsGuid(), "C1AF639D-7DD9-4042-BBB9-A0E31E93613A".AsGuid(), "Event Registration Wizard", "Main", @"", @"", 0, "8011F994-36A2-4B85-B14B-3DEFACED5045" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "F4399CEF-827B-48B2-A735-F7806FCFE8E8", "Root Group", "RootGroup", "", @"This is the ""root"" of the group tree which will be offered for the staff person to pick the parent group from – limiting where the new group can be created.", 3, @"", "622AA8EA-7885-41EA-94AC-477B03A6F532" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "EC0D9528-1A22-404E-A776-566404987363", "Default Calendar", "DefaultCalendar", "", @"The default calendar which will be pre-selected if the staff person is permitted to create new calendar events.", 1, @"", "CA28C495-383D-4EB1-ACDC-FC88AE1057BD" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "C28C7BF3-A552-4D77-9408-DEDCF760CED0", "Registration Instance Instructions Lava Template", "LavaInstruction_Registration", "", @"Instructions here will show up on the second panel of the wizard.", 2, @"", "84897122-0799-4D72-8C1F-E840206DAC2E" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "434D7B6F-F8DD-45B7-8C3E-C76EF10BE56A", "Default Account", "DefaultAccount", "", @"Select the default financial account which will be pre-filled if a cost is set on the new registration instance.", 0, @"", "190EA097-D590-4246-8A4D-C87A3CFBF861" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Require Group", "RequireGroup", "", @"If set to ""Yes"", you will be required to create a new group.", 5, @"False", "005C6A79-6ECE-4480-B7C6-ACBD7F7D8F0C" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Set Registration Instance Active", "SetRegistrationInstanceActive", "", @"If set to ""No"", the new registration instance will be created, but marked as ""inactive"".", 5, @"True", "B3123E85-0B9A-479D-A4EF-F82C695EAE2F" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Enable Calendar Events", "EnableCalendarEvents", "", @"If calendar events are not enabled, registrations and groups will be created and linked, but not linked to any calendar event.", 6, @"True", "467C8F3B-2838-4014-AA5C-2FBA5CEE567A" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Allow Creating New Calendar Events", "AllowCreatingNewCalendarEvents", "", @"If set to ""Yes"", the staff person will be offered the ""New Event"" tab to create a new event and a new occurrence of that event, rather than only picking from existing events.", 7, @"False", "7A2A6A89-4915-4FD3-A60A-ACBA8F682940" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Require Calendar Events", "RequireCalendarEvents", "", @"If calendar events are enabled and required, you must either select an existing calendar event or create a new one, and you must create an event occurrence.", 8, @"True", "AFE7FA66-8955-460B-B143-3919DBF8A75D" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "46A03F59-55D3-4ACE-ADD5-B4642225DD20", "Completion Workflow", "CompletionWorkflow", "", @"A workflow that will be launched when a new registration is created.", 9, @"", "00C50152-1F59-45E5-94FE-99865B3065F6" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "F725B854-A15E-46AE-9D4C-0608D4154F1E", "Check-In Group Types", "CheckInGroupTypes", "", @"Select group types which should enable check-in.  If the selected registration template is one of these types, check-in options will be enabled for the group.", 10, @"", "970D28B2-41E2-416E-BF58-EF9835AD484C" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "C28C7BF3-A552-4D77-9408-DEDCF760CED0", "Registration Template Instructions Lava Template", "LavaInstruction_InitiateWizard", "", @"Instructions here will show up on the first panel of the wizard.", 1, @"", "DEC5220C-6777-4D1B-B38D-CC421B2EDC18" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "BD53F9C9-EBA9-4D3F-82EA-DE5DD34A8108", "Group Viewer Page", "GroupViewerPage", "", @"Determines which page the link in the final confirmation screen will take you to.", 4, @"4E237286-B715-4109-A578-C1445EC02707", "5804F9BA-8CAA-4D9F-88DF-C238F214DEF6" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "C28C7BF3-A552-4D77-9408-DEDCF760CED0", "Group Instructions Lava Template", "LavaInstruction_Group", "", @"Instructions here will show up on the third panel of the wizard.", 3, @"", "7F8D0252-B099-495E-B79D-B056791666D2" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "C28C7BF3-A552-4D77-9408-DEDCF760CED0", "Event Instructions Lava Template", "LavaInstruction_Event", "", @"Instructions here will show up on the fourth panel of the wizard.", 4, @"", "83324238-1096-44EF-A860-06CD9E8264F2" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "C28C7BF3-A552-4D77-9408-DEDCF760CED0", "Event Occurrence Instructions Lava Template", "LavaInstruction_EventOccurrence", "", @"Instructions here will show up on the fifth panel of the wizard.", 5, @"", "7B5863CA-E2DC-4672-9429-4BE69E50F06C" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "C28C7BF3-A552-4D77-9408-DEDCF760CED0", "Summary Instructions Lava Template", "LavaInstruction_Summary", "", @"Instructions here will show up on the sixth panel of the wizard.", 6, @"", "B279799F-7533-4DD4-99D3-0946D7D204A5" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "C28C7BF3-A552-4D77-9408-DEDCF760CED0", "Wizard Finished Instructions Lava Template", "LavaInstruction_Finished", "", @"Instructions here will show up on the final panel of the wizard.", 7, @"", "8B919E2B-E999-4806-B48E-D1BADDD8FC31" );
            RockMigrationHelper.UpdateBlockTypeAttribute( "C1AF639D-7DD9-4042-BBB9-A0E31E93613A", "74E258FB-DF5B-4708-801D-4837C42ADA32", "Available Registration Templates", "AvailableRegistrationTemplates", "", @"The list of templates the staff person can pick from – not all templates need to be available to all blocks.", 2, @"", "3A557824-F266-42EE-A40D-032DE3B87B27" );
        }
