...
namespace Rock.Migrations
{
    ...
    ///
    /// </summary>
    public partial class DaysUntilAnniversary : Rock.Migrations.RockMigration
    {
        /// <summary>
        ...
        {
            Sql( MigrationSQL._201803201617508_DaysUntilAnniversary, true );
...
{% endif %}", "DF74EDE5-3B7D-4A79-B1F2-499D18FE6F2C" );
        ...
        {
            DropColumn("dbo.Person", "DaysUntilAnniversary");
        }
    }
}
