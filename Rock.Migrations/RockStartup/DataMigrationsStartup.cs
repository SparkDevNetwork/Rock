...
namespace Rock.Migrations.RockStartup
{
    ...
    public class DataMigrationsStartup : IRockStartup
    {
        ...
        public static List<Guid> startupRunOnceJobGuids = new List<Guid>
        {
            ...
            SystemGuid.ServiceJob.DATA_MIGRATIONS_183_FIX_BROKEN_ACHIEVEMENT_TYPES.AsGuid(),
        ...
        public static List<Guid> scheduledRunOnceJobGuids = new List<Guid>
        {
            ...
            SystemGuid.ServiceJob.DATA_MIGRATIONS_190_BACKFILL_CONNECTION_REQUEST_CONNECTED_DATETIME.AsGuid(),
            SystemGuid.ServiceJob.DATA_MIGRATIONS_201_UPDATE_EXCEPTION_LIST_INDEX.AsGuid(),
        };
