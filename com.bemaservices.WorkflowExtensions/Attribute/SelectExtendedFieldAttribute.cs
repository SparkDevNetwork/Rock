...
namespace com.bemaservices.WorkflowExtensions.Attribute
{
    ...
    public abstract class SelectExtendedFieldAttribute : FieldAttribute
    {
        /// <summary>
        ...
        public int RepeatColumns
        {
            ...
            set
            {
                ...
                FieldConfigurationValues.AddOrReplace( REPEAT_COLUMNS, new Rock.Field.ConfigurationValue( value.ToString() ) );
            }
        }
    }
}
