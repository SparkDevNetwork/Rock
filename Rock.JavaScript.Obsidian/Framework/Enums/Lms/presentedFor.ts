 ...
 * be presented to.
 */
export const PresentedForDescription: Record<number, string> = {
    0: "Configuration",
 ...
 * be presented to.
 */
export type PresentedFor = typeof PresentedFor[keyof typeof PresentedFor];
