...
export const StreakStructureType = {
...
/** Represents the attendance association of a StreakType. */
export const StreakStructureTypeDescription: Record<number, string> = {
    0: "Attendance: Any",
...
/** Represents the attendance association of a StreakType. */
export type StreakStructureType = typeof StreakStructureType[keyof typeof StreakStructureType];
