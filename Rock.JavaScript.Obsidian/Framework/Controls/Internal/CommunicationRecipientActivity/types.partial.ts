...
export const RecipientActivityIconCssClass: Record<number, string> = {
...
export const RecipientActivityIconLabelType: Record<number, "default" | "success" | "info" | "warning" | "danger" | "custom"> = {
