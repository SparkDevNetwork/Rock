...
export default defineComponent({
    name: "FinancialStatementTemplatePicker",
    ...
    setup(props, { emit }) {
        ...
        const loadOptions = async (): Promise<ListItemBag[]> => {
            const result = await http.post<ListItemBag[]>("/api/v2/Controls/FinancialStatementTemplatePickerGetFinancialStatementTemplates", undefined, {});
