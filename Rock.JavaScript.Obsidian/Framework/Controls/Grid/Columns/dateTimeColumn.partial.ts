...
import DateTimeColumnCell from "../Cells/dateTimeCell.partial.obs";
import DateTimeColumnSkeletonCell from "../Cells/dateTimeSkeletonCell.partial.obs";
...
function getQuickFilterValue(row: Record<string, unknown>, column: ColumnDefinition): string | undefined {
    ...
    return RockDateTime.parseISO(value)?.toASPString("g");
}
...
export default defineComponent({
    props: {
        ...
        formatComponent: {
            ...
            default: DateTimeColumnCell
        },

        skeletonComponent: {
            type: Object as PropType<Component>,
            default: DateTimeColumnSkeletonCell
        },
