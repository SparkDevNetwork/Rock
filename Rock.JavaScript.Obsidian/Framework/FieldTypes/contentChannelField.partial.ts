...
const editComponent = defineAsyncComponent(async () => {
    return (await import("./contentChannelFieldComponents")).EditComponent;
});

// The configuration component can be quite large, so load it only as needed.
const configurationComponent = defineAsyncComponent(async () => {
    return (await import("./contentChannelFieldComponents")).ConfigurationComponent;
});

export class ContentChannelFieldType extends FieldTypeBase {
