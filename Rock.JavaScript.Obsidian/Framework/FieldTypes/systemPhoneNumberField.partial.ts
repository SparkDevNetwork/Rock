...
const editComponent = defineAsyncComponent(async () => {
    return (await import("./systemPhoneNumberFieldComponents")).EditComponent;
});

// The configuration component can be quite large, so load it only as needed.
const configurationComponent = defineAsyncComponent(async () => {
    return (await import("./systemPhoneNumberFieldComponents")).ConfigurationComponent;
});

export class SystemPhoneNumberFieldType extends FieldTypeBase {
