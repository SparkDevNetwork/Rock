...
import { ConfigurationKey } from "./badgesField.partial";
...
export const EditComponent = defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const options = computed((): ListItemBag[] => {
            const selectedBadges = JSON.parse(props.configurationValues[ConfigurationKey.ClientValues] || "[]") as ListItemBag[];
