...
const editComponent = defineAsyncComponent(async () => {
    return (await import("./achievementTypeFieldComponents")).EditComponent;
});

// Load the configuration component only as needed.
const configurationComponent = defineAsyncComponent(async () => {
    return (await import("./achievementTypeFieldComponents")).ConfigurationComponent;
});

/**
 * The field type handler for the Achievement Type field.
 */
export class AchievementTypeFieldType extends FieldTypeBase {
