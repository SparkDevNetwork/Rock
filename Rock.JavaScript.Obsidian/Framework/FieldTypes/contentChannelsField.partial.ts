...
const editComponent = defineAsyncComponent(async () => {
    return (await import("./contentChannelsFieldComponents")).EditComponent;
});

// The configuration component can be quite large, so load it only as needed.
const configurationComponent = defineAsyncComponent(async () => {
    return (await import("./contentChannelsFieldComponents")).ConfigurationComponent;
});

export class ContentChannelsFieldType extends FieldTypeBase {
