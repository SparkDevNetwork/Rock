...
const editComponent = defineAsyncComponent(async () => {
    return (await import("./codeEditorFieldComponents")).EditComponent;
});

// The configuration component can be quite large, so load it only as needed.
const configurationComponent = defineAsyncComponent(async () => {
    return (await import("./codeEditorFieldComponents")).ConfigurationComponent;
});

export class CodeEditorFieldType extends FieldTypeBase {
