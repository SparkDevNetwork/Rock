...
import { ConfigurationValueKey } from "./secondaryAuthsField.partial";
import { getFieldEditorProps } from "./utils";
import { ListItemBag } from "@Obsidian/ViewModels/Utility/listItemBag";

export const EditComponent = defineComponent({
    name: "SecondaryAuthsField.Edit",
    ...
    template: `
    <CheckBoxList v-model="internalValue" :items="options" :horizontal="false" :repeatColumns="1" />
`
});

export const ConfigurationComponent = defineComponent({
    name: "SecondaryAuthsField.Configuration",
