...
const editComponent = defineAsyncComponent(async () => {
    return (await import("./dataViewsFieldComponents")).EditComponent;
});

// The configuration component can be quite large, so load it only as needed.
const configurationComponent = defineAsyncComponent(async () => {
    return (await import("./dataViewsFieldComponents")).ConfigurationComponent;
});

/**
 * The field type handler for the Financial Account field.
 */
export class DataViewsFieldType extends FieldTypeBase {
