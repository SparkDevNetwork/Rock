...
import { ConfigurationPropertyKey, ConfigurationValueKey } from "./connectionOpportunityField.partial";
...
export const ConfigurationComponent = defineComponent({
    ...
    template: `
    <CheckBox label="Include Inactive" text="Yes" v-model="includeInactive" help="When set, inactive connection opportunities will be included in the list." />
