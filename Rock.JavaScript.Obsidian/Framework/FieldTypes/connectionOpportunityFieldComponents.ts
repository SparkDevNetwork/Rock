...
import { ConfigurationPropertyKey, ConfigurationKey } from "./connectionOpportunityField.partial";
import { ListItemBag } from "@Obsidian/ViewModels/Utility/listItemBag";
import { asBoolean, asTrueOrFalseString } from "@Obsidian/Utility/booleanUtils";
import { isNullOrWhiteSpace } from "@Obsidian/Utility/stringUtils";

export const EditComponent = defineComponent({
    name: "ConnectionOpportunityField.Edit",
    ...
    setup(props, { emit }) {
        ...
        // The ConnectionOpportunities to choose from.
...
export const ConfigurationComponent = defineComponent({
    name: "ConnectionOpportunityField.Configuration",
    ...
    setup(props, { emit }) {
        ...
        watch(connectionTypeValue, () => {
            ...
            maybeUpdateConfiguration(ConfigurationKey.ConnectionTypeFilter, json);
        });
    ...
    template: `
    <CheckBox label="Include Inactive" v-model="includeInactive" help="When set, inactive connection opportunities will be included in the list." />
    <DropDownList label="Connection Type"
        v-model="connectionTypeValue"
        :items="options"
        showBlankItem
        help="Select a Connection Type to limit selection to a specific connection type. Leave blank to allow selection of opportunities from any connection type." />
`
});
