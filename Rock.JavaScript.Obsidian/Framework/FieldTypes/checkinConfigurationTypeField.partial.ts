...
const editComponent = defineAsyncComponent(async () => {
    return (await import("./checkinConfigurationTypeFieldComponents")).EditComponent;
});

// Load the configuration component only as needed.
const configurationComponent = defineAsyncComponent(async () => {
    return (await import("./checkinConfigurationTypeFieldComponents")).ConfigurationComponent;
});

/**
 * The field type handler for the Checkin Configuration field.
 */
export class CheckinConfigurationTypeField extends FieldTypeBase {
