...
const editComponent = defineAsyncComponent(async () => {
    return (await import("./binaryFileTypesFieldComponents")).EditComponent;
});

// The configuration component can be quite large, so load it only as needed.
const configurationComponent = defineAsyncComponent(async () => {
    return (await import("./binaryFileTypesFieldComponents")).ConfigurationComponent;
});

export class BinaryFileTypesFieldType extends FieldTypeBase {
