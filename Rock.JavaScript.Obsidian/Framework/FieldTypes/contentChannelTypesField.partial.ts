...
const editComponent = defineAsyncComponent(async () => {
    return (await import("./contentChannelTypesFieldComponents")).EditComponent;
});

// The configuration component can be quite large, so load it only as needed.
const configurationComponent = defineAsyncComponent(async () => {
    return (await import("./contentChannelTypesFieldComponents")).ConfigurationComponent;
});

export class ContentChannelTypesFieldType extends FieldTypeBase {
