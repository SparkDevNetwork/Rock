 ...
 */
export type BadgeListGetBadgesOptionsBag = {
    /**
    ...
    /**
     * Gets or sets the entity key used with Rock.ViewModels.Rest.Controls.BadgeListGetBadgesOptionsBag.EntityTypeGuid
