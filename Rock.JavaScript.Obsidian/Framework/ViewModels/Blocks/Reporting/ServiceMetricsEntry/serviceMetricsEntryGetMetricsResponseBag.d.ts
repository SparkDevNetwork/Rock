...
export type ServiceMetricsEntryGetMetricsResponseBag = {
    /** Gets or sets the metric categories. */
    metricCategories?: ServiceMetricsEntryMetricCategoryBag[] | null;

    /** Gets or sets the metric items. */
    metricItems?: ServiceMetricsEntryMetricItemBag[] | null;
