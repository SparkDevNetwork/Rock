...
export type ContentSourceBag = {
    /**
     * Gets or sets the unique identifier of this content library source
     * record. This is not the unique identifier of the target entity.
     */
    guid?: Guid | null;

    /** Gets or sets the friendly name of this content library source. */
    name?: string | null;
     ...
     * library source. This will be in the format #rrggbb.
     */
    color?: string | null;
    ...
    /** Gets or sets the number of items that exist on this content library source. */
    itemCount: number;
};
