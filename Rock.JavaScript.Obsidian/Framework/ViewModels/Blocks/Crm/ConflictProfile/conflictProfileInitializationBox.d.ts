...
import { ConflictProfileResultBag } from "@Obsidian/ViewModels/Blocks/Crm/ConflictProfile/conflictProfileResultBag";

/** Contains all the initial configuration data required to render the Conflict Profile block. */
export type ConflictProfileInitializationBox = {
    /**
    ...
    /** Gets or sets the scored results of the most recent assessment. This is null until the assessment is completed. */
    results?: ConflictProfileResultBag | null;
