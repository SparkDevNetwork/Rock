...
import { RequestStatusCountBag } from "@Obsidian/ViewModels/Blocks/Engagement/ConnectionOperationalSnapshot/requestStatusCountBag";

/** Aggregated counts describing the current state of connection requests. */
export type RequestStateBag = {
    /** Gets or sets the request counts grouped by status. */
    byStatus?: RequestStatusCountBag[] | null;
