...
/**
 * Returned by the per-row SaveAttendee block action so the view-panel donut chart
 * can re-render against fresh server-side counts without a full block reload.
 */
export type RsvpAttendeeCountsBag = {
