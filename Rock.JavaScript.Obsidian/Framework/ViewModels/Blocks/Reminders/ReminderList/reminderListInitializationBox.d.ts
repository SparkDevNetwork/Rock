 ...
 * GetReminders block action on mount to populate them so the
 * initialization payload stays minimal.
 */
export type ReminderListInitializationBox = {
    /**
     ...
     * be visible to the user. Driven by the ShowFilters block setting;
