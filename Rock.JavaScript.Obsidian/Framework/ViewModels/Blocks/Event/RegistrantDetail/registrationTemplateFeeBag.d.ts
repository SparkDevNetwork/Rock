...
export type RegistrationTemplateFeeBag = {
     ...
     * hidden entirely when no items remain. When false, the control
    ...
    items?: RegistrationTemplateFeeItemBag[] | null;
