...
import { NotificationMessageActionBag } from "@Obsidian/ViewModels/Core/notificationMessageActionBag";

/**
 * Describes the response data sent back from the GetMessageAction
 * block action.
 */
export type GetMessageActionResponseBag = {
    /** Gets or sets the action to be performed for the message. */
    action?: NotificationMessageActionBag | null;
