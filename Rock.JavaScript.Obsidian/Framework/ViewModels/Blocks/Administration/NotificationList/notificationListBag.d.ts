 ...
 */
export type NotificationListBag = {
    /** Gets or sets the list of unread notification items to display. */
    notifications?: NotificationItemBag[] | null;
};
