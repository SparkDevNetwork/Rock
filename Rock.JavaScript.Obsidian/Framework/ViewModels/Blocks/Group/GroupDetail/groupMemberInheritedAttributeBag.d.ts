...
/**
 * Represents a group-member attribute inherited from a parent (or grandparent) group type,
 * surfaced read-only in the "Inherited Attributes" grid on the edit panel.
 */
