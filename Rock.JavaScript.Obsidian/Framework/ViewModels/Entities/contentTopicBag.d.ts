...
/** ContentTopic View Model */
export type ContentTopicBag = {
    ...
    /** Gets or sets the ContentTopicDomainId of the Rock.Model.ContentTopicDomain that this ContentTopic belongs to. This property is required. */
    contentTopicDomainId: number;
