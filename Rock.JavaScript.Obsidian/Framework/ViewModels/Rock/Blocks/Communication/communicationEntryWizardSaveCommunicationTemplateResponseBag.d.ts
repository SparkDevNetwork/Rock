...
export type CommunicationEntryWizardSaveCommunicationTemplateResponseBag = {
    ...
    communicationTemplateListItem?: CommunicationEntryWizardCommunicationTemplateListItemBag | null;
};
