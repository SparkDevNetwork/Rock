...
/*
    ...
    The single compiler for Custom Component authored source. Only Rock's
    ...
    specs/260814-vibe-coding-custom-components.md for why both were dropped.)
...
export type CustomComponentCompileResult = {
 ...
 */
export function compileSource(source: string): CustomComponentCompileResult {
    const parsed = parse(source, { filename: "CustomComponent.vue" });
