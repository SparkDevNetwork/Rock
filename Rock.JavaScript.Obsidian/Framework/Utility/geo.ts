...
export async function loadMapResources(options: GeoPickerGetSettingsOptionsBag = { mapStyleValueGuid: emptyGuid }): Promise<GeoPickerSettingsBag> {
    ...
    await loadJavaScriptAsync(`https://maps.googleapis.com/maps/api/js?${keyParam}v=3.64&libraries=drawing,visualization,geometry,marker`, () => typeof (google) != "undefined" && typeof (google.maps) != "undefined", {}, false);
