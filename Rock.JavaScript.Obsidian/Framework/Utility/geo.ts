...
export async function loadMapResources(options: GeoPickerGetSettingsOptionsBag = { mapStyleValueGuid: emptyGuid }): Promise<GeoPickerSettingsBag> {
    ...
    await loadJavaScriptAsync(`https://maps.googleapis.com/maps/api/js?${keyParam}libraries=visualization,geometry,marker`, () => typeof (google) != "undefined" && typeof (google.maps) != "undefined", {}, false);
