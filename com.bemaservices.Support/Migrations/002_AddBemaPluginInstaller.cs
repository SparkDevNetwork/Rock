...
namespace com.bemaservices.Support
{
    ...
    public class AddBemaPluginInstaller : Migration
    {
        ...
        {
            RockMigrationHelper.AddGlobalAttribute( Rock.SystemGuid.FieldType.TEXT, "", "", "BEMA Code Package Version", "Currently installed BEMA Code version number", 0, "0.0.0.0", com.bemaservices.Support.SystemGuid.Attribute.BEMA_CODE_VERSION_ATTRIBUTE_GUID );
        ...
        public override void Down()
        {
            ...
            RockMigrationHelper.DeleteAttribute( com.bemaservices.Support.SystemGuid.Attribute.BEMA_CODE_VERSION_ATTRIBUTE_GUID );
        }
    }
}
