...
namespace Rock.NCOA
{
    ...
    public class NcoaReturnRecord
    {
        ...
        /// </value>
        [JsonProperty( "input_personId" )]
        public string InputIndividualId { get; set; }

        [JsonProperty( "input_personAliasId" )]
        public string InputPersonAliasId {  get; set; }

        [JsonProperty( "input_familyId" )]
        public string InputFamilyId {  get; set; }

        [JsonProperty( "input_locationId" )]
        public string InputLocationId { get; set; }
