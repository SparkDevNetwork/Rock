...
{
    /// <summary>
    /// Custom <see cref="RouteDataValueProvider"/> implementation that
    /// handles special API v2 considerations.
    /// </summary>
    /// <seealso cref="System.Web.Http.ValueProviders.Providers.RouteDataValueProvider" />
    public class RockRouteDataValueProvider : RouteDataValueProvider
    {
        private readonly HttpActionContext _actionContext;

        /// <summary>
        /// Initializes a new instance of the <see cref="RockRouteDataValueProvider"/> class.
        /// </summary>
        /// <param name="actionContext">The action context.</param>
        public RockRouteDataValueProvider( HttpActionContext actionContext )
