...
{
    /// <summary>
    /// The options that can be provided to <see cref="ControlsController.LocationPickerGetActiveChildren(LocationPickerGetActiveChildrenOptions)"/>.
    /// </summary>
    public class LocationPickerGetActiveChildrenOptions
    {
        /// <summary>
