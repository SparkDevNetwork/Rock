...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class PersonAliasesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.PersonAlias ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.PersonAlias, Rock.Model.PersonAliasService>( this );
