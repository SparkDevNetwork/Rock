...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ConnectionRequestActivitiesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ConnectionRequestActivity ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ConnectionRequestActivity, Rock.Model.ConnectionRequestActivityService>( this );
