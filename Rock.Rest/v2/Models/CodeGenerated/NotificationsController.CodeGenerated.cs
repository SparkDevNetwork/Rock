...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class NotificationsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.Notification ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.Notification, Rock.Model.NotificationService>( this );
