...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Learning Activity Completions.
    /// </summary>
    [RoutePrefix( "api/v2/models/learningactivitycompletions" )]
    [Rock.SystemGuid.RestControllerGuid( "94c5133d-10b9-5376-9ebc-546b61987234" )]
    public partial class LearningActivityCompletionsController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( HttpStatusCode.OK, Type = typeof( Rock.Model.LearningActivityCompletion ) )]
        [ProducesResponseType( HttpStatusCode.BadRequest )]
        [ProducesResponseType( HttpStatusCode.NotFound )]
        [ProducesResponseType( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "15d426dc-3718-569d-b1fe-073464632a3c" )]
        public IActionResult GetItem( string id )
        {
            var helper = new CrudEndpointHelper<Rock.Model.LearningActivityCompletion, Rock.Model.LearningActivityCompletionService>( this );
        ...
        [ProducesResponseType( HttpStatusCode.NotFound )]
        [ProducesResponseType( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "3904d5aa-0da7-5c98-8c1a-5fa2bdf010a8" )]
        public IActionResult PostItem( [FromBody] Rock.Model.LearningActivityCompletion value )
        {
            var helper = new CrudEndpointHelper<Rock.Model.LearningActivityCompletion, Rock.Model.LearningActivityCompletionService>( this );
        ...
        [ProducesResponseType( HttpStatusCode.NotFound )]
        [ProducesResponseType( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "4b1d8b7b-b35a-53f6-a4ad-4d2253d34877" )]
        public IActionResult PutItem( string id, [FromBody] Rock.Model.LearningActivityCompletion value )
        {
            var helper = new CrudEndpointHelper<Rock.Model.LearningActivityCompletion, Rock.Model.LearningActivityCompletionService>( this );
        ...
        [ProducesResponseType( HttpStatusCode.NotFound )]
        [ProducesResponseType( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "b6ff0e65-1af6-530f-a678-75ad327bc674" )]
        ...
        [ProducesResponseType( HttpStatusCode.NotFound )]
        [ProducesResponseType( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "0095d228-08e8-59eb-93d0-64b0ecd55d40" )]
        ...
        [ProducesResponseType( HttpStatusCode.NotFound )]
        [ProducesResponseType( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "cac4aa07-e0ab-594d-80fd-7379c0a42d0c" )]
        ...
        [ProducesResponseType( HttpStatusCode.NotFound )]
        [ProducesResponseType( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "dbbd72ce-afbf-525e-9f49-0b3b2fd7735e" )]
        ...
        [SystemGuid.RestActionGuid( "add27745-5b54-5772-bbd6-f5c529e485aa" )]
        ...
        [ProducesResponseType( HttpStatusCode.NotFound )]
        [ProducesResponseType( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "ca45aa35-7666-5122-b30b-a7a8330fadfb" )]
        ...
        [ProducesResponseType( HttpStatusCode.NotFound )]
        [ProducesResponseType( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "755ada14-5f1e-511b-b2ec-a3fd7f0a52fc" )]
