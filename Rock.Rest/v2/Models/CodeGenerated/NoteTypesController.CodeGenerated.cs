...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class NoteTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.NoteType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.NoteType, Rock.Model.NoteTypeService>( this );
