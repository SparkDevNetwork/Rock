...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class StepProgramCompletionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.StepProgramCompletion ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.StepProgramCompletion, Rock.Model.StepProgramCompletionService>( this );
