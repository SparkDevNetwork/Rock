...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AnalyticsSourceGivingUnitsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AnalyticsSourceGivingUnit ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AnalyticsSourceGivingUnit, Rock.Model.AnalyticsSourceGivingUnitService>( this );
