...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class GroupRequirementTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.GroupRequirementType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.GroupRequirementType, Rock.Model.GroupRequirementTypeService>( this );
