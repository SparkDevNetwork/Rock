...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class PersonalLinksController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.PersonalLink ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.PersonalLink, Rock.Model.PersonalLinkService>( this );
