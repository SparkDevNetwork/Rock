...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class RegistrationRegistrantsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.RegistrationRegistrant ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.RegistrationRegistrant, Rock.Model.RegistrationRegistrantService>( this );
