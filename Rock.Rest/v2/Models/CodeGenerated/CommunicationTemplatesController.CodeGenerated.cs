...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class CommunicationTemplatesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.CommunicationTemplate ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.CommunicationTemplate, Rock.Model.CommunicationTemplateService>( this );
