...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AdaptiveMessageCategoriesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AdaptiveMessageCategory ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AdaptiveMessageCategory, Rock.Model.AdaptiveMessageCategoryService>( this );
