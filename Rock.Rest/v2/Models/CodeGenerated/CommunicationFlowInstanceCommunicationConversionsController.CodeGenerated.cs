...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class CommunicationFlowInstanceCommunicationConversionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.CommunicationFlowInstanceCommunicationConversion ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.CommunicationFlowInstanceCommunicationConversion, Rock.Model.CommunicationFlowInstanceCommunicationConversionService>( this );
