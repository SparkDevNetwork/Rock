...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AuthScopesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AuthScope ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AuthScope, Rock.Model.AuthScopeService>( this );
