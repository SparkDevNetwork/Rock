...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Metric Values.
    /// </summary>
    [RoutePrefix( "api/v2/models/metricvalues" )]
    [Rock.SystemGuid.RestControllerGuid( "83f11725-77f9-5fee-b9cf-2af97af5b080" )]
    public partial class MetricValuesController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.MetricValue ) )]
