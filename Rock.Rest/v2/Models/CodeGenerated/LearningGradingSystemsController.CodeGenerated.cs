...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class LearningGradingSystemsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.LearningGradingSystem ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.LearningGradingSystem, Rock.Model.LearningGradingSystemService>( this );
