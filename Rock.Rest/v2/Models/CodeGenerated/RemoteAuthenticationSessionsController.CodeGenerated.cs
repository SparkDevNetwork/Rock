...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Remote Authentication Sessions.
    /// </summary>
    [RoutePrefix( "api/v2/models/remoteauthenticationsessions" )]
    [Rock.SystemGuid.RestControllerGuid( "e32eb52b-26bc-5180-8e00-28940c0da1db" )]
    public partial class RemoteAuthenticationSessionsController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.RemoteAuthenticationSession ) )]
