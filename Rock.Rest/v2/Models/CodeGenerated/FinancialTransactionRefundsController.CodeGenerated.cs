...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Financial Transaction Refunds.
    /// </summary>
    [RoutePrefix( "api/v2/models/financialtransactionrefunds" )]
    [Rock.SystemGuid.RestControllerGuid( "5164f5a0-e476-5a50-adfa-0287c6da109a" )]
    public partial class FinancialTransactionRefundsController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.FinancialTransactionRefund ) )]
