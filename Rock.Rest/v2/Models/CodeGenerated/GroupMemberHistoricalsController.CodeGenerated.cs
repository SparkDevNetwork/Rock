...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class GroupMemberHistoricalsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.GroupMemberHistorical ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.GroupMemberHistorical, Rock.Model.GroupMemberHistoricalService>( this );
