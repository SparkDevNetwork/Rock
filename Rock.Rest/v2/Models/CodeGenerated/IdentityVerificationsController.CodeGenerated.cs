...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class IdentityVerificationsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.IdentityVerification ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.IdentityVerification, Rock.Model.IdentityVerificationService>( this );
