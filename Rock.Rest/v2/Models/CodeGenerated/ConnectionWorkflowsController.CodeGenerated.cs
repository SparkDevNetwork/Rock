...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ConnectionWorkflowsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ConnectionWorkflow ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ConnectionWorkflow, Rock.Model.ConnectionWorkflowService>( this );
