...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Following Event Types.
    /// </summary>
    [RoutePrefix( "api/v2/models/followingeventtypes" )]
    [Rock.SystemGuid.RestControllerGuid( "fd7d848f-c685-5520-9318-e9b8494ccdd4" )]
    public partial class FollowingEventTypesController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.FollowingEventType ) )]
