...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class BenevolenceWorkflowsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.BenevolenceWorkflow ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.BenevolenceWorkflow, Rock.Model.BenevolenceWorkflowService>( this );
