...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class EntitySetsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.EntitySet ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.EntitySet, Rock.Model.EntitySetService>( this );
