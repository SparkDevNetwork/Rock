...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class EntityIntentsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.EntityIntent ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.EntityIntent, Rock.Model.EntityIntentService>( this );
