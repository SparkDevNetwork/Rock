...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class LearningCourseRequirementsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.LearningCourseRequirement ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.LearningCourseRequirement, Rock.Model.LearningCourseRequirementService>( this );
