...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class SystemCommunicationsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.SystemCommunication ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.SystemCommunication, Rock.Model.SystemCommunicationService>( this );
