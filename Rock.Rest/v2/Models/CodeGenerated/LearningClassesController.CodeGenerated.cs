...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class LearningClassesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.LearningClass ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.LearningClass, Rock.Model.LearningClassService>( this );
