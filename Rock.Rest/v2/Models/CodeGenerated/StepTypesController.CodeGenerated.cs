...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class StepTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.StepType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.StepType, Rock.Model.StepTypeService>( this );
