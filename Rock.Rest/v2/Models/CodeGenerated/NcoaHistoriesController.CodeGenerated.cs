...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class NcoaHistoriesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.NcoaHistory ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.NcoaHistory, Rock.Model.NcoaHistoryService>( this );
