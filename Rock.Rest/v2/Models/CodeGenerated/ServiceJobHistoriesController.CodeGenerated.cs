...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ServiceJobHistoriesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ServiceJobHistory ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ServiceJobHistory, Rock.Model.ServiceJobHistoryService>( this );
