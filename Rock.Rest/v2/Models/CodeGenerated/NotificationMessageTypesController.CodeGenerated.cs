...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class NotificationMessageTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.NotificationMessageType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.NotificationMessageType, Rock.Model.NotificationMessageTypeService>( this );
