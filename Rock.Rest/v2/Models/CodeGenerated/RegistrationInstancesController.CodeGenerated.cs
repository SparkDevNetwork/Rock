...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class RegistrationInstancesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.RegistrationInstance ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.RegistrationInstance, Rock.Model.RegistrationInstanceService>( this );
