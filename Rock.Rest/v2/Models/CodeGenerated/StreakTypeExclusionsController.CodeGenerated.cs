...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class StreakTypeExclusionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.StreakTypeExclusion ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.StreakTypeExclusion, Rock.Model.StreakTypeExclusionService>( this );
