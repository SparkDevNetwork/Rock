...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class StepProgramsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.StepProgram ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.StepProgram, Rock.Model.StepProgramService>( this );
