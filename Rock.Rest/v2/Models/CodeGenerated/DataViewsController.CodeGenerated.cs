...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class DataViewsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.DataView ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.DataView, Rock.Model.DataViewService>( this );
