...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Campus Topics.
    /// </summary>
    [RoutePrefix( "api/v2/models/campustopics" )]
    [Rock.SystemGuid.RestControllerGuid( "5f6a1a4a-73df-5556-891f-cb0600c18d56" )]
    public partial class CampusTopicsController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.CampusTopic ) )]
