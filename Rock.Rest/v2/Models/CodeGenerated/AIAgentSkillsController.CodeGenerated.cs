...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AIAgentSkillsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AIAgentSkill ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AIAgentSkill, Rock.Model.AIAgentSkillService>( this );
