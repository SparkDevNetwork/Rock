...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ServiceLogsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ServiceLog ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ServiceLog, Rock.Model.ServiceLogService>( this );
