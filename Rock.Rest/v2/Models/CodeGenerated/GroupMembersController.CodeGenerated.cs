...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class GroupMembersController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.GroupMember ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.GroupMember, Rock.Model.GroupMemberService>( this );
