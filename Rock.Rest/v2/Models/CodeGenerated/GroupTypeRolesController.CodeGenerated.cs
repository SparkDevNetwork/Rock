...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class GroupTypeRolesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.GroupTypeRole ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.GroupTypeRole, Rock.Model.GroupTypeRoleService>( this );
