...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class FinancialScheduledTransactionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.FinancialScheduledTransaction ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.FinancialScheduledTransaction, Rock.Model.FinancialScheduledTransactionService>( this );
