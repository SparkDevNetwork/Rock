...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Interactive Experience Occurrences.
    /// </summary>
    [RoutePrefix( "api/v2/models/interactiveexperienceoccurrences" )]
    [Rock.SystemGuid.RestControllerGuid( "259bb9b8-6281-5bd6-936f-f4a0f72b15ac" )]
    public partial class InteractiveExperienceOccurrencesController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.InteractiveExperienceOccurrence ) )]
