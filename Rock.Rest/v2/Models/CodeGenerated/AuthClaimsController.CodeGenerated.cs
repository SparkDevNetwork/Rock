...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AuthClaimsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AuthClaim ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AuthClaim, Rock.Model.AuthClaimService>( this );
