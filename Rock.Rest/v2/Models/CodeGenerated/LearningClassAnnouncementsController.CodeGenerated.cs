...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class LearningClassAnnouncementsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.LearningClassAnnouncement ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.LearningClassAnnouncement, Rock.Model.LearningClassAnnouncementService>( this );
