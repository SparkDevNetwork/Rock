...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class RegistrationTemplateFormsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.RegistrationTemplateForm ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.RegistrationTemplateForm, Rock.Model.RegistrationTemplateFormService>( this );
