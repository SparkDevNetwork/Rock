...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ServiceJobsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ServiceJob ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ServiceJob, Rock.Model.ServiceJobService>( this );
