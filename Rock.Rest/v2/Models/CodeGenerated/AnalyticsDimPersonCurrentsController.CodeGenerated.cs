...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AnalyticsDimPersonCurrentsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AnalyticsDimPersonCurrent ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AnalyticsDimPersonCurrent, Rock.Model.AnalyticsDimPersonCurrentService>( this );
