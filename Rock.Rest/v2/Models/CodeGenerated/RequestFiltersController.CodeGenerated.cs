...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class RequestFiltersController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.RequestFilter ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.RequestFilter, Rock.Model.RequestFilterService>( this );
