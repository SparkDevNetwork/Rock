...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class CommunicationAttachmentsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.CommunicationAttachment ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.CommunicationAttachment, Rock.Model.CommunicationAttachmentService>( this );
