...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class PhoneNumbersController : ApiControllerBase
    {
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.PhoneNumber ) )]
        ...
        {
            var helper = new CrudEndpointHelper<Rock.Model.PhoneNumber, Rock.Model.PhoneNumberService>( this );
