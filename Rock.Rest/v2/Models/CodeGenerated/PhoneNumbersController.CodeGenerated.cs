...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class PhoneNumbersController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.PhoneNumber ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.PhoneNumber, Rock.Model.PhoneNumberService>( this );
