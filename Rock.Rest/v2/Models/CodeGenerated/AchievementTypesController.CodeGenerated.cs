...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Achievement Types.
    /// </summary>
    [RoutePrefix( "api/v2/models/achievementtypes" )]
    [Rock.SystemGuid.RestControllerGuid( "965fa776-9fc7-556f-8f9c-43f97844a60a" )]
    public partial class AchievementTypesController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.AchievementType ) )]
