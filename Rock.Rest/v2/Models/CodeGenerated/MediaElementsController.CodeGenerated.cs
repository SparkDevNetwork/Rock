...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class MediaElementsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.MediaElement ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.MediaElement, Rock.Model.MediaElementService>( this );
