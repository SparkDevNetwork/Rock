...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class LearningCoursesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.LearningCourse ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.LearningCourse, Rock.Model.LearningCourseService>( this );
