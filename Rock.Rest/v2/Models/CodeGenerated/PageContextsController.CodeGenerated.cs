...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class PageContextsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.PageContext ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.PageContext, Rock.Model.PageContextService>( this );
