...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class GroupMemberAssignmentsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.GroupMemberAssignment ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.GroupMemberAssignment, Rock.Model.GroupMemberAssignmentService>( this );
