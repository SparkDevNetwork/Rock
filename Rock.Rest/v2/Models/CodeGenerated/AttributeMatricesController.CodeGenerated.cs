...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Attribute Matrices.
    /// </summary>
    [RoutePrefix( "api/v2/models/attributematrices" )]
    [Rock.SystemGuid.RestControllerGuid( "36a5f667-5bed-5548-8235-933ee30009f8" )]
    public partial class AttributeMatricesController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.AttributeMatrix ) )]
