...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class BinaryFilesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.BinaryFile ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.BinaryFile, Rock.Model.BinaryFileService>( this );
