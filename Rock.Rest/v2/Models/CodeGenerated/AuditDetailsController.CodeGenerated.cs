...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AuditDetailsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AuditDetail ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AuditDetail, Rock.Model.AuditDetailService>( this );
