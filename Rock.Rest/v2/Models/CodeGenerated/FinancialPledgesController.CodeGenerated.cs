...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class FinancialPledgesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.FinancialPledge ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.FinancialPledge, Rock.Model.FinancialPledgeService>( this );
