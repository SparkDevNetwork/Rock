...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class HistoryLoginsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.HistoryLogin ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.HistoryLogin, Rock.Model.HistoryLoginService>( this );
