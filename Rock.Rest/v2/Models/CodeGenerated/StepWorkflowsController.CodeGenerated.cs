...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class StepWorkflowsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.StepWorkflow ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.StepWorkflow, Rock.Model.StepWorkflowService>( this );
