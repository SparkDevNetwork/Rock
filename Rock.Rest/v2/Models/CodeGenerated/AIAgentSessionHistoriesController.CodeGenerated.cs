...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AIAgentSessionHistoriesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AIAgentSessionHistory ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AIAgentSessionHistory, Rock.Model.AIAgentSessionHistoryService>( this );
