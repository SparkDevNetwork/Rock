...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class HtmlContentsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.HtmlContent ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.HtmlContent, Rock.Model.HtmlContentService>( this );
