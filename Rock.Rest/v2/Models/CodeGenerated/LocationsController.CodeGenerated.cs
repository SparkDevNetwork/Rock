...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class LocationsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.Location ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.Location, Rock.Model.LocationService>( this );
