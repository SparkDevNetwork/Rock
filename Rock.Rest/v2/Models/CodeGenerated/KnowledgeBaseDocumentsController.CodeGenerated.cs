...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Knowledge Base Documents.
    /// </summary>
    [RoutePrefix( "api/v2/models/knowledgebasedocuments" )]
    [Rock.SystemGuid.RestControllerGuid( "7ea47fba-3bcd-58f5-b8bd-6a3966cf4b6e" )]
    public partial class KnowledgeBaseDocumentsController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.KnowledgeBaseDocument ) )]
        ...
        [SystemGuid.RestActionGuid( "dfa116fc-8139-5990-b6a0-5199f4c4224a" )]
        public IActionResult GetItem( string id )
        {
            var helper = new CrudEndpointHelper<Rock.Model.KnowledgeBaseDocument, Rock.Model.KnowledgeBaseDocumentService>( this );
        ...
        [ProducesResponse( HttpStatusCode.NotFound )]
        [ProducesResponse( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "67837ddf-3f5b-55c0-a376-bc149e41d8c6" )]
        public IActionResult PostItem( [FromBody] Rock.Model.KnowledgeBaseDocument value )
        {
            var helper = new CrudEndpointHelper<Rock.Model.KnowledgeBaseDocument, Rock.Model.KnowledgeBaseDocumentService>( this );
        ...
        [ProducesResponse( HttpStatusCode.NotFound )]
        [ProducesResponse( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "17e4acf5-6abe-55d6-ba17-7c5eb09537ca" )]
        public IActionResult PutItem( string id, [FromBody] Rock.Model.KnowledgeBaseDocument value )
        {
            var helper = new CrudEndpointHelper<Rock.Model.KnowledgeBaseDocument, Rock.Model.KnowledgeBaseDocumentService>( this );
        ...
        [ProducesResponse( HttpStatusCode.NotFound )]
        [ProducesResponse( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "000ced8c-5d52-52d6-95bb-1a83cfcc8685" )]
        ...
        [ProducesResponse( HttpStatusCode.NotFound )]
        [ProducesResponse( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "a67cdc9a-3b9b-503f-81e0-d71adc03da0d" )]
        ...
        [ProducesResponse( HttpStatusCode.NotFound )]
        [ProducesResponse( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "4feeb988-a660-5685-ac84-9e9bf18884e1" )]
        ...
        [ProducesResponse( HttpStatusCode.NotFound )]
        [ProducesResponse( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "4ae9ada8-b921-5252-a47a-a445b1ff6780" )]
        ...
        [SystemGuid.RestActionGuid( "4d340450-0603-51d5-8034-10009a04d08d" )]
        ...
        [ProducesResponse( HttpStatusCode.NotFound )]
        [ProducesResponse( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "d47fa952-b701-5be3-b709-a411a17c70e1" )]
        ...
        [ProducesResponse( HttpStatusCode.NotFound )]
        [ProducesResponse( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "9b6df48d-2ee5-567b-8586-2617b4373043" )]
