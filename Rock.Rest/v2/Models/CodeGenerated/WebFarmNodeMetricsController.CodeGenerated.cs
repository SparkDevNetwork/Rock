...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Web Farm Node Metrics.
    /// </summary>
    [RoutePrefix( "api/v2/models/webfarmnodemetrics" )]
    [Rock.SystemGuid.RestControllerGuid( "2f16a7c2-05fa-5ab9-8c3c-912cfdd41934" )]
    public partial class WebFarmNodeMetricsController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.WebFarmNodeMetric ) )]
        [ProducesResponseType( StatusCodes.Status400BadRequest )]
        [ProducesResponseType( StatusCodes.Status404NotFound )]
        [ProducesResponseType( StatusCodes.Status401Unauthorized )]
        [SystemGuid.RestActionGuid( "124b3170-2120-5e10-80df-a198d65579a0" )]
        public IActionResult GetItem( string id )
        {
            var helper = new CrudEndpointHelper<Rock.Model.WebFarmNodeMetric, Rock.Model.WebFarmNodeMetricService>( this );
        ...
        [ProducesResponseType( StatusCodes.Status404NotFound )]
        [ProducesResponseType( StatusCodes.Status401Unauthorized )]
        [SystemGuid.RestActionGuid( "137dea4a-c386-577e-bca0-e2481cc8e988" )]
        ...
        [SystemGuid.RestActionGuid( "5fad6370-b9c8-5206-9408-35756fd5f37f" )]
        ...
        [ProducesResponseType( StatusCodes.Status404NotFound )]
        [ProducesResponseType( StatusCodes.Status401Unauthorized )]
        [SystemGuid.RestActionGuid( "2593c86c-f0c6-5041-b495-07551b9288b1" )]
        ...
        [ProducesResponseType( StatusCodes.Status404NotFound )]
        [ProducesResponseType( StatusCodes.Status401Unauthorized )]
        [SystemGuid.RestActionGuid( "e9d5cde7-169a-55df-b94f-069854d08275" )]
