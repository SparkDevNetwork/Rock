...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class WebFarmNodeMetricsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.WebFarmNodeMetric ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.WebFarmNodeMetric, Rock.Model.WebFarmNodeMetricService>( this );
