...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class FieldTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.FieldType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.FieldType, Rock.Model.FieldTypeService>( this );
