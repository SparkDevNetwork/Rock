...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class MetricPartitionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.MetricPartition ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.MetricPartition, Rock.Model.MetricPartitionService>( this );
