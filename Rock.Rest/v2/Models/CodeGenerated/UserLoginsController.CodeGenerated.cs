...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class UserLoginsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.UserLogin ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.UserLogin, Rock.Model.UserLoginService>( this );
