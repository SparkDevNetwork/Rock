...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AIAgentSessionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AIAgentSession ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AIAgentSession, Rock.Model.AIAgentSessionService>( this );
