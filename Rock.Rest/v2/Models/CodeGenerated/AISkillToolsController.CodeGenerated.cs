...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AISkillToolsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AISkillTool ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AISkillTool, Rock.Model.AISkillToolService>( this );
