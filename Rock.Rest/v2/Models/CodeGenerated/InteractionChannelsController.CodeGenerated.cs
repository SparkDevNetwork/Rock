...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class InteractionChannelsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.InteractionChannel ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.InteractionChannel, Rock.Model.InteractionChannelService>( this );
