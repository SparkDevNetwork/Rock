...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class CommunicationRecipientsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.CommunicationRecipient ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.CommunicationRecipient, Rock.Model.CommunicationRecipientService>( this );
