...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class SchedulesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.Schedule ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.Schedule, Rock.Model.ScheduleService>( this );
