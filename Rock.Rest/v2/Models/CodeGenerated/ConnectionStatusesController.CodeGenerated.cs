...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ConnectionStatusesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ConnectionStatus ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ConnectionStatus, Rock.Model.ConnectionStatusService>( this );
