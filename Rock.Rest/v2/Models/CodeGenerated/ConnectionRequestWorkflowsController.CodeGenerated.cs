...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ConnectionRequestWorkflowsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ConnectionRequestWorkflow ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ConnectionRequestWorkflow, Rock.Model.ConnectionRequestWorkflowService>( this );
