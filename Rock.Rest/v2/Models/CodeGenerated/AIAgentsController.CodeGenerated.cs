...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AIAgentsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AIAgent ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AIAgent, Rock.Model.AIAgentService>( this );
