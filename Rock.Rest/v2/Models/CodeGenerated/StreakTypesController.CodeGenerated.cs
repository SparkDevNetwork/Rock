...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class StreakTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.StreakType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.StreakType, Rock.Model.StreakTypeService>( this );
