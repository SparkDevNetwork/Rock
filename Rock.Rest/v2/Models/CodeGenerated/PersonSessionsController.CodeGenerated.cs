...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Person Sessions.
    /// </summary>
    [RoutePrefix( "api/v2/models/personsessions" )]
    [Rock.SystemGuid.RestControllerGuid( "76692273-ade5-5f96-8654-b870d589c305" )]
    public partial class PersonSessionsController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.PersonSession ) )]
        ...
        [SystemGuid.RestActionGuid( "2d6d5b79-adf9-5477-abf7-17dd51042f3e" )]
        public IActionResult GetItem( string id )
        {
            var helper = new CrudEndpointHelper<Rock.Model.PersonSession, Rock.Model.PersonSessionService>( this );
        ...
        [ProducesResponse( HttpStatusCode.NotFound )]
        [ProducesResponse( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "a03bb9f2-d0d3-5210-8075-cf882a06285e" )]
        ...
        [SystemGuid.RestActionGuid( "0a2e23af-0163-57ad-bac0-569c07108d02" )]
        ...
        [ProducesResponse( HttpStatusCode.NotFound )]
        [ProducesResponse( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "462889b5-9774-54f3-bc27-926790f540be" )]
        ...
        [ProducesResponse( HttpStatusCode.NotFound )]
        [ProducesResponse( HttpStatusCode.Unauthorized )]
        [SystemGuid.RestActionGuid( "8703df39-50f3-5939-8dc0-721bf7666fde" )]
