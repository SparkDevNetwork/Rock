...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ContentChannelTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ContentChannelType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ContentChannelType, Rock.Model.ContentChannelTypeService>( this );
