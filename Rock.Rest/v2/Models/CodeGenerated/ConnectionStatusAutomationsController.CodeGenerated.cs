...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ConnectionStatusAutomationsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ConnectionStatusAutomation ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ConnectionStatusAutomation, Rock.Model.ConnectionStatusAutomationService>( this );
