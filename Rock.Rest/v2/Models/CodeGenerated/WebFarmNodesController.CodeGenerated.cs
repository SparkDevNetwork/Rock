...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class WebFarmNodesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.WebFarmNode ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.WebFarmNode, Rock.Model.WebFarmNodeService>( this );
