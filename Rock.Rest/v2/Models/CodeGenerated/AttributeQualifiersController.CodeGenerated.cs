...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Attribute Qualifiers.
    /// </summary>
    [RoutePrefix( "api/v2/models/attributequalifiers" )]
    [Rock.SystemGuid.RestControllerGuid( "1141a11a-137d-5577-8988-b7479abfaee0" )]
    public partial class AttributeQualifiersController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.AttributeQualifier ) )]
