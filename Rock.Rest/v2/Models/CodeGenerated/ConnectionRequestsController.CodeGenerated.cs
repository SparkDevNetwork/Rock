...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ConnectionRequestsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ConnectionRequest ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ConnectionRequest, Rock.Model.ConnectionRequestService>( this );
