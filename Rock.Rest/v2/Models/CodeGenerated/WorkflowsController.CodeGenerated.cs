...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class WorkflowsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.Workflow ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.Workflow, Rock.Model.WorkflowService>( this );
