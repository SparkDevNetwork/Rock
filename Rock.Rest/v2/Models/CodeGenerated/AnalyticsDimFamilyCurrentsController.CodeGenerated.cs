...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AnalyticsDimFamilyCurrentsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AnalyticsDimFamilyCurrent ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AnalyticsDimFamilyCurrent, Rock.Model.AnalyticsDimFamilyCurrentService>( this );
