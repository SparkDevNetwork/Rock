...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class SmsPipelinesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.SmsPipeline ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.SmsPipeline, Rock.Model.SmsPipelineService>( this );
