...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class SnippetsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.Snippet ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.Snippet, Rock.Model.SnippetService>( this );
