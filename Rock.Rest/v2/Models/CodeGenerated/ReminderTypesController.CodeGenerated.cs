...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ReminderTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ReminderType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ReminderType, Rock.Model.ReminderTypeService>( this );
