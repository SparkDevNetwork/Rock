...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class NotificationRecipientsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.NotificationRecipient ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.NotificationRecipient, Rock.Model.NotificationRecipientService>( this );
