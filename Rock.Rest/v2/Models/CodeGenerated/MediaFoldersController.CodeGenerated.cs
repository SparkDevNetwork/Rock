...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class MediaFoldersController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.MediaFolder ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.MediaFolder, Rock.Model.MediaFolderService>( this );
