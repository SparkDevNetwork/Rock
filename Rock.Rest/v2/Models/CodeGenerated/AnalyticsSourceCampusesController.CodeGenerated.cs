...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AnalyticsSourceCampusesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AnalyticsSourceCampus ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AnalyticsSourceCampus, Rock.Model.AnalyticsSourceCampusService>( this );
