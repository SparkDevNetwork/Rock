...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class CommunicationFlowsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.CommunicationFlow ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.CommunicationFlow, Rock.Model.CommunicationFlowService>( this );
