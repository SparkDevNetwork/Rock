...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class DocumentsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.Document ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.Document, Rock.Model.DocumentService>( this );
