...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class WorkflowActivityTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.WorkflowActivityType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.WorkflowActivityType, Rock.Model.WorkflowActivityTypeService>( this );
