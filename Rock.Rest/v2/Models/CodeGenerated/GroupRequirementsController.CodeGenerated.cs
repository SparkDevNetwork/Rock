...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class GroupRequirementsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.GroupRequirement ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.GroupRequirement, Rock.Model.GroupRequirementService>( this );
