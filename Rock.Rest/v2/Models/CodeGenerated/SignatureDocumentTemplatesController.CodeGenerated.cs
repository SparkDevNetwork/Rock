...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class SignatureDocumentTemplatesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.SignatureDocumentTemplate ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.SignatureDocumentTemplate, Rock.Model.SignatureDocumentTemplateService>( this );
