...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class FinancialPaymentDetailsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.FinancialPaymentDetail ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.FinancialPaymentDetail, Rock.Model.FinancialPaymentDetailService>( this );
