...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class WorkflowActivitiesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.WorkflowActivity ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.WorkflowActivity, Rock.Model.WorkflowActivityService>( this );
