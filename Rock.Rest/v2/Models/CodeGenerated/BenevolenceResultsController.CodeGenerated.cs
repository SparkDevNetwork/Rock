...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class BenevolenceResultsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.BenevolenceResult ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.BenevolenceResult, Rock.Model.BenevolenceResultService>( this );
