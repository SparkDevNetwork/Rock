...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class CommunicationResponsesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.CommunicationResponse ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.CommunicationResponse, Rock.Model.CommunicationResponseService>( this );
