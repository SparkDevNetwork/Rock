...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ConnectionActivityTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ConnectionActivityType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ConnectionActivityType, Rock.Model.ConnectionActivityTypeService>( this );
