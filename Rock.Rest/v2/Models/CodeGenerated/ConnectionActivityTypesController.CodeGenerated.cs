...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ConnectionActivityTypesController : ApiControllerBase
    {
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.ConnectionActivityType ) )]
        ...
        {
            var helper = new CrudEndpointHelper<Rock.Model.ConnectionActivityType, Rock.Model.ConnectionActivityTypeService>( this );
