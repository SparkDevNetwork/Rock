...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ContentChannelsController : ApiControllerBase
    {
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.ContentChannel ) )]
        ...
        {
            var helper = new CrudEndpointHelper<Rock.Model.ContentChannel, Rock.Model.ContentChannelService>( this );
