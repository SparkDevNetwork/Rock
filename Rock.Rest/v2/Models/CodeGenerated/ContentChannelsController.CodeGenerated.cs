...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ContentChannelsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ContentChannel ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ContentChannel, Rock.Model.ContentChannelService>( this );
