...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class SmsActionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.SmsAction ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.SmsAction, Rock.Model.SmsActionService>( this );
