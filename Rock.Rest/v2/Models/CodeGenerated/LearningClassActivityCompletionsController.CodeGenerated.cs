...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class LearningClassActivityCompletionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.LearningClassActivityCompletion ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.LearningClassActivityCompletion, Rock.Model.LearningClassActivityCompletionService>( this );
