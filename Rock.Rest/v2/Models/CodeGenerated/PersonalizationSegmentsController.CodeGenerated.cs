...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Personalization Segments.
    /// </summary>
    [RoutePrefix( "api/v2/models/personalizationsegments" )]
    [Rock.SystemGuid.RestControllerGuid( "b1a1f375-1350-586e-ad19-539dfd43e621" )]
    public partial class PersonalizationSegmentsController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.PersonalizationSegment ) )]
