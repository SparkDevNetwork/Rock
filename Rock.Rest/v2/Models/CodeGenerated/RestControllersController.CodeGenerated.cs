...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Rest Controllers.
    /// </summary>
    [RoutePrefix( "api/v2/models/restcontrollers" )]
    [Rock.SystemGuid.RestControllerGuid( "579e0aed-1c11-5485-9e02-108c87f493a0" )]
    public partial class RestControllersController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.RestController ) )]
