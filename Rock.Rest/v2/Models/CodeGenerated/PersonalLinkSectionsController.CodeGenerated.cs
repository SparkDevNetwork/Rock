...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class PersonalLinkSectionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.PersonalLinkSection ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.PersonalLinkSection, Rock.Model.PersonalLinkSectionService>( this );
