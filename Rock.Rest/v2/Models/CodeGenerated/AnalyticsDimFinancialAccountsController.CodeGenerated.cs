...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AnalyticsDimFinancialAccountsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AnalyticsDimFinancialAccount ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AnalyticsDimFinancialAccount, Rock.Model.AnalyticsDimFinancialAccountService>( this );
