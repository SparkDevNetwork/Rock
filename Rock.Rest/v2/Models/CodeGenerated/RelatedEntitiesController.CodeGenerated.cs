...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class RelatedEntitiesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.RelatedEntity ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.RelatedEntity, Rock.Model.RelatedEntityService>( this );
