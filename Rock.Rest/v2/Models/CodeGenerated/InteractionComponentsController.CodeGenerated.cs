...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class InteractionComponentsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.InteractionComponent ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.InteractionComponent, Rock.Model.InteractionComponentService>( this );
