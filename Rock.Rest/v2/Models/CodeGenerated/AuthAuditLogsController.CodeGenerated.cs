...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AuthAuditLogsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AuthAuditLog ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AuthAuditLog, Rock.Model.AuthAuditLogService>( this );
