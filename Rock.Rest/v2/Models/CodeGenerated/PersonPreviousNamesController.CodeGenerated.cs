...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class PersonPreviousNamesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.PersonPreviousName ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.PersonPreviousName, Rock.Model.PersonPreviousNameService>( this );
