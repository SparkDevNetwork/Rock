...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class DocumentTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.DocumentType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.DocumentType, Rock.Model.DocumentTypeService>( this );
