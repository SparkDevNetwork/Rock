...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AnalyticsSourcePersonHistoricalsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AnalyticsSourcePersonHistorical ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AnalyticsSourcePersonHistorical, Rock.Model.AnalyticsSourcePersonHistoricalService>( this );
