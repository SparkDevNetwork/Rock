...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class FinancialTransactionDetailsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.FinancialTransactionDetail ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.FinancialTransactionDetail, Rock.Model.FinancialTransactionDetailService>( this );
