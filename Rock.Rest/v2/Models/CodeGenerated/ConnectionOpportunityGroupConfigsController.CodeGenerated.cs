...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ConnectionOpportunityGroupConfigsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ConnectionOpportunityGroupConfig ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ConnectionOpportunityGroupConfig, Rock.Model.ConnectionOpportunityGroupConfigService>( this );
