...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class LearningActivitiesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.LearningActivity ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.LearningActivity, Rock.Model.LearningActivityService>( this );
