...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Person Preferences.
    /// </summary>
    [RoutePrefix( "api/v2/models/personpreferences" )]
    [Rock.SystemGuid.RestControllerGuid( "dd82a046-403d-52eb-9951-a284eca6fbdf" )]
    public partial class PersonPreferencesController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.PersonPreference ) )]
