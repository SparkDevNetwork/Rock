...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class SignalTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.SignalType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.SignalType, Rock.Model.SignalTypeService>( this );
