...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class FinancialTransactionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.FinancialTransaction ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.FinancialTransaction, Rock.Model.FinancialTransactionService>( this );
