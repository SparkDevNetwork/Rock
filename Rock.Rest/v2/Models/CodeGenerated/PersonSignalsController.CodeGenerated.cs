...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class PersonSignalsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.PersonSignal ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.PersonSignal, Rock.Model.PersonSignalService>( this );
