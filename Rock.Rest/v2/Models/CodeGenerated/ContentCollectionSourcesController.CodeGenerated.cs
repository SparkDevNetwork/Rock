...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ContentCollectionSourcesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ContentCollectionSource ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ContentCollectionSource, Rock.Model.ContentCollectionSourceService>( this );
