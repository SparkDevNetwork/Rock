...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class GroupsController : ApiControllerBase
    {
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.Group ) )]
        ...
        {
            var helper = new CrudEndpointHelper<Rock.Model.Group, Rock.Model.GroupService>( this );
