...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class BlockTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.BlockType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.BlockType, Rock.Model.BlockTypeService>( this );
