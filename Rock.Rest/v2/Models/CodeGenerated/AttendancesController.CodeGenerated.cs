...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AttendancesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.Attendance ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.Attendance, Rock.Model.AttendanceService>( this );
