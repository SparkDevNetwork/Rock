...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class PageRoutesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.PageRoute ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.PageRoute, Rock.Model.PageRouteService>( this );
