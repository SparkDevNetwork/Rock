...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class FollowingSuggestedsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.FollowingSuggested ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.FollowingSuggested, Rock.Model.FollowingSuggestedService>( this );
