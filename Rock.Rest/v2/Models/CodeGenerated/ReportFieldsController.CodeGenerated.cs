...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ReportFieldsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ReportField ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ReportField, Rock.Model.ReportFieldService>( this );
