...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class InteractionSessionLocationsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.InteractionSessionLocation ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.InteractionSessionLocation, Rock.Model.InteractionSessionLocationService>( this );
