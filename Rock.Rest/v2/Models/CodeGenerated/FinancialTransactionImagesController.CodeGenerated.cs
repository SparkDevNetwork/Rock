...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class FinancialTransactionImagesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.FinancialTransactionImage ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.FinancialTransactionImage, Rock.Model.FinancialTransactionImageService>( this );
