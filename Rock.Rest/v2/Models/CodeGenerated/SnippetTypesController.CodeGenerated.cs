...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class SnippetTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.SnippetType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.SnippetType, Rock.Model.SnippetTypeService>( this );
