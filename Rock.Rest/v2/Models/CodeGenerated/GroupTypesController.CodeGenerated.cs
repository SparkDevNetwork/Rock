...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class GroupTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.GroupType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.GroupType, Rock.Model.GroupTypeService>( this );
