...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class BenevolenceRequestsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.BenevolenceRequest ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.BenevolenceRequest, Rock.Model.BenevolenceRequestService>( this );
