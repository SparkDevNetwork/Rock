...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class InteractiveExperienceActionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.InteractiveExperienceAction ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.InteractiveExperienceAction, Rock.Model.InteractiveExperienceActionService>( this );
