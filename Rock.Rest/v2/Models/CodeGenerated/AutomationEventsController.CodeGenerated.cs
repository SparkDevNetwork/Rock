...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AutomationEventsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AutomationEvent ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AutomationEvent, Rock.Model.AutomationEventService>( this );
