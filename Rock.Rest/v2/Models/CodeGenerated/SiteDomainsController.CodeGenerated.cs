...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class SiteDomainsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.SiteDomain ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.SiteDomain, Rock.Model.SiteDomainService>( this );
