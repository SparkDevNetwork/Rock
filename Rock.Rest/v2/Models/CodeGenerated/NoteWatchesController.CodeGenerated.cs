...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class NoteWatchesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.NoteWatch ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.NoteWatch, Rock.Model.NoteWatchService>( this );
