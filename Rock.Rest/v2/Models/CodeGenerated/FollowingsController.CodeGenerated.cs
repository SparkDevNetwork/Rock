...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class FollowingsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.Following ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.Following, Rock.Model.FollowingService>( this );
