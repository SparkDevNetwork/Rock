...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class BenevolenceTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.BenevolenceType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.BenevolenceType, Rock.Model.BenevolenceTypeService>( this );
