...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ConnectionOpportunityGroupsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ConnectionOpportunityGroup ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ConnectionOpportunityGroup, Rock.Model.ConnectionOpportunityGroupService>( this );
