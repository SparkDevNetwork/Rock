...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class WorkflowFormBuilderTemplatesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.WorkflowFormBuilderTemplate ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.WorkflowFormBuilderTemplate, Rock.Model.WorkflowFormBuilderTemplateService>( this );
