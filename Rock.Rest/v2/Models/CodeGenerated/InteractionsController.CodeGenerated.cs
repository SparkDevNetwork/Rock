...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class InteractionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.Interaction ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.Interaction, Rock.Model.InteractionService>( this );
