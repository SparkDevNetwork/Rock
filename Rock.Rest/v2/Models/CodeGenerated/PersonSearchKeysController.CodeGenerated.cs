...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class PersonSearchKeysController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.PersonSearchKey ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.PersonSearchKey, Rock.Model.PersonSearchKeyService>( this );
