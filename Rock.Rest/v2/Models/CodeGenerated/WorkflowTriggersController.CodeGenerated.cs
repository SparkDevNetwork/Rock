...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class WorkflowTriggersController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.WorkflowTrigger ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.WorkflowTrigger, Rock.Model.WorkflowTriggerService>( this );
