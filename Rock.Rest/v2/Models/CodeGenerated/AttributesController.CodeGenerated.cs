...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AttributesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.Attribute ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.Attribute, Rock.Model.AttributeService>( this );
