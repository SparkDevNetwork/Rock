...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class EntitySearchesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.EntitySearch ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.EntitySearch, Rock.Model.EntitySearchService>( this );
