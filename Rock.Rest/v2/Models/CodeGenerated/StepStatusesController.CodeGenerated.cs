...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class StepStatusesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.StepStatus ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.StepStatus, Rock.Model.StepStatusService>( this );
