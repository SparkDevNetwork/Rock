...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class CommunicationTemplateAttachmentsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.CommunicationTemplateAttachment ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.CommunicationTemplateAttachment, Rock.Model.CommunicationTemplateAttachmentService>( this );
