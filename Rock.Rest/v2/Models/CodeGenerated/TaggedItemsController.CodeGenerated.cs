...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class TaggedItemsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.TaggedItem ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.TaggedItem, Rock.Model.TaggedItemService>( this );
