...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class RegistrationTemplateFeeItemsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.RegistrationTemplateFeeItem ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.RegistrationTemplateFeeItem, Rock.Model.RegistrationTemplateFeeItemService>( this );
