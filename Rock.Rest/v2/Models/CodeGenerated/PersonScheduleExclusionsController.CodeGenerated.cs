...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class PersonScheduleExclusionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.PersonScheduleExclusion ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.PersonScheduleExclusion, Rock.Model.PersonScheduleExclusionService>( this );
