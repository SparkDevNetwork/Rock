...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class FollowingEventNotificationsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.FollowingEventNotification ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.FollowingEventNotification, Rock.Model.FollowingEventNotificationService>( this );
