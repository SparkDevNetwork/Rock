...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class GroupHistoricalsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.GroupHistorical ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.GroupHistorical, Rock.Model.GroupHistoricalService>( this );
