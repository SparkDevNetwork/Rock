...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class HistoriesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.History ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.History, Rock.Model.HistoryService>( this );
