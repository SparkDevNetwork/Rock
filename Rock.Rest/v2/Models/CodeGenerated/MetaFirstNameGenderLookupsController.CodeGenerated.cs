...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Meta First Name Gender Lookups.
    /// </summary>
    [RoutePrefix( "api/v2/models/metafirstnamegenderlookups" )]
    [Rock.SystemGuid.RestControllerGuid( "0ec7d4f9-74f6-560d-9399-66d21b993eb2" )]
    public partial class MetaFirstNameGenderLookupsController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.MetaFirstNameGenderLookup ) )]
