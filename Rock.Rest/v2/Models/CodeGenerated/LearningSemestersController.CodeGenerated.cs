...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class LearningSemestersController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.LearningSemester ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.LearningSemester, Rock.Model.LearningSemesterService>( this );
