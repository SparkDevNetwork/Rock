...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class EventItemOccurrencesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.EventItemOccurrence ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.EventItemOccurrence, Rock.Model.EventItemOccurrenceService>( this );
