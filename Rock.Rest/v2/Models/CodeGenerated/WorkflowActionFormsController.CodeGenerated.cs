...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class WorkflowActionFormsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.WorkflowActionForm ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.WorkflowActionForm, Rock.Model.WorkflowActionFormService>( this );
