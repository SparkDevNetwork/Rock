...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class RestActionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.RestAction ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.RestAction, Rock.Model.RestActionService>( this );
