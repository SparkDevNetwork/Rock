...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AnalyticsDimFamilyHistoricalsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AnalyticsDimFamilyHistorical ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AnalyticsDimFamilyHistorical, Rock.Model.AnalyticsDimFamilyHistoricalService>( this );
