...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class MediaAccountsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.MediaAccount ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.MediaAccount, Rock.Model.MediaAccountService>( this );
