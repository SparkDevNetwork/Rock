...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AuthClientsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AuthClient ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AuthClient, Rock.Model.AuthClientService>( this );
