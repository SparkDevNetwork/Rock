...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class EntityTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.EntityType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.EntityType, Rock.Model.EntityTypeService>( this );
