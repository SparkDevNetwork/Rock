...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class ContentChannelItemsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ContentChannelItem ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ContentChannelItem, Rock.Model.ContentChannelItemService>( this );
