...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AIProvidersController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AIProvider ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AIProvider, Rock.Model.AIProviderService>( this );
