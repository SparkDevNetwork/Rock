...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class InteractiveExperiencesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.InteractiveExperience ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.InteractiveExperience, Rock.Model.InteractiveExperienceService>( this );
