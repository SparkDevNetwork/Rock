...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AttendanceOccurrencesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AttendanceOccurrence ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AttendanceOccurrence, Rock.Model.AttendanceOccurrenceService>( this );
