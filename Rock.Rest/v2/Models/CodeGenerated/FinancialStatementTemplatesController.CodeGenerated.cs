...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class FinancialStatementTemplatesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.FinancialStatementTemplate ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.FinancialStatementTemplate, Rock.Model.FinancialStatementTemplateService>( this );
