...
namespace Rock.Rest.v2.Models
{
    ...
    /// <summary>
    /// Provides data API endpoints for Signature Documents.
    /// </summary>
    [RoutePrefix( "api/v2/models/signaturedocuments" )]
    [Rock.SystemGuid.RestControllerGuid( "c1c651fb-c474-5970-98d6-2eb241267ad1" )]
    public partial class SignatureDocumentsController : ApiControllerBase
    {
        /// <summary>
        ...
        [ProducesResponseType( StatusCodes.Status200OK, Type = typeof( Rock.Model.SignatureDocument ) )]
