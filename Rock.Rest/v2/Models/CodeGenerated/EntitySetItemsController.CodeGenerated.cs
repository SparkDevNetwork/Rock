...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class EntitySetItemsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.EntitySetItem ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.EntitySetItem, Rock.Model.EntitySetItemService>( this );
