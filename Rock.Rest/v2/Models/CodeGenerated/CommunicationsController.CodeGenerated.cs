...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class CommunicationsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.Communication ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.Communication, Rock.Model.CommunicationService>( this );
