...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AnalyticsFactAttendancesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AnalyticsFactAttendance ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AnalyticsFactAttendance, Rock.Model.AnalyticsFactAttendanceService>( this );
