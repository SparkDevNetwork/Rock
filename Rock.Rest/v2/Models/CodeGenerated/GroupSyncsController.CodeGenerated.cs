...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class GroupSyncsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.GroupSync ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.GroupSync, Rock.Model.GroupSyncService>( this );
