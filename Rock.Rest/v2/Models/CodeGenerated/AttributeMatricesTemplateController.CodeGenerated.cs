...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AttributeMatricesTemplateController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AttributeMatrixTemplate ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AttributeMatrixTemplate, Rock.Model.AttributeMatrixTemplateService>( this );
