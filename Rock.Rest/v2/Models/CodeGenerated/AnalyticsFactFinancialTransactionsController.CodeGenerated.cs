...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AnalyticsFactFinancialTransactionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AnalyticsFactFinancialTransaction ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AnalyticsFactFinancialTransaction, Rock.Model.AnalyticsFactFinancialTransactionService>( this );
