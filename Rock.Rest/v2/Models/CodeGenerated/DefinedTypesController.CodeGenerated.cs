...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class DefinedTypesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.DefinedType ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.DefinedType, Rock.Model.DefinedTypeService>( this );
