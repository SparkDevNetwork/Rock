...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class RemindersController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.Reminder ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.Reminder, Rock.Model.ReminderService>( this );
