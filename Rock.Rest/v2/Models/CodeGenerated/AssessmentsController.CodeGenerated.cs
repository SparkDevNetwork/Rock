...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AssessmentsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.Assessment ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.Assessment, Rock.Model.AssessmentService>( this );
