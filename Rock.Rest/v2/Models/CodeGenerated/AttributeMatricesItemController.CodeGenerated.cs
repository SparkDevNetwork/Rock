...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AttributeMatricesItemController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AttributeMatrixItem ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AttributeMatrixItem, Rock.Model.AttributeMatrixItemService>( this );
