...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class LearningProgramsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.LearningProgram ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.LearningProgram, Rock.Model.LearningProgramService>( this );
