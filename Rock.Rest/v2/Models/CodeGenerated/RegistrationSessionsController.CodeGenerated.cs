...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class RegistrationSessionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.RegistrationSession ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.RegistrationSession, Rock.Model.RegistrationSessionService>( this );
