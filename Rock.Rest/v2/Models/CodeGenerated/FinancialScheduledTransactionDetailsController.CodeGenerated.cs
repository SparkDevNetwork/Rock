...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class FinancialScheduledTransactionDetailsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.FinancialScheduledTransactionDetail ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.FinancialScheduledTransactionDetail, Rock.Model.FinancialScheduledTransactionDetailService>( this );
