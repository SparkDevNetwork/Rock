...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class WorkflowActionsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.WorkflowAction ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.WorkflowAction, Rock.Model.WorkflowActionService>( this );
