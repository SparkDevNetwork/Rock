...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class GroupLocationHistoricalsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.GroupLocationHistorical ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.GroupLocationHistorical, Rock.Model.GroupLocationHistoricalService>( this );
