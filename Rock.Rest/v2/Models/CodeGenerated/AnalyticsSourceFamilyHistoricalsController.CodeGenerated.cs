...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class AnalyticsSourceFamilyHistoricalsController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.AnalyticsSourceFamilyHistorical ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.AnalyticsSourceFamilyHistorical, Rock.Model.AnalyticsSourceFamilyHistoricalService>( this );
