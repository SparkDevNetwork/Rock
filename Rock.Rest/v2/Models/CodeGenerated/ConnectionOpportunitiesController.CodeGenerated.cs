...
namespace Rock.Rest.v2.Models
{
    ...
    [Rock.SystemGuid.RestControllerGuid( "2f0c824b-ec71-52e2-b1ae-aad59fcbfac1" )]
    public partial class ConnectionOpportunitiesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.ConnectionOpportunity ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.ConnectionOpportunity, Rock.Model.ConnectionOpportunityService>( this );
