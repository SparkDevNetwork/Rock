...
namespace Rock.Rest.v2.Models
{
    ...
    public partial class FinancialBatchesController : ApiControllerBase
    {
        ...
        [ProducesResponse( HttpStatusCode.OK, Type = typeof( Rock.Model.FinancialBatch ) )]
        ...
        {
            var helper = CreateCrudEndpointHelper<Rock.Model.FinancialBatch, Rock.Model.FinancialBatchService>( this );
