...
{
    /// <summary>
    /// Gets people by search parameters
    /// </summary>
    public partial class PeopleController : IHasCustomRoutes
    {
        ...
        public void AddRoutes( System.Web.Routing.RouteCollection routes )
        {
            ...
            routes.MapHttpRoute(
               ...
               routeTemplate: "api/People/SearchByEmail/{email}/{includeHtml}",
               defaults: new
               {
                   controller = "People",
                   action = "SearchByEmail"
            ...
            routes.MapHttpRoute(
                ...
                routeTemplate: "api/People/SearchByPhoneNumber/{number}/{includeHtml}",
                defaults: new
                {
                    controller = "People",
                    action = "SearchByPhoneNumber"
