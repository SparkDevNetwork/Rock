...
namespace com.lcbcchurch.Utility.Migrations
{
    ...
    class SecurityNote : Migration
    {
        public override void Up()
        {
            ...
            RockMigrationHelper.AddSecurityAuthForNoteType( "DABE0530-4E30-4A14-A1B8-16AE9AABE3EE", 1, Rock.Security.Authorization.VIEW, true, "32E80B6C-A1EB-40FD-BEC3-E11DE8FF75AB", ( int ) Rock.Model.SpecialRole.None, "4192AAD12-197E-4F1B-965E-4BD89DF157F1" );  // [RSR - Staff Workers] - Allow
            RockMigrationHelper.AddSecurityAuthForNoteType( "DABE0530-4E30-4A14-A1B8-16AE9AABE3EE", 0, Rock.Security.Authorization.EDIT, true, "5F03301C-E1F1-44A2-972C-3940DB555509", ( int ) Rock.Model.SpecialRole.None, "4192AAD12-197E-4F1B-965E-4BD89DF157F1" );  // [RSR - Staff Workers] - Allow
            ...
            RockMigrationHelper.AddPersonBadgeAttributeValue( "CAF90175-6E5C-4EBC-B2D2-2069C0C56CC5", "01C9BA59-D8D4-4137-90A6-B3C06C70BBC3", @"{% assign noteExists = false %} {% assign noteTypeGuid = 'DABE0530-4E30-4A14-A1B8-16AE9AABE3EE' %} {% notetype where:'Guid == ""{ { noteTypeGuid} }
            ""' %}     {% for noteType in notetypeItems %}         {% assign noteTypeId = noteType.Id %}             {% note where:'NoteTypeId == ""{ { noteTypeId} }"" && EntityId == {{Person.Id}}' %}                 {% for note in noteItems %}                     {% assign noteExists = true %}                 {% endfor %}             {% endnote %}     {% endfor %} {% endnotetype %} {% if noteExists %}     <span class=""label label-danger"">Security Note Exists</span> {% endif %} " );
