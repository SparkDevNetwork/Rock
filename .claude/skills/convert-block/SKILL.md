...
7. **Identify the matching canonical reference block** from the "Canonical Reference Blocks" table in `common-patterns.md`. You will read the specific canonical block files later when implementing — not now.
