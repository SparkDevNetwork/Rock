...
namespace Rock.Tests.Integration.Modules.Core.Lava.Filters
{
    ...
    public class PersonalizationFilterTests : LavaIntegrationTestBase
    {
        ...
        private const string PersistedDatasetKey = "contentChannelItems";
        [ClassInitialize]
...
{%- contentchannel where:'Name == ""Messages""' -%}
    ...
    <h1>{{ CurrentPerson.NickName }}, you might be interested in these messages on the topic of Marriage:</h1>
    <ul>
...
";
            ...
            var expectedOutput = @"
<h1>Ted, you might be interested in these messages on the topic of Marriage:</h1>
<ul>
