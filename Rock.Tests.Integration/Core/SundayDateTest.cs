...
namespace Rock.Tests.Integration.Core
{
    ...
    public class SundayDateTest
    {
        ...
        public void TestFirstDateOfWeekSunday()
        {
            ...
            Assert.That.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('{new DateTime( 2019, 10, 6 )}')" ).FirstOrDefault() == sundayDate20191006, "Incorrect Sunday Date" );
            Assert.That.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('{new DateTime( 2019, 10, 8 )}')" ).FirstOrDefault() == sundayDate20191006, "Incorrect Sunday Date" );
            Assert.That.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('{new DateTime( 2019, 10, 9 )}')" ).FirstOrDefault() == sundayDate20191006, "Incorrect Sunday Date" );
            Assert.That.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('{new DateTime( 2019, 10, 12 )}')" ).FirstOrDefault() == sundayDate20191006, "Incorrect Sunday Date" );
            Assert.That.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('{new DateTime( 2019, 10, 13 )}')" ).FirstOrDefault() == sundayDate20191013, "Incorrect Sunday Date" );
            Assert.That.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('{new DateTime( 2019, 10, 14 )}')" ).FirstOrDefault() == sundayDate20191013, "Incorrect Sunday Date" );
            Assert.That.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('{new DateTime( 2019, 10, 19 )}')" ).FirstOrDefault() == sundayDate20191013, "Incorrect Sunday Date" );
            Assert.That.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('{new DateTime( 2019, 10, 20 )}')" ).FirstOrDefault() == sundayDate20191020, "Incorrect Sunday Date" );
            Assert.That.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('{new DateTime( 2019, 10, 25 )}')" ).FirstOrDefault() == sundayDate20191020, "Incorrect Sunday Date" );
            Assert.That.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('{new DateTime( 2019, 10, 28 )}')" ).FirstOrDefault() == sundayDate20191027, "Incorrect Sunday Date" );
        }
    }
}
