...
namespace Rock.Tests.Integration.Core
{
    ...
    public class SundayDateTest : DatabaseTestsBase
    {
        ...
        public void TestFirstDateOfWeekMonday()
        {
            ...
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-8-23')" ).FirstOrDefault() == sundayDate20190825, "Incorrect Sunday Date (SQL)" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-8-24')" ).FirstOrDefault() == sundayDate20190825, "Incorrect Sunday Date (SQL)" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-8-25')" ).FirstOrDefault() == sundayDate20190825, "Incorrect Sunday Date (SQL)" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-8-26')" ).FirstOrDefault() == sundayDate20190901, "Incorrect Sunday Date (SQL)" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-8-27')" ).FirstOrDefault() == sundayDate20190901, "Incorrect Sunday Date (SQL)" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-8-28')" ).FirstOrDefault() == sundayDate20190901, "Incorrect Sunday Date (SQL)" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-8-29')" ).FirstOrDefault() == sundayDate20190901, "Incorrect Sunday Date (SQL)" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-8-30')" ).FirstOrDefault() == sundayDate20190901, "Incorrect Sunday Date (SQL)" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-9-5')" ).FirstOrDefault() == sundayDate20190908, "Incorrect Sunday Date (SQL)" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-9-9')" ).FirstOrDefault() == sundayDate20190915, "Incorrect Sunday Date (SQL)" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-9-17')" ).FirstOrDefault() == sundayDate20190922, "Incorrect Sunday Date (SQL)" );
        ...
        public void TestFirstDateOfWeekTuesday()
        {
            ...
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-7')" ).FirstOrDefault() == sundayDate20191006, "Incorrect Sunday Date" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-8')" ).FirstOrDefault() == sundayDate20191013, "Incorrect Sunday Date" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-14')" ).FirstOrDefault() == sundayDate20191013, "Incorrect Sunday Date" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-13')" ).FirstOrDefault() == sundayDate20191013, "Incorrect Sunday Date" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-21')" ).FirstOrDefault() == sundayDate20191020, "Incorrect Sunday Date" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-22')" ).FirstOrDefault() != sundayDate20191020, "Incorrect Sunday Date" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-22')" ).FirstOrDefault() == sundayDate20191027, "Incorrect Sunday Date" );
        ...
        public void TestFirstDateOfWeekSunday()
        {
            ...
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-9')" ).FirstOrDefault() == sundayDate20191006, "Incorrect Sunday Date" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-12')" ).FirstOrDefault() == sundayDate20191006, "Incorrect Sunday Date" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-13')" ).FirstOrDefault() == sundayDate20191013, "Incorrect Sunday Date" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-14')" ).FirstOrDefault() == sundayDate20191013, "Incorrect Sunday Date" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-19')" ).FirstOrDefault() == sundayDate20191013, "Incorrect Sunday Date" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-20')" ).FirstOrDefault() == sundayDate20191020, "Incorrect Sunday Date" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-25')" ).FirstOrDefault() == sundayDate20191020, "Incorrect Sunday Date" );
            Assert.IsTrue( rockContext.Database.SqlQuery<DateTime>( $@"SELECT dbo.ufnUtility_GetSundayDate('2019-10-28')" ).FirstOrDefault() == sundayDate20191027, "Incorrect Sunday Date" );
        }
    }
}
