...
";
    ...
    {
        var fileProvider = GetMockFileProvider(
            ["/main.lava", GetEmptyLayout( "<Rock:PageIcon></Rock:PageIcon>" )]
        );

        static void configureRockContext( Mock<RockContext> rockContextMock )
        {
            var pageMock = MockDatabaseHelper.CreateEntityMock<Model.Page>( 1, new Guid( "fdd9603f-85c0-4813-86aa-a3bc0d5e533b" ) );
    ...
    {
        var fileProvider = GetMockFileProvider(
            ["/main.lava", GetEmptyLayout( "<Rock:PageTitle></Rock:PageTitle>" )]
        );
    ...
    {
        var fileProvider = GetMockFileProvider(
            ["/main.lava", GetEmptyLayout( "AA<Rock:PageTitle></Rock:PageTitle>ZZ" )]
        );
    ...
    {
        var fileProvider = GetMockFileProvider(
            ["/main.lava", GetEmptyLayout( "<Rock:PageBreadCrumbs></Rock:PageBreadCrumbs>" )]
        );
        ...
        using ( TestHelper.CreateScopedRockApp( sc => ConfigureServices( sc ) ) )
        {
            ...
            {
                new( new BreadCrumbLink( "parent<page", "/page/1", true ) ),
            };
            var layout = builder.CreateLayout( "/main.lava", "RockNextGen", engine );
            var lavaContext = engine.NewRenderContext( new Dictionary<string, object>
            {
    ...
    public async Task ProcessPageBreadCrumbsNodes_WithTwoBreadCrumbs_RendersBoth()
    {
        ...
        using ( TestHelper.CreateScopedRockApp( sc => ConfigureServices( sc ) ) )
        {
            ...
            var breadcrumbs = new List<LavaDataObject>
            {
                new( new BreadCrumbLink( "parent-page", "/page/1", false ) ),
                new( new BreadCrumbLink( "child-page", "/page/2", true ) ),
            };
            var layout = builder.CreateLayout( "/main.lava", "RockNextGen", engine );
            var lavaContext = engine.NewRenderContext( new Dictionary<string, object>
            {
    ...
    {
        var fileProvider = GetMockFileProvider(
            ["/main.lava", GetEmptyLayout( "<Rock:PageDescription></Rock:PageDescription>" )]
        );
    ...
    {
        var fileProvider = GetMockFileProvider(
            ["/main.lava", GetEmptyLayout( "AA<Rock:PageDescription></Rock:PageDescription>ZZ" )]
        );
