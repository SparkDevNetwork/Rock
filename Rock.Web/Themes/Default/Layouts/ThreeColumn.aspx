<%@ Page Title="" ValidateRequest="false"Language="C#" MasterPageFile="~/Themes/Default/Layouts/Site.Master" AutoEventWireup="true" CodeBehind="ThreeColumn.aspx.cs" Inherits="Rock.Themes.Default.Layouts.ThreeColumn" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#cms-admin-footer .page-zones').click(function (ev) {
                ...
                $('.zone-instance').each(function (index) {
                    //alert(index + ': ' + $(this).attr('id'));

                    //var zoneWidth = $(this).contents().width();
                    //alert(index + ': ' + $(this).outerWidth( true ));
                });
