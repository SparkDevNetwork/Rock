...
The build will fail if the path of this needs to be changed, so feel free to adjust it. You can do so by following these steps: 
	...
	I had to update the path here to match the actual location of 'editbin.exe', yours may look different than mine as you can see in the two examples provided above, so keep that in mind. 
