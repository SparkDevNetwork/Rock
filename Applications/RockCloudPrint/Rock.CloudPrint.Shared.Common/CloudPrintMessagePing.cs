...
namespace Rock.CloudPrint.Shared
{
    ...
    /// </summary>
    internal class CloudPrintMessagePing : CloudPrintMessage
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CloudPrintMessagePing"/> class.
        /// </summary>
        public CloudPrintMessagePing()
        {
            Type = CloudPrintMessageType.Ping;
        }
    }
}
