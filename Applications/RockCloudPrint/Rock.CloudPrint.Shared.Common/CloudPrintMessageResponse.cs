...
namespace Rock.CloudPrint.Shared
{
    ...
    /// </summary>
    internal class CloudPrintMessageResponse : CloudPrintMessage
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CloudPrintMessageResponse"/> class.
        /// </summary>
        public CloudPrintMessageResponse()
        {
            Type = CloudPrintMessageType.Response;
        }
        ...
        public CloudPrintMessageResponse( CloudPrintMessage fromMessage )
            : this()
        {
            Id = fromMessage.Id;
        }
