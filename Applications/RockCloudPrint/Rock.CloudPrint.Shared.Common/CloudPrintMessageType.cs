...
namespace Rock.CloudPrint.Shared
{
    ...
    /// </summary>
    internal enum CloudPrintMessageType
    {
        /// <summary>
        ...
        /// The response should be of type <see cref="CloudPrintResponsePing"/>.
        /// </summary>
        Ping,

        /// <summary>
        /// A special message that contains a response to a previous message. The
        /// <see cref="CloudPrintMessage.Id"/> value should match the original
        /// message.
        /// </summary>
        Response,
