...
namespace com.centralaz.DataTransform.DataFilter.Person
{
    /// <summary>
    /// Filter people on whether they were registered in the designated registration instance (Id).
    /// </summary>
    ...
    public class InRegistrationInstanceFilter : DataFilterComponent
    {
        ...
        {
            return "In Registration Instance (Id)";
        }
