...
namespace com.centralaz.DataTransform.DataFilter.Person
{
    ...
    [ExportMetadata( "ComponentName", "First Contribution Transaction Date Filter" )]
    public class FirstContributionTransactionDateFilter : DataFilterComponent
    {
        #region Properties
        ...
        {
            return "First Contribution Transaction Date";
        }
...
function() {
   ...
   return 'First contribution transaction date to accounts ' + accountNames  + ' between ' + startDate + ' and ' + endDate;
}
";
        }
        ...
        {
            string result = "First Contribution Transaction Date";
            ...
            if ( selectionValues.Length >= 3 )
            {
                ...
                result = string.Format(
                    "First contribution transaction date {0} between {1} and {2}",
        ...
        public override Control[] CreateChildControls( Type entityType, FilterField filterControl )
        {
            ...
            checkBox.Label = "Include end date?";
            filterControl.Controls.Add( checkBox );

            var controls = new Control[3] { accountPicker, dateRangePicker, checkBox };
        ...
        public override string GetSelection( Type entityType, Control[] controls )
        {
            ...
            RockCheckBox checkBox = controls[2] as RockCheckBox;
            return string.Format( "{0}|{1}|{2}|{3}", dateRangePicker.LowerValue, dateRangePicker.UpperValue, accountGuids, checkBox.Checked );
        }
        ...
        public override void SetSelection( Type entityType, Control[] controls, string selection )
        {
            ...
            if ( selectionValues.Length >= 4 )
            {
                ...
                var checkBox = controls[2] as RockCheckBox;
                checkBox.Checked = selectionValues[3].AsBoolean();
            }
        }
        ...
        public override Expression GetExpression( Type entityType, IService serviceInstance, ParameterExpression parameterExpression, string selection )
        {
            ...
            {
                firstContributionDateQry = firstContributionDateQry.Where( xx => xx.FirstTransactionDate >= startDate.Value );
            }
            ...
            if ( endDate.HasValue )
            {
                if ( includeEndDate )
                {
                    ...
                    firstContributionDateQry = firstContributionDateQry.Where( xx => xx.FirstTransactionDate < endDate );
                }
                else
                {
                    firstContributionDateQry = firstContributionDateQry.Where( xx => xx.FirstTransactionDate < endDate );
