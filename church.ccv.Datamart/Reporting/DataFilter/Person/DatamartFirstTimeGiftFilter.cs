...
namespace church.ccv.Datamart.Reporting.DataFilter.Person
{
    ...
    /// 
    /// </summary>
    [Description( "Filter people based on the FirstTimeGift value of the Datamart Person record." )]
    [Export( typeof( DataFilterComponent ) )]
    [ExportMetadata( "ComponentName", "First Time Gift Filter" )]
    public class DatamartFirstTimeGiftFilter : DataFilterComponent
    {
        #region Properties
        ...
        public override Expression GetExpression( Type entityType, IService serviceInstance, ParameterExpression parameterExpression, string selection )
        {
            ...
            if ( dateRange.Start.HasValue )
            {
                ...
                qryDatamartPerson = qryDatamartPerson.Where( p => p.FirstTimeGift >= startDate );
            }
