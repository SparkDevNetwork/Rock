                    ...
                    <div class="form-horizontal">
                        <div class="form-group">
                            <div class="controls col-md-10 col-md-offset-2">
                                <Rock:DataTextBox ID="tbEmail" PrependText="<i class='fa fa-envelope'></i>" runat="server" SourceTypeName="Rock.Model.Person, Rock" PropertyName="Email" Label="Email Address" Required="true" />
                            </div>
                        </div>
