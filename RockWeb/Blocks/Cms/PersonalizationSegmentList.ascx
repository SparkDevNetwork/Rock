                ...
                <div class="grid grid-panel">
                    ...
                    <Rock:Grid ID="gList" runat="server" AllowSorting="true" RowItemText="Personalization Segments" OnRowSelected="gList_RowSelected">
                        <Columns>
                            ...
                            <Rock:RockBoundField DataField="TimeToUpdateDurationMilliseconds" HeaderText="Time To Update (ms)" SortExpression="TimeToUpdateDurationMilliseconds" DataFormatString="{0:N0}" />
