    ...
    <ContentTemplate>
        ...
        <div class="panel-body">
            ...
            <div id="pnlEditDetails" runat="server">
                ...
                <div class="actions">
                    <asp:LinkButton ID="btnSave" runat="server" AccessKey="s" ToolTip="Alt+s" Text="Save" CssClass="btn btn-primary" OnClick="btnSave_Click" ValidationGroup="LayoutDetail" ></asp:LinkButton>
