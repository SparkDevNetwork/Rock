    ...
    <ContentTemplate>
        ...
        <div id="pnlEditDetails" runat="server">
            ...
            <fieldset>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <Rock:DataTextBox ID="tbLayoutName" runat="server" SourceTypeName="Rock.Model.Layout, Rock" PropertyName="Name" />
                    </div>
                    <div class="col-md-6">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <Rock:DataTextBox ID="tbDescription" runat="server" SourceTypeName="Rock.Model.Layout, Rock" PropertyName="Description" TextMode="MultiLine" Rows="4" />
                    </div>
                </div>

                <div class="row">
                    <div class="col-md-6">
                        <Rock:RockDropDownList ID="ddlLayout" runat="server" Label="Layout File" Help="The layout file that this layout should use"  />
                    </div>
                </div>
