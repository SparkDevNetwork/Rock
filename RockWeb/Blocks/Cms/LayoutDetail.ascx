...
<asp:UpdatePanel ID="upDetail" runat="server">
    <ContentTemplate>
        ...
        <div class="panel-body">
            <asp:ValidationSummary ID="ValidationSummary1" runat="server" HeaderText="Please correct the following:" CssClass="alert alert-validation" ValidationGroup="LayoutDetail" />
            ...
            <div id="pnlEditDetails" runat="server">
                ...
                <div class="actions">
                    <asp:LinkButton ID="btnSave" runat="server" data-shortcut-key="s" ToolTip="Alt+s" Text="Save" CssClass="btn btn-primary" OnClick="btnSave_Click" ValidationGroup="LayoutDetail" ></asp:LinkButton>
