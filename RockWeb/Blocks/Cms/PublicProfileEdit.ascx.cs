...
namespace RockWeb.Blocks.Cms
{
    ...
    public partial class PublicProfileEdit : RockBlock
    {
        ...
        protected void btnSave_Click( object sender, EventArgs e )
        {
            ...
            rockContext.WrapTransaction( () =>
            {
                ...
                if ( personGuid == Guid.Empty )
                {
                    ...
                    {
                        groupMember.Person.ConnectionStatusValueId = DefinedValueCache.Read( connectionStatusGuid.Value ).Id;
                    }
                    else
                    {
        ...
        private void ShowDetail()
        {
            ...
            rptPersonAttributes.DataSource = CurrentPerson.Attributes.Where( a => attributeGuidList.Contains( a.Value.Guid ) )
                .Select( a => new
                {
                    Name = a.Value.Name,
                    ...
                    if ( group != null )
                    {
                        ...
                        if ( locationTypeGuid.HasValue )
                        {
                            ...
                            if ( familyGroupTypeGuid.HasValue )
                            {
                                ...
                                var address = new GroupLocationService( rockContext )
                                    .Queryable()
