                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <span class="pull-right">
                                        <asp:LinkButton ID="btnRefreshChart" runat="server" CssClass="btn btn-xs btn-default" Style="vertical-align: bottom" ToolTip="Refresh Chart" OnClick="btnRefreshChart_Click"><i class="fa fa-refresh"></i></asp:LinkButton>
                                    </span>
                                </div>
                            </div>
                        </div>
