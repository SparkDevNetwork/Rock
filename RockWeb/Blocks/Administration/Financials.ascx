<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Financials.ascx.cs" Inherits="Blocks_Administration_Financials" %>
 ...
 <fieldset>
           ...
           <asp:Panel id="pnlDateRange" runat="server" style="margin-bottom:18px; margin-left:20px;">
               <label id="lblDateRange">Date Range</label>
                <asp:TextBox ID="txtFromDate" runat="server"/> to <asp:TextBox ID="txtToDate" runat="server"/>
            </asp:Panel>
            <asp:Panel id="pnlAmountRange" runat="server" style="margin-bottom:18px;">
             <label id="lblAmountRange" >Amount Range</label>
             <asp:TextBox ID="txtFromAmount" runat="server" Columns="10" Style="width:auto; margin-left:20px;"/> to <asp:TextBox ID="txtToAmount" runat="server" Columns="10" Style="width:auto;"/>
            </asp:Panel>
            <asp:Panel id="pnlTransactionCode" runat="server" style="margin-bottom:18px;">
            <label id="lblTransactionCode">Transaction Code</label>
