...
<asp:UpdatePanel ID="upBinaryFile" runat="server">
    <ContentTemplate>
        ...
        <Rock:GridFilter ID="fBinaryFile" runat="server">
            <Rock:LabeledTextBox ID="tbName" runat="server" Label="File Name" />
            <Rock:LabeledTextBox ID="tbType" runat="server" Label="Mime Type" />
            <Rock:LabeledCheckBox ID="dbIncludeTemporary" runat="server" Checked="false" Label="Include Temporary" Text="Yes"
