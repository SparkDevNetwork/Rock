    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-heading">
                <h1 class="panel-title"><i class="ti ti-bell"></i> Notifications</h1>
                ...
                <asp:Repeater ID="rptNotifications" OnItemDataBound="rptNotifications_ItemDataBound" OnItemCommand="rptProjects_ItemCommand" runat="server" >
                    <ItemTemplate>
                        <div class="alert" id="rptNotificationAlert" runat="server">
                            <div class="pull-right"><asp:LinkButton runat="server" CssClass="action" CommandName="Close" CommandArgument='<%#Eval("Guid") %>' CausesValidation="false"><i class="ti ti-x"></i></asp:LinkButton></div>
                            <h4>
