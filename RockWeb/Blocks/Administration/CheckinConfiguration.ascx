...
<asp:UpdatePanel ID="upDetail" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlCheckinLabelPicker" runat="server" Visible="false">
            ...
            <Rock:LabeledDropDownList ID="ddlCheckinLabel" runat="server" Label="Select Check-in Label" />
        ...
        <asp:Panel ID="pnlLocationPicker" runat="server" Visible="false">
            ...
            <Rock:LabeledDropDownList ID="ddlLocation" runat="server" Label="Select Check-in Location" />
