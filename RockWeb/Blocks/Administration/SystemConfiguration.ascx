    ...
    <ContentTemplate>
        ...
        <div class="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <fieldset>
                    <Rock:RockDropDownList ID="ddTimeZone" runat="server" CausesValidation="false" CssClass="input-width-xxl" Label="Time Zone" Help="The time zone you want Rock to operate in (regardless of what time zone the server is set to.)" ></Rock:RockDropDownList>
