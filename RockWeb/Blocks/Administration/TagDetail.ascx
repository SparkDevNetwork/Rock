                ...
                <fieldset>
                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            ...
                            <Rock:LabeledRadioButtonList ID="rblScope" runat="server" Label="Scope" RepeatDirection="Horizontal"
                        ...
                        <div class="span6">
                            ...
                            <Rock:LabeledTextBox ID="tbEntityTypeQualifierColumn" runat="server" Label="Entity Type Qualifier Column" />
                            <Rock:LabeledTextBox ID="tbEntityTypeQualifierValue" runat="server" Label="Entity Type Qualifier Value" />
                       </div>
                    </div>
