        ...
        <asp:Panel ID="pnlDetails" runat="server">
            ...
            <div id="pnlEditDetails" runat="server" class="well">
                ...
                <fieldset>
                    ...
                    <Rock:LabeledText ID="lblEntityTypeName" runat="server" Label="Entity Type" />
                    <asp:HiddenField ID="hfEntityTypeId" runat="server" />
                    <Rock:LabeledText ID="lblEntityTypeQualifierColumn" runat="server" Label="Entity Type Qualifier Column" />
                    <Rock:LabeledText ID="lblEntityTypeQualifierValue" runat="server" Label="Entity Type Qualifier Value" />
