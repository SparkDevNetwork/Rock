    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlDetails" CssClass="panel panel-block" runat="server">
            ...
            <div class="panel-heading">
                <h1 class="panel-title"><i class="fa fa-credit-card"></i> <asp:Literal ID="lTitle" runat="server" /></h1>
            </div>
            <div class="panel-body">
                ...
                <div id="pnlEditDetails" runat="server">
                    ...
                    <div class="actions">
                        <asp:LinkButton ID="lbSave" runat="server" Text="Save" CssClass="btn btn-primary" OnClick="lbSaveTransaction_Click" />
                        <asp:LinkButton ID="lbCancel" runat="server" Text="Cancel" CssClass="btn btn-link" CausesValidation="false" OnClick="lbCancelTransaction_Click" />
                    </div>
                </div>
                ...
                <br />
                <asp:Panel ID="pnlTransactionDetails" CssClass="container-fluid" runat="server">
