            ...
            <div class="panel-body">
                ...
                <div id="pnlEditDetails" runat="server">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <Rock:NotificationBox ID="nbTransactionDetailValidationMessage" runat="server" NotificationBoxType="Validation" Text="An amount for at least account is required." Visible="false" />
