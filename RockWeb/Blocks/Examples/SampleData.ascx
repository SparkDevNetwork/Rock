...
<asp:UpdatePanel ID="upnlContent" runat="server">
    <ContentTemplate>
        <Rock:NotificationBox ID="nbMessage" runat="server" Visible="true" NotificationBoxType="Info" Title="Important!" Text="Never load sample data into your production (real) Rock system.  This sample data for training and testing purposes only."></Rock:NotificationBox>
