<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationInstanceDetail_OldBigOne.ascx.cs" Inherits="RockWeb.Blocks.Event.RegistrationInstanceDetail_OldBigOne" %>
