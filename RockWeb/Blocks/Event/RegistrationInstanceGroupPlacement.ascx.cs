...
namespace RockWeb.Blocks.Event
{
    ...
    public partial class RegistrationInstanceGroupPlacement : RegistrationInstanceBlock, ISecondaryBlock
    {
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            gGroupPlacements.EmptyDataText = "There are no items to show in this view.";
            gGroupPlacements.DataKeyNames = new string[] { "Id" };
            gGroupPlacements.Actions.ShowAdd = false;
            gGroupPlacements.RowDataBound += gGroupPlacements_RowDataBound;
        ...
        /// <summary>
        /// Handles the RowDataBound event of the gGroupPlacements control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="GridViewRowEventArgs"/> instance containing the event data.</param>
        private void gGroupPlacements_RowDataBound( object sender, GridViewRowEventArgs e )
        {
            ...
            if ( registrant != null )
            {
                ...
                // Set the campus
                var lCampus = e.Row.FindControl( "lGroupPlacementsCampus" ) as Literal;
        ...
        protected void gGroupPlacements_GridRebind( object sender, GridRebindEventArgs e )
        {
            ...
            gGroupPlacements.ExportTitleName = registrationInstance.Name + " - Registration Group Placements";
            gGroupPlacements.ExportFilename = gGroupPlacements.ExportFilename ?? registrationInstance.Name + "RegistrationGroupPlacements";
        ...
        protected void gpGroupPlacementParentGroup_SelectItem( object sender, EventArgs e )
        {
            ...
            SetUserPreference(
                string.Format( "ParentGroup_{0}_{1}", BlockId, this.RegistrationInstanceId ),
        ...
        private void ShowDetail()
        {
            ...
            foreach ( var attributeCache in new AttributeService( rockContext ).GetByEntityTypeQualifier( entityTypeId, "RegistrationTemplateId", registrationInstance.RegistrationTemplateId.ToString(), false )
            ...
            SetUserPreferencePrefix( registrationInstance.RegistrationTemplateId );
        ...
        {
            fGroupPlacements.UserPreferenceKeyPrefix = string.Format( "{0}-GroupPlacements-", registrationTemplateId );
        }
        ...
        private void BindGroupPlacementGrid( bool isExporting = false )
        {
            ...
            if ( instanceId.HasValue )
            {
                using ( var rockContext = new RockContext() )
                {
                    ...
                    // Filter by daterange
                    var dateRange = SlidingDateRangePicker.CalculateDateRangeFromDelimitedValues( sdrpGroupPlacementsDateRange.DelimitedValues );
        ...
        {
            fGroupPlacements.SaveUserPreference( "Date Range", "Date Range", sdrpGroupPlacementsDateRange.DelimitedValues );
            fGroupPlacements.SaveUserPreference( "First Name", "First Name", tbGroupPlacementsFirstName.Text );
            fGroupPlacements.SaveUserPreference( "Last Name", "Last Name", tbGroupPlacementsLastName.Text );
            fGroupPlacements.SaveUserPreference( "In Group", "In Group", ddlGroupPlacementsInGroup.SelectedValue );
            fGroupPlacements.SaveUserPreference( "Signed Document", "Signed Document", ddlGroupPlacementsSignedDocument.SelectedValue );
                    ...
                    if ( field.FieldSource == RegistrationFieldSource.PersonField && field.PersonFieldType.HasValue )
                    {
                        switch ( field.PersonFieldType.Value )
                        {
                            case RegistrationPersonFieldType.Campus:
                                ...
                                if ( ddlCampus != null )
                                {
                                    fGroupPlacements.SaveUserPreference( "Home Campus", "Home Campus", ddlCampus.SelectedValue );
                                }
                            ...
                            case RegistrationPersonFieldType.Email:
                                ...
                                {
                                    fGroupPlacements.SaveUserPreference( "Email", "Email", tbEmailFilter.Text );
                                }
                            ...
                            case RegistrationPersonFieldType.Birthdate:
                                ...
                                if ( drpBirthdateFilter != null )
                                {
                                    fGroupPlacements.SaveUserPreference( "Birthdate Range", "Birthdate Range", drpBirthdateFilter.DelimitedValues );
                                }
                            ...
                            case RegistrationPersonFieldType.MiddleName:
                                ...
                                {
                                    fGroupPlacements.SaveUserPreference( "MiddleName", "MiddleName", tbGroupPlacementsMiddleNameFilter.Text );
                                }
                            ...
                            case RegistrationPersonFieldType.AnniversaryDate:
                                ...
                                if ( drpGroupPlacementsAnniversaryDateFilter != null )
                                {
                                    fGroupPlacements.SaveUserPreference( "AnniversaryDate Range", "AnniversaryDate Range", drpGroupPlacementsAnniversaryDateFilter.DelimitedValues );
                                }
                            ...
                            case RegistrationPersonFieldType.Grade:
                                ...
                                if ( gpGradeFilter != null )
                                {
                                    ...
                                    fGroupPlacements.SaveUserPreference( "Grade", "Grade", gradeOffset.HasValue ? gradeOffset.Value.ToString() : string.Empty );
                                }
                            ...
                            case RegistrationPersonFieldType.Gender:
                                ...
                                if ( ddlGenderFilter != null )
                                {
                                    fGroupPlacements.SaveUserPreference( "Gender", "Gender", ddlGenderFilter.SelectedValue );
                                }
                            ...
                            case RegistrationPersonFieldType.MaritalStatus:
                                ...
                                if ( dvpMaritalStatusFilter != null )
                                {
                                    fGroupPlacements.SaveUserPreference( "Marital Status", "Marital Status", dvpMaritalStatusFilter.SelectedValue );
                                }
                            ...
                            case RegistrationPersonFieldType.MobilePhone:
                                ...
                                {
                                    fGroupPlacements.SaveUserPreference( "Phone", "Cell Phone", tbMobilePhoneFilter.Text );
                                }
                            ...
                            case RegistrationPersonFieldType.HomePhone:
                                ...
                                {
                                    fGroupPlacements.SaveUserPreference( "HomePhone", "Home Phone", tbGroupPlacementsHomePhoneFilter.Text );
                                }
                    ...
                    if ( field.Attribute != null )
                    {
                        ...
                        if ( filterControl != null )
                        {
                            try
                            {
                                ...
                                fGroupPlacements.SaveUserPreference( attribute.Key, attribute.Name, attribute.FieldType.Field.GetFilterValues( filterControl, attribute.QualifierValues, Rock.Reporting.FilterMode.SimpleFilter ).ToJson() );
                            }
                            catch { }
                        }
                    }
        ...
        {
            sdrpGroupPlacementsDateRange.DelimitedValues = fGroupPlacements.GetUserPreference( "Date Range" );
            tbGroupPlacementsFirstName.Text = fGroupPlacements.GetUserPreference( "First Name" );
            tbGroupPlacementsLastName.Text = fGroupPlacements.GetUserPreference( "Last Name" );
            ddlGroupPlacementsInGroup.SetValue( fGroupPlacements.GetUserPreference( "In Group" ) );

            ddlGroupPlacementsSignedDocument.SetValue( fGroupPlacements.GetUserPreference( "Signed Document" ) );
        ...
        {
            AddRegistrationTemplateFieldsToGrid( this.RegistrantFields, phGroupPlacementsFormFieldFilters, gGroupPlacements, fGroupPlacements, setValues, false );

            // Add Group Picker column.
