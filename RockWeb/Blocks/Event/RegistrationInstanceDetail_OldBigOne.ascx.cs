...
namespace RockWeb.Blocks.Event
{
    ...
    /// </summary>
    [DisplayName( "Registration Instance Detail (Old Big One)" )]
    [Category( "Event" )]
    ...
    public partial class RegistrationInstanceDetail_OldBigOne : Rock.Web.UI.RockBlock, IDetailBlock
    {
        #region Fields
    ...
    $('table.js-grid-registration a.grid-delete-button').on('click', function( e ){
        e.preventDefault();
