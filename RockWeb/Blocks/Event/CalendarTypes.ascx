        ...
        <div class="panel panel-block">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    <asp:LinkButton ID="lbEventCalenderAttributes" runat="server" CssClass="btn btn-action btn-xs" OnClick="lbEventCalenderAttributes_Click" CausesValidation="false"><i class="fa fa-gear"></i></asp:LinkButton>
