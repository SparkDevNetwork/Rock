...
namespace RockWeb.Blocks.Event
{
    ...
    [CodeEditorField( "Summary Lava Template", "Lava template to use to display ", CodeEditorMode.Lava, CodeEditorTheme.Rock, 400, true, @"{% include '~~/Assets/Lava/CalendarItem.lava' %}", "", 2 )]
