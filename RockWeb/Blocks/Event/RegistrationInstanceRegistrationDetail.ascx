<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationInstanceRegistrationDetail.ascx.cs" Inherits="RockWeb.Blocks.Event.RegistrationInstanceRegistrationDetail" %>
