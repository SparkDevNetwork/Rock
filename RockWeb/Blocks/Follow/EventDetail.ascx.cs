    ...
    public partial class EventDetail : RockBlock, IDetailBlock
    {
        ...
        protected void btnSave_Click( object sender, EventArgs e )
        {
            using ( var rockContext = new RockContext() )
            {
                ...
                {
                    var followedEntityType = CacheEntityType.Get( eventComponent.FollowedType );
        ...
        private void BuildDynamicControls( FollowingEventType followingEvent, bool SetValues )
        {
            if ( SetValues )
            {
                ...
                {
                    var EventComponentEntityType = CacheEntityType.Get( followingEvent.EntityTypeId.Value );
                    var EventEntityType = CacheEntityType.Get( "Rock.Model.FollowingEventType" );
