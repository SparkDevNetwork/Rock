            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <fieldset>
                        ...
                        <Rock:CodeEditor ID="tbQuery" runat="server" Label="SQL Text" Height="400" EditorMode="Sql" Help="The SQL query or stored procedure name to execute."></Rock:CodeEditor>
