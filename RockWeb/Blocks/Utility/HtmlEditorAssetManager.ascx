...
<asp:Panel ID="pnlAssetManager" runat="server" CssClass="js-AssetManager-modal modal-content">
    ...
    <asp:Panel ID="pnlAssetManagerControl" runat="server" ScrollBars="Vertical" Height="300px">
