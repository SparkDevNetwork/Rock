            ...
            if ( communicationRecipientResponse != null )
            {
                ...
                if ( communicationRecipientResponse.HasAttachments( rockContext ) )
                {
                    ...
                    foreach ( var binaryFileGuid in communicationRecipientResponse.GetBinaryFileGuids( rockContext ) )
                    {
                        ...
                        string imageUrl = FileUrlHelper.GetFileUrl( binaryFileGuid, "GetImage" );
                        string imageElement = $"<a href='{imageUrl}' target='_blank' rel='noopener noreferrer'><img src='{imageUrl}&width=200' class='img-responsive sms-image'></a>";
