            ...
            <div class="panel panel-default">
                ...
                <asp:Panel ID="pnlNavHeading" runat="server" CssClass="panel-heading clickable clearfix" >
                    <asp:PlaceHolder runat="server">
                        ...
                        <asp:Panel ID="pnlThreshold" runat="server" CssClass="pull-right margin-v-sm margin-r-md js-threshold">
                            Threshold: 
                            ...
                            <Rock:NumberBox ID="nbThreshold" runat="server" CssClass="input-width-xs js-threshold-edit js-threshold-nb" NumberType="Integer" style="display:none"></Rock:NumberBox>
                            <asp:LinkButton id="lbUpdateThreshold" runat="server" CssClass="btn btn-success btn-xs js-threshold-edit js-threshold-btn-save" OnClick="lbUpdateThreshold_Click" style="display:none"><i class="fa fa-check"></i></asp:LinkButton>
                            <a class="btn btn-warning btn-xs js-threshold-edit js-threshold-btn-cancel" style="display:none"><i class="fa fa-ban"></i></a>
                        </asp:Panel>
                    </asp:PlaceHolder>
                </asp:Panel>
