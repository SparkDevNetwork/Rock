        ...
        <asp:Panel ID="pnlContent" runat="server" CssClass="checkin-manager">
            ...
            <div class="input-group mb-4">
                ...
                <span class="input-group-btn">
                    <asp:LinkButton ID="lbSearch" runat="server" CssClass="btn btn-default" OnClick="lbSearch_Click"><i class="ti ti-search"></i> Search</asp:LinkButton>
                </span>
            </div>
                            ...
                            <li id="liNavItem" runat="server" class="list-group-item d-flex align-items-center cursor-pointer clearfix" >
                                ...
                                <div class="ml-auto">
                                    ...
                                    <asp:LinkButton ID="lbRemoveAttendance" runat="server" CssClass="js-cancel-checkin btn btn-xs btn-square btn-danger"
                                        CommandArgument='<%# Eval("Id") %>' CommandName="Delete" Visible='<%# (bool)Eval("ShowCancel") %>'><i class="ti ti-x"></i></asp:LinkButton>
                                </div>
                            </li>
                        </ItemTemplate>
                    </asp:Repeater>
