                ...
                <div class="panel-body">
                    ...
                    <div id="pnlEditDetails" runat="server">
                        ...
                        <Rock:PanelWidget ID="wpHeaderText" runat="server" Title="Header Text">
                            ...
                            <Rock:CodeEditor runat="server" EditorMode="Lava" ID="ceTimeSelectHeaderTemplate" Label="Time Select" Help="Lava template to use for the 'Time Select' check-in block header. The available merge fields are:<br>{{ Family }} which is a Group object and is the current family.<br>{{ SelectedIndividuals }} is a list of Person objects which contains all of the currently selected persons.<br>{{ CheckinType }} is the type of check-in given as a string which will be either 'Family' or 'Individual'." />
                            <Rock:CodeEditor runat="server" EditorMode="Lava" ID="ceAbilityLevelSelectHeaderTemplate" Label="Ability Level Select" Help="Lava template to use for the 'Ability Level Select' check-in block header. The available merge fields are:<br>{{ Family }} which is a Group object and is the current family.<br>{{ Individual }} which is a Person object and is the current selected person.<br>{{ SelectedArea }} is a GroupType object and corrasponds to the selected check-in Area listed in Areas and Groups." />
                            <Rock:CodeEditor runat="server" EditorMode="Lava" ID="ceLocationSelectHeaderTemplate" Label="Location Select" Help="Lava template to use for the 'Location Select' check-in block header. The available merge fields are:<br>{{ Family }} which is a Group object and is the current family.<br>{{ Individual }} which is a Person object and is the current selected person.<br>{{ SelectedGroup }} is a Group object and corrasponds to the selectged check-in group listed in Areas and Groups.<br>{{ SelectedSchedule}} is a Schedule object and is the current selected schedule." />
                            <Rock:CodeEditor runat="server" EditorMode="Lava" ID="ceGroupSelectHeaderTemplate" Label="Group Select" Help="Lava template to use for the 'Group Select' check-in block header. The available merge fields are:<br>{{ Family }} which is a Group object and is the current family.<br>{{ Individual }} which is a Person object and is the current selected person.<br>{{ SelectedArea }} is a GroupType object and corrasponds to the selected check-in Area listed in Areas and Groups.<br>{{ SelectedGroup }} is a Group object and corrasponds to the selectged check-in group listed in Areas and Groups." />
                        </Rock:PanelWidget>
