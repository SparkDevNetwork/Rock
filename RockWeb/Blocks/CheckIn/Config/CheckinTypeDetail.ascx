                ...
                <div class="panel-body">
                    ...
                    <div id="pnlEditDetails" runat="server">
                        ...
                        <Rock:PanelWidget ID="wpHeaderText" runat="server" Title="Header Text">
                            ...
                            <Rock:CodeEditor runat="server" EditorMode="Lava" ID="ceGroupSelectHeaderTemplate" Label="Group Select" Help="Lava template to use for the 'Group Select' check-in block header. The available merge fields are:<br>{{ Family }} which is a Group object and is the current family.<br>{{ Individual }} which is a Person object and is the current selected person.<br>{{ SelectedArea }} is a GroupType object and corraeponds to the selected check-in Area listed in Areas and Groups.<br>{{ SelectedGroup }} is a Group object and corresponds to the selected check-in group listed in Areas and Groups." />
                        </Rock:PanelWidget>
