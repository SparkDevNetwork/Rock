                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <Rock:RockDropDownList ID="ddlGradeAndAgeMatchingBehavior"
                                        ...
                                        Required="true"
                                        Help="Defines how the Grade Range and Age Range/Birthdate Range values are used (blank ranges are still allowed in all cases). See documentation for edge cases not described here.
