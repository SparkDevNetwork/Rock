...
<ul class="nav navbar-nav loginstatus">
    ...
    <li ID="liLogin" runat="server" Visible="false"><asp:LinkButton ID="lbLogin" runat="server" OnClick="lbLoginLogout_Click" CausesValidation="false" Text="Log In"></asp:LinkButton></li>
</ul>
