...
namespace RockWeb.Blocks.Reporting
{
    ...
    [BooleanField( "Show Debug SQL", "Show the SQL generated by the report (must be Admin to see this, even if it is enabled)", false) ]
    ...
    public partial class DynamicReport : RockBlockCustomSettings
    {
        ...
        private void BindReportGrid()
        {
            ...
            else
            {
                ...
                if ( GetAttributeValue( "ShowDebugSQL" ).AsBoolean() && this.IsUserAuthorized(Rock.Security.Authorization.ADMINISTRATE) )
                {
                    lDebugShowSQL.Text = string.Format( "<pre>{0}</pre>", gReport.DatasourceSQL );
                    lDebugShowSQL.Visible = true;
                }
                else
                {
                    lDebugShowSQL.Visible = false;
                }
