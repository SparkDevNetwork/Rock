        ...
        <div class="dynamic-report">
            ...
            <asp:PlaceHolder ID="phDetails" runat="server">
                ...
                <div class="dynamic-report-details row-fluid well" style="display: none;">
                    ...
                    <div class="span6">
                        <fieldset>
                            <Rock:LabeledTextBox ID="tbName" runat="server" Label="Page Name" CssClass="input-large" Help="The current page's title" />
                            <Rock:LabeledTextBox ID="tbDesc" runat="server" Label="Page Description" TextMode="MultiLine" Rows="2" CssClass="input-xlarge" Help="The current page's description" />
                            <Rock:LabeledTextBox ID="tbQuery" runat="server" Label="Query" TextMode="MultiLine" Rows="5" CssClass="input-xlarge" 
...
returns one row and one column with a name of 'Xml', the escaped xml will be displayed, or the xml can optionally be transformed to html by specifying an 'Xslt File' value." />
                            <Rock:LabeledTextBox ID="tbParams" runat="server" Label="Parameters" TextMode="MultiLine" Rows="2" CssClass="input-xlarge" 
...
form, or page route) will have it's value replaced with the page's current value.  A parameter with the name of 'CurrentPersonId' will have it's value replaced with the currently logged in person's id."/>
                    ...
                    <div class="span6">
                        <fieldset>
                            <Rock:LabeledTextBox ID="tbUrlMask" runat="server" Label="Selection Url" CssClass="input-large"
                            ...
                            <Rock:LabeledTextBox ID="tbXslt" runat="server" Label="Xslt File" CssClass="input-large" 
                            ...
                            <Rock:LabeledCheckBox ID="cbPersonReport" runat="server" Label="Person Report" Text="Yes"
                            ...
                            <Rock:LabeledTextBox ID="tbMergeFields" runat="server" Label="Communication Merge Fields" TextMode="MultiLine" Rows="2" CssClass="input-xlarge" 
