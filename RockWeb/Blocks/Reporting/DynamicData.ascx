        ...
        <div class="dynamic-report">
            ...
            <asp:PlaceHolder ID="phDetails" runat="server">
                ...
                <div class="dynamic-report-details row-fluid well" style="display: none;">
                    ...
                    <div class="span6">
                        <fieldset>
                            <Rock:LabeledTextBox ID="tbName" runat="server" LabelText="Page Name" CssClass="input-large" Help="The current page's title" />
                            <Rock:LabeledTextBox ID="tbDesc" runat="server" LabelText="Page Description" TextMode="MultiLine" Rows="2" CssClass="input-xlarge" Help="The current page's description" />
