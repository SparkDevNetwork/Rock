    ...
    <ContentTemplate>
        ...
        <Rock:ModalDialog ID="mdEdit" runat="server" Title="Entity" OnCancelScript="clearActiveDialog();">
            <Content>
                ...
                <Rock:CodeEditor ID="ceIndexResultsTemplate" runat="server" Label="Index Results Template" Help="The Lava used by the Universal Search feature to display results." />
            </Content>
        </Rock:ModalDialog>
