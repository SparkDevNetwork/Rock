                    ...
                    <div class="row d-md-flex justify-content-center align-items-center">
                        ...
                        <div class="col-sm-9 col-md-10">
                            ...
                            <asp:Panel runat="server" ID="pnlEarlyAccessEnabled" Visible="false">
                                Thank you for being a Community Contributor! <a href="https://www.rockrms.com/earlyaccess">Learn more about the Early Access program</a>.
                            </asp:Panel>
                        </div>
                    </div>
                </div>
                            ...
                            <div id="divPanel" runat="server" class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        <asp:Literal runat="server" Text='<%# GetRockVersion( Eval( "Version" ) )%>' /></h3>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-2">
