            ...
            <div class="panel-body">
                ...
                <div id="pnlEditDetails" runat="server">
                    ...
                    <div class="well">
                        ...
                        <Rock:CodeEditor ID="ceESignatureLavaTemplate" runat="server" EditorMode="Lava"  Label="Lava Template" Help="asdf. The Lava template that makes up the body of the document. The person's final signature will automatically be appended to the end of the document. However, if you include the keyword '&amp;lt;!--[[ SignatureDetails ]]--&amp;gt;' in the Lava Template, each occurrence of this keyword will be replaced with the person's signature details in the final PDF, and the signature will not be appended to the bottom of the document." EditorHeight="500" />
