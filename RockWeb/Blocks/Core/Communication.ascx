...
<asp:UpdatePanel ID="upPanel" runat="server">
    <ContentTemplate>
        ...
        <Rock:DateTimePicker ID="dtpFutureSend" runat="server" LabelText="Delay Send Until" DatePickerType="Date" SourceTypeName="Rock.Model.Communication" PropertyName="FutureSendDateTime" />
