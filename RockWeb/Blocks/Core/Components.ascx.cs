    ...
    public partial class Components : RockBlock, ICustomGridColumns
    {
        ...
        protected void rGrid_RowDataBound( object sender, System.Web.UI.WebControls.GridViewRowEventArgs e )
        {
            ...
            if ( componentDescription != null )
            {
                ...
                if ( aSecure != null )
                {
                    ...
                    var entityType = CacheEntityType.Get( componentDescription.Type );
        ...
        private void BindGrid()
        {
            ...
            foreach ( var component in components )
            {
                ...
                if ( Rock.Attribute.Helper.UpdateAttributes( type, Rock.Cache.CacheEntityType.GetId( type.FullName ), string.Empty, string.Empty, rockContext ) )
                {
