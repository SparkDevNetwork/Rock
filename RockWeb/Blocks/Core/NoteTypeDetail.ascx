            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <Rock:RockCheckBox ID="cbAllowsAttachments" runat="server" Label="Allows Attachments" Text="Yes" Help="If enabled, then this note type will allow attachments. However, not all UI components will currently allow file uploads." AutoPostBack="true" OnCheckedChanged="cbAllowsAttachments_CheckedChanged" Visible="false" />
                        <Rock:BinaryFileTypePicker ID="bftpAttachmentType" runat="server" Label="Attachment File Type" Required="true" Help="When a file is attached to a note, it will be stored using this file type." Visible="false" />
