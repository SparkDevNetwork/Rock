            ...
            <div class="panel-body">
                ...
                <div class="actions">
                    ...
                    <div class="pull-right">
                        <asp:LinkButton ID="btnEditLabelContents" runat="server" Text="Edit Label Contents" CssClass="btn btn-link" Visible="false" OnClick="btnEditLabelContents_Click" />
                        <asp:LinkButton ID="btnRerunWorkflow" runat="server" Text="Rerun Workflow" CssClass="btn btn-link" Visible="false" OnClick="btnRerunWorkflow_Click" />
                    </div>
                </div>
