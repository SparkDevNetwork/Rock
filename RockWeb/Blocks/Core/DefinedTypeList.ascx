    ...
    <ContentTemplate>
        ...
        <div class="panel panel-block">
            <div class="panel-heading">
                <h1 class="panel-title"><i class="ti ti-book"></i> Defined Types List</h1>
            </div>
                ...
                <div class="grid grid-panel">
                    ...
                    <Rock:Grid ID="gDefinedType" runat="server" AllowSorting="true" OnRowSelected="gDefinedType_Edit" TooltipField="Description">
                        <Columns>
                            ...
                            <Rock:HtmlField DataField="Description" HeaderText="Description" SortExpression="Description" DisplayMode="PlainText" />
