            ...
            <div class="panel-body">
                ...
                <div id="pnlEditDetails" runat="server">
                    ...
                    <div class="actions">
                        ...
                        <asp:LinkButton ID="btnReCheckRequirements" runat="server" AccessKey="r" Text="Re-Check Requirements" CssClass="btn btn-default" OnClick="btnReCheckRequirements_Click" CausesValidation="false" />
