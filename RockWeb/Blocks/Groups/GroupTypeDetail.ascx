            ...
            <Content>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <Rock:RockCheckBox ID="cbIsCheckInAllowed" runat="server" Label="Is Check-in Allowed" Text="Yes" Help="Used with the &quot;already belongs&quot; check-in filter to only allow certain roles to check into a group." />
                    </div>
                    <div class="col-md-6">
