        ...
        <div class="panel panel-block">
            ...
            <div class="panel-body xs-soft-half">
                ...
                <asp:Panel ID="pnlDetails" runat="server">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12 xs-push-half-bottom">
                    ...
                    <div class="actions">
                        <asp:LinkButton ID="lbSave" runat="server" AccessKey="s" ToolTip="Alt+s" Text="Save" CssClass="btn btn-primary xs-btn-sm" OnClick="lbSave_Click" CausesValidation="false" />
                        <asp:LinkButton ID="lbCancel" runat="server" AccessKey="c" ToolTip="Alt+c" Text="Cancel" CssClass="btn btn-link xs-btn-sm" OnClick="lbCancel_Click" CausesValidation="false"></asp:LinkButton>
                        <asp:LinkButton ID="lbPrintAttendanceRoster" runat="server" ToolTip="Print Attendance Roster" CssClass="btn btn-default xs-btn-sm btn-square pull-right" OnClick="lbPrintAttendanceRoster_Click" CausesValidation="false"><i class="fa fa-print"></i></asp:LinkButton>
                    </div>
