            ...
            <div class="panel-body">
                ...
                <div class="grid grid-panel">
                    ...
                    <Rock:Grid ID="gOccurrences" runat="server" DisplayType="Full" AllowSorting="true" RowItemText="Occurrence" OnRowSelected="gOccurrences_Edit" >
                        <Columns>
                            <Rock:DateField DataField="Date" HeaderText="Date" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" SortExpression="Date" />
                            ...
                            <Rock:RockBoundField DataField="Percentage" HeaderText="Percent Attended" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:P0}" SortExpression="Percentage" HeaderStyle-HorizontalAlign="Right"/>
