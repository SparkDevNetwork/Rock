        ...
        protected void lvMembers_ItemDataBound( object sender, ListViewItemEventArgs e )
        {
            if ( e.Item.ItemType == ListViewItemType.DataItem )
            {
                ...
                if ( groupMember != null )
                {
                    ...
                    {
                        divPersonImage.Style.Add( "background-image", @String.Format( @"url({0})", Person.GetPhotoUrl( groupMember.PhotoId, groupMember.Age, groupMember.Gender, 200, 200, groupMember.Id ) + "&width=65" ) );
