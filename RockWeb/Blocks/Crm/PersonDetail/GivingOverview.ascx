        ...
        <asp:Panel ID="pnlContent" runat="server">
            <div class="panel panel-block">
                ...
                <div class="panel-body pt-0">
                    <Rock:Badge ID="bdgFirstGift" runat="server" BadgeType="" />
                    <Rock:Badge ID="bdgLastGift" runat="server" BadgeType="success" />
                    <div class="giving-alerts">
                        <i class="fa fa-fw fa-comment-alt"></i> Giving Alerts
                    ...
                    <asp:Panel ID="pnlGiving" runat="server">
                        ...
                        <hr class="m-0">
                            ...
                            <div class="row d-flex flex-wrap align-items-start py-3">
                                <div class="col-xs-12 col-sm-8 col-lg-9 giving-characteristics">
