...
";
        ...
        private void ShowDetails()
        {
            ...
            ddlReason.Visible = Person.RecordStatusValueId.HasValue && Person.RecordStatusReasonValueId.Value == DefinedValueCache.Read( new Guid( Rock.SystemGuid.DefinedValue.PERSON_RECORD_STATUS_INACTIVE ) ).Id;
