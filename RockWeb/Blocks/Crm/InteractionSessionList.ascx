<%@ Control Language="C#" AutoEventWireup="true" CodeFile="InteractionSessionList.ascx.cs" Inherits="RockWeb.Blocks.Crm.InteractionSessionList" %>

<asp:UpdatePanel ID="upnlContent" runat="server">
    <ContentTemplate>
        <div class="panel panel-block">
            <div class="panel-heading">
                <h1 class="panel-title"><i class="fa fa-desktop"></i> Interactions Session List</h1>
