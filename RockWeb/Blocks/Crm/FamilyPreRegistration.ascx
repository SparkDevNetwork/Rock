    ...
    <ContentTemplate>
        ...
        <div class="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlVisit" Visible="false" runat="server" CssClass="hidden panel panel-default">
                    <div class="panel-heading">
                ...
                <asp:Panel ID="pnlParents" runat="server" CssClass="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <h4 class="text-primary">First Adult</h4>
                        <div class="row">
                            ...
                            <asp:Panel CssClass="col-xs-12 col-sm-10" runat="server" ID="pnlEmail1">
                                <Rock:EmailBox ID="tbEmail1" runat="server" Label="Email" />
                            </asp:Panel>
                            <asp:Panel CssClass="col-xs-12 col-sm-6" runat="server" ID="pnlMobilePhone1">
                                <Rock:PhoneNumberBox ID="pnMobilePhone1" runat="server" Label="Mobile Phone" />
                            </asp:Panel>
                            <asp:Panel CssClass="hidden" Visible="false" runat="server" ID="pnlSuffix1">
                                <Rock:DefinedValuePicker ID="dvpSuffix1" runat="server" Label="Suffix" />
                            </asp:Panel>
                            <asp:Panel CssClass="col-xs-12 col-sm-6" runat="server" ID="pnlBirthDate1">
                            ...
                            <asp:Panel CssClass="col-xs-12 col-sm-6"  runat="server" ID="pnlGender1">
                                <Rock:RockDropDownList ID="ddlGender1" runat="server" Label="Gender" />
                            </asp:Panel>
                            <asp:Panel CssClass="col-xs-12 col-sm-6" runat="server" ID="pnlMaritalStatus1">
                        ...
                        <h4 class="text-primary">Second Adult (optional)</h4>
                        <div class="adult-2-fields">
                            ...
                            <div class="row">
                                ...
                                <asp:Panel CssClass="col-xs-12 col-sm-10 js-Adult2Required" runat="server" ID="pnlEmail2">
                                    <Rock:EmailBox ID="tbEmail2" runat="server" Label="Email" />
                                </asp:Panel>
                                <asp:Panel CssClass="col-xs-12 col-sm-6 js-Adult2Required" runat="server" ID="pnlMobilePhone2">
                                    <Rock:PhoneNumberBox ID="pnMobilePhone2" runat="server" Label="Mobile Phone" />
                                </asp:Panel>
                                <asp:Panel CssClass="hidden col-xs-12 col-sm-6 js-Adult2Required" Visible="false" runat="server" ID="pnlSuffix2">
                                    <Rock:DefinedValuePicker ID="dvpSuffix2" runat="server" Label="Suffix" />
                                </asp:Panel>
                                <asp:Panel CssClass="col-xs-12 col-sm-6 js-Adult2Required" runat="server" ID="pnlBirthDate2">
                                    <Rock:DatePicker ID="dpBirthDate2" runat="server" Label="Birthdate" AllowFutureDates="False" ShowOnFocus="false" StartView="decade" />
                                </asp:Panel>
                                
                                <div class="clearfix"></div>
                                <asp:Panel CssClass="col-xs-12 col-sm-6 js-Adult2Required" runat="server" ID="pnlGender2">
                                    <Rock:RockDropDownList ID="ddlGender2" runat="server" Label="Gender" />
                                </asp:Panel>
                                <asp:Panel CssClass="col-xs-12 col-sm-6 js-Adult2Required" runat="server" ID="pnlMaritalStatus2">
