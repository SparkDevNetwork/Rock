...
<asp:UpdatePanel ID="upGroups" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlDetails" runat="server" Visible="false">
            ...
            <fieldset>
                <legend>
                    <asp:Label ID="lblIsSystem" runat="server" CssClass="icon-lock" ToolTip="Non-editable system value" />
                    <asp:Literal ID="lActionTitle" runat="server" />
                </legend>
                <div class="row-fluid">
                    <div class="span6">
                        <Rock:DataTextBox ID="tbName" runat="server" SourceTypeName="Rock.Groups.Group, Rock" PropertyName="Name" />
                        <Rock:DataTextBox ID="tbDescription" runat="server" SourceTypeName="Rock.Groups.Group, Rock" PropertyName="Description" TextMode="MultiLine" Rows="4" />
                        <Rock:DataDropDownList ID="ddlGroupType" runat="server" DataTextField="Name" DataValueField="Id" SourceTypeName="Rock.Groups.GroupType, Rock" PropertyName="Name" LabelText="Group Type" />
                    </div>
                    <div class="span6">
                        <Rock:DataDropDownList ID="ddlParentGroup" runat="server" DataTextField="Name" DataValueField="Id" SourceTypeName="Rock.Groups.Group, Rock" PropertyName="Name" LabelText="Parent Group" />
