<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupSchedulerAnalytics.ascx.cs" Inherits="RockWeb.Blocks.GroupScheduling.GroupSchedulerAnalytics" %>
            ...
            <div class="panel-body">
                <div class="row row-eq-height-md">
                    <div class="col-md-3 filter-options" role="tabpanel">
                        ...
                        <Rock:SlidingDateRangePicker ID="sdrpDateRange" runat="server" Label="Date Range" EnabledSlidingDateRangeTypes="Previous, Last, Current, DateRange" EnabledSlidingDateRangeUnits="Week, Month, Year" SlidingDateRangeMode="Current" DelimitedValues="Last|4|Week||" />
                        ...
                        <div class="form-group rock-control-wrapper">
                            ...
                            <div class="toggle-container">
                                <div class="btn-group" data-toggle="view-btns" role="tablist" id="tablist">
                                    <a href="#group" class="btn btn-default btn-xs" aria-controls="group" role="tab" data-toggle="tab" onclick='$("#<%= hfTabs.ClientID %>").attr( "value", "group");'>Group</a>
                                    <a href="#dataview" class="btn btn-default btn-xs" aria-controls="dataview" role="tab" data-toggle="tab" onclick='$("#<%= hfTabs.ClientID %>").attr( "value", "dataview");'>Dataview</a>
                                    <a href="#person" class="btn btn-default btn-xs" aria-controls="person" role="tab" data-toggle="tab" onclick='$("#<%= hfTabs.ClientID %>").attr( "value", "person");'>Person</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content" style="padding-bottom: 20px">
                            <div role="tabpanel" class="tab-pane fade in active" id="group">
                                <Rock:GroupPicker ID="gpGroups" runat="server" AllowMultiSelect="false" Label="Select Group" LimitToSchedulingEnabledGroups="true" OnSelectItem="gpGroups_SelectItem" />
                            ...
                            <div class="col-md-12">
                                ...
                                <Rock:Grid ID="gData" runat="server" AllowPaging="true" EmptyDataText="No Data Found" ShowActionsInHeader="false">
                                    <Columns>
                                        ...
                                        <Rock:RockBoundField DataField="ScheduledCount" HeaderText="Scheduled"></Rock:RockBoundField>
                                        <Rock:RockBoundField DataField="NoResponseCount" HeaderText="No Response"></Rock:RockBoundField>
                                        <Rock:RockBoundField DataField="DeclineCount" HeaderText="Declines"></Rock:RockBoundField>
                                        <Rock:RockBoundField DataField="AttendedCount" HeaderText="Attended"></Rock:RockBoundField>
                                        <Rock:RockBoundField DataField="CommittedNoShowCount" HeaderText="Committed No Show"></Rock:RockBoundField>
                                    </Columns>
                                </Rock:Grid>
                            </div>
                        </div>
