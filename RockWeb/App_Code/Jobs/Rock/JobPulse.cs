		...
		public virtual void  Execute(IJobExecutionContext context)
		{
            ...
            */
            ...
            using ( new Rock.Helpers.UnitOfWorkScope() )
            {
                ...
                Rock.Models.Core.Attribute jobPulseAttrib = attribService.GetAttributeByGuid( SystemGuids.JOB_PULSE_ATTRIBUTE_GUID );
                ...
                if ( jobPulseAttribValue == null )
                {
                    ...
                    attributeValueService.AddAttributeValue( jobPulseAttribValue );
                }
                ...
                // save attribute
                attributeValueService.Save( jobPulseAttribValue, 1 );
            }
		}
