...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        protected void Session_Start( object sender, EventArgs e )
        {
            ...
            // The browser-session identifier is no longer stored in ASP.NET Session
            // ("RockSessionId"). It now lives in the cookie-backed
            // RockRequestContext.SessionGuid (see RequestCookieKey.ROCK_SESSION_ID),
            // established in Application_BeginRequest, because ASP.NET Session state is
            // not available that early in the pipeline.
        }
