...
+ Account attributes marked as 'Show In Grid' will now appear in the Account List block.
...
+ Added a new "Right" Lava filter which returns the right most part of a string of the given length.
