...
var programBlog={init:function(){var t=this;this.loadFirstPost(),$(window).one("programBlogFirstPostLoaded",function(){t.loadAllPosts()})},loadFirstPost:function(){var t=this,e="//ccvprogramblog.dreamhosters.com/?json=get_recent_posts&count=1&callback=?";$.getJSON(e,function(e){var n=t.formatPost(e.posts[0]);$(".js-wp-container").prepend(n),$(window).trigger("programBlogFirstPostLoaded")})},loadAllPosts:function(){var t=this,e="//ccvprogramblog.dreamhosters.com/?json=get_recent_posts&callback=?",n="";$.getJSON(e,function(e){for(var i=1;i<e.posts.length;i++)n+=t.formatPost(e.posts[i]);$(".js-wp-loading-icon").remove(),$(".js-wp-container").append(n),$(window).trigger("programBlogAllLoaded")})},formatPost:function(t){var e='<article class="wordpress-post">';return e+='<h1 class="page-header">'+t.title+' <small style="display:inline-block;">'+moment(t.date).format("MMMM Do, YYYY")+"</small></h1>",e+="<div>"+t.content+"</div>",e+="</article>"}};programBlog.init(),$(window).on("programBlogAllLoaded",function(){$('a img[class*="wp-image"]').parent().each(function(){var t=$(this);t.parent().hasClass("lightbox-gallery")||t.hasClass("lightbox")||t.addClass("lightbox")}),$(".wordpress-post").each(function(t,e){var n=$(e).find("img.attachment-thumbnail");n&&n.parent().wrapAll('<div class="lightbox-gallery">').each(function(){var t=$(this),e=t.find("img").attr("src").replace("-150x150","");t.attr("href",e)})}),$(".lightbox").magnificPopup({type:"image",closeOnContentClick:!0,mainClass:"mfp-img-mobile",image:{verticalFit:!0}}),$(".lightbox-gallery").each(function(){$(this).magnificPopup({delegate:"a",type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},image:{tError:'<a href="%url%">The image #%curr%</a> could not be loaded.',verticalFit:!0,titleSrc:function(t){return t.el.find("img").attr("alt")}}})}),$(".js-wp-container").fitVids()});
