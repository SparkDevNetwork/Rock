...
<asp:Content ID="ctMain" ContentPlaceHolderID="main" runat="server">
    ...
    <Rock:Lava ID="HeaderImage" runat="server">
        ...
        {%- else -%}
            <div class="hero has-overlay classic-hero py-sm-5" style="background-image:url('https://images.unsplash.com/photo-1521127021408-f33c67dfcb76?fm=jpg&q=60&w=2500');">
        {%- endif -%}
    </Rock:Lava>
