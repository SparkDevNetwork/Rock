...
<asp:Content ID="ctMain" ContentPlaceHolderID="main" runat="server">
    ...
    <Rock:Lava ID="HeaderImage" runat="server">
        ...
        {%- if headerImageId != '' -%}
            <div class="hero hero-card has-overlay" style="background-image: url('{{ headerImageId | ImageUrl }}&maxWidth=2500');">
        {%- else -%}
            <div class="hero hero-card has-overlay" style="background-image:url('https://images.unsplash.com/photo-1521127021408-f33c67dfcb76?fm=jpg&q=60&w=2500');">
        {%- endif -%}
    </Rock:Lava>
    ...
    <Rock:Lava ID="SecondaryImage" runat="server">
        ...
        <div class="container d-flex flex-column" style="height: 95vh; max-height: 560px;">
            <div class="row my-auto">
