...
**/function a(){o(".notification-bar").each(function(){o("body").css({"padding-top":o(this).outerHeight()}),o(".navbar-subheader").css({top:o(this).outerHeight()})})}window.location.hash&&s(window.location.hash),o("a[href*=\\#]:not([href=\\#])").click(function(){location.pathname.replace(/^\//,"")!=this.pathname.replace(/^\//,"")&&location.hostname!=this.hostname||s(this.hash)});
//set class on fixed header after scrolling
var n=!0,t=0,i=5,r;o(window).scroll(function(){n=!0}),setInterval(function(){n&&(e(),n=!1)},250),o(".navbar-subheader").on("click touchstart",".menu-opener",function(e){e.preventDefault(),o("#navbar-main").show().addClass("open")}),o("#navbar-main").on("click",".closer",function(e){e.preventDefault(),o("#navbar-main").hide().removeClass("open")}),o(".navbar-subheader").on("click",".search-opener",function(e){e.preventDefault(),o("#search-layer").show().addClass("open")}),o("#ipl_search").on("click","a",function(e){e.preventDefault(),o("#search-layer").show().addClass("open"),o(".searchbox input").focus()}),o("#search-layer").on("click",".closer",function(e){e.preventDefault(),o("#search-layer").hide().removeClass("open")}),o("#navbar-main").on("click","li.has-children > a",function(e){if(o("#navbar-main").hasClass("open")){var a=o(this).next(),n=o(this).text();o(a).hasClass("child-menu")&&(e.preventDefault(),o(a).prepend("<li class='backtext'><a>"+n+"</a></li>"),o(a).show().animate({left:"0"},175,"swing"))}}),o("#navbar-main").on("click","li.has-children ul.child-menu li a",function(e){if(o(this).parents().hasClass("backtext")){e.preventDefault();var a=o(this).parents(".child-menu");o(a).animate({left:"100%"},175,"swing",function(){o(a).hide(),o("li.backtext").remove()})}}),992<=o(window).width()&&o(".messages-grid .sermondetail").each(function(){var e=o(this).closest(".sermons-container");o(this).appendTo(e)}),o(".series-link").on("click touchstart",function(e){e.preventDefault(),window.console.log(e),o(".sermondetail").hide();var a=o(this).data("openid"),n=o(this).closest(".sermon");o("#"+a).hasClass("open")?(o(".sermon").removeClass("open"),o(".sermondetail").removeClass("open")):(o(".sermon").removeClass("open"),o(".sermondetail").removeClass("open"),o(n).addClass("open"),o("#"+a).addClass("open").slideDown(),s("#"+a))}),o(".sermondetail .closer").on("click touchstart",function(e){e.preventDefault();var a=o(this).closest(".sermondetail");o(".sermon").removeClass("open"),o(a).removeClass("open").hide()}),o(window).resize(function(){a(),n=!0}),a()});