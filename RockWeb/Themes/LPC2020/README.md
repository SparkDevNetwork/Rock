...
* HTML Content Block, Header Right
  ...
  - HTML Content:
    ...
    ```html
    {% schedule where:'CategoryId==335' %}{% for sched in scheduleItems %}{% assign startdates = sched.iCalendarContent | DatesFromICal:1 %}{% for date in startdates %}{% capture startDatesToSort %}{{ startDatesToSort }}{{date | Date:'yyyy^MM^dd^HH^mm^ss' }},{% endcapture %}{% endfor %}{% endfor %}{% endschedule %}
    {% assign startDateArray = startDatesToSort | Split:',' | Sort:'' %}{% assign nextService = startDateArray | First | Split:'^' %}
    ...
    <script language="javascript" type="text/javascript">
        ...
        targetDate: {
    	    ...
    	    'min':  {{nextService[4]}},
    	    'sec':  {{nextService[5]}},
    	    'launchtime': '{{nextService[1]}}/{{nextService[2]}}/{{nextService[0]}} {{nextService[3]}}:{{nextService[4]}}:{{nextService[5]}}',
