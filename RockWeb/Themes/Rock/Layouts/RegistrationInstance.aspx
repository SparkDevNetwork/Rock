...
<asp:Content ID="ctMain" ContentPlaceHolderID="main" runat="server">
        ...
        <section id="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <Rock:Zone Name="ProcessNavigationBar" runat="server" />
                </div>
            </div>

            <div class="row">
                <div class="col-md-12">
                    <Rock:Zone Name="RegistrationInstanceDetail" runat="server" />
                </div>
            </div>
            ...
            <div class="registration-content">
                <div class="row">
                    <div class="col-md-12">
                        <Rock:Zone Name="RegistrationInstanceTabDetail" runat="server" />
                    </div>
                </div>
		    </div>
