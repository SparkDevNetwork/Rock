...
// funciton to set the marker to active and others to default
function setMarkerActive(marker, type) {
    // set all other markers to default icon
    ...
    // replace map marker icon with active icon
    marker.setIcon({
        url: '/Themes/LCBC/Assets/Images/Icons/map-marker-active.svg',
        scaledSize: new google.maps.Size(30, 30),
        anchor: new google.maps.Point(15, 30)
    });
}
