        ...
        execute: function () {
            ...
            StarkDetailOptions = vue_1.defineComponent({
                ...
                setup: function () {
                    ...
                    var configurationValues = vue_1.inject('configurationValues');
                    var invokeBlockAction = vue_1.inject('invokeBlockAction');
                    // Reactive data are declared as "ref" variables
                    var configMessage = vue_1.ref('');
                    var blockActionMessage = vue_1.ref('');
                    // Methods can be declared as typical javascript functions
                    /** Load the message from a C# block action. */
                    var loadBlockActionMessage = function () { return __awaiter(_this, void 0, void 0, function () {
                        var response;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, invokeBlockAction('GetMessage', {
                    ...
                    return {
                        ...
                        blockActionMessage: blockActionMessage,
                        loadBlockActionMessage: loadBlockActionMessage
                    };
                },
...
//# sourceMappingURL=StarkDetailComposition.js.map