                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, this.fetchAndSetFormattedValue()];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
                    ...
                    fetchAndSetFormattedValue: function () {
                        return __awaiter(this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        if (!this.isCurrentDateValue) return [3 /*break*/, 1];
                                        ...
                                        return [3 /*break*/, 6];
                                    case 1:
                                        if (!(this.isDatePartsPicker && this.datePartsAsDate)) return [3 /*break*/, 3];
                                        _a = this;
                                        return [4 /*yield*/, this.getFormattedDateString(this.datePartsAsDate, this.dateFormatTemplate)];
                                    case 2:
                                        _a.formattedString = _c.sent();
                                        return [3 /*break*/, 6];
                                    case 3:
                                        if (!(!this.isDatePartsPicker && this.asDate)) return [3 /*break*/, 5];
                                        _b = this;
                                        return [4 /*yield*/, this.getFormattedDateString(this.asDate, this.dateFormatTemplate)];
                                    case 4:
                        ...
                        return __awaiter(this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        get = this.http.get;
                                        return [4 /*yield*/, get('api/obsidian/v1/format/date', { value: value, format: format })];
                                    case 1:
                                        result = _a.sent();
                                        return [2 /*return*/, result.data || "" + value];
                                }
                            });
                        });
                    }
                ...
                watch: {
                    ...
                    modelValue: {
                        ...
                        handler: function () {
                            return __awaiter(this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.syncModelValue()];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
                    ...
                    dateFormatTemplate: function () {
                        return __awaiter(this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.fetchAndSetFormattedValue()];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
