...
export default interface WebFarmNode {
    Id: number;
    AddedDateTime: string | Date;
    ...
    IsLeader: boolean;
    JobsAllowed: boolean;
    LastRestartDateTime: string | Date;
    LastSeenDateTime: string | Date;
    NodeName: string;
    StoppedDateTime: string | Date | null;
