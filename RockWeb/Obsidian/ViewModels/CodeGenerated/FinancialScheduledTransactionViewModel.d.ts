...
export default interface FinancialScheduledTransaction {
    Id: number;
    AuthorizedPersonAliasId: number;
    CardReminderDate: string | Date | null;
    ...
    IsActive: boolean;
    LastRemindedDate: string | Date | null;
    LastStatusUpdateDateTime: string | Date | null;
