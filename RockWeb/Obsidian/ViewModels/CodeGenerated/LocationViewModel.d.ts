...
export default interface Location {
    ...
    GeocodeAttemptedDateTime: string | Date | null;
    GeocodeAttemptedResult: string | null;
    GeocodeAttemptedServiceType: string | null;
    GeocodedDateTime: string | Date | null;
    ...
    StandardizeAttemptedDateTime: string | Date | null;
    StandardizeAttemptedResult: string | null;
    StandardizeAttemptedServiceType: string | null;
    StandardizedDateTime: string | Date | null;
    State: string | null;
    Street1: string | null;
    Street2: string | null;
