    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                <Rock:DataViewPicker ID="dvpDataview" runat="server" Label="DataView" Help="Choose the Dataview that contains the list of people to deactivate"  Required="true" AutoPostBack="true" OnSelectedIndexChanged="dvpDataview_SelectedIndexChanged" EntityTypeId="15" />
                ...
                <asp:LinkButton ID="btnInactivateRecords" runat="server" CssClass="btn btn-primary js-inactivate-btn" Text="Inactivate Records" OnClick="btnInactivateRecords_Click" />
