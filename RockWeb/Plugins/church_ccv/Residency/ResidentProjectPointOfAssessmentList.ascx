<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ResidentProjectPointOfAssessmentList.ascx.cs" Inherits="RockWeb.Plugins.church_ccv.Residency.ResidentProjectPointOfAssessmentList" %>
