<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CCVAccountEntry.ascx.cs" Inherits="RockWeb.Plugins.church_ccv.Security.CCVAccountEntry" %>
...
<ContentTemplate>
    ...
    <asp:PlaceHolder ID="phDuplicates" runat="server" Visible="false">
        ...
        <div class="grid-mobile">
            <asp:Literal ID="lMobileDuplicates" runat="server">Placeholder</asp:Literal>
        </div>
