<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CareRequestDetail.ascx.cs" Inherits="RockWeb.Plugins.church_ccv.Pastoral.CareRequestDetail" %>

<asp:UpdatePanel ID="upnlContent" runat="server">
    <ContentTemplate>

        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            <asp:HiddenField ID="hfCareRequestId" runat="server" />
            <div class="panel-heading">
                <h1 class="panel-title pull-left"><i class="fa fa-paste"></i> Care Request</h1>
            ...
            <div class="panel-body">
                ...
                <div class="">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <Rock:RockDropDownList ID="ddlRequestStatus" runat="server" Label="Request Status" SourceTypeName="church.ccv.Pastoral.Model.CareRequest, church.ccv.Pastoral" PropertyName="RequestStatusValue" />
                        </div>
                    </div>
                </div>
        ...
        <Rock:ModalDialog ID="mdAddResult" runat="server" ScrollbarEnabled="false" SaveButtonText="Add" OnSaveClick="btnAddResults_Click" Title="Care Request Result" ValidationGroup="valResult">
            <Content>
        ...
        <Rock:ConfirmPageUnload ID="confirmExit" runat="server" ConfirmationMessage="Changes have been made to this care request that have not yet been saved." Enabled="false" />
