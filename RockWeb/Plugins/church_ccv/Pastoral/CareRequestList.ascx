<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CareRequestList.ascx.cs" Inherits="RockWeb.Plugins.church_ccv.Pastoral.CareRequestList" %>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="">
            <div class="panel panel-block">
                <div class="panel-heading">
                    <h1 class="panel-title"><i class="fa fa-paste"></i> Care Requests</h1>
                </div>
