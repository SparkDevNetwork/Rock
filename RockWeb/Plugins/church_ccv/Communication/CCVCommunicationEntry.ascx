<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CCVCommunicationEntry.ascx.cs" Inherits="RockWeb.Plugins.church_ccv.Communication.CCVCommunicationEntry" %>
