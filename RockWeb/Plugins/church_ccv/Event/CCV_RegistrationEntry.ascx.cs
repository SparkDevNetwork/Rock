...
namespace RockWeb.Plugins.church_ccv.Event
{
    /// <summary>
    /// CCV customized block used to register for a registration instance.
    /// </summary>
    [DisplayName( "CCV Registration Entry" )]
    [Category( "CCV > Event" )]
        ...
        private void CreateSummaryControls( bool setValues )
        {
            ...
            if ( setValues && RegistrationState != null && RegistrationInstanceState != null )
            {
                ...
                if ( costs.Where( c => c.Cost > 0.0M ).Any() )
                {
                    ...
                    // Make sure payment amount is within minumum due and balance due. If not, set to minimum due
                    ...
                    //  Set "Amount to Pay Today" field to the minimum payment
                    nbAmountPaid.Visible = allowPartialPayment;
                    nbAmountPaid.Text = ( minimumPayment.Value.ToString() );
