<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AccountDetail.ascx.cs" Inherits="RockWeb.Plugins.com_mineCartStudio.WistiaIntegration.AccountDetail" %>
            ...
            <div class="panel panel-block">
                ...
                <div class="panel-body">
                    ...
                    <div id="pnlEditDetails" runat="server">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <Rock:DataTextBox ID="tbName" runat="server" SourceTypeName="com.minecartstudio.WistiaIntegration.Model.WistiaAccount, com.minecartstudio.WistiaIntegration" PropertyName="Name" />
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <Rock:DataTextBox ID="tbApiKey" runat="server" SourceTypeName="com.minecartstudio.WistiaIntegration.Model.WistiaAccount, com.minecartstudio.WistiaIntegration" PropertyName="ApiKey" Label="API Key" />
                            </div>
                            <div class="col-md-6">
                            </div>
                        </div>
