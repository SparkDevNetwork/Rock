                ...
                <div id="pnlEditDetails" runat="server">
                    ...
                    <asp:Panel ID="pnlTabImages" runat="server" Visible="false">
                        ...
                        <p>
                            ...
                            <br />
                            <small>Standard Size: 375 x 98 pxs for event tickets, 375 x 144 px for store cards and coupons</small>
                            <br />
                            <small>Retina Size: 750 x 196 pxs for event tickets, 750 x 288 px for store cards and coupons</small>
                        </p>
                        <div class="row">
                            <div class="col-md-6">
