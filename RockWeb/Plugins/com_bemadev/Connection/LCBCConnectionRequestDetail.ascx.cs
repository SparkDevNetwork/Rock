...
namespace RockWeb.Plugin.com_bemadev.Connection
{
    [DisplayName( "LCBC Connection Request Detail" )]
    [Category( "LCBC > Connection" )]
    ...
    public partial class LCBCConnectionRequestDetail : PersonBlock, IDetailBlock
    {
                    ...
                    if ( connectionStatus != null )
                    {
                        ...
                        if ( personId.HasValue )
                        {
                            ...
                            if ( person != null )
                            {
                                ...
                                connectionRequest.CampusId = person.GetCampusIds().First();
                            }
                        }
                    }
                }
