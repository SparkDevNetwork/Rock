<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LCBCConnectionRequestDetail.ascx.cs" Inherits="RockWeb.Plugin.com_bemadev.Connection.LCBCConnectionRequestDetail" %>
