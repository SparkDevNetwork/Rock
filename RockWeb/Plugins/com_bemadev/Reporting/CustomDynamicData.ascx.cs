...
namespace RockWeb.Plugins.com_bemadev.Reporting
{
    ...
    public partial class CustomDynamicData : RockBlockCustomSettings
    {
        #region Fields
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            int databaseTimeout = GetAttributeValue( "Timeout" ).AsIntegerOrNull() ?? 180;
