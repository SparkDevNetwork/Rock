<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TempHistoryLog.ascx.cs" Inherits="RockWeb.Plugins.com_bemadev.LogFix.TempHistoryLog" %>
    ...
    <ContentTemplate>
        <asp:Panel ID="pnlList" CssClass="panel panel-block" runat="server">
            ...
            <div class="panel-body">
                    <asp:Literal ID="tbDebug" runat="server" />
