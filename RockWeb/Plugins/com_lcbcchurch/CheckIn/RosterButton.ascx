...
<asp:UpdatePanel runat="server" ID="upContent">
    <ContentTemplate>
        ...
        <asp:LinkButton runat="server" ID="btnPrintRoster" CssClass="btn btn-default btn-large btn-block btn-checkin-select" Text="Print Roster" OnClick="btnRoster_Click"></asp:LinkButton>
    </ContentTemplate>
</asp:UpdatePanel>
