...
{
    [DisplayName( "NFCI Person Info Search" )]
    [Category( "Extra Search" )]
    [Description( "Displays list of people that match a given search term." )]

    [LinkedPage( "Person Detail Page" )]
    public partial class NFCIPersonInfoSearch : Rock.Web.UI.RockBlock
    {
        #region Fields
        ...
        public string PhotoUrl
        {
            get
            {
                if ( RecordTypeValueId.HasValue )
                {
                    ...
                    if ( recordType != null )
                    {
                        return Person.GetPersonPhotoUrl( this.Id, this.PhotoId, this.Age, this.Gender, recordType.Guid, null, 200, 200 );
                    }
                }
                return Person.GetPersonPhotoUrl( this.Id, this.PhotoId, this.Age, this.Gender, null, null, 200, 200 );
            }
            private set { }
        }
