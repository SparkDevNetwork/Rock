<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NFCIPersonInfoSearch.ascx.cs" Inherits="RockWeb.Plugins.org_newpointe.ExtraSearch.NFCIPersonInfoSearch" %>
...
<asp:UpdatePanel ID="upnlContent" runat="server">
    <ContentTemplate>
        ...
        <div class="grid">
            <Rock:Grid ID="gPeople" runat="server" EmptyDataText="No People Found" AllowSorting="true" OnRowSelected="gPeople_RowSelected" ShowActionRow="false">
                <Columns>
