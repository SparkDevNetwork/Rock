<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomCheckinSuccess.ascx.cs" Inherits="RockWeb.Plugins.org_newpointe.CheckinBatchCut.CustomCheckinSuccess" %>
