        ...
        <asp:Panel ID="pnlDetails" CssClass="panel panel-block" runat="server" Visible="false">
            ...
            <div class="panel-body">
                ...
                <div id="pnlEditDetails" runat="server">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <Rock:DataTextBox ID="tbName" runat="server" SourceTypeName="com.bemaservices.HrManagement.Model.PtoTier, com.bemaservices.HrManagement" PropertyName="Name" />
                        </div>
                        <div class="col-md-6">
                            <Rock:RockCheckBox ID="cbActive" runat="server" SourceTypeName="com.bemaservices.HrManagement.Model.PtoTier, com.bemaservices.HrManagement" PropertyName="IsActive" Label="Active" Checked="true" Text="Yes" />
                        </div>
                    </div>

                    <Rock:DataTextBox ID="tbDescription" runat="server" SourceTypeName="com.bemaservices.HrManagement.Model.PtoTier, com.bemaservices.HrManagement" PropertyName="Description" TextMode="MultiLine" Rows="4" />
