<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LocationLayoutList.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.RoomManagement.LocationLayoutList" %>
