<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuestionList.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.RoomManagement.QuestionList" %>
<%@ Register Namespace="com.bemaservices.RoomManagement.Web.UI.Controls" TagPrefix="BEMA" Assembly="com.bemaservices.RoomManagement" %>
    ...
    <ContentTemplate>
        ...
        <Rock:ModalDialog ID="modalDetails" runat="server" Title="Add/Edit Question" ValidationGroup="ReservationQuestions" OnSaveClick="modalDetails_SaveClick" OnCancelScript="clearActiveDialog();">
            <Content>
                ...
                <BEMA:SimpleAttributeEditor ID="edtQuestion" runat="server" ShowActions="false" ValidationGroup="ReservationQuestions"
        ...
        <Rock:ModalDialog ID="mdCopyQuestions" runat="server" Title="Copy Questions From..." OnSaveClick="mdCopyQuestions_SaveClick" OnCancelScript="clearActiveDialog();">
            <Content>
                <div>
                    Copy from resource:
                    <Rock:RockDropDownList ID="ddlResourceCopySource" runat="server" EnhanceForLongLists="true"></Rock:RockDropDownList>
                </div>
                <div class="margin-t-md">
                    Copy from location:
                    <Rock:LocationPicker ID="locpLocations" runat="server" AllowedPickerModes="Named"></Rock:LocationPicker>
                </div>
            </Content>
        </Rock:ModalDialog>
