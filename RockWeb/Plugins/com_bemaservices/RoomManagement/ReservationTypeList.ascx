<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReservationTypeList.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.RoomManagement.ReservationTypeList" %>
