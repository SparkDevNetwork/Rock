<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ResourceList.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.RoomManagement.ResourceList" %>
            ...
            <div class="panel-body">
                ...
                <div class="grid grid-panel">
                    <Rock:GridFilter ID="gfSettings" runat="server">
                        ...
                        <Rock:CategoryPicker ID="cpCategory" runat="server" Label="Category" Required="false" EntityTypeName="com.bemaservices.RoomManagement.Model.Resource" />
                    </Rock:GridFilter>
