<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReservationLavaKiosk.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.RoomManagement.ReservationLavaKiosk" %>
<style>
