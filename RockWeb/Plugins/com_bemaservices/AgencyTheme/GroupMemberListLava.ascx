<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupMemberListLava.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.AgencyTheme.GroupMemberListLava" %>
