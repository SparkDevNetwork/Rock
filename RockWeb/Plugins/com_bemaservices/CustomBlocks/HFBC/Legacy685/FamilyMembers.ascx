<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FamilyMembers.ascx.cs" Inherits="RockWeb.Plugins.org_hfbc.Legacy685.FamilyMembers" %>
...
<div class="panel panel-block">
    ...
    <div class="panel-body">
        ...
        <asp:Panel ID="pnlView" runat="server">
            ...
            <asp:Panel ID="pnlInactiveFamily" runat="server" Visible="false">
                <h3>Inactive Family</h3>
                <asp:Repeater ID="rptInactiveGroupMembers" runat="server" OnItemDataBound="rptGroupMembers_ItemDataBound" OnItemCommand="rptGroupMembers_ItemCommand">
                    <ItemTemplate>
                        <div class="row">
                            <div class="col-md-1">
                                <div class="photo">
