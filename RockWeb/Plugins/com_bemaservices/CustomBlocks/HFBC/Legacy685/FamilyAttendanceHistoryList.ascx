<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FamilyAttendanceHistoryList.ascx.cs" Inherits="RockWeb.Plugins.org_hfbc.Legacy685.FamilyAttendanceHistoryList" %>
