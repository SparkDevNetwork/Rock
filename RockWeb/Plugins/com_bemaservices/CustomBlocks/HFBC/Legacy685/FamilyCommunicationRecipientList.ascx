<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FamilyCommunicationRecipientList.ascx.cs" Inherits="RockWeb.Plugins.org_hfbc.Legacy685.FamilyCommunicationRecipientList" %>
