 ...
 *
 * Additional Features:
 * - UI1) Added Ability to rename the Summary label
 * - UI2) Added Ability to rename the Description label
 * - UI3) Added Ability to hide the Audience grid
 */

namespace RockWeb.Plugins.com_bemaservices.CustomBlocks.BEMA.Event
{
    /// <summary>
    ...
    /* BEMA.UI1.Start */
    [TextField( "Summary Label", "The label for the summary field.", false, "Summary", "BEMA Additional Features", 0, BemaAttributeKey.SummaryLabel )]
    /* BEMA.UI1.End */

    /* BEMA.UI1.Start */
    [TextField( "Description Label", "The label for the description field.", false, "Description", "BEMA Additional Features", 1, BemaAttributeKey.DescriptionLabel )]
    /* BEMA.UI1.End */

    /* BEMA.UI1.Start */
    [BooleanField( "Is Audience Grid Shown", "Determines if the audience grid should be shown.", true, "BEMA Additional Features", 2, BemaAttributeKey.IsAudienceGridShown )]
    /* BEMA.UI1.End */
    ...
    public partial class EventItemDetail : RockBlock, IDetailBlock
    {
        ...
        private static class BemaAttributeKey
        {
            ...
            public const string IsAudienceGridShown = "IsAudienceGridShown";
        }
...
";
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            /* BEMA.UI1.Start */
            var customSummaryLabel = GetAttributeValue( BemaAttributeKey.SummaryLabel );
            if ( customSummaryLabel.IsNotNullOrWhiteSpace() )
            {
                tbSummary.Label = customSummaryLabel;
                lSummary.Label = customSummaryLabel;
            }
            /* BEMA.UI1.End */

            /* BEMA.UI2.Start */
            var customDescriptionLabel = GetAttributeValue( BemaAttributeKey.DescriptionLabel );
            if ( customDescriptionLabel.IsNotNullOrWhiteSpace() )
            {
                htmlDescription.Label = customDescriptionLabel;
            }
            /* BEMA.UI2.End */

            /* BEMA.UI3.Start */
            if ( !GetAttributeValue( BemaAttributeKey.IsAudienceGridShown ).AsBoolean() )
            {
                rcwAudiences.Visible = false;
            }
            /* BEMA.UI3.End */
