 ...
 * 
 * Additional Features:
 * - FE1) Added Ability to filter off of multiple audiences
 */
namespace RockWeb.Plugins.com_bemaservices.Event
{
    ...
    /* BEMA.FE1.Start */
    [DefinedValueField( Rock.SystemGuid.DefinedType.MARKETING_CAMPAIGN_AUDIENCE_TYPE,
        ...
        private void LoadContent()
        {
            ...
            /* BEMA.FE1.End */
            {
                ...
                var qry = new EventItemOccurrenceService( rockContext ).Queryable()
                                            /* BEMA.FE1.Start */
                                            .Where( e => e.EventItem.EventItemAudiences.Any( a => a.DefinedValue.Guid == audienceGuid || selectedCategoryGuids.Contains( a.DefinedValue.Guid ) ) && e.EventItem.IsActive );
                                            /* BEMA.FE1.End */
