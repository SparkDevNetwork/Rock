<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationEntryWithSlots.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.Event.RegistrationEntryWithSlots" %>
