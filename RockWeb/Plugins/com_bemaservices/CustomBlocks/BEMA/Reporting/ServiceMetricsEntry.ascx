<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ServiceMetricsEntry.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.CustomBlocks.BEMA.ServiceMetricsEntry" %>
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlMetrics" runat="server" Visible="false">
                    ...
                    <div class="btn-group btn-group-justified margin-b-lg panel-settings-group">
                        ...
                        <!-- BEMA.UI2.Start -->
                        <Rock:ButtonDropDownList ID="bddlPreWeekendService" runat="server" OnSelectionChanged="bddlPreWeekendService_SelectionChanged" />
                        <!-- BEMA.UI2.End -->
