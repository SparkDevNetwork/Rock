...
namespace RockWeb.com_bemaservices.CheckIn
{
    ...
    [LinkedPage ( "Group Detail Page", "", true, "", "", 1 )]
            ...
            var importTask = new Task ( () =>
            {
                ...
                if ( groupsSelected.Any () )
                {
                    ...
                    foreach ( var group in groupsToUpdate )
                    {
                        ...
                        if (promotesToValue != null && promotesToValue != "")
                        {
                            groupsUpdated++;
                    ...
                    WriteProgressMessage ( "Success.", string.Format ( "{0} group(s) were updated.", groupsUpdated ) );
                }
                else
                {
                    WriteProgressMessage ( "Error.", "There were no groups selected." );
