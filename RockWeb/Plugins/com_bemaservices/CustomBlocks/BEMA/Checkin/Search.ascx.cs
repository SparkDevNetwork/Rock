 ...
 * 
 * Additional Features:
 * - FE1) Added Ability to display the number pad in Name & Phone search mode
 */
...
namespace RockWeb.Plugins.com_bemaservices.CheckIn
{
    ...
    /* BEMA.FE1.Start */
    [BooleanField(
        "Show Number Pad In Name And Phone Mode",
        Key = AttributeKey.ShowNumberPadInNameAndPhoneMode,
        Description = "Should the number pad be shown when checkin is set to the Name & Phone search mode?",
    ...
    public partial class Search : CheckInSearchBlock
    {
        ...
        {
            public const string ShowNumberPadInNameAndPhoneMode = "ShowNumberPadInNameAndPhoneMode";
        }
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            if ( !Page.IsPostBack )
            {
                ...
                if ( GetAttributeValue( AttributeKey.ShowNumberPadInNameAndPhoneMode ).AsBoolean() && searchType == "Phone or Name" )
                {
                    tbPhone.Label = "Phone or Name";
                    tbPhone.MaxLength = 0;
                    pnlSearchName.Visible = false;
                    pnlSearchPhone.Visible = true;
                }
