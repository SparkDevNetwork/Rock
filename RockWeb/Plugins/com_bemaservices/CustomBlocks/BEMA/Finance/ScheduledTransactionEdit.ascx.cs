 ...
 *
 * Additional Features:
 * - FE1) Added Ability to set an end date on Scheduled Transactions
 * 
 */
...
", "Text Options", 12 )]
    ...
    /* Bema.FE1.Start */
    [BooleanField( "Allow Scheduled End Date", "Should the block allow users to set an end date for their scheduled transactions.", false, "", 36, BemaAttributeKeys.AllowScheduledEndDate )]
    /* Bema.FE1.End */

    /* Bema.UI1.Start */
    [BooleanField( "Hide Summary Field", "Should the summary field be hidden?", false, "", 36, BemaAttributeKeys.HideSummaryField )]
    /* Bema.UI1.End */
    ...
    public partial class ScheduledTransactionEdit : RockBlock
    {
        ...
        private static class BemaAttributeKeys
        {
            public const string AllowScheduledEndDate = "AllowScheduledEndDate";
            public const string HideSummaryField = "HideSummaryField";
        }
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            if ( !Page.IsPostBack )
            {
                ...
                if ( scheduledTransaction != null )
                {
                    ...
                    /* BEMA.FE1.Start */
                    if ( scheduledTransaction.EndDate.HasValue )
                    {
                    ...
                    if ( GetAttributeValue( BemaAttributeKeys.AllowScheduledEndDate ).AsBoolean()
                        && ( !oneTime ) )
                    {
                    ...
                    /* BEMA.UI1.Start */
                    tbSummary.Visible = GetAttributeValue( BemaAttributeKeys.HideSummaryField ).AsBoolean();
                    /* BEMA.UI1.End */
        ...
        private bool ProcessPaymentInfo( out string errorMessage )
        {
            ...
            {
                tdWhen.Description = tdWhen.Description + " and ending on " + dtpEndDate.SelectedDate.Value.ToShortDateString();
            }
            /* BEMA.FE1.End */
