<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ScheduledTransactionListLiquid.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.Finance.ScheduledTransactionListLiquid" %>
