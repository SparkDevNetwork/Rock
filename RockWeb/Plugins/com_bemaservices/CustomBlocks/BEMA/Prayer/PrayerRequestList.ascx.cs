 ...
 * 
 * Additional Features:
 * - UI1) Added Ability to hide the campus filter
 * - UI2) Added Ability to hide the campus column
 */
namespace RockWeb.Plugins.com_bemaservices.Prayer
{
    [DisplayName( "Prayer Request List" )]
    [Category( "BEMA Services > Prayer" )]
