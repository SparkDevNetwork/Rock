    ...
    <ContentTemplate>
        ...
        <asp:Panel id="pnlDetails" runat="server" CssClass="row">
            ...
            <asp:Panel ID="pnlFilters" CssClass="hidden-print " runat="server">
				...
				<div id="campus-filter" class="filter-menu"> <%--Added campus-filter id - JM - 8/3/2018--%>
                ...
                <div class="col-md-4">
                 <Rock:DateRangePicker ID="drpDateRange" runat="server" Label="" /><asp:LinkButton ID="lbDateRangeRefresh" runat="server" CssClass="btn btn-default btn-sm" Text="Refresh" OnClick="lbDateRangeRefresh_Click" />
                </div>
