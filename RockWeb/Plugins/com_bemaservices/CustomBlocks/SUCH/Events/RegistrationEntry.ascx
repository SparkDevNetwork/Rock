<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationEntry.ascx.cs" Inherits="com_BEMAServices.Event.RegistrationEntry" %>
...
<ContentTemplate>
	...
	<asp:Literal runat="server" ID="ltPageTitle" />
