            ...
            <asp:Panel ID="pnlMain" runat="server">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                     ...
                     <div class="col-md-4 ">
                        <asp:Image ID="imgOpportunityPhoto" runat="server" CssClass="title-image img-responsive" Visible='false' />
                ...
                <asp:Panel ID="pnlContributions" runat="server">
                    <Rock:Grid ID="gContributions" runat="server" DisplayType="Light" OnRowDataBound="gContributions_RowDataBound">
                        <Columns>
                            ...
                            <Rock:RockLiteralField ID="lTransactionDetailAmount" HeaderText="Amount" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" Visible='false' />
                        </Columns>
                    </Rock:Grid>
                </asp:Panel>
