                ...
                if ( singleSelectKeyValue.IsNotNullOrWhiteSpace() && slotsValue.IsNotNullOrWhiteSpace() )
                {
                    ...
                    if ( singleSelectField != null && singleSelectField.Id == field.Id )
                    {
                        ...
                        if ( slots.Any() )
                        {
							...
							ListItemCollection removedItems2 = new ListItemCollection();
							string fieldId = "attribute_field_" + singleSelectField.AttributeId ;
							Control control2 = phRegistrantControls.FindControl( fieldId );
							
							 var dropDownList = control2 as RockDropDownList;
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            if ( totalSlots != null )
                                                            {
                                                                ...
                                                                if ( availableSlots < 0 )
                                                                {
                                                                    ...
                                                                    {
                                                                        item.Text += string.Format( " ({0} slots available, Add to Waitlist)", availableSlots );
                                                                    }
                                            ...
                                            foreach ( ListItem item in removedItems2 )
                                            {
