    ...
    public partial class PublicProfileEdit : RockBlock
    {
                ...
                if ( group != null )
                {
                    rockContext.WrapTransaction( () =>
                    {
                        ...
                        if ( personId == 0 )
                        {
                            ...
                            {
                                groupMember.Person.ConnectionStatusValueId = DefinedValueCache.Get( "B91BA046-BC1E-400C-B85D-638C1F4E0CE2" ).Id;
                            }
        ...
        private void ShowDetail()
        {
            ...
            if ( CurrentPerson != null )
            {
                ...
                if(CurrentPerson.GetCampus().IsNotNull())
                    lCampus.Text = CurrentPerson.GetCampus().Name;
                        ...
                        if ( person != null )
                        {
                            ...
                            else
                            {
                                ddlGradePicker.Visible = false;
                                 ...
                                 cpCampus.Items.Remove(cpCampus.Items.FindByValue("8"));
