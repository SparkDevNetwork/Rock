...
",
        ...
        private void SetControls()
        {
            ...
            ddlServiceTimes.Items.Clear();
			ddlServiceTimes.Items.Add(new ListItem("", ""));
            var serviceTimes = DefinedTypeCache.Read(71).DefinedValues.OrderBy(a => a.Order).ThenBy(a => a.Value);
            foreach (var time in serviceTimes)
            {
                ddlServiceTimes.Items.Add(new ListItem(time.Value, time.Id.ToString()));
            }
        ...
        private void SetCurrentFamilyValues()
        {
            ...
            else
            {
                ...
                if (!string.IsNullOrWhiteSpace(PageParameter("Campus")))
                {
                    int campusId = PageParameter("Campus").AsInteger();
        ...
        {
            if (string.IsNullOrWhiteSpace(tbFirstName2.Text) && string.IsNullOrWhiteSpace(tbLastName2.Text))
            {
