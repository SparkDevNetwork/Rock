                ...
                <asp:Panel ID="pnlVisit" runat="server" CssClass="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <asp:Panel CssClass="col-md-4" runat="server" ID="pnlPlannedDate">
                                <Rock:DatePicker ID="dpPlannedDate" runat="server" Label="Planned Visit Date"  />
                            </asp:Panel>
							<asp:Panel CssClass="col-md-4" runat="server" ID="PnlServiceTime">
                                <Rock:RockDropDownList ID="ddlServiceTimes" runat="server" CssClass="input-width-lg" Label="Service Time" />
                            </asp:Panel>
                        </div>
                    </div>
                </asp:Panel>
