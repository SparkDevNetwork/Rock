<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PledgeDetail.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.CustomBlocks.SUCH.Finance.PledgeDetail" %>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <Rock:RockDropDownList ID="ddlAccounts" runat="server" Label="Account" Required="true"  />
                             <Rock:AccountPicker ID="apAccount" runat="server" Label="Account" Required="false" Visible="false" />
                    ...
                    <div class="actions">
                        <asp:LinkButton ID="btnSaveAdd" runat="server" AccessKey="a" ToolTip="Alt+a" Text="Save & Add" CssClass="btn btn-primary" OnClick="btnSaveAdd_Click" />
