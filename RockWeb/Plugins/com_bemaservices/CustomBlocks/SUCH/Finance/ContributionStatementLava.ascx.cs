...
namespace RockWeb.Plugins.com_beamservices.Finance
{
    /// <summary>
...
<p class=""text-center"">
    ...
    public partial class ContributionStatementLava : Rock.Web.UI.RockBlock
    {
        ...
        private void DisplayResults()
        {
            ...
            mergeFields.Add( "AccountSummary", qry.GroupBy( t => new { t.Account.Name, t.Account.PublicName,t.Account.ParentAccountId, t.Account.Description } )
                                                .Select( s => new AccountSummary
                                                {
                                                    AccountName = s.Key.Name,
                                                    PublicName = s.Key.PublicName,
                                                    ParentAccountId = s.Key.ParentAccountId,
