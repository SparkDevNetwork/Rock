            ...
            <div class="panel-body">
                <div class="grid grid-panel">
                    <Rock:Grid ID="gDonations" runat="server" DisplayType="Full" AllowSorting="true" EmptyDataText="No Donations Found" PersonIdField="DonorId" RowItemText="Donations" DataKeyNames="DonorId" ExportSource="ColumnOutput" OnRowDataBound="gDonations_RowDataBound" >
                        <Columns>
                            <Rock:SelectField />
                            <Rock:RockLiteralField HeaderText="Donor" SortExpression="Donor.LastName, Donor.NickName" ExcelExportBehavior="AlwaysInclude" />
                            ...
                            <Rock:RockLiteralField HeaderText="Participant" SortExpression="Participant.Person.LastName, Participant.Person.NickName" ExcelExportBehavior="AlwaysInclude" />
                            ...
                            <Rock:CurrencyField DataField="Amount" HeaderText="Amount" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" SortExpression="Amount" ExcelExportBehavior="AlwaysInclude" />
                            <Rock:RockLiteralField  HeaderText="Payment Type"  ExcelExportBehavior="AlwaysInclude" />
                        </Columns>
                    </Rock:Grid>
                </div>
            </div>
