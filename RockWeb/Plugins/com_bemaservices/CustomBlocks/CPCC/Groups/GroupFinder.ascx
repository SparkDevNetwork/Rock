<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupFinder.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.Groups.GroupFinder" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlFilters" runat="server" cssclass="Small Groups Filters section">

				          <div id="group-filters" class="container">

                    <div class="<%= colClass %> cpCampus">
                        <Rock:CampusPicker runat="server" ID="cpCampus" OnSelectedIndexChanged="cpCampus_SelectedIndexChanged" AutoPostBack="true" Label=""/>
                    </div>

                    <div class="<%= colClass %> ddlCatPicker">
                        <Rock:DefinedValuePicker runat="server" ID="ddlCatPicker" DefinedTypeId="1333" OnSelectedIndexChanged="ddlCatPicker_SelectedIndexChanged" AutoPostBack="true" />
                    </div>

                    <div class="<%= colClass %> ddlCommunityPicker">
                        <Rock:DefinedValuePicker runat="server" ID="ddlCommunityPicker" DefinedTypeId="334" OnSelectedIndexChanged="ddlCommunityPicker_SelectedIndexChanged" AutoPostBack="true" />
                    </div>

                    <div class="<%= colClass %> ddlDayOfTheWeekPicker">
                        <Rock:DayOfWeekPicker runat="server" ID="ddlDayOfTheWeekPicker" OnSelectedIndexChanged="ddlDayOfTheWeekPicker_SelectedIndexChanged" AutoPostBack="true" />
                    </div>

                    <div class="<%= colClass %> ddlAgePicker">
                        <Rock:DefinedValuePicker runat="server" ID="ddlAgePicker" DefinedTypeId="76" OnSelectedIndexChanged="ddlAgePicker_SelectedIndexChanged" AutoPostBack="true" />
                    </div>

                    <div class="<%= colClass %> ddlChildcarePicker">
                        <Rock:DefinedValuePicker runat="server" ID="ddlChildcarePicker" DefinedTypeId="333" OnSelectedIndexChanged="ddlChildcarePicker_SelectedIndexChanged" AutoPostBack="true" />
                    </div>

					          <div class="<%= colClass %> ddlHourPicker">
                        <Rock:DefinedValuePicker runat="server" ID="ddlHourPicker" DefinedTypeId="89" OnSelectedIndexChanged="ddlCommunityPicker_SelectedIndexChanged" AutoPostBack="true" />
                    </div>

                    <div class="col-md-3 hidden">
                        <asp:LinkButton ID="lbShowHideMap" runat="server" Text="Show Map" CssClass="btn btn-link" OnClick="lbShowHideMap_Click" AutoPostBack="true" />
                    </div>
				          </div>
                </asp:Panel>

                <asp:Panel ID="pnlResults" runat="server" Visible="false" cssclass="">
                    ...
                    <asp:Panel ID="pnlMap" runat="server" CssClass="margin-v-sm" Visible="false">
                        <div id="map_wrapper">
