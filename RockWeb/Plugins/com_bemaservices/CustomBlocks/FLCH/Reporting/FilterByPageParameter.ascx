            ...
            <div class="panel-body">
                ...
                <asp:Panel runat="server" ID="pnlFilters">
                    ...
                    <div class="text-center">
                        <Rock:BootstrapButton ID="btnResetFilters" runat="server" Text="Clear Filters" CssClass="btn btn-default" OnClick="btnResetFilters_Click" />
                        <Rock:BootstrapButton ID="btnFilter" runat="server" Text="Filter" CssClass="btn btn-primary" OnClick="btnFilter_Click" />
                        <Rock:BootstrapButton ID="btnPrint" runat="server" Text="Print" CssClass="btn btn-primary" OnClick="btnPrint_Click" />
                    </div>
                </asp:Panel>
