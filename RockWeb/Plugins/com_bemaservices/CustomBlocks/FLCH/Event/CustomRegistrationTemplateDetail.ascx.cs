...
{
    [DisplayName( "Custom Registration Template Detail" )]
...
{{ 'Global' | Attribute:'EmailFooter' }}", "", 3 )]
    public partial class CustomRegistrationTemplateDetail : RockBlock
    {
        #region Properties
        ...
        protected override void LoadViewState( object savedState )
        {
            ...
            if ( registrationTemplateId.HasValue )
            {
                ...
                if ( registrationTemplate != null )
                {
                    ...
                    Rock.Attribute.Helper.AddEditControls( registrationTemplate, phAttributes, true, BlockValidationGroup );
                }
            }
...
";
        ...
        protected void btnSave_Click( object sender, EventArgs e )
        {
            ...
            // Saving Custom Attribute Values
            registrationTemplate.LoadAttributes( rockContext );
            Rock.Attribute.Helper.GetEditValues( phAttributes, registrationTemplate );
            registrationTemplate.SaveAttributeValues( rockContext );
        ...
        private void BindCustomAttributes()
        {
