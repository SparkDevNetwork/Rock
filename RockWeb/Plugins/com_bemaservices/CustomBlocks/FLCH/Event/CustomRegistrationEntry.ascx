<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomRegistrationEntry.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.Event.CustomRegistrationEntry" %>
    ...
    <asp:Panel ID="pnlSummaryAndPayment" runat="server" Visible="false" CssClass="registrationentry-summary">
        ...
        <asp:Panel ID="pnlPaymentInfo" runat="server" CssClass="well">
            ...
            <div class="tab-content" style="padding-top: 15px;">
                <div id="divNewCard" runat="server" class="radio-content" visible="false">
