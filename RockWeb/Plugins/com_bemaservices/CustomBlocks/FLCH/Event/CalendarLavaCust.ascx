<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CalendarLavaCust.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.Event.CalendarLava" %>
...
<asp:UpdatePanel ID="upnlContent" runat="server">
 ...
 <div class="row">
                <div class="col-md-8 col-md-offset-2">
                 ...
                 <asp:Button ID="lbDateRangeRefresh" runat="server" CssClass="button button-default" Text="Filter by Date" OnClick="lbDateRangeRefresh_Click" />
                </div>
</div>
