<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomRegistrationTemplateDetail.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.Event.CustomRegistrationTemplateDetail" %>
        ...
        <asp:Panel ID="pnlDetails" CssClass="panel panel-block" runat="server">
            ...
            <div class="panel-body container-fluid">
                ...
                <div id="pnlEditDetails" runat="server">
                    ...
                    <Rock:PanelWidget ID="wpCustom" runat="server" Title="Custom Attributes">
                            <div class="row">
                                <div class="col-md-12">
