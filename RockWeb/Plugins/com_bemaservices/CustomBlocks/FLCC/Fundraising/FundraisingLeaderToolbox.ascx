<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FundraisingLeaderToolbox.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.Fundraising.FundraisingLeaderToolbox" %>
            ...
            <div class="margin-t-md">
                <Rock:Grid ID="gGroupMembers" runat="server" OnRowSelected="gGroupMembers_RowSelected" DataKeyNames="Id" PersonIdField="PersonId" AllowSorting="true">
                    <Columns>
						...
						<Rock:CurrencyField DataField="FundingTotal" HeaderText="Funding Received Total" NullDisplayText=""/>
						<Rock:CurrencyField DataField="FundingGoal" HeaderText="Funding Goal" NullDisplayText=""/>
