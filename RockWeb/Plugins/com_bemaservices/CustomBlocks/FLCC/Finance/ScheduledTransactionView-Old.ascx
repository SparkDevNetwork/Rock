<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ScheduledTransactionView-Old.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.Finance.ScheduledTransactionView" %>
