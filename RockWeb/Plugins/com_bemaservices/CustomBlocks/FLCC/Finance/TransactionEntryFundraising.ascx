<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransactionEntryFundraising.ascx.cs" Inherits="RockWeb.Blocks.Finance.TransactionEntryFundraising" %>
                                    ...
                                    <fieldset>
                                        ...
                                        <div id="divRepeatingPayments" runat="server" visible="false">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                     <Rock:DatePicker ID="dtpEndDate" runat="server" Label="End Gift" AutoPostBack="true" AllowPastDateSelection="false" OnTextChanged="btnFrequency_SelectionChanged" Visible="false" />
                                                </div>
