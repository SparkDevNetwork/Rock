...
namespace RockWeb.Plugins.com_bemadev.Finance
{
    ...
    public partial class TransactionEntityMatching : RockBlockCustomSettings, ICustomGridColumns
    {
        ...
        private void LoadDropDowns()
        {
            ...
            {
				var batchText = string.Format("#{0} {1} ({2})", batch.Id, batch.Name, batch.BatchStartDateTime.Value.ToString("MM/dd/yyyy"));
                ddlBatch.Items.Add( new ListItem( batchText, batch.Id.ToString() ) );
            }
        }
