...
namespace RockWeb.Blocks.Finance
{
    ...
    /// </summary>
    [DisplayName( "Transaction Entry Funraising" )]
...
TransactionAccountDetails: [
  ...
  },
  {
    ...
    public partial class TransactionEntryFundraising : Rock.Web.UI.RockBlock
    {
        #region Fields
        ...
        protected void btnFrequency_SelectionChanged( object sender, EventArgs e )
        {
            ...
            {
                dtpEndDate.SelectedDate = RockDateTime.Today.AddMonths( 11 );
            }
        ...
        private bool ProcessPaymentInfo( out string errorMessage )
        {
            ...
            {
                if ( dtpStartDate.SelectedDate < RockDateTime.Today && dtpEndDate.SelectedDate < RockDateTime.Today )
                {
