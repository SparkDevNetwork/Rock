 ...
 * 
 * Additional Features:
 * - FE1) Added Ability to specify End Date on Schedule Transactions
 */
...
TransactionAccountDetails: [
  ...
  },
  {
    ...
    [BooleanField(
        "Display End Date",
        Key = AttributeKey.DisplayEndDate,
        Description = "If Enabled, a End Date will be show when creating a Schedule Transaction",
    ...
    [IntegerField(
        ...
        Key = AttributeKey.DefaultEndDateMonths,
    ...
    public partial class TransactionEntry : Rock.Web.UI.RockBlock
    {
        ...
        {
            /* BEMA.FE1.Start */
            public const string DisplayEndDate = "DisplayEndDate";
        ...
        protected void btnFrequency_SelectionChanged( object sender, EventArgs e )
        {
            ...
            /* BEMA.FE1.Start */
            if ( GetAttributeValue( AttributeKey.DisplayEndDate ).AsBoolean() )
            {
                if ( !oneTime )
                {
                    dtpStartDate.Label = "First Gift";
                    dtpEndDate.Visible = true;
                }
                else
                {
                    dtpStartDate.Label = "When";
            ...
            if ( GetAttributeValue( AttributeKey.DisplayEndDate ).AsBoolean() )
            {
                if ( !oneTime && ( !dtpEndDate.SelectedDate.HasValue || dtpEndDate.SelectedDate.Value.Date <= RockDateTime.Today ) )
                {
                    var months = GetAttributeValue( AttributeKey.DefaultEndDateMonths ).AsIntegerOrNull();
                    if( months != null)
                    {
