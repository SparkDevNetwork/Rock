<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationInstanceDetail (V8).ascx.cs" Inherits="RockWeb.Plugins.com_bemaservice.Event.RegistrationInstanceDetail" %>
