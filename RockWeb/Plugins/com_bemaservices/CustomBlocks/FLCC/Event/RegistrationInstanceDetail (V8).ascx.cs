// This block was created to add Project Codes to the list.
// This is the only reason the core block is not being used
...
namespace RockWeb.Plugins.com_bemaservice.Event
{
    /// <summary>
    /// Template block for developers to use to start a new block.
    /// </summary>
    [DisplayName( "Registration Instance Detail (V8)" )]
    ...
    [AttributeField( "5CD9C0C8-C047-61A0-4E36-0FDB8496F066", "Project Code Attribute", "Attribute to store Project Code", false, false )]
    public partial class RegistrationInstanceDetail : Rock.Web.UI.RockBlock, IDetailBlock
    {
        ...
        private string _projectCodeAttributeKey = string.Empty;
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            if ( !string.IsNullOrEmpty( GetAttributeValue( "ProjectCodeAttribute" ) ) )
            {
                _projectCodeAttributeKey = AttributeCache.Get( Guid.Parse( GetAttributeValue( "ProjectCodeAttribute" ) ) ).Key;
...
";
        ...
        protected void btnSave_Click( object sender, EventArgs e )
        {
            ...
            using ( var rockContext = new RockContext() )
            {
                ...
                instance.SetAttributeValue( _projectCodeAttributeKey, tbProjectCode.Text );
        ...
        private void ShowEditDetails( RegistrationInstance instance, RockContext rockContext )
        {
            ...
            instance.LoadAttributes( rockContext );
            tbProjectCode.Text = instance.GetAttributeValue( _projectCodeAttributeKey );
        }
        ...
        private void ShowReadonlyDetails( RegistrationInstance registrationInstance, bool setTab = true )
        {
            ...
            if ( !string.IsNullOrEmpty( registrationInstance.GetAttributeValue( _projectCodeAttributeKey ) ) )
            {
                lProjectCode.Visible = true;
                lProjectCode.Text = registrationInstance.GetAttributeValue( _projectCodeAttributeKey );
            }
