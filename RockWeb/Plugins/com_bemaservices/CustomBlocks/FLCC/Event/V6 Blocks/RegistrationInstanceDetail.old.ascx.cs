...
namespace RockWeb.Plugins.com_bemadev.Event
{
    ...
    public partial class RegistrationInstanceDetail : Rock.Web.UI.RockBlock, IDetailBlock
    {
        ...
        private string ProjectCodeAttributeKey = string.Empty;
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            // Added by Tyler Strout
            // 02/18/2018
            if( !string.IsNullOrEmpty( GetAttributeValue( "ProjectCodeAttribute" ) ) ){
                ProjectCodeAttributeKey = AttributeCache.Read( Guid.Parse( GetAttributeValue( "ProjectCodeAttribute" ) ) ).Key;
...
";
        ...
        private void ShowReadonlyDetails( RegistrationInstance RegistrationInstance, bool setTab = true )
        {
            ...
            if( !string.IsNullOrEmpty( RegistrationInstance.GetAttributeValue( ProjectCodeAttributeKey ) ) )
            {
