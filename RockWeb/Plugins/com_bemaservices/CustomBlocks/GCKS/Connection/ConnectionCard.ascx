...
<%--					<Rock:BootstrapButton ID="btnUpdate" runat="server" CssClass="btn btn-primary btn-block btn-checkin-select margin-b-sm text-left" OnClick="btnUpdate_Click" >
                    ...
                    <asp:Panel ID="pnAddressWarning" runat="server" Visible="false">
                        <label class="label label-danger" style="margin-bottom: 10px;">Please enter new address</label>
                    </asp:Panel>
				
                    <Rock:BootstrapButton ID="btnAddress" runat="server" CssClass="btn btn-primary btn-block btn-checkin-select margin-b-sm text-left" OnClick="btnChangedAddress_Click" >
                        <i class='fa fa-square-o'></i> I have changed my address
                    </Rock:BootstrapButton>

                    <asp:Panel ID="pnChangeAddress" runat="server" Visible="false">
						<Rock:AddressControl runat="server" Label="Home Address" ID="tbChangeAddress"/>
					</asp:Panel>
    ...
    <ContentTemplate>
        ...
        <Rock:ModalDialog ID="mdEditFamily" runat="server" Title="Add Family" CancelLinkVisible="false">
            <Content>
                ...
                <%-- Have an inner UpdatePanel wrapper by a 'Conditional' Update Panel so that we don't lose the modal effect on postback from mdEditFamily --%>
