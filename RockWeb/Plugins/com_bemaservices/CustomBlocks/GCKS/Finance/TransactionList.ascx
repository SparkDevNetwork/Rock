<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransactionList.ascx.cs" Inherits="RockWeb.Plugins.com_visitgracechurch.Finance.TransactionList" %>
                ...
                <div class="panel-body">
                    ...
                    <div class="grid grid-panel">
                        <Rock:GridFilter ID="gfTransactions" runat="server">
                            ...
                            <Rock:RockDropDownList ID="ddlSoftCredit" runat="server" Label="Has Soft Credit" />
                        ...
                        <Rock:Grid ID="gTransactions" runat="server" EmptyDataText="No Transactions Found" 
                            ...
                            <Columns>
                                ...
                                <Rock:RockLiteralField ID="lPrimaryFamilyId" HeaderText="Family ID" ExcelExportBehavior="AlwaysInclude" />
                                ...
                                <Rock:RockLiteralField ID="lBatchName" HeaderText="Batch Name" SortExpression="Batch Name" ColumnPriority="DesktopSmall" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ExcelExportBehavior="AlwaysInclude" />
                                ...
                                <Rock:RockLiteralField ID="lSoftCreditPersonId" HeaderText="Soft Credit Person ID" ExcelExportBehavior="AlwaysInclude" />
                                <Rock:RockLiteralField ID="lSoftCreditFamilyId" HeaderText="Soft Credit Family ID" ExcelExportBehavior="AlwaysInclude" />
