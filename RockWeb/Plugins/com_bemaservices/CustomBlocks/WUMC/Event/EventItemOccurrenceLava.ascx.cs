            ...
            if ( eventItemOccurrenceId > 0 )
            {
                ...
                var qry = eventItemOccurrenceService
                    ...
                    .Where( i => i.Id == eventItemOccurrenceId 
                                && i.EventItem.IsActive == true
                                // && i.Schedule.EffectiveEndDate.Value >= RockDateTime.Today
                                );
                  //.Where(e => e.EventItem.EventItemOccurrences.Any(o => o.Schedule.EffectiveStartDate <= RockDateTime.Today && o.Schedule.EffectiveEndDate >= RockDateTime.Today || o.Schedule.EffectiveEndDate == o.Schedule.EffectiveStartDate ));

                var eventItemOccurrence = qry.FirstOrDefault();

                 if ( eventItemOccurrence != null && eventItemOccurrence.Schedule.GetNextStartDateTime(RockDateTime.Today) >= RockDateTime.Today)
                {
