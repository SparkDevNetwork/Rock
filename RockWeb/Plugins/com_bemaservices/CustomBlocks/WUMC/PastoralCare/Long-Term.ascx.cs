...
namespace RockWeb.Plugins.com_bemadev.PastoralCare
{
    ...
    public partial class LongTerm : RockBlock
    {
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            gReport.Actions.AddButton.Text = "<i class=\"fa fa-plus\" Title=\"Add Long-Term or FYI\"></i>";
        ...
        {
            Response.Redirect( "~/Pastoral/LongTerm/" + e.RowKeyId );
        }
