<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Long-Term.ascx.cs" Inherits="RockWeb.Plugins.com_bemadev.PastoralCare.LongTerm" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel runat="server" ID="pnlMain" Visible="true">
            ...
            <div class="panel panel-block">
                <div class="panel-heading">
                    <h1 class="panel-title"><i class="fa fa-bed"></i> Long-Term / FYI List</h1>
                </div>
                    ...
                    <Columns>
                        ...
                        <Rock:RockTemplateField HeaderText="Actions" ItemStyle-Width="160px">
                            <ItemTemplate>
                                ...
                                <a href="<%# "/Pastoral/LongTerm/"+Eval("Workflow.Id") %>" class="btn btn-default"><i class="fa fa-pencil"></i></a>
