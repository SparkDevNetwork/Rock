<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NursingHomeList.ascx.cs" Inherits="RockWeb.Plugins.com_bemadev.PastoralCare.NursingHomeList" %>
            ...
            <div class="panel panel-block">
                ...
                <Rock:Grid ID="gReport" runat="server" AllowSorting="true" EmptyDataText="No Results" DataKeyNames="Id" OnRowSelected="gReport_RowSelected">
                    <Columns>
						...
						<Rock:RockBoundField DataField="NursingHomePhone" HeaderText="Nursing Home Phone" SortExpression="NursingHomePhone"></Rock:RockBoundField>
