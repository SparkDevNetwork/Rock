...
namespace RockWeb.Blocks.Event
{
    ...
    public partial class EventItemOccurrenceListByAudienceLava : Rock.Web.UI.RockBlock
    {
        ...
        private void LoadContent()
        {
            ...
            if ( definedType != null )
            {
                categories = definedType.DefinedValues.Where( v => selectedCategoryGuids.Contains( v.Guid ) ).Select(a => a.Id).ToList();
            ...
            if ( categories.Any() )
            {
                ...
                var qry = new EventItemOccurrenceService( rockContext ).Queryable()
                                            .Where(e => e.EventItem.EventItemAudiences.Any( c => categories.Contains( c.DefinedValueId ) ) && e.EventItem.IsActive);
