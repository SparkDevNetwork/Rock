<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Login.ascx.cs" Inherits="RockWeb.Plugins.com_bemaservices.CustomBlocks.BEMA.Security.Login" %>
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <asp:Panel ID="pnlInternalAuthLogin" runat="server" CssClass="col-md-6">
                        ...
                        <Rock:BootstrapButton ID="btnLogin" runat="server" Text="Log In" CssClass="btn btn-primary mb-1" OnClick="btnLogin_Click" DataLoadingText="Logging In..." />
                        <asp:Button ID="btnNewAccount" runat="server" Text="Register" CssClass="btn btn-action  ml-1 mb-1" OnClick="btnNewAccount_Click" CausesValidation="false" />
                        ...
                        <asp:Button ID="btnHelp" runat="server" Text="Forgot Account" CssClass="btn btn-link  ml-1 mb-1" OnClick="btnHelp_Click" CausesValidation="false" />
