...
namespace RockWeb.Plugins.com_bemadev.Security
{
	...
	[TextField( "ul Class", "the classes for the ul class", false, "", "", 2 )]
    ...
    public partial class LoginStatus : Rock.Web.UI.RockBlock
    {
        ...
        protected override void OnLoad( EventArgs e )
        {
			...
			ulClass.Attributes.Add("class", GetAttributeValue( "ulClass" ));
			ulClass.Attributes.Add("style", "list-style: none;");
