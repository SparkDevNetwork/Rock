<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ServiceMetricsEntry.ascx.cs" Inherits="com_BEMAServices.Reporting.ServiceMetricsEntry" %>
        ...
        <div class="panel-body">
            ...
            <asp:Panel ID="pnlMetrics" runat="server" Visible="false">
                ...
                <div class="btn-group btn-group-justified margin-b-lg panel-settings-group" >
                    ...
                    <Rock:ButtonDropDownList ID="bddlLocation" runat="server" OnSelectionChanged="bddl_SelectionChanged" />
