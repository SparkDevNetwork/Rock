<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomTransactionEntry.ascx.cs" Inherits="RockWeb.Plugins.org_thewoodlandsumc.Finance.CustomTransactionEntry" %>
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlContributionInfo" runat="server">
                    ...
                    <% } %>
                            ...
                            <div class="panel panel-default contribution-info">
                                <div class="panel-heading hidden"><h3 class="panel-title"><asp:Literal ID="lContributionInfoTitle" runat="server" /></h3></div>
                                <div class="panel-body">
                                    <fieldset>
                ...
                <asp:Panel ID="pnlContributionPayment" runat="server">
                    ...
                    <asp:Panel ID="pnlPayment" runat="server" CssClass="panel panel-default contribution-payment">
                        ...
                        <div class="panel-heading hidden"><h3 class="panel-title"><asp:Literal ID="lPaymentInfoTitle" runat="server" /></h3></div>
                        <div class="panel-body">   
