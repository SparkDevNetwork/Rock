...
<p class=""text-center"">
    ...
    public partial class ContributionStatementLava : Rock.Web.UI.RockBlock
    {
        ...
        private void DisplayResults()
        {
            ...
            /* BEMA.FE1.Start */
            var accounts1 = new FinancialAccountService( rockContext ).GetByGuids( GetAttributeValue( AttributeKey.PledgeAccounts ).SplitDelimitedValues().AsGuidList() );
            var accountIds = accounts1.Select( a => a.Id ).ToList();
            /* BEMA.FE1.End */
