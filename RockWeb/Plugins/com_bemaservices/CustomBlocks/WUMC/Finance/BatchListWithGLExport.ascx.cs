...
" )]
    ...
    public partial class BatchListWithGLExport : RockBlock, IPostBackEventHandler, ICustomGridColumns
    {
        #region Constants
        ...
        protected void gfBatchFilter_ApplyFilterClick( object sender, EventArgs e )
        {
            ...
            gfBatchFilter.SaveUserPreference( "Id", tbBatchId.Text);
        ...
        private IOrderedQueryable<FinancialBatch> GetQuery( RockContext rockContext )
        {
            ...
            // filter by Id
			string batchId = gfBatchFilter.GetUserPreference( "Id" );
            if ( !string.IsNullOrEmpty( batchId ) )
            {
			  int id = batchId.AsInteger();
