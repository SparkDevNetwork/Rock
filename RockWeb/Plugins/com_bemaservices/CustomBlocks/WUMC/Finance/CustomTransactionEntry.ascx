<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomTransactionEntryNew.ascx.cs" Inherits="RockWeb.Plugins.org_thewoodlandsumc.Finance.CustomTransactionEntry" %>
                            ...
                            <div class="panel panel-default contribution-info">
                                ...
                                <div class="panel-body">
                                    <fieldset>
                                        ...
                                        <div class="form-group rock-text-box hide-from-css">
						                <label class="control-label" >Is this is memorial or honorarium? Please leave blank if neither.</label> 
                                            <div class="control-wrapper">
                                                <asp:DropDownList ID="ddlGift" runat="server" Label="Is this is memorial or honorarium? Please leave blank if neither." OnSelectedIndexChanged="dllGiftIndexChange" AutoPostBack="true" >
                                                    <asp:ListItem Text="" Value="" />  
                                                    <asp:ListItem Text="Memorial" Value="Memorial" />
                                                    <asp:ListItem Text="Honorarium" Value="Honorarium" />    
                                                </asp:DropDownList>
                                            </div>
                                       
                                        <Rock:RockTextBox ID="txtGiftFor" runat="server" Label="Who is the gift in memory or honor of?" Visible="False" />
                                        <Rock:RockTextBox ID="txtNotified" runat="server" Label="Who should be notified of the gift? Please include name and mailing address if known." Visible="False" />
                                         </div>
                                    </fieldset>
                                </div>
                            </div>
