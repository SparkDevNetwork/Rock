<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomEditFamily.ascx.cs" Inherits="RockWeb.Plugins.com_bemadev.Checkin.EditFamily" %>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="pnlEditPerson" runat="server" DefaultButton="btnDonePerson">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <Rock:DatePicker ID="dpBirthDate" runat="server" Label="Birthdate"  Required="true" AllowFutureDateSelection="False" RequireYear="True" ShowOnFocus="false" StartView="decade" ValidationGroup="vgEditPerson" />
                                </div>
                                <div class="col-md-6">
