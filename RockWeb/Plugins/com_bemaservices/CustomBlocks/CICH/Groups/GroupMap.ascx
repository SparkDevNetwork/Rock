<%@ Control AutoEventWireup="true" CodeFile="GroupMap.ascx.cs" Inherits="RockWeb.Plugins.com_bemadev.Groups.GroupMap" Language="C#" %>
...
<asp:UpdatePanel ID="upnlContent" runat="server">
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlContainer" class="panel panel-block" runat="server">
            ...
            <div class="panel-body">
                ...
                <asp:Literal ID="pnlMap" runat="server"></asp:Literal>
        ...
        <asp:Literal ID="lMinimal" runat="server" />
