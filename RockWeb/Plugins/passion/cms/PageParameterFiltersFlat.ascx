<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageParameterFiltersFlat.ascx.cs" Inherits="RockWeb.Plugins.rocks_pillars.Cms.PageParameterFilters" %>
        ...
        <div class="panel panel-block">
            <div class="panel-heading rollover-container">
                <h4 class="panel-title">
                    <asp:Literal ID="lHeadingIcon" runat="server" />&nbsp;<asp:Literal ID="lHeading" runat="server" /></h4>
                ...
                <asp:Panel runat="server" ID="pnlFilters">
                    <div class="row align-vertical">
                        ...
                        <div class="col-xs-12 col-lg-3" style="padding-top: 15px;">
                                ...
                                <Rock:BootstrapButton ID="btnResetFilters" runat="server" Text="Reset" CssClass="btn-sm btn-smd btn-link text-gray" OnClick="btnResetFilters_Click" />
                        </div>
                    </div>
                </asp:Panel>
