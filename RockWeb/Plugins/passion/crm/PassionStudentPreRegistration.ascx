<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PassionStudentPreRegistration.ascx.cs"  %>
                ...
                <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12">
                    ...
                    <asp:Panel ID="pnlChildren" runat="server" CssClass="panel-body">
                        <div class="row">
                            ...
                            <Passion:PassionPreRegistrationStudents ID="prChildren" runat="server" OnAddChildClick="prChildren_AddChildClick" />
                        </div>
                    </asp:Panel>
                    <hr />
                            ...
                            <div class="row">
                                <asp:Panel ID="pnlVisit" runat="server">
                                    <asp:Panel CssClass="col-md-8 col-xs-12" runat="server" ID="pnlLocation">
                                        <Rock:RockDropDownList ID="ddlLocation" runat="server" Label="Location" DataTextField="Name" DataValueField="Id"/>
                                    </asp:Panel>
