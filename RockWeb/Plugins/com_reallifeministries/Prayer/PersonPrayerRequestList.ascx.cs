...
namespace com.reallifeministries.Prayer
{
    [DisplayName( "Person Prayer Request List" )]
    [Category( "Prayer" )]
    [Description( "Displays a list of prayer requests for the Person, in the configured top-level group category." )]
    ...
    public partial class PersonPrayerRequestList : PersonBlock
    {
        #region Fields
        ...
        private void BindGrid()
        {
            ...
            var prayerRequests = prayerRequestService.Queryable().Where( a => 
                    a.RequestedByPersonAlias.PersonId == Person.Id
                ).Select( a =>
                new
                {
                    a.Id,
