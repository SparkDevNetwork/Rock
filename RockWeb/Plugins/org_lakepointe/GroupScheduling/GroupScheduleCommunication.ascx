<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupScheduleCommunication.ascx.cs" Inherits="RockWeb.Plugins.org_lakepointe.GroupScheduling.GroupScheduleCommunication" %>
