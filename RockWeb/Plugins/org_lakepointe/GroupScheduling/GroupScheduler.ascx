<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupScheduler.ascx.cs" Inherits="RockWeb.Plugins.org_lakepointe.GroupScheduling.GroupScheduler" %>
                    ...
                    <div class="col-lg-9 col-md-8">
                        ...
                        <!--<div class="group-scheduler-occurrence-filter occurrences-filter-options">-->
                            ...
                            <div class="panel-toolbar">
                                ...
                                <div class="d-flex" style="width: 80%; background-color: #eee;">
                                    <p style="padding: 5px; margin: 0; font-size: 30px; background-color: #eee;">
                                        <i class="fa fa-users"></i>
                                    </p>
                                    <Rock:RockListBox ID="rlbGroups" runat="server" AllowMultiSelect="true" />
                                    <asp:LinkButton ID="btnGroupsGo" runat="server" Text="Apply" OnClick="btnGroupsGo_Click" CssClass="btn btn-default" />
                                    <p style="margin: 0; padding: 5px;" ID="pGroups" runat="server" Visible="false" /></p>
                                </div>

                                <!-- Filter for Week -->
                                <div class="d-block" style="width:175px;">
