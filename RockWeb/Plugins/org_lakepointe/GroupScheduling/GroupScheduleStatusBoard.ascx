<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupScheduleStatusBoard.ascx.cs" Inherits="RockWeb.Plugins.org_lakepointe.GroupScheduling.GroupScheduleStatusBoard" %>
...
<asp:UpdatePanel ID="upScheduleStatusBoard" runat="server">
    <ContentTemplate>
        ...
        <Rock:ModalDialog ID="dlgGroups" runat="server" Title="Groups" Visible="false" OnSaveClick="dlgGroups_SaveClick">
            <Content>
                <Rock:RockListBox ID="rlbGroups" runat="server" Label="Select Group(s)" AllowMultiSelect="true" />
            </Content>
        </Rock:ModalDialog>
