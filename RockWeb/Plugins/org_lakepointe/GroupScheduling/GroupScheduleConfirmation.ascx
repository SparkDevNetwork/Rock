<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupScheduleConfirmation.ascx.cs" Inherits="RockWeb.Plugins.org_lakepointe.GroupScheduling.GroupScheduleConfirmation" %>
