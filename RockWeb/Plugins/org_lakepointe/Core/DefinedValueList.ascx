<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefinedValueList.ascx.cs" Inherits="RockWeb.Plugins.org_lakepointe.Core.DefinedValueList" %>
                ...
                <asp:Panel ID="pnlList" runat="server" Visible="false">
                        ...
                        <asp:Panel ID="pnlValues" runat="server">
                            ...
                            <div class="grid grid-panel">
                                <Rock:GridFilter ID="fDefinedValues" runat="server" OnDisplayFilterValue="fDefinedValues_DisplayFilterValue" OnClearFilterClick="fDefinedValues_ClearFilterClick" OnApplyFilterClick="fDefinedValues_ApplyFilterClick">
                                    <Rock:RockTextBox ID="tbValue" runat="server" Label="Value" />
                                    <Rock:RockDropDownList ID="ddlActive" runat="server" Label="Active" />
                                </Rock:GridFilter>
