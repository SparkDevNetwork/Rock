  ...
  },
  {
...
]</pre>", CodeEditorMode.Lava, CodeEditorTheme.Rock, 100, false, "Online Contribution", "", 28)]    //[BooleanField( "Enable Comment Entry", "Allows the guest to enter the the value that's put into the comment field (will be appended to the 'Payment Comment' setting)", false, "", 29 )]
    [CustomDropdownListField("Enable Comment Entry", "Allows the guest to enter the value that's put into the comment field (will be appended to the 'Payment Comment' setting.", "1^Yes - Required,2^Yes - Not Required,0^No", false, "No", "", 29, "EnableCommentEntry")]
    ...
    public partial class TransactionEntry : Rock.Web.UI.RockBlock
    {
        ...
        private void SetControlOptions()
        {
            ...
            txtCommentEntry.Visible = GetAttributeValue("EnableCommentEntry").AsInteger() > 0;
        ...
        private bool ProcessStep3(string resultQueryString, out string errorMessage)
        {
            ...
            if (GetAttributeValue("EnableCommentEntry").AsInteger() > 0)
            {
