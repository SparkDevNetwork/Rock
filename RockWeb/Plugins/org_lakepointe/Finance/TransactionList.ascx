<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransactionList.ascx.cs" Inherits="RockWeb.Plugins.org_lakepointe.Finance.TransactionList" %>
...
<asp:UpdatePanel ID="upTransactions" runat="server">
    <ContentTemplate>
        ...
        <Rock:ModalDialog ID="dlgExport" runat="server" Title="Mark As Exported" ValidationGroup="Export"
                SaveButtonText="Update" OnSaveClick="dlgExport_SaveClick" OnCancelScript="clearActiveDialog();">
            <Content>
                <h2 class="transactonExport-Confirm">Confirm Export</h2>
                <p><asp:Literal ID="lExportConfirmMessage" runat="server" /></p>
            </Content>
        </Rock:ModalDialog>
