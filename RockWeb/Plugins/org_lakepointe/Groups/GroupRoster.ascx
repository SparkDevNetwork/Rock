<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupRoster.ascx.cs" Inherits="RockWeb.Plugins.org_lakepointe.Groups.GroupRoster" %>
                    ...
                    <asp:Panel ID="pnlCommandsTop" runat="server" CssClass="row">
                        <div class="col-md-12">
                            <span class="pull-right">
                                <asp:LinkButton ID="lbSendCommunicationTop" CssClass="btn btn-sm btn-default" runat="server" OnClick="lbSendCommunication_Click"><i class="far fa-envelope"></i> Send Communication</asp:LinkButton>
                            </span>
                            <span class="pull-right">
                                <asp:LinkButton ID="lbSendParentCommunication" CssClass="btn btn-sm btn-default" runat="server" OnClick="lbSendParentCommunication_Click"><i class="far fa-envelope"></i> Send Parent Communication</asp:LinkButton>
                            </span>
                        </div>
                    </asp:Panel>
...
<%--                        <Rock:RockDropDownList ID="ddlGroupMemberRole" Required="true" runat="server" Label="Group Role" RequiredErrorMessage="Group Member Role is required." ValidationGroup="vgEditMember" Visible="false" />--%>
                ...
                <Rock:NotificationBox ID="nbMemberRoleError" runat="server" NotificationBoxType="Validation" />
                <div class="row">
                    <div class="col-xs-12">
