<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Relationships.ascx.cs" Inherits="RockWeb.Plugins.org_lakepointe.Crm.PersonDetail.Relationships" %>
            ...
            <Rock:ModalDialog ID="modalAddPerson" runat="server" Title="Add Relationship" ValidationGroup="NewRelationship">
                <Content>
                    ...
                    <div id="divExistingPerson" runat="server">
                        ...
                        <div class="actions">
                            <Rock:NotificationBox ID="nbSaveSucess" runat="server" NotificationBoxType="Danger" Text="" />
                            <Rock:BootstrapButton ID="bbSaveAndAdd" runat="server" Text="Save then Add" OnClick="bbSaveAndAdd_Click" CssClass="btn btn-primary" />
                        </div>
                    </div>
