<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PersonProgramStepList.ascx.cs" Inherits="RockWeb.Plugins.org_lakepointe.Steps.PersonProgramStepList" %>
...
<asp:UpdatePanel ID="upContent" runat="server">
                                            ...
                                            <div class="step-records-table-container">
                                                <table class="step-records-table">
                                                    <asp:repeater id="rSteps" runat="server" OnItemDataBound="rSteps_ItemDataBound">
                                                        <itemtemplate>
                                                            <tr>
                                                                <td runat="server" id="tdStart">
                                                                    <asp:LinkButton runat="server" ID="lbStart" OnCommand="ScOnClick" CommandArgument='<%# Eval("StepId") %>' CssClass="btn-actions">
                                                                     Start
                                                                    </asp:LinkButton>
                                                                </td>
  ...
  $( ".step-card" ).each(function( index ) {
    ...
    $(this).mouseenter(function () {
        $(this).css('transform', 'scale(1.1,1.1)').css('transition-duration', '0.25s');
    }).mouseleave(function () {
        $(this).css('transform', '');
    });
