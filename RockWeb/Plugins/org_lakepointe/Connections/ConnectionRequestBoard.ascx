<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ConnectionRequestBoard.ascx.cs" Inherits="RockWeb.Plugins.org_lakepointe.Connections.ConnectionRequestBoard" %>
                    ...
                    <Content>
                        ...
                        <div id="divRequestModalViewMode" runat="server">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <a runat="server" class="small pull-right" id="aRequestModalViewModeProfileLink" visible="false">
                                        <i class="fa fa-user-alt"></i>
                                        Person Profile
                                    </a>
                                    <asp:Panel runat="server" ID="pnlCustomConnector">
                                        <h6 class="mt-0 mb-1 pull-right">Connector</h6>
                                        <br />
                                    ...
                                    <h2 class="mt-0 mb-3">
                                            ...
                                            <asp:Label ID="lWeddingTitle" runat="server"></asp:Label>
                                    </h2>
                                    
                                    <div class="row">
                                        <asp:Panel ID="pnlRegularContactInfo" runat="server">
                                        ...
                                        <asp:Panel ID="pnlCustomWeddingContactInfo" runat="server" Visible="false">
                                            <%-- Bride --%>
                                            <div class="col-sm-6 col-md-4 mb-3">
                                                <br />
                                                <h6 class="mt-0 mb-1">Bride's Contact Information</h6>
                                                <div class="personcontact">
                                                    <ul class="list-unstyled phonenumbers mb-1">
                                                        <ItemTemplate>
                                                            <li>
                                                                <asp:Label ID="lBrideMobile" runat="server"></asp:Label>
                                                                <small>Mobile</small>
                                                            </li>
                                                        </ItemTemplate>
                                                    </ul>
                                                    <div class="email">
                                                        <asp:Label ID="lBrideEmail" runat="server"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                            <%-- Groom --%>
                                            <div class="col-sm-6 col-md-5 mb-3">
                                                <br />
                                                <h6 class="mt-0 mb-1">Groom's Contact Information</h6>
                                                <div class="personcontact">
                                                    <ul class="list-unstyled phonenumbers mb-1">
                                                        <ItemTemplate>
                                                            <li>
                                                                <asp:Label ID="lGroomMobile" runat="server"></asp:Label>
                                                                <small>Mobile</small>
                                                            </li>
                                                        </ItemTemplate>
                                                    </ul>
                                                    <div class="email">
                                                        <asp:Label ID="lGroomEmail" runat="server"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                        </asp:Panel>
                                        <asp:Panel runat="server" ID="pnlStandardConnector" >
                                            <div class="col-sm-6 col-md-4 mb-3">
                                                <h6 class="mt-0 mb-1">Connector</h6>
                                                <div class="btn-group">
                                                    <div class="dropdown-toggle cursor-pointer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        <asp:Literal runat="server" ID="lRequestModalViewModeConnectorProfilePhotoStd" />
                                                        <asp:Literal ID="lRequestModalViewModeConnectorFullNameStd" runat="server" />
                                                    </div>
                                                    <ul class="dropdown-menu">
                                                        <asp:Repeater ID="rRequestModalViewModeConnectorSelectStd" runat="server" OnItemCommand="rRequestModalViewModeConnectorSelect_ItemCommand">
                                                            <ItemTemplate>
                                                                <li>
                                                                    <asp:LinkButton runat="server" CommandArgument='<%# Eval("PersonAliasId") %>'>
                                                                        <%# Eval("FullName") %>
                            ...
                            <asp:Panel ID="pnlWeddingAttributes" runat="server">
                                <h4>Wedding Applications</h4>
                                <div class="row">
                                    <asp:LinkButton ID="lbBackgroundApplication" runat="server" Text="View Personal and Spiritual Background Applicaiton" CssClass="btn btn-link" CausesValidation="false" />
                                </div>
                                <%-- Moved wedding information row from here to Discovery Meeting section --%>
                                <hr />
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5>Bride</h5>
                                        <a runat="server" class="small pull-left" id="aBridePersonProfileLink">
                                            <i class="fa fa-user-alt"></i>
                                                <b><asp:Label ID="lBrideFullName" runat="server"></asp:Label></b>
                                        </a>
                                    </div>
                                    <div class="col-md-6">
                                        <h5>Groom</h5>
                                        <a runat="server" class="small pull-left" id="aGroomPersonProfileLink">
                                            <i class="fa fa-user-alt"></i>
                                                <b><asp:Label ID="lGroomFullName" runat="server"></asp:Label></b>
                                        </a>
                                    </div>
                                </div>
                                <div class="row">
                                    <br />
                                    <div class="col-md-6">
                                        <b>Membership Status:  </b><asp:Label ID="lBrideMembershipStatus" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-6">
                                        <b>Membership Status:  </b><asp:Label ID="lGroomMembershipStatus" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <b>First Marriage:  </b><asp:Label ID="lBridePreviouslyDivorced" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-6">
                                        <b>First Marriage:  </b><asp:Label ID="lGroomPreviouslyDivorced" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <b>Attended Premarital Class:  </b><asp:Label ID="lBrideAttendedClass" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-6">
                                        <b>Attended Premarital Class:  </b><asp:Label ID="lGroomAttendedClass" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <div class="row">
                                    <br />
                                    <div class="col-md-3">
                                        <h6>Desired Wedding Date:</h6>
                                        <asp:Label ID="lDesiredWeddingDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Desired Rehersal Date:</h6>
                                        <asp:Label ID="lDesiredRehersalDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Desired Campus:</h6>
                                        <asp:Label ID="lDesiredCampus" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Desired Wedding Type:</h6>
                                        <asp:Label ID="lDesiredWeddingType" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <h6>Discovery Meeting Scheduled Date:</h6>
                                        <asp:Label ID="lDiscoveryMeetingDate" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <br />
                                <hr />
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <asp:Label ID="lWeddingCoordinator" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Officiating Pastor:</h6>
                                        <asp:Label ID="lPastor" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <%-- Following row moved from Wedding Applications section --%>
                                <div class="row">
                                    <div class="col-md-3">
                                        <br />
                                        <asp:LinkButton ID="lbSendWeddingInformationForm" runat="server" Text="Send Wedding Information Form" CssClass="btn btn-primary" CausesValidation="false" />
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Last Sent Date:</h6>
                                        <asp:Label ID="lWeddingInformationFormLastSentDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Completed Date:</h6>
                                        <asp:Label ID="lWeddingInformationFormCompletedDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <br />
                                        <asp:LinkButton ID="lbCompletedWeddingInformationForm" runat="server" Text="View Completed Form" CssClass="btn btn-link" CausesValidation="false" Visible="false" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <br />
                                        <asp:LinkButton ID="lbSendWeddinngPolicyPDF" runat="server" Text="Send Wedding Policy PDF" CssClass="btn btn-primary" CausesValidation="false" />
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Last Sent Date:</h6>
                                        <asp:Label ID="lWeddingPolicyPDFLastSentDate" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <h6>Wedding Coordinator Meeting Scheduled Date:</h6>
                                        <asp:Label ID="lWeddingCoordinatiorMeetingDate" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <br />
                                <hr />
                                ...
                                <h4>Wedding Coordinator Meeting</h4>
                                <div class="row">
                                    <div class="col-md-3">
                                        <h6>Approved Wedding Date & Time:</h6>
                                        <asp:Label ID="lApprovedWeddingDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Approved Rehearsal Date & Time:</h6>
                                        <asp:Label ID="lApprovedRehearsalDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Selected Package:</h6>
                                        <asp:Label ID="lSelectedPackage" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Facility Reservation Status:</h6>
                                        <asp:Label ID="lReservationStatus" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <br />
                                        <asp:LinkButton ID="lbSendWeddingPolicyAndDeposit" runat="server" Text="Send Agreement & Deposit Form" CssClass="btn btn-primary" CausesValidation="false" />
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Last Sent Date:</h6>
                                        <asp:Label ID="lPolicyAndDepositLastSentDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Completed Date:</h6>
                                        <asp:Label ID="lPolicyAndDepositCompletedDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <br />
                                        <asp:LinkButton ID="lbCompletedWeddingPolicyAndDeposit" runat="server" Text="View Completed Form" CssClass="btn btn-link" CausesValidation="false" Visible="false" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <h6>Pastor Meeting Scheduled Date:</h6>
                                        <asp:Label ID="lPastorMeetingScheduledDate" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <br />
                                <hr />
                                ...
                                <h4>Pastor Meeting</h4>
                                <div class="row">
                                    <div class="col-md-3">
                                        <h6>Remarriage Form Necessary:</h6>
                                        <asp:Label ID="lRemarriageFormNecessary" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Premarital Class:</h6>
                                        <asp:Label ID="lPremaritalClass" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Premarital Class Completed Date:</h6>
                                        <asp:Label ID="lPremaritalClassCompletedDate" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <br />
                                        <asp:LinkButton ID="lbSendBrideRemarriageForm" runat="server" Text="Send Bride Remarriage Form" CssClass="btn btn-primary" CausesValidation="false" />
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Last Sent Date:</h6>
                                        <asp:Label ID="lBrideRemarriageFormLastSentDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Completed Date:</h6>
                                        <asp:Label ID="lBrideRemarriageFormCompletedDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <br />
                                        <asp:LinkButton ID="lbBrideCompletedRemarriageForm" runat="server" Text="View Completed Form" CssClass="btn btn-link" CausesValidation="false" Visible="false" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <br />
                                        <asp:LinkButton ID="lbSendGroomRemarriageForm" runat="server" Text="Send Groom Remarriage Form" CssClass="btn btn-primary" CausesValidation="false" />
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Last Sent Date:</h6>
                                        <asp:Label ID="lGroomRemarriageFormLastSentDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Completed Date:</h6>
                                        <asp:Label ID="lGroomRemarriageFormCompletedDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <br />
                                        <asp:LinkButton ID="lbGroomCompletedRemarriageForm" runat="server" Text="View Completed Form" CssClass="btn btn-link" CausesValidation="false" Visible="false" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <h6>Final Meeting Scheduled Date:</h6>
                                        <asp:Label ID="lFinalMeetingScheduledDate" runat="server"></asp:Label>
                                    </div>
                                </div>
                                <br />
                                <hr />
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <br />
                                        <asp:LinkButton ID="lbSendFinalPayment" runat="server" Text="Send Final Payment Form" CssClass="btn btn-primary" CausesValidation="false" />
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Last Sent Date:</h6>
                                        <asp:Label ID="lFinalPaymentLastSentDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Completed Date:</h6>
                                        <asp:Label ID="lFinalPaymentCompletedDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <br />
                                        <asp:LinkButton ID="lbCompletedFinalPayment" runat="server" Text="View Completed Form" CssClass="btn btn-link" CausesValidation="false" Visible="false" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <br />
                                        <asp:LinkButton ID="lbSendEventForms" runat="server" Text="Send Event Forms" CssClass="btn btn-primary" CausesValidation="false" />
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Last Sent Date:</h6>
                                        <asp:Label ID="lEventFormsLastSentDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Completed Date:</h6>
                                        <asp:Label ID="lEventFormsCompletedDate" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-3">
                                        <br />
                                        <asp:LinkButton ID="lbCompletedEventForms" runat="server" Text="View Completed Form" CssClass="btn btn-link" CausesValidation="false" Visible="false" />
                                    </div>
                                </div>
                                <hr /> 
                                </asp:Panel>
                                <asp:Panel runat="server" ID="pnlStandardAttributes">
                        ...
                        <div id="divRequestModalAddEditMode" runat="server">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <Rock:RockDropDownList ID="ddlRequestModalAddEditModePlacementGroup" runat="server" Label="Placement Group" AutoPostBack="true" OnSelectedIndexChanged="ddlRequestModalAddEditModePlacementGroup_SelectedIndexChanged" EnhanceForLongLists="true" Visible="false"/>
                            ...
                            <asp:Panel ID="pnlEditWeddingAttributes" runat="server">
                                <h4>Application Highlights</h4>
                                <div class="row">
                                    <div class="col-md-3">
                                        <Rock:DateTimePicker ID="dtpEditDesiredWeddingDate" runat="server" Label="Desired Wedding Date" Required="true"></Rock:DateTimePicker>
                                    </div>
                                    <div class="col-md-3">
                                        <Rock:DateTimePicker ID="dtpEditDesiredRehersalDate" runat="server" Label="Desired Rehersal Date" Required="true"></Rock:DateTimePicker>
                                    </div>
                                    <div class="col-md-3">
                                        <Rock:CampusPicker ID="cpEditDesiredCampus" runat="server" Label="Desired Campus" Required="true"></Rock:CampusPicker>
                                    </div>
                                    <div class="col-md-3">
                                        <Rock:RockTextBox ID="rtbDesiredWeddingType" runat="server" Label="Desired Wedding Type" Required="true"></Rock:RockTextBox>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <Rock:DateTimePicker ID="dtpEditDiscoveryMeetingDate" runat="server" Label="Discovery Meeting Scheduled Date" />
                                    </div>
                                </div>
                                <br />
                                <hr />
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <Rock:RockTextBox ID="rtbEditWeddingCoordinator" runat="server" Label="Wedding Coordinator" />
                                    </div>
                                    <div class="col-md-3">
                                        <Rock:RockTextBox ID="rtbEditOfficiatingPastor" runat="server" Label="Officiating Pastor" />
                                    </div>
                                    <div class="col-md-6">
                                        <Rock:DateTimePicker ID="dtpEditWeddingCoordinatorMeeting" runat="server" Label="Wedding Coordinator Meeting Scheduled Date" />
                                    </div>
                                </div>
                                <br />
                                <hr />
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <Rock:DateTimePicker ID="dtpEditApprovedWeddingDate" runat="server" Label="Approved Wedding Date" />
                                    </div>
                                    <div class="col-md-4">
                                        <Rock:DateTimePicker ID="dtpEditApprovedRehearsalDate" runat="server" Label="Approved Rehearsal Date" />
                                    </div>
                                   <div class="col-md-2">
                                        <Rock:RockDropDownList ID="ddlEditSelectedPackage" runat="server" Label="Selected Package" ></Rock:RockDropDownList>
                                    </div>
                                    <div class="col-md-2">
                                        <Rock:RockCheckBox ID="rcbEditFacilityReservation" runat="server" Label="Facility Reservation Complete" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <Rock:DateTimePicker ID="dtpEditPastorMeetingDate" runat="server" Label="Pastor Meeting Scheduled Date" />
                                    </div>
                                </div>
                                <br />
                                <hr />
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <Rock:RockTextBox ID="rtbEditPremaritalClass" runat="server" Label="Premarital Class" />
                                    </div>
                                    <div class="col-md-4">
                                        <Rock:DatePicker ID="dpEditPremartialClassDate" runat="server" Label="Premarital Class Completed Date" />
                                    </div>
                                   <div class="col-md-4">
                                        <Rock:DateTimePicker ID="dtpEditFinalMeetingDate" runat="server" Label="Final Meeting Scheduled Date" ></Rock:DateTimePicker>
                                    </div>
                                </div>
                                <br />
                                <hr />
                            </asp:Panel>
                            <asp:Panel runat="server" ID="pnlStandardAttributeEdit">
