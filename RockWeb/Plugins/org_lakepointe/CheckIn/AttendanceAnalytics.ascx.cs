...
namespace RockWeb.Plugins.org_lakepointe.CheckIn
{
    ...
    /// </summary>
    [DisplayName( "LPC Attendance Analytics" )]
    [Category( "Check-in" )]
            ...
            else
            {
                qryTasks.Add( Task.Run( () =>
                {
                    ...
                    foreach ( DataRow row in dtNonAttenders.Rows )
                    {
                        ...
                        person.Gender = row["Gender"].ToString().ConvertToEnum<Gender>();
                        Person.GetAge( person.Birthdate, null );
                        ...
                        if ( includeParents )
                        {
                            ...
                            parent.Age = Person.GetAge( parent.Birthdate, null );
                        ...
                        if ( includeChildren )
                        {
                            ...
                            child.Age = Person.GetAge( child.Birthdate, null );
                            result.Child = child;
                        }
                ...
                if ( dtAttendees != null )
                {
                    ...
                    foreach ( DataRow row in dtAttendees.Rows )
                    {
                        ...
                        if ( allAttendeeVisits.ContainsKey( personId ) )
                        {
                            ...
                            person.Birthdate = row["BirthDate"] as DateTime?;
                            person.Gender = row["Gender"].ToString().ConvertToEnum<Gender>();
                            person.Age = Person.GetAge( person.Birthdate, null );
                            person.ConnectionStatusValueId = row["ConnectionStatusValueId"] as int?;
