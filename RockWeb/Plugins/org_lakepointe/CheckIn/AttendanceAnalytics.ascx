<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AttendanceAnalytics.ascx.cs" Inherits="RockWeb.Plugins.org_lakepointe.CheckIn.AttendanceAnalytics" %>
                                ...
                                <asp:Panel ID="pnlShowByAttendees" CssClass="analytics-details" runat="server">
                                    ...
                                    <Rock:Grid ID="gAttendeesAttendance" runat="server" AllowSorting="true" RowItemText="Attendee" OnRowDataBound="gAttendeesAttendance_RowDataBound" ExportSource="ColumnOutput" ExportFilename="AttendanceAnalytics">
                                        <Columns>
                                            ...
                                            <Rock:CampusField DataField="LastVisit.CampusId" HeaderText="Campus" SortExpression="LastVisit.CampusName" />
