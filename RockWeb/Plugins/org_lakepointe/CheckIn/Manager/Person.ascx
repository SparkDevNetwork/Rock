<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Person.ascx.cs" Inherits="RockWeb.Plugins.org_lakepointe.CheckIn.Manager.Person" %>
                ...
                <Columns>
                    <Rock:RockTemplateField HeaderText="When">
                        <ItemTemplate>
                            ...
                            <asp:Literal ID="lWhoCheckedOut" runat="server"></asp:Literal>
                        </ItemTemplate>
