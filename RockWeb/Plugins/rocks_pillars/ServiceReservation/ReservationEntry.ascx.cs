...
<div class='reservation-card'>
    {% if Campus.Location.ImageUrl and Campus.Location.ImageUrl != '' %}
        <div class='card-image'>
            ...
            {% endcomment %}
            {% campus id:'{{ Campus.Id }}' %}
                <img src='/GetImage.ashx?Id={{ campus.Location.Image.Id }}&mode=crop&height=540' class='img img-responsive'>
            {% endcampus %}
...
<div class='reservation-card'>       
    ...
    {% if imgId and imgId != 0 %}
        <div class='img-hover'>
            <img src='/GetImage.ashx?id={{ imgId }}&mode=crop&height=540' class='card-image img-responsive'>
        </div>
    {% else %}
        <div class='card-icon'>
                ...
                using ( var rockContext = new RockContext() )
                {
                    ...
                    if ( schedule != null )
                    {
                        ...
                        if ( workflowType != null && option != null && ( !option.SpotsLeft.HasValue || option.SpotsLeft.Value >= 1 ) )
                        {
                            ...
                            pageParams.Add("PersonId", PersonId.ToString());
