        ...
        public class AccountHelper
        {
            ...
            public AccountHelper( PCOAccount account, RockContext rockContext )
            {
                if ( account != null )
                {
                    ...
                    var pcoAccountFieldType = FieldTypeCache.Get( rocks.pillars.PCOSync.SystemGuid.FieldType.PCO_ACCOUNT.AsGuid(), rockContext );
                    var groupEntityType = EntityTypeCache.Get<Rock.Model.Group>( false, rockContext );
