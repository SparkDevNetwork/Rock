<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BinaryFileLinkList.ascx.cs" Inherits="RockWeb.Plugins.com_centralaz.Finance.BinaryFileLinkList" %>
            ...
            <div class="panel-body">
                ...
                <div class="grid grid-panel">
                    ...
                    <Rock:Grid ID="gBinaryFile" runat="server" AllowSorting="true" OnRowSelected="gBinaryFile_Edit">
                        <Columns>
                            <Rock:RockBoundField DataField="FileLink" HeaderText="File Name" SortExpression="FileName" HtmlEncode="false" />
