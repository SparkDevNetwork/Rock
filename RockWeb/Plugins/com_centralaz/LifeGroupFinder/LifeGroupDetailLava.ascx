<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LifeGroupDetailLava.ascx.cs" Inherits="RockWeb.Plugins.com_centralaz.LifeGroupFinder.LifeGroupDetailLava" %>
...
<asp:UpdatePanel ID="upnlContent" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlMoveGroupMember" runat="server" Visible="false">
            ...
            <div class="actions">
                <asp:Button ID="btnMoveGroupMember" runat="server" AccessKey="s" CssClass="btn btn-primary" Text="Save" OnClick="btnMoveGroupMember_Click" />
                <asp:LinkButton ID="btnCancelMoveGroupMember" runat="server" AccessKey="c" CssClass="btn btn-link" OnClick="btnCancelMoveGroupMember_Click" CausesValidation="false">Cancel</asp:LinkButton>
            </div>
        </asp:Panel>
