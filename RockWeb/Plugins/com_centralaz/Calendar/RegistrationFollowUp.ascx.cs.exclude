...
namespace RockWeb.Plugins.com_centralaz.Calendar
{
    ...
    /// </summary>
    [DisplayName( "Registration Follow-up" )]
    [Category( "com_centralaz > Calendar" )]
    [Description( "Block used to complete a registration for a registration instance." )]
    ...
    public partial class RegistrationFollowUp : RockBlock
    {
        #region Fields
        ...
        private void ShowHowMany()
        {
            ...
            if ( RegistrationState != null && RegistrationState.RegistrationId.HasValue )
            {
                ...
                SetRegistrantState( RegistrationState.RegistrantCount );
