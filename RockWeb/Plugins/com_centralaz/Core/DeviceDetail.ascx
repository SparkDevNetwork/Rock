<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DeviceDetail.ascx.cs" Inherits="RockWeb.Plugins.com_centralaz.Core.DeviceDetail" %>
        ...
        <asp:Panel ID="pnlDetails" CssClass="panel panel-block" runat="server" Visible="false">
            ...
            <div class="panel-body">
                ...
                <fieldset>
                    ...
                    <Rock:PanelWidget ID="wpAttributes" runat="server" Title="Device Attributes">
