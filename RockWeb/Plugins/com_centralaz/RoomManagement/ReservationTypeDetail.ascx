<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReservationTypeDetail.ascx.cs" Inherits="RockWeb.Plugins.com_centralaz.RoomManagement.ReservationTypeDetail" %>
