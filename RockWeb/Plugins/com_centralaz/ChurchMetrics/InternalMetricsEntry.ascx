<%@ Control Language="C#" AutoEventWireup="true" CodeFile="InternalMetricsEntry.ascx.cs" Inherits="RockWeb.Plugins.com_centralaz.ChurchMetrics.InternalMetricsEntry" %>
