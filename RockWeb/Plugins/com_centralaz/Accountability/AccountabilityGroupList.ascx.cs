            ...
            else
            {
                ...
                if ( !isEditor )
                {
                    ...
                    gGroups.DataSource = qry.Select( g => new
                    {
                        Id = g.Group.Id,
                        Name = g.Group.Name,
                        GroupTypeName = g.Group.GroupType.Name,
                        GroupOrder = g.Group.Order,
                        GroupTypeOrder = g.Group.GroupType.Order,
                        Description = g.Group.Description,
                        IsSystem = g.Group.IsSystem,
                        IsActive = g.Group.IsActive,
                        GroupRole = string.Empty,
                        DateAdded = DateTime.MinValue,
                        MemberCount = g.Group.Members.Count()
                    } )
                        .Sort( sortProperty )
                        .ToList();
                }
                else
                {
                    ...
                    .Where( g =>
                        ...
                        g.GroupType.GroupTypePurposeValueId == purpose.Id &&
