...
{
    [DisplayName( "Accountability Group List Personalized Lava" )]
    ...
    [CodeEditorField( "Lava Template", "The lava template to use to format the group list.", CodeEditorMode.Lava, CodeEditorTheme.Rock, 400, true, "{% include '~/Plugins/com_centralaz/Accountability/Lava/AccountabilityGroupListSidebar.lava' %}", "", 6 )]
    ...
    public partial class AccountabilityGroupListPersonalizedLava : RockBlock
    {
        ...
        private void ListGroups()
        {
            ...
            var purpose = new DefinedValueService( rockContext ).GetByDefinedTypeGuid( Rock.SystemGuid.DefinedType.GROUPTYPE_PURPOSE.AsGuid() ).Where( a => a.Value == "Accountability Group" ).FirstOrDefault();
            ...
            var qry = new GroupMemberService(rockContext)
                        ...
                        .Where( m => m.PersonId == CurrentPersonId 
                                ...
                                && m.Group.GroupType.GroupTypePurposeValueId == purpose.Id );
