    ...
    public partial class RegistrationEntry : RockBlock
    {
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            else
            {
                ...
                /* SimpleDonation.Start */
                var allowTransaction = hfAllowTransaction.Value.AsBoolean();
                if ( Request.Form["__EVENTARGUMENT"] != null && allowTransaction )
                {
        ...
        private bool ProcessPayment( RockContext rockContext, Registration registration, out string errorMessage )
        {
            ...
            if ( allowTransaction )
            {
                ...
                {
                    hfAllowTransaction.Value = "False";
                    hfStripeToken.Value = String.Empty;
                }
            ...
            {
                errorMessage = "Double Charged Payment Prevented.";
                return false;
            }
...
",
        ...
        private PaymentInfo GetPaymentInfo( GatewayComponent gateway )
        {
            ...
            if ( CurrentPerson != null )
            {
                homeLocation = CurrentPerson.GetHomeLocation();
            }
