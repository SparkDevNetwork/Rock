...
namespace Plugins.com_simpledonation
{
    ...
    public partial class TransactionEntryKiosk : Rock.Web.UI.RockBlock
    {
        ...
        private void SendReceipt()
        {
            ...
            var receiptEmail = new SystemCommunicationService( rockContext ).Get( new Guid( GetAttributeValue( "ReceiptEmail" ) ) );
            ...
            if ( receiptEmail != null )
            {
                ...
                //emailMessage.AddRecipient( new RecipientData( givingUnit.Email, GetMergeFields( givingUnit ) ) );  SNS just deleting this and expecting SimpleDonation to replace the whole file when they update their plugin
