<%@ Control Language="C#" AutoEventWireup="true" CodeFile="~/Plugins/com_simpledonation/SimpleDonationTransactionEntry.ascx.cs" Inherits="Plugins.com_simpledonation.SimpleDonationTransactionEntry" %>
                                ...
                                <div class="panel-body">
                                    <fieldset>
                                        ...
                                        <div id="payment-container" class="form-group">
                                            ...
                                            <asp:HiddenField ID="hfStripeToken" runat="server" ClientIDMode="Static" />
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <dl class="dl-horizontal gift-confirmation margin-b-md">
                            ...
                            <Rock:TermDescription ID="tdOffsetAmountConfirm" runat="server" Term="Processing Fee" />
        ...
        <asp:Panel ID="pnlSuccess" runat="server" Visible="false">
            ...
            <div class="well">
                ...
                <dl class="dl-horizontal gift-success">
                    ...
                    <Rock:TermDescription ID="tdOffsetAmountReceipt" runat="server" Term="Processing Fees" />
            ...
            <asp:Panel ID="pnlSaveAccount" runat="server" Visible="false">
                <div class="well">
                    <legend>
                        <asp:Literal ID="lSaveAcccountTitle" runat="server" /></legend>
                    <fieldset>
