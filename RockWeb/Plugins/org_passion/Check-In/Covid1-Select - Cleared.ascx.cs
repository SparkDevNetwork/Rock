...
{
    [DisplayName("Passion | COVID-19-1 Cleared")]
    [Category("Check-in")]
    ...
    public partial class COVID48HourSelect : CheckInBlockMultiPerson
    {
        ...
        public override bool RequiresSelection( bool backingUp )
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if ( person.StateParameters.ContainsKey("COVID-ClearedNotCleared") )
                    {
        ...
        private bool NoConfiguredAbilityLevels( List<CheckInGroupType> groupTypes )
        {
            ...
            {
                var groupTypeAttributes = groupType.GroupType.GetAttributeValues("COVID-ClearedNotCleared");
                ...
                {
                    var groupAttributes = group.Group.GetAttributeValues("COVID-ClearedNotCleared");
        ...
        protected void rSelection_ItemCommand( object source, RepeaterCommandEventArgs e )
        {
            if ( KioskCurrentlyActive )
            {
                ...
                if ( person != null )
                {
                    ...
                    _personAbilityLevelGuid = person.Person.GetAttributeValue("COVID-ClearedNotCleared").ToUpper();

                    // Save the fact that user has already selected an ability level so they won't be asked again
                    person.StateParameters.AddOrReplace("COVID-ClearedNotCleared", _personAbilityLevelGuid.ToString() );
                    ...
                    if ( _personAbilityLevelGuid != selectedAbilityLevelGuid )
                    {
                        ...
                        using ( var rockContext = new RockContext() )
                        {
                            ...
                            if ( p != null )
                            {
                                ...
                                p.SetAttributeValue("COVID-ClearedNotCleared", selectedAbilityLevelGuid.ToUpperInvariant() );
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        var abilityLevelDType = DefinedTypeCache.Get("EC184D44-875F-4045-91B3-368E10B0F9DF".AsGuid() );
        ...
        protected override void NavigateToPreviousPage( Dictionary<string, string> queryParams, bool validateSelectionRequired )
        {
            if ( CurrentCheckInState.CheckInType.TypeOfCheckin == TypeOfCheckin.Family )
            {
                ...
                {
                    currentPerson.StateParameters.Remove("COVID-ClearedNotCleared");
