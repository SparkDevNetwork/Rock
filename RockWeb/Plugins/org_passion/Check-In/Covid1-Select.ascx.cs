...
{
    [DisplayName("Passion | COVID-19-1 Select")]
    [Category("Check-in")]
    ...
    public partial class COVID48HourSelect : CheckInBlockMultiPerson
    {
        ...
        public override bool RequiresSelection( bool backingUp )
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if ( person.StateParameters.ContainsKey("COVIDSymptoms48Hours") )
                    {
        ...
        private bool NoConfiguredAbilityLevels( List<CheckInGroupType> groupTypes )
        {
            ...
            {
                var groupTypeAttributes = groupType.GroupType.GetAttributeValues("COVIDSymptoms48Hours");
                ...
                {
                    var groupAttributes = group.Group.GetAttributeValues("COVIDSymptoms48Hours");
        ...
        protected void rSelection_ItemCommand( object source, RepeaterCommandEventArgs e )
        {
            if ( KioskCurrentlyActive )
            {
                ...
                if ( person != null )
                {
                    ...
                    _personAbilityLevelGuid = person.Person.GetAttributeValue("COVIDSymptoms48Hours").ToUpper();

                    // Save the fact that user has already selected an ability level so they won't be asked again
                    person.StateParameters.AddOrReplace("COVIDSymptoms48Hours", _personAbilityLevelGuid.ToString() );
                    ...
                    if ( _personAbilityLevelGuid != selectedAbilityLevelGuid )
                    {
                        ...
                        using ( var rockContext = new RockContext() )
                        {
                            ...
                            if ( p != null )
                            {
                                ...
                                p.SetAttributeValue("COVIDSymptoms48Hours", selectedAbilityLevelGuid.ToUpperInvariant() );
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        var abilityLevelDType = DefinedTypeCache.Get("85E92173-D791-4F76-9B50-0ADC517B6CBA".AsGuid() );
        ...
        protected override void NavigateToPreviousPage( Dictionary<string, string> queryParams, bool validateSelectionRequired )
        {
            if ( CurrentCheckInState.CheckInType.TypeOfCheckin == TypeOfCheckin.Family )
            {
                ...
                {
                    currentPerson.StateParameters.Remove("COVIDSymptoms48Hours");
