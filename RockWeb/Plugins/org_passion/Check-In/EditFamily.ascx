                ...
                <asp:UpdatePanel ID="upEditFamily" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="pnlEditFamily" runat="server">
                            <div id="lblAdultWarning" runat="server" visible="false" class="alert alert-warning">Please add an Adult record for Child/Student Check-In</div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                <Rock:AddressControl ID="adrStreetAddress" runat="server" Label="Address" />
                                </div>  
                            </div>
