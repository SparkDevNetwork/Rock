...
{
    [DisplayName( "Passion | Group Schedule Confirmation" )]
...
{{ ScheduledItem.Location.Name }} {{ ScheduledItem.Schedule.Name }}<br></p>", "", 2, "DeclineHeadingTemplate" )]
    ...
    [SystemEmailField( "Scheduling Response Email", "The system email that will be used for sending responses back to the scheduler.", false, Rock.SystemGuid.SystemCommunication.SCHEDULING_RESPONSE, "", 8, "SchedulingResponseEmail" )]
        ...
        private void GetAttendanceByAttendanceIdAndSelectedPersonId()
        {
            using ( var rockContext = new RockContext() )
            {
                ...
                else if ( CurrentPerson != null && _selectedPerson != CurrentPerson )
                {
                    ...
                    //nbError.Text = string.Format( "Thanks for letting us know, {0}.", _selectedPerson.NickName );
                }
