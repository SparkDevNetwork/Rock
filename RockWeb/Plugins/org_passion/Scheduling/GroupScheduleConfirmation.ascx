                    ...
                    <asp:Panel ID="pnlDeclineReason" runat="server" CssClass="decline-reason margin-b-lg"  Visible="false">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-5">
                                <Rock:DataTextBox ID="dtbDeclineReasonNote" runat="server"  TextMode="MultiLine" Rows="3" ValidateRequestMode="Disabled" SourceTypeName="Rock.Model.Attendance, Rock" PropertyName="Note" Visible="false" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8">
