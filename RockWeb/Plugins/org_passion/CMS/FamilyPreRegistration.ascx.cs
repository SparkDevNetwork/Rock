...
",
        ...
        protected void btnSave_Click( object sender, EventArgs e )
        {
            if ( ValidateInfo() )
            {
                ...
                var childRoleId = familyGroupType.Roles.FirstOrDefault( r => r.Guid == Rock.SystemGuid.GroupRole.GROUPROLE_FAMILY_MEMBER_ADULT.AsGuid() ).Id;
                ...
                foreach ( var child in Children )
                {
                    ...
                    else
                    {
                        ...
                        EnsurePersonInOtherFamily( familyGroupType.Id, primaryFamily.Id, person.Id, person.LastName, adultRoleId, newFamilyIds );
                ...
                if ( processRemovals )
                {
                    ...
                    {
                        EnsurePersonInOtherFamily( familyGroupType.Id, primaryFamily.Id, removedChild.Id, removedChild.Person.LastName, adultRoleId, na );
