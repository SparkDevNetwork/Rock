...
namespace RockWeb.Blocks.Cms
{
    ...
    public partial class PublicProfileEdit : RockBlock
    {
        ...
        protected void rptGroupMembers_ItemDataBound( object sender, RepeaterItemEventArgs e )
        {
            ...
            // Setup Image
            string imgTag = Rock.Model.Person.GetPersonPhotoImageTag( person, 250, 250 );
            ...
            lGroupMemberEmail.Text = "<a href='mailto: '" + person.Email + ">" + person.Email + "</a>";
        ...
        private void ShowDetail()
        {
            ...
            // Setup Image
            string imgTag = Rock.Model.Person.GetPersonPhotoImageTag( CurrentPerson, 250, 250 );
            ...
            lEmail.InnerHtml = CurrentPerson.Email;
            lEmail.HRef = "mailto: " + CurrentPerson.Email;
        ...
        private void ShowEditPersonDetails( Guid personGuid )
        {
            ...
            imgPhoto.NoPictureUrl = Person.GetPersonNoPictureUrl( person, 250, 250 );
            ...
            if(person.Gender.ConvertToString() != "Unknown")
            {
            ...
            if ( person.Id == CurrentPerson.Id )
            {
                ...
                if ( locationTypeGuid.HasValue )
                {
                    ...
                    lAddressTitle.InnerHtml = addressTypeDv.Value + " Address";
