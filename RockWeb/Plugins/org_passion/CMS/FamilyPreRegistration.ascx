...
<asp:UpdatePanel ID="upnlContent" runat="server">
    <ContentTemplate>
        ...
        <div class="panel panel-body">
            ...
            <h3 class="text-center">// Atlanta //</h3>
            ...
            <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12">
                ...
                <h4 class="text-primary">Second Adult</h4>
                ...
                <hr />
                <div class="actions col-sm-8 col-sm-offset-2 col-xs-12 text-center form-group">
                    <asp:LinkButton ID="lbSave" runat="server" Text="Submit" CssClass="btn btn-primary btn-block" OnClick="btnSave_Click" />
                </div>
