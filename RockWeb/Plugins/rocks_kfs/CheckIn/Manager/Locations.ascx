<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Locations.ascx.cs" Inherits="RockWeb.Plugins.rocks_kfs.CheckIn.Manager.Locations" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlContent" runat="server" CssClass="checkin-manager">
            ...
            <div class="panel panel-default">
                ...
                <asp:Panel ID="pnlNavHeading" runat="server" CssClass="panel-heading clickable clearfix" OnClientClick="this.disabled='true';return true;">
                ...
                <ul class="list-group">
                    ...
                    <asp:Repeater ID="rptNavItems" runat="server">
                        <ItemTemplate>
                            <li id="liNavItem" runat="server" class="list-group-item clickable" OnClientClick="this.disabled='true';return true;">
