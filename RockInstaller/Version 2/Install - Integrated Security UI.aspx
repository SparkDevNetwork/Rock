	...
	<body>
				...
				<div id="content">
					...
					<div id="content-box">
						...
						<asp:Panel id="pDatabaseConfig" Visible="false" runat="server">
                            ...
                            <div class="checkbox">
                                <label>
                                    <asp:CheckBox ID="cbUseIntegratedSecurity" runat="server" />
		...
		<script language="javascript">
          ...
          $(document).ready(function() {
              ...
              // slide toggle the use integrated database security
              $('body').on('click', '#cbUseIntegratedSecurity', function (e) {
                  $('.js-sqlserver-auth').slideToggle();
              });
          });
