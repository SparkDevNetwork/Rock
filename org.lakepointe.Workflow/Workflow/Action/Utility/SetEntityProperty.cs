...
namespace org.lakepointe.Workflow.Action.Utility
{
    /// <summary>
    /// Sets an entity property.
    /// </summary>
    [ActionCategory( "LPC Utility" )]
    [Description( "Sets an entity property (supports nullable enums)." )]
    ...
    public class SetEntityProperty : ActionComponent
    {
        ...
        private static object ConvertObject( string theObject, Type objectType, bool tryToNull = true )
        {
            ...
            // This paragraph is the only modification from the core version. It allows conversion if the objectType was a nullable enum.
            if ( underType.IsEnum )
            {
