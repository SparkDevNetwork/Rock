...
namespace Rock.Api
{
    public partial class Service
    {
		...
		[WebGet( UriTemplate = "GroupRole/{id}" )]
		...
		[WebInvoke( Method = "PUT", UriTemplate = "GroupRole/{id}" )]
		...
		[WebInvoke( Method = "POST", UriTemplate = "GroupRole" )]
		...
		[WebInvoke( Method = "DELETE", UriTemplate = "GroupRole/{id}" )]
