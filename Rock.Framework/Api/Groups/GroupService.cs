...
namespace Rock.Api
{
    public partial class Service
    {
		...
		[WebInvoke( Method = "PUT", UriTemplate = "Group/{id}" )]
		...
		[WebInvoke( Method = "POST", UriTemplate = "Group" )]
		...
		[WebInvoke( Method = "DELETE", UriTemplate = "Group/{id}" )]
