...
*/
ALTER PROCEDURE [dbo].[spCommunication_SaturationReport]
  @StartDate DATE
, @EndDate DATE
  ...
  rb.[Id] AS [MessageBucketId]
        FROM (
            ...
            WHERE
                ...
                AND NOT (p.[FirstName] = 'Anonymous' AND p.[LastName] = 'Visitor')
                AND NOT (p.[FirstName] = 'Giver' AND p.[LastName] = 'Anonymous')
