...
{
    /// <summary>
    /// Base client model for SequenceEnrollment that only includes the non-virtual fields. Use this for PUT/POSTs
    /// </summary>
    public partial class SequenceEnrollmentEntity
    {
        /// <summary />
        ...
        /// <summary>
        /// Copies the base properties from a source SequenceEnrollment object
        /// </summary>
    ...
    /// <summary>
    /// Client model for SequenceEnrollment that includes all the fields that are available for GETs. Use this for GETs (use SequenceEnrollmentEntity for POST/PUTs)
    /// </summary>
    public partial class SequenceEnrollment : SequenceEnrollmentEntity
    {
        /// <summary />
