...
{
    /// <summary>
    /// Base client model for LearningClassContentPage that only includes the non-virtual fields. Use this for PUT/POSTs
    /// </summary>
    public partial class LearningClassContentPageEntity
    {
        /// <summary />
        ...
        /// <summary>
        /// Copies the base properties from a source LearningClassContentPage object
        /// </summary>
    ...
    /// <summary>
    /// Client model for LearningClassContentPage that includes all the fields that are available for GETs. Use this for GETs (use LearningClassContentPageEntity for POST/PUTs)
    /// </summary>
