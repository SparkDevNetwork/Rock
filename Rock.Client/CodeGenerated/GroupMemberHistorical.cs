...
{
    /// <summary>
    /// Base client model for GroupMemberHistorical that only includes the non-virtual fields. Use this for PUT/POSTs
    /// </summary>
    public partial class GroupMemberHistoricalEntity
    {
        /// <summary />
        ...
        /// <summary>
        /// Copies the base properties from a source GroupMemberHistorical object
        /// </summary>
        /// <param name="source">The source.</param>
        public void CopyPropertiesFrom( GroupMemberHistorical source )
        {
            this.Id = source.Id;
    ...
    /// <summary>
    /// Client model for GroupMemberHistorical that includes all the fields that are available for GETs. Use this for GETs (use GroupMemberHistoricalEntity for POST/PUTs)
    /// </summary>
    public partial class GroupMemberHistorical : GroupMemberHistoricalEntity
    {
        /// <summary />
