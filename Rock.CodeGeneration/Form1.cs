                ...
                if ( rootFolder != null )
                {
                    ...
                    foreach ( object item in cblModels.CheckedItems )
                    {
                        ...
                        if ( typeof( Rock.Data.IEntity ).IsAssignableFrom( type ) )
                        {
                            ...
                            {
                                WriteViewModelTypeScriptFile( viewModelTypescriptFolder, type );
                            }
                        }
...
{{
    ...
    /// </summary>
    [ViewModelOf( typeof( Rock.Model.{type.Name} ) )]
    public partial class {type.Name}ViewModel : IViewModel
    {{" );
...
" );
        ...
        /// <param name="rootFolder"></param>
        /// <param name="type"></param>
        private void WriteViewModelTypeScriptFile( string rootFolder, Type type )
        {
            if ( type.GetCustomAttribute<ViewModelExcludeAttribute>() != null )
            {
                return;
            ...
            var properties = GetEntityProperties( type, false, true, true )
                ...
                .Select( p => new
                {
                    ...
                    TypeScriptType = GetTypescriptType(
                        ...
                        p.Value.GetCustomAttribute<RequiredAttribute>() != null,
                        imports )
                } )
                .ToList();
            ...
            sb.AppendLine( $"export default interface {type.Name} {{" );
            ...
            var file = new FileInfo( Path.Combine( rootFolder, "CodeGenerated", type.Name + "ViewModel.d.ts" ) );
            WriteFile( file, sb );
        }
        ...
        /// <returns></returns>
        private static string GetTypescriptType( Type type, bool isRequired, HashSet<string> imports )
        {
            ...
            switch ( Type.GetTypeCode( type ) )
            {
                case TypeCode.Object:
                    ...
                    {
                        tsType = "Guid";
                        imports.Add( "import { Guid } from '../../Util/Guid.js';" );
                    }
                    else
                    {
