        ...
        private void btnGenerate_Click( object sender, EventArgs e )
        {
            ...
            if ( cblModels.CheckedItems.Count > 0 )
            {
                ...
                if ( rootFolder != null )
                {
                    ...
                    if ( cbViewModelTs.Checked && cblModels.Items.Count == cblModels.CheckedItems.Count )
                    {
                        WriteViewModelTypeScriptIndexFile( viewModelTypescriptFolder, cblModels.CheckedItems.Cast<Type>(), viewModelTypes );
...
" );
        ...
        private void WriteViewModelTypeScriptIndexFile( string rootFolder, IEnumerable<Type> types, IEnumerable<Type> viewModelTypes )
        {
            var includedTypes = types
                ...
                .Where( t => viewModelTypes.Any( vmt => vmt.Name == $"{t.Name}ViewModel" ) )
                .Select( t => new
                {
                    Name = t.Name,
