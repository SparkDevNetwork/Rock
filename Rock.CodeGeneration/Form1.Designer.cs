namespace Rock.CodeGeneration
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.fbdServiceDtoOutput = new System.Windows.Forms.FolderBrowserDialog();
			...
			// fbdServiceDtoOutput
			// 
			this.fbdServiceDtoOutput.Description = "Select the project folder that the Service and DTO files should be added to.  The" +
    " namespace of the objects will be used to create a relative folder path if necce" +
    "ssary.";
			this.fbdServiceDtoOutput.ShowNewFolderButton = false;
			// 
			// cbDto
			// 
			...
			this.cbDto.Location = new System.Drawing.Point(167, 385);
			...
			this.cbRest.Location = new System.Drawing.Point(222, 385);
    ...
    "of the objects will be used to create a relative folder path if neccessary.";
        ...
        private System.Windows.Forms.FolderBrowserDialog fbdServiceDtoOutput;
