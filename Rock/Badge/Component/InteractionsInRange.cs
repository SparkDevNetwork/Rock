...
namespace Rock.Badge.Component
{
    ...
    [InteractionChannelField( "Interaction Channel",
        Description = "The Interaction channel to use.",
        IsRequired = true,
        Order = 0 )]
    [SlidingDateRangeField( "Date Range",
        Description = "The date range in which the interactions were made.",
        IsRequired = false,
        Order = 1 )]
    [LinkedPage( "Detail Page",
        Description = "Select the page to navigate when the badge is clicked.",
        IsRequired = false,
        Order = 2 )]
    [TextField( "Badge Icon CSS",
        Description = "The CSS icon to use for the badge.",
        IsRequired = true,
        DefaultValue = "ti-arrows-shuffle",
        Key = "BadgeIconCss",
        Order = 3 )]
