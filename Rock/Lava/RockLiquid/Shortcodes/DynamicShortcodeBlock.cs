...
namespace Rock.Lava.Shortcodes
{
    ...
    public class DynamicShortcodeBlock : RockLavaShortcodeBlockBase
    {
        ...
        public override void Render( Context context, TextWriter result )
        {
            ...
            if ( shortcode != null )
            {
                ReadOnlyDictionary<string, object> _internalMergeFields;
                var parms = ParseMarkup( _markup, context, shortcode, out _internalMergeFields );
                ...
                var blockMarkup = _blockMarkup.ToString().ResolveMergeFields( _internalMergeFields, enabledSecurityCommands );
