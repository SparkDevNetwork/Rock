...
{
    /// <summary>
    /// Calls <see cref="IContentLibraryIndexer.IndexContentLibraryDocumentAsync(int, IndexDocumentOptions)"/> for the specified <see cref="IEntity"/>
    /// </summary>
    public sealed class ProcessContentLibraryDocument : BusStartedTaskAsync<ProcessContentLibraryDocument.Message>
    {
        /// <summary>
        ...
        public override async Task ExecuteAsync( Message message )
        {
            ...
            await indexer.IndexContentLibraryDocumentAsync( message.EntityId, new IndexDocumentOptions() );
        }
