...
{
    /// <summary>
    /// Calls <see cref="IContentLibraryIndexer.DeleteContentLibraryDocumentAsync(int)"/> for the specified <see cref="IEntity"/>
    /// </summary>
    public sealed class DeleteContentLibraryDocument : BusStartedTaskAsync<DeleteContentLibraryDocument.Message>
    {
        /// <summary>
        ...
        public override async Task ExecuteAsync( Message message )
        {
            ...
            await indexer.DeleteContentLibraryDocumentAsync( message.EntityId );
        }
