...
{
    /// <summary>
    /// Calls <see cref="IContentLibraryIndexer.IndexAllContentLibrarySourceDocumentsAsync(int, IndexDocumentOptions)"/> for the specified <see cref="Rock.Model.ContentLibrarySource"/>
    /// </summary>
    public sealed class AddContentLibrarySource : BusStartedTaskAsync<AddContentLibrarySource.Message>
    {
        /// <summary>
        ...
        public override async Task ExecuteAsync( Message message )
        {
            ...
            foreach ( var entityTypeCache in contentLibraryEntityTypes )
            {
                ...
                await indexer.IndexAllContentLibrarySourceDocumentsAsync( message.SourceId, new IndexDocumentOptions() );
            }
        }
