...
{
    /// <summary>
    /// Calls <see cref="IContentCollectionIndexer.IndexAllContentCollectionSourceDocumentsAsync(int, IndexDocumentOptions)"/> for the specified <see cref="Rock.Model.ContentCollectionSource"/>
    /// </summary>
    public sealed class AddContentCollectionSource : BusStartedTaskAsync<AddContentCollectionSource.Message>
    {
        /// <summary>
        ...
        public override async Task ExecuteAsync( Message message )
        {
            ...
            foreach ( var entityTypeCache in contentCollectionEntityTypes )
            {
                ...
                await indexer.IndexAllContentCollectionSourceDocumentsAsync( message.SourceId, new IndexDocumentOptions() );
            }
        }
