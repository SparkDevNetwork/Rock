...
public sealed class UserAgentInfo
{
    ...
    private static readonly Regex _regexCrawler = new( @"bot|googlebot|crawler|spider|robot|crawling|whatsup|chartbeat|facebookexternalhit|pingdom|newrelic", RegexOptions.IgnoreCase | RegexOptions.Multiline | RegexOptions.Compiled );
...
#pragma warning restore CS0618
    ...
    internal static string DetermineClientType( string userAgent )
    {
        ...
        if ( _regexCrawler.IsMatch( userAgent ) )
        {
            return "Crawler";
        }
