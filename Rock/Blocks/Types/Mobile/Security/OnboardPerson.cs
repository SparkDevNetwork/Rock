...
namespace Rock.Blocks.Types.Mobile.Security
{
    ...
    public class OnboardPerson : RockMobileBlockType
    {
        ...
        #region Classes to be blown away later.

        /// <summary>
        /// The configuration for the On-boarding block.
        /// </summary>
        public class Configuration
        {
            /// <summary>
            /// Gets or sets a value indicating whether this instance can authenticate by SMS.
            /// </summary>
            /// <value>
            ///   <c>true</c> if this instance can authenticate by SMS; otherwise, <c>false</c>.
            /// </value>
            public bool CanAuthenticateBySms { get; set; }

            /// <summary>
            /// Gets or sets a value indicating whether this instance can authenticate by email.
            /// </summary>
            /// <value>
            ///   <c>true</c> if this instance can authenticate by email; otherwise, <c>false</c>.
            /// </value>
            public bool CanAuthenticateByEmail { get; set; }

            /// <summary>
            /// Gets or sets a value indicating whether the on-boarding process can be skipped.
            /// </summary>
            /// <value>
            ///   <c>true</c> if the on-boarding process can be skipped; otherwise, <c>false</c>.
            /// </value>
            public bool AllowSkipOfOnboarding { get; set; }

            /// <summary>
            /// Gets or sets the completed page unique identifier.
            /// </summary>
            /// <value>
            /// The completed page unique identifier.
            /// </value>
            public Guid CompletedPageGuid { get; set; }

            /// <summary>
            /// Gets or sets the login page unique identifier.
            /// </summary>
            /// <value>
            /// The login page unique identifier.
            /// </value>
            public Guid? LoginPageGuid { get; set; }

            /// <summary>
            /// Gets or sets the email address visibility.
            /// </summary>
            /// <value>
            /// The email address visibility.
            /// </value>
            public VisibilityTriState EmailAddressVisibility { get; set; }

            /// <summary>
            /// Gets or sets a value indicating whether e-mail address field should be hidden if known.
            /// </summary>
            /// <value>
            ///   <c>true</c> if e-mail address field should be hidden if known; otherwise, <c>false</c>.
            /// </value>
            public bool HideEmailAddressIfKnown { get; set; }

            /// <summary>
            /// Gets or sets the mobile phone visibility.
            /// </summary>
            /// <value>
            /// The mobile phone visibility.
            /// </value>
            public VisibilityTriState MobilePhoneVisibility { get; set; }

            /// <summary>
            /// Gets or sets a value indicating whether mobile phone field should be hidden if known.
            /// </summary>
            /// <value>
            ///   <c>true</c> if mobile phone field should be hidden if known; otherwise, <c>false</c>.
            /// </value>
            public bool HideMobilePhoneIfKnown { get; set; }

            /// <summary>
            /// Gets or sets the gender visibility.
            /// </summary>
            /// <value>
            /// The gender visibility.
            /// </value>
            public VisibilityTriState GenderVisibility { get; set; }

            /// <summary>
            /// Gets or sets a value indicating whether the gender field should be hidden if known.
            /// </summary>
            /// <value>
            ///   <c>true</c> if the gender field should be hidden if known; otherwise, <c>false</c>.
            /// </value>
            public bool HideGenderIfKnown { get; set; }

            /// <summary>
            /// Gets or sets the birth date visibility.
            /// </summary>
            /// <value>
            /// The birth date visibility.
            /// </value>
            public VisibilityTriState BirthDateVisibility { get; set; }

            /// <summary>
            /// Gets or sets a value indicating whether the birth date field should be hidden if known.
            /// </summary>
            /// <value>
            ///   <c>true</c> if the birth date field should be hidden if known; otherwise, <c>false</c>.
            /// </value>
            public bool HideBirthDateIfKnown { get; set; }

            /// <summary>
            /// Gets or sets the interest topics available for the user to pick from.
            /// </summary>
            /// <value>
            /// The interest topics available for the user to pick from.
            /// </value>
            public List<InterestTopic> Interests { get; set; }

            /// <summary>
            /// Gets or sets the campuses available for the user to pick from.
            /// </summary>
            /// <value>
            /// The campuses available for the user to pick from.
            /// </value>
            public List<MobileCampus> Campuses { get; set; }

            /// <summary>
            /// Gets or sets a value indicating whether the campus screen should be hidden if already known.
            /// </summary>
            /// <value>
            ///   <c>true</c> if the campus screen should be hidden if already known; otherwise, <c>false</c>.
            /// </value>
            public bool HideCampusIfKnown { get; set; }

            /// <summary>
            /// Gets or sets the on-line campus unique identifier.
            /// </summary>
            /// <value>
            /// The on-line campus unique identifier.
            /// </value>
            public Guid? OnlineCampusGuid { get; set; }

            /// <summary>
            /// Gets or sets the do not attend campus unique identifier.
            /// </summary>
            /// <value>
            /// The do not attend campus unique identifier.
            /// </value>
            public Guid? DoNotAttendCampusGuid { get; set; }

            /// <summary>
            /// Gets or sets the create login visibility.
            /// </summary>
            /// <value>
            /// The create login visibility.
            /// </value>
            public VisibilityTriState CreateLoginVisibility { get; set; }

            /// <summary>
            /// Gets or sets a value indicating whether notification permission should be requested.
            /// </summary>
            /// <value>
            ///   <c>true</c> if notification permission should be requested; otherwise, <c>false</c>.
            /// </value>
            public bool RequestNotificationPermission { get; set; }

            /// <summary>
            /// Gets or sets the screen settings.
            /// </summary>
            /// <value>
            /// The screen settings.
            /// </value>
            public List<OnboardScreenSettings> ScreenSettings { get; set; }

            /// <summary>
            /// Gets or sets the custom header XAML.
            /// </summary>
            /// <value>
            /// The custom header XAML.
            /// </value>
            public string HeaderXaml { get; set; }
        }

        /// <summary>
        /// The parameters that should be posted to the SendCode endpoint.
        /// </summary>
        public class SendCodeRequest
        {
            /// <summary>
            /// Gets or sets a value indicating whether the code should be sent by SMS.
            /// </summary>
            /// <value>
            ///   <c>true</c> if the code should be sent by SMS; otherwise, <c>false</c>.
            /// </value>
            public bool SendSms { get; set; }

            /// <summary>
            /// Gets or sets a value indicating whether the code should be sent by email.
            /// </summary>
            /// <value>
            ///   <c>true</c> if the code should be sent by email; otherwise, <c>false</c>.
            /// </value>
            public bool SendEmail { get; set; }

            /// <summary>
            /// Gets or sets the phone number to send the code to.
            /// </summary>
            /// <value>
            ...
            /// <summary>
            /// Gets or sets the email address to send the code to.
            /// </summary>
            /// <value>
        ...
        /// <summary>
        /// The response from the SendCode endpoint.
        /// </summary>
        public class SendCodeResponse
        {
            /// <summary>
            /// Gets or sets the server state. This should be included in the code validation request.
            /// </summary>
            /// <value>
            /// The server state.
            /// </value>
            ...
            /// <summary>
            /// Gets or sets a value indicating whether the OTP request was successful.
            /// </summary>
            /// <value>
            ///   <c>true</c> if the OTP request was successful; otherwise, <c>false</c>.
            /// </value>
            public bool IsSuccess { get; set; }

            /// <summary>
            /// Gets or sets the message that should be displayed to the user. If <see cref="IsSuccess"/>
            /// is <c>false</c> then it should be displayed as an error message, otherwise an
        ...
        /// <summary>
        /// The parameters that should be posted to the VerifyCode endpoint.
        /// </summary>
        public class VerifyCodeRequest
        {
            /// <summary>
            /// Gets or sets the server state. This should be the same value received in
            /// <see cref="SendCodeResponse.State"/>.
            /// </summary>
            /// <value>
            /// The server state.
            /// </value>
        ...
        /// <summary>
        /// The response that is returned from the VerifyCode endpoint.
        /// </summary>
        public class VerifyCodeResponse
        {
            ...
            /// <summary>
            /// Gets or sets a value indicating whether a login should be created.
            /// </summary>
            /// <value>
            ///   <c>true</c> if a login should be created; otherwise, <c>false</c>.
            /// </value>
            public bool CreateLogin { get; set; }

            /// <summary>
            /// Gets or sets the initial values to be used on the forms.
            /// </summary>
            /// <value>
            /// The initial values to be used on the forms.
            /// </value>
            public OnboardDetails InitialValues { get; set; }
        }

        /// <summary>
        /// The parameters that should be posted to the CreatePerson endpoint.
        /// </summary>
        public class CreatePersonRequest
        {
            /// <summary>
            /// Gets or sets the server state. This should contain the value from
            /// <see cref="VerifyCodeResponse.State"/>.
            /// </summary>
            /// <value>
            /// The server state.
            /// </value>
            ...
            /// <summary>
            /// Gets or sets the details about the person to create.
            /// </summary>
            /// <value>
            /// The details about the person to create.
            /// </value>
            public OnboardDetails Details { get; set; }
        }

        /// <summary>
        /// The response that is returned from the CreatePerson endpoint.
        /// </summary>
        public class CreatePersonResponse
        {
            /// <summary>
            /// Gets or sets a value indicating whether this call was successful.
            /// </summary>
            /// <value>
            ///   <c>true</c> if this call was successful; otherwise, <c>false</c>.
            /// </value>
            public bool IsSuccess { get; set; }

            /// <summary>
            /// Gets or sets the message that should be displayed if an error occurred.
            /// </summary>
            /// <value>
            /// The message that should be displayed if an error occurred.
            /// </value>
            public string Message { get; set; }

            /// <summary>
            /// Gets or sets the details about the logged in person.
            /// </summary>
            /// <value>
            /// The details about the logged in person.
            /// </value>
            public MobilePerson Person { get; set; }
        }

        /// <summary>
        /// Common details about an on-boarding request used by various API endpoints.
        /// </summary>
        public class OnboardDetails
        {
            ...
            /// The gender.
            /// </value>
            public Common.Mobile.Enums.Gender? Gender { get; set; }
            ...
            /// <summary>
            /// Gets or sets the interests by their key.
            /// </summary>
            /// <value>
            /// The interests by their key.
            /// </value>
            public List<string> Interests { get; set; }
        }

        /// <summary>
        /// Contains common screen settings that are specific to each screen.
        /// </summary>
        public class OnboardScreenSettings
        {
            /// <summary>
            /// Gets or sets the screen that these settings apply to.
            /// </summary>
            /// <value>
            /// The screen that these settings apply to.
            /// </value>
            public OnboardScreen Screen { get; set; }
        ...
        /// <summary>
        /// A single topic of interest to present to the user that they can subscribe to.
        /// </summary>
        public class InterestTopic
        {
            /// <summary>
            /// Gets or sets the type of interest.
            /// </summary>
            /// <value>
            /// The type of interest.
            /// </value>
            /// <remarks>
            /// This will never be displayed to the user. It's used by the server
            /// to track different interest types so it knows how to update the
            /// database after final submission. Therefore the shell should never
            /// make any assumptions about what is in this value.
            /// </remarks>
            public string Type { get; set; }

            /// <summary>
            /// Gets or sets the title text to be displayed.
            /// </summary>
            /// <value>
            ...
            /// <summary>
            /// Gets or sets the key used to identify this topic.
            /// </summary>
            /// <value>
            /// The key used to identify this topic.
            /// </value>
            public string Key { get; set; }

            /// <summary>
            /// Gets or sets a value indicating whether there is interest in this topic.
            /// </summary>
            /// <value>
            ///   <c>true</c> if there is interest in this topic; otherwise, <c>false</c>.
            /// </value>
            public bool IsInterested { get; set; }
        }

        /// <summary>
        /// The different screens that can appear in the on-boarding process.
        /// </summary>
        public enum OnboardScreen
        {
            /// <summary>
            /// The initial screen that shows and asks the user how they want to login.
            /// </summary>
            Hello = 0,

            /// <summary>
            /// The screen that shows when an OTP code has been sent to them.
            /// </summary>
            CodeSent = 1,

            /// <summary>
            /// The screen that asks for their name.
            /// </summary>
            Name = 2,

            /// <summary>
            /// The screen that asks for personal information.
            /// </summary>
            PersonalInformation = 3,

            /// <summary>
            /// The screen that asks for contact information.
            /// </summary>
            ContactInformation = 4,

            /// <summary>
            /// The screen that asks for topics of interests.
            /// </summary>
            Interests = 5,

            /// <summary>
            /// The screen that asks if they want to enable notifications.
            /// </summary>
            Notifications = 6,

            /// <summary>
            /// The screen that asks what campus they attend.
            /// </summary>
            Campus = 7,

            /// <summary>
            /// The screen that asks them to create a login.
            /// </summary>
            CreateLogin = 8
        }
