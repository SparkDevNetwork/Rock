...
namespace Rock.Blocks.Types.Mobile.Groups
{
    ...
    public class GroupView : RockMobileBlockType
    {
        #region Block Attributes
        ...
        /// </value>
        public override string MobileBlockType => "Rock.Mobile.Blocks.Groups.GroupView";
        ...
        private string BuildContent()
        {
            ...
            {
                var group = new GroupService( rockContext ).Get( RequestContext.GetPageParameter( PageParameterKeys.GroupId ).AsInteger() );
