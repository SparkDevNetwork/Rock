...
namespace Rock.CRM
{
	...
	/// </summary>
    public partial class PersonRepository : Repository<Rock.CRM.Person>
    {
		/// <summary>
        ...
        {
            return Find( t => ( t.Email == email || ( email == null && t.Email == null ) ) );
        }
        ...
        {
            return Find( t => ( t.MaritalStatusId == maritalStatusId || ( maritalStatusId == null && t.MaritalStatusId == null ) ) );
        }
        ...
        {
            return Find( t => ( t.PersonStatusId == personStatusId || ( personStatusId == null && t.PersonStatusId == null ) ) );
        }
        ...
        {
            return Find( t => ( t.RecordStatusId == recordStatusId || ( recordStatusId == null && t.RecordStatusId == null ) ) );
        }
        ...
        {
            return Find( t => ( t.RecordStatusReasonId == recordStatusReasonId || ( recordStatusReasonId == null && t.RecordStatusReasonId == null ) ) );
        }
        ...
        {
            return Find( t => ( t.RecordTypeId == recordTypeId || ( recordTypeId == null && t.RecordTypeId == null ) ) );
        }
        ...
        {
            return Find( t => ( t.SuffixId == suffixId || ( suffixId == null && t.SuffixId == null ) ) );
        }
        ...
        {
            return Find( t => ( t.TitleId == titleId || ( titleId == null && t.TitleId == null ) ) );
        }
        ...
        public Person GetByEncryptedID( string encryptedID )
        {
            ...
            if ( idParts.Length == 2 )
            {
                ...
                PersonTrailRepository personTrailRepository = new PersonTrailRepository();
                PersonTrail personTrail = personTrailRepository.AsQueryable().
                    Where( p => p.Guid == personGuid && p.Id == personId ).FirstOrDefault();
        ...
        {
            if ( followTrail )
                id = new PersonTrailRepository().Current( id );
        ...
        {
            if ( followTrail )
                publicKey = new PersonTrailRepository().Current( publicKey );
