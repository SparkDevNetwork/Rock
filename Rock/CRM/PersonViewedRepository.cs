...
{
	/// <summary>
	/// Person Viewed POCO Repository class
	/// </summary>
    public partial class PersonViewedRepository : Repository<Rock.CRM.PersonViewed>
    {
		/// <summary>
        ...
        {
            return Find( t => ( t.TargetPersonId == targetPersonId || ( targetPersonId == null && t.TargetPersonId == null ) ) );
        }
        ...
        {
            return Find( t => ( t.ViewerPersonId == viewerPersonId || ( viewerPersonId == null && t.ViewerPersonId == null ) ) );
        }
