...
namespace Rock.CMS
{
	...
	/// </summary>
    public partial class SiteDomainRepository : Repository<Rock.CMS.SiteDomain>
    {
		/// <summary>
        ...
        {
            return FirstOrDefault( t => t.Domain == domain );
        }
        ...
        {
            return Find( t => t.SiteId == siteId && t.Domain == domain );
        }
        ...
        {
            return FirstOrDefault( t => domain.ToLower().Contains( t.Domain.ToLower() ) );
        }
    }
}
