...
namespace Rock.CMS
{
	...
	/// </summary>
    public partial class UserRepository : Repository<Rock.CMS.User>
    {
        ...
        {
            return Find( t => ( t.ApiKey == apiKey || ( apiKey == null && t.ApiKey == null ) ) );
        }
        ...
        {
            return FirstOrDefault( t => t.UserName == userName );
        }
        ...
        public static User GetCurrentUser( bool userIsOnline )
        {
            ...
            User user = userRepository.GetByUserName( User.GetCurrentUserName() );
        ...
        public static bool Validate( string username, string password )
        {
            ...
            if ( user != null )
                return userRepository.Validate( user, password );
