...
namespace Rock.Jobs
{
    ...
    [IntegerField( 0, "Hours to Keep Unconfirmed Accounts", "14", "HoursKeepUnconfirmedAccounts", "General", "The number of hours to keep user accounts that have not been confirmed (default is 48 hours.)" )]
