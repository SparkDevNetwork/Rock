...
namespace Rock.Jobs
{
    ...
    /// </summary>
    [DisplayName( "Rock Update Helper v16.0 - Update InteractionSession InteractionChannelId columns." )]
    [Description( "This job update all empty InteractionChannelId columns on the InteractionSession table with their corresponding InteractionChannelId values." )]
    ...
    public class PostV16UpdateInteractionSessionChannelId : RockJob
    {
