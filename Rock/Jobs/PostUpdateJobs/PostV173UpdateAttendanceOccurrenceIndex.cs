...
namespace Rock.Jobs
{
    ...
    /// </summary>
    [DisplayName( "Rock Update Helper v17.3 - Update AttendanceOccurrence Index" )]
    ...
    public class PostV173UpdateAttendanceOccurrenceIndex : RockJob
    {
        ...
        public override void Execute()
        {
            ...
            // Drops the redundant IX_GroupId index on AttendanceOccurrence
            jobMigration.Sql( @"
-- Drop the redundant index.
IF EXISTS (SELECT * FROM sys.indexes WHERE NAME = N'IX_GroupId' AND object_id = OBJECT_ID('AttendanceOccurrence'))
BEGIN
    DROP INDEX [IX_GroupId] ON [dbo].[AttendanceOccurrence];
END" );
