...
{
    /// <summary>
    /// Run once job for v18.1 to add a new index to the FinancialBatch table.
    /// </summary>
    [DisplayName( "Rock Update Helper v18.1 - Add FinancialBatch Index" )]
    ...
    public class PostV181AddFinancialBatchIndex : RockJob
    {
        ...
        public override void Execute()
        {
            ...
            jobMigration.Sql( @"
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE NAME = N'IX_Status_Name_BatchStartDateTime_BatchEndDateTime' AND object_id = OBJECT_ID('FinancialBatch'))
BEGIN
