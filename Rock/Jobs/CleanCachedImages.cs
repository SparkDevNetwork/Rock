...
namespace Rock.Jobs
{
    ...
    [Rock.Attribute.Property( 0, "Days to Expire", "DaysToExpire", "General", "The number of days to leave an image in the cache directory.",  false, "100", "Rock", "Rock.FieldTypes.Integer" )]
