...
namespace Rock
{
    ...
    public static partial class ExtensionMethods
    {
        ...
        /// <returns></returns>
        [Obsolete]
        public static Dictionary<string, Web.Cache.AttributeCache> GetAuthorizedAttributes ( this Rock.Attribute.IHasAttributes entity, string action, Person person)
        {
            var authorizedAttributes = new Dictionary<string, Web.Cache.AttributeCache>();
