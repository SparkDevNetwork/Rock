...
namespace Rock.Cms
{
    /*
        ...
        Compiles Custom Component authored source (a Vue single-file component) on
    ...
    */
    ...
    /// <summary>
    /// Compiles Custom Component authored source into a SystemJS module by running
    /// the shared compiler bundle in Rock's managed headless browser.
    /// </summary>
    [RockInternal( "20.0" )]
    internal class CustomComponentCompiler
    {
        #region Constants

        /// <summary>
        /// The Rock-relative path of the compiler bundle built from
        /// Rock.JavaScript.Obsidian/Framework/Libs/customComponentCompiler.ts.
        /// </summary>
        private const string CompilerBundleVirtualPath = "~/Obsidian/Libs/customComponentCompiler.js";
...
";
        ...
        /// </summary>
        public CustomComponentCompiler()
        {
        }
        ...
        public CustomComponentCompileResult CompileSource( string source )
        {
            if ( source.IsNullOrWhiteSpace() )
            {
                return CustomComponentCompileResult.Failure( "No source was provided." );
            }
            ...
            {
                return CustomComponentCompileResult.BundleMissing();
            }

            if ( !IsBrowserInstalled() )
            {
                return CustomComponentCompileResult.BrowserMissing();
            }
        ...
        /// <param name="source">The authored Vue single-file-component source.</param>
        /// <returns>The result of the compile attempt.</returns>
        private async Task<CustomComponentCompileResult> CompileInPageAsync( string bundle, string source )
        {
            ...
            try
            {
                ...
                {
                    return CustomComponentCompileResult.Failure( "The compiler returned no output." );
                }
                ...
                {
                    return CustomComponentCompileResult.Failure( "The compiler produced output that is not a SystemJS module." );
                }

                return CustomComponentCompileResult.Success( output.CompiledContent, output.VueVersion );
            }
            finally
            {
                if ( page != null )
    ...
    /// <summary>
    /// The result of a server-side Custom Component compile attempt.
    /// </summary>
    [RockInternal( "20.0" )]
    internal class CustomComponentCompileResult
    {
        #region Properties
        ...
        public static CustomComponentCompileResult Success( string compiledContent, string vueVersion )
        {
            return new CustomComponentCompileResult
            {
                IsSuccess = true,
        ...
        /// <returns>The result.</returns>
        public static CustomComponentCompileResult Failure( string error )
        {
        ...
        /// </summary>
        /// <returns>The result.</returns>
        public static CustomComponentCompileResult BundleMissing()
        {
            var result = new CustomComponentCompileResult
            {
                IsSuccess = false,
        ...
        /// </summary>
        /// <returns>The result.</returns>
        public static CustomComponentCompileResult BrowserMissing()
        {
            var result = new CustomComponentCompileResult
            {
                IsSuccess = false,
