...
{
    /// <summary>
    /// Defines a component that can provide lava merge features to the
    /// structured content block it handles.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [RockInternal( "17.1" )]
    internal interface IStructuredContentBlockLavaRenderer
    {
        dynamic ResolveMergeFields( Dictionary<string, object> mergeFields, dynamic data );
    }
}
