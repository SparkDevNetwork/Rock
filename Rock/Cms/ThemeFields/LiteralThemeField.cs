...
namespace Rock.Cms.ThemeFields
{
    ...
    /// of text. The output is unformatted.
    /// </summary>
    internal class LiteralThemeField : TextThemeField
    {
        /// <summary>
        /// Creates a new instance of <see cref="LiteralThemeField"/>.
        /// </summary>
        /// <param name="jField">The JSON object to be parsed.</param>
        /// <param name="type">The type of field of this instance.</param>
        public LiteralThemeField( JObject jField, ThemeFieldType type )
            : base( jField, type )
        {
        }
