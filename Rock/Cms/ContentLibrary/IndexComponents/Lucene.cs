...
namespace Rock.Cms.ContentLibrary.IndexComponents
{
    /// <summary>
    /// Lucene Search Index Provider
    /// </summary>
    /// <seealso cref="Rock.Cms.ContentLibrary.ContentIndexComponent" />
    [Description( "Lucene.Net Content Library Index (v4.8)" )]
    ...
    internal sealed class Lucene : ContentIndexComponent
    {
        ...
        private static readonly string _path = System.Web.Hosting.HostingEnvironment.MapPath( "~/App_Data/LuceneContentLibraryIndex" );
