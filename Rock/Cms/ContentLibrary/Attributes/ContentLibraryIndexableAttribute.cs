...
namespace Rock.Cms.ContentLibrary.Attributes
{
    /// <summary>
    /// Identifiers the class as supporting the content library index system
    /// and specifies the class that will handle the indexing of items.
    /// </summary>
    [AttributeUsage( AttributeTargets.Class, AllowMultiple = false )]
    internal class ContentLibraryIndexableAttribute : System.Attribute
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentLibraryIndexableAttribute"/> class.
        /// </summary>
        ...
        public ContentLibraryIndexableAttribute( Type indexerType, Type documentType )
        {
