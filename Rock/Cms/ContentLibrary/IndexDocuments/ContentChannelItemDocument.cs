...
namespace Rock.Cms.ContentLibrary.IndexDocuments
{
    ...
    internal class ContentChannelItemDocument : IndexDocumentBase
    {
        ...
        internal static async Task<ContentChannelItemDocument> LoadByModelAsync( ContentChannelItem contentChannelItem, ContentLibrarySourceCache source )
        {
            ...
            FieldValueHelper.AddFieldValue( source.ContentLibraryId, nameof( document.Year ), yearValue, yearValue );
