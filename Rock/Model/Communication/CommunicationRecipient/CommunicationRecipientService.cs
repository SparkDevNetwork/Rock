...
namespace Rock.Model
{
    ...
    public partial class CommunicationRecipientService 
    {
        ...
        internal ConversationMessageBag GetConversationMessageBag( int communicationRecipientId )
        {
            ...
            {
                bag.PhotoUrl = FileUrlHelper.GetFileUrl( recipient.PersonAlias.Person.PhotoId.Value, "GetImage", publicUrl, null, 256, 256 );
            }
            ...
            foreach ( var attachment in recipient.Communication.Attachments )
            {
                ...
                bag.Attachments.Add( new ConversationAttachmentBag
                {
                    ...
                    Url = FileUrlHelper.GetFileUrl( attachment.BinaryFile.Guid, "GetImage", publicUrl ),
                    ThumbnailUrl = isImage ? FileUrlHelper.GetFileUrl( attachment.BinaryFile.Guid, "GetImage", publicUrl, null, 512, 512 ) : null
                } );
            }
