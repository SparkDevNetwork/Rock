...
namespace Rock.Model
{
    ...
    public partial class CommunicationResponseService
    {
        ...
        internal ConversationMessageBag GetConversationMessageBag( int communicationResponseId )
        {
            ...
            {
                messageBag.PhotoUrl = FileUrlHelper.GetFileUrl( communicationResponse.FromPerson.PhotoId.Value, "GetImage" ) + "&maxwidth=256&maxheight=256";
            }
            ...
            foreach ( var attachment in communicationResponse.Attachments )
            {
                ...
                if ( isImage )
                {
                    messageBag.Attachments.Add( new ConversationAttachmentBag
                    {
                        ...
                        Url = FileUrlHelper.GetFileUrl( attachment.Guid, "GetImage" ),
                        ThumbnailUrl = FileUrlHelper.GetFileUrl( attachment.Guid, "GetImage" ) + "&maxwidth=512&maxheight=512"
                    } );
                }
                else
                {
