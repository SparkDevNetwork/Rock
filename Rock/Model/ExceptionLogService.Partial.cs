...
namespace Rock.Model
{
    ...
    public partial class ExceptionLogService 
    {
        ...
        public static void LogException( Exception ex, object context, int? pageId = null, int? siteId = null, PersonAlias personAlias = null )
#else
        ...
        /// <returns></returns>
#if NET5_0_OR_GREATER
        private static ExceptionLog PopulateExceptionLog( Exception ex, object context, int? pageId, int? siteId, PersonAlias personAlias )
#else
        ...
        /// <returns>
        ///   <c>true</c> if the value should be considered sensitve data; otherwise, <c>false</c>.
        /// </returns>
