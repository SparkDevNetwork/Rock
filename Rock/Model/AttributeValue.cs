...
namespace Rock.Model
{
    ...
    public partial class AttributeValue : Model<AttributeValue>
    {
        ...
        /// Calculated Field: alter table AttributeValue add ValueAsNumeric as case when (ISNUMERIC( value) = 1 and value not like '%[^0-9.]%') then convert(numeric(38,10), value ) else null end
        /// </summary>
        /// <value>
        /// The match score.
        /// </value>
        ...
        /// Calculated Field: alter table AttributeValue add ValueAsDateTime as case when ISDATE( value) = 1 then convert(datetime, value) else null end
        /// </summary>
        /// <value>
        /// The match score.
        /// </value>
