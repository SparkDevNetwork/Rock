...
{
    /// <summary>
    /// PageViewUserAgent Model Entity.
    /// </summary>
    [Table( "PageViewUserAgent" )]
    [DataContract]
    [NotAudited]
    public partial class PageViewUserAgent : Entity<PageViewUserAgent>
    {
        ...
        [DataMember]
        [MaxLength( 450 )]
        [Index( "IX_UserAgent", IsUnique = true )]
    ...
    /// <summary>
    /// PageViewUserAgent Configuration class.
    /// </summary>
    public partial class PageViewUserAgentConfiguration : EntityTypeConfiguration<PageViewUserAgent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SiteConfiguration"/> class.
        /// </summary>
        public PageViewUserAgentConfiguration()
        {
        }
    }
