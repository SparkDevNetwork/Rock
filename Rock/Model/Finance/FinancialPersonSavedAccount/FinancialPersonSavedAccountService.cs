...
namespace Rock.Model
{
    ...
    public partial class FinancialPersonSavedAccountService
    {
        ...
        /// <param name="additionalParameters">The additional parameters for the request.</param>
        ...
        internal FinancialPersonSavedAccount CreateAccountFromToken( FinancialGateway gateway, SavedAccountTokenBag options, Person person, int? authorizationTransactionTypeId, Dictionary<string, string> additionalParameters, out string errorMessage )
        {
            ...
            if ( isCreditCard )
            {
                return CreateCreditCardAccountFromToken( gateway, options, person, authorizationTransactionTypeId, additionalParameters, out errorMessage );
            }
            else if ( isAch )
            {
                return CreateAchAccountFromToken( gateway, options, person, authorizationTransactionTypeId, additionalParameters, out errorMessage );
            }
        ...
        /// <param name="additionalParameters">The additional parameters for the request.</param>
        /// <returns>A <see cref="FinancialPersonSavedAccount"/> object or null if an error occurs.</returns>
        internal FinancialPersonSavedAccount CreateCreditCardAccountFromToken( FinancialGateway gateway, SavedAccountTokenBag options, Person person, int? authorizationTransactionTypeId, Dictionary<string, string> additionalParameters, out string errorMessage )
        {
        ...
        /// <param name="errorMessage">The error message, if any.</param>
        /// <returns>A <see cref="FinancialPersonSavedAccount"/> object or null if an error occurs.</returns>
        internal FinancialPersonSavedAccount CreateAchAccountFromToken( FinancialGateway gateway, SavedAccountTokenBag options, Person person, int? authorizationTransactionTypeId, Dictionary<string, string> additionalParameters, out string errorMessage )
        {
