...
{
    /// <summary>
    /// The options that can be specified when querying for connection request upcoming follow-up windows.
    /// </summary>
    internal class ConnectionRequestUpcomingFollowUpWindowQueryOptions
    {
        /// <summary>
