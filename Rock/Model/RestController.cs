...
namespace Rock.Model
{
    ...
    public partial class RestController : Model<RestController>, ICacheable
    {
        ...
        {
            CacheRestController.Get( this.Id )?.SetAttributeValue( attributeKey, value );
        }
        ...
        {
            CacheRestController.UpdateCachedEntity( this.Id, entityState, dbContext as RockContext );
        }
