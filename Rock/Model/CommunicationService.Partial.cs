...
namespace Rock.Model
{
    ...
    public partial class CommunicationService 
    {
        ...
        /// <param name="senderPersonAliasId">The sender person alias identifier.</param>
        /// <returns></returns>
        [Obsolete( "Use method without send date time argument" )]
        public Communication CreateEmailCommunication
        (
            List<string> recipientEmails,
            string fromName,
            ...
            int? senderPersonAliasId = null )
        {
            ...
            return CreateEmailCommunication( recipientEmails, fromName, fromAddress, replyTo, subject, message, bulkCommunication, recipientStatus, senderPersonAliasId, sendDateTime );
        }
