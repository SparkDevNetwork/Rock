...
{
    /// <summary>
    /// Data access and service class for <see cref="Rock.Model.CustomComponent"/> entity objects.
    /// </summary>
    public partial class CustomComponentService
    {
        /// <summary>
        /// Returns the <see cref="Rock.Model.CustomComponent"/> owned by the specified <see cref="Rock.Model.Block"/> placement.
        /// </summary>
        /// <param name="blockId">A <see cref="System.Int32"/> representing the Id of the owning <see cref="Rock.Model.Block"/>.</param>
        /// <returns>The <see cref="Rock.Model.CustomComponent"/> for the specified block, or <c>null</c> if none exists yet.</returns>
        public CustomComponent GetByBlockId( int blockId )
        {
        ...
        public CustomComponent GetOrCreateByBlockId( int blockId )
        {
