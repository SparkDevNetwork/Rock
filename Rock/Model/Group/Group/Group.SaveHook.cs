                ...
                else if ( originalInactiveDateTime.HasValue )
                {
                    ...
                    var membersToReactivateIds = groupMemberQuery
                        ...
                        .Where( a => a.GroupMemberStatus == GroupMemberStatus.Inactive
                                     ...
                                     && Math.Abs( EF.Functions.DateDiffHour( a.InactiveDateTime.Value, originalInactiveDateTime.Value ) ) < 24 )
#else
...
#if REVIEW_NET5_0_OR_GREATER
                    var membersToUnarchiveQuery = groupMemberQuery.Where( a => a.IsArchived && a.ArchivedDateTime.HasValue && Math.Abs( EF.Functions.DateDiffHour( a.ArchivedDateTime.Value, originalArchivedDateTime.Value ) ) < 24 );
#else
