...
namespace Rock.Model
{
    ...
    [HasQueryableAttributes( typeof( PersonSearchKey.PersonSearchKeyQueryableAttributeValue ), nameof( PersonSearchKeyAttributeValues ) )]
    public partial class PersonSearchKey
    {
        ...
        /// </summary>
        public virtual ICollection<PersonSearchKeyQueryableAttributeValue> PersonSearchKeyAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class PersonSearchKeyQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
    ...
    public static partial class PersonSearchKeyExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this PersonSearchKey object to a new PersonSearchKey object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static PersonSearchKey CloneWithoutIdentity( this PersonSearchKey source )
        {
            var target = new PersonSearchKey();
            target.CopyPropertiesFrom( source );
