...
namespace Rock.Model
{
    ...
    public partial class TagService : Service<Tag>
    {
        ...
        public TagService(RockContext context) : base(context)
        {
        }
    ...
    [HasQueryableAttributes( typeof( Tag.TagQueryableAttributeValue ), nameof( TagAttributeValues ) )]
    public partial class Tag
    {
        ...
        /// </summary>
        public virtual ICollection<TagQueryableAttributeValue> TagAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class TagQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
    ...
    public static partial class TagExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this Tag object to a new Tag object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static Tag CloneWithoutIdentity( this Tag source )
        {
            var target = new Tag();
            target.CopyPropertiesFrom( source );
