...
namespace Rock.Model
{
    ...
    [HasQueryableAttributes( typeof( Block.BlockQueryableAttributeValue ), nameof( BlockAttributeValues ) )]
    public partial class Block
    {
        ...
        /// </summary>
        public virtual ICollection<BlockQueryableAttributeValue> BlockAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class BlockQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
    ...
    public static partial class BlockExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this Block object to a new Block object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static Block CloneWithoutIdentity( this Block source )
        {
            var target = new Block();
            target.CopyPropertiesFrom( source );
