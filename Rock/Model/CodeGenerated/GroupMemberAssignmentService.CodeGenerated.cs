...
namespace Rock.Model
{
    ...
    [HasQueryableAttributes( typeof( GroupMemberAssignment.GroupMemberAssignmentQueryableAttributeValue ), nameof( GroupMemberAssignmentAttributeValues ) )]
    public partial class GroupMemberAssignment
    {
        ...
        /// </summary>
        public virtual ICollection<GroupMemberAssignmentQueryableAttributeValue> GroupMemberAssignmentAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class GroupMemberAssignmentQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
    ...
    public static partial class GroupMemberAssignmentExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this GroupMemberAssignment object to a new GroupMemberAssignment object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static GroupMemberAssignment CloneWithoutIdentity( this GroupMemberAssignment source )
        {
            var target = new GroupMemberAssignment();
            target.CopyPropertiesFrom( source );
