...
namespace Rock.Model
{
    ...
    public static class UserLoginExtensions
    {
        ...
        /// <returns></returns>
        public static string ToJson( this UserLogin value, bool deep = false )
        {
        ...
        /// <returns></returns>
        public static List<dynamic> ToDynamic( this ICollection<UserLogin> values )
        {
        ...
        /// <param name="deep">if set to <c>true</c> [deep].</param>
        /// <returns></returns>
        public static dynamic ToDynamic( this UserLogin value, bool deep = false )
        {
            dynamic dynamicUserLogin = new UserLoginDto( value ).ToDynamic();
            ...
            {
                dynamicUserLogin.Person = value.Person.ToDynamic();
            }
        ...
        public static void FromJson( this UserLogin value, string json )
        {
        ...
        /// <param name="deep">if set to <c>true</c> [deep].</param>
        public static void FromDynamic( this UserLogin value, object obj, bool deep = false )
        {
