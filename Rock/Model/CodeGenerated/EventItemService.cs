...
namespace Rock.Model
{
    ...
    public partial class EventItemViewModelHelper : ViewModelHelper<EventItem, Rock.ViewModel.EventItemViewModel>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.EventItemViewModel CreateViewModel( EventItem model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.EventItemViewModel
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class EventItemExtensionMethods
    {
        ...
        public static Rock.ViewModel.EventItemViewModel ToViewModel( this EventItem model, Person currentPerson = null, bool loadAttributes = false )
        {
