...
namespace Rock.Model
{
    ...
    public static partial class MetaLastNameLookupExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this MetaLastNameLookup object to a new MetaLastNameLookup object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static MetaLastNameLookup CloneWithoutIdentity( this MetaLastNameLookup source )
        {
            var target = new MetaLastNameLookup();
            target.CopyPropertiesFrom( source );
