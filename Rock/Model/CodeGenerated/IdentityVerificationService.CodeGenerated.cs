...
{
    /// <summary>
    /// IdentityVerification Service class
    /// </summary>
    public partial class IdentityVerificationService : Service<IdentityVerification>
    {
        /// <summary>
    ...
    public partial class IdentityVerification : IHasQueryableAttributes<IdentityVerification.IdentityVerificationQueryableAttributeValue>
    {
        /// <inheritdoc/>
        public virtual ICollection<IdentityVerificationQueryableAttributeValue> EntityAttributeValues { get; set; } 
    ...
    /// </summary>
    public static partial class IdentityVerificationExtensionMethods
    {
        /// <summary>
        /// Clones this IdentityVerification object to a new IdentityVerification object
        /// </summary>
        ...
        public static IdentityVerification Clone( this IdentityVerification source, bool deepCopy )
        {
            if (deepCopy)
            {
                return source.Clone() as IdentityVerification;
            }
            else
            {
        ...
        public static void CopyPropertiesFrom( this IdentityVerification target, IdentityVerification source )
        {
            ...
            target.RequestIpAddress = source.RequestIpAddress;
