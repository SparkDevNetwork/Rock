...
namespace Rock.Model
{
    ...
    /// </summary>
    public partial class EntitySetItemViewModelHelper : ViewModelHelper<EntitySetItem, Rock.ViewModel.EntitySetItemViewModel>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.EntitySetItemViewModel CreateViewModel( EntitySetItem model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.EntitySetItemViewModel
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class EntitySetItemExtensionMethods
    {
        ...
        public static Rock.ViewModel.EntitySetItemViewModel ToViewModel( this EntitySetItem model, Person currentPerson = null, bool loadAttributes = false )
        {
