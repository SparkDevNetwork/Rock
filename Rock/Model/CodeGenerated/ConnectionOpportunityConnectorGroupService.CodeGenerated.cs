...
namespace Rock.Model
{
    ...
    [HasQueryableAttributes( typeof( ConnectionOpportunityConnectorGroup.ConnectionOpportunityConnectorGroupQueryableAttributeValue ), nameof( ConnectionOpportunityConnectorGroupAttributeValues ) )]
    public partial class ConnectionOpportunityConnectorGroup
    {
        ...
        /// </summary>
        public virtual ICollection<ConnectionOpportunityConnectorGroupQueryableAttributeValue> ConnectionOpportunityConnectorGroupAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class ConnectionOpportunityConnectorGroupQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
