...
namespace Rock.Model
{
    ...
    /// <summary>
    /// PersonDuplicate View Model Helper
    /// </summary>
    [DefaultViewModelHelper( typeof( PersonDuplicate ) )]
    public partial class PersonDuplicateViewModelHelper : ViewModelHelper<PersonDuplicate, Rock.ViewModel.PersonDuplicateViewModel>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.PersonDuplicateViewModel CreateViewModel( PersonDuplicate model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.PersonDuplicateViewModel
            {
                Id = model.Id,
                Guid = model.Guid,
                ...
                IsConfirmedAsNotDuplicate = model.IsConfirmedAsNotDuplicate,
    ...
    public static partial class PersonDuplicateExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this PersonDuplicate object to a new PersonDuplicate object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static PersonDuplicate CloneWithoutIdentity( this PersonDuplicate source )
        {
            var target = new PersonDuplicate();
            target.CopyPropertiesFrom( source );
        ...
        public static Rock.ViewModel.PersonDuplicateViewModel ToViewModel( this PersonDuplicate model, Person currentPerson = null, bool loadAttributes = false )
        {
            var helper = new PersonDuplicateViewModelHelper();
