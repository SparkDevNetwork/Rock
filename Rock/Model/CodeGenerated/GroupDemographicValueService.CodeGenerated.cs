...
namespace Rock.Model
{
    ...
    /// <summary>
    /// GroupDemographicValue View Model Helper
    /// </summary>
    [DefaultViewModelHelper( typeof( GroupDemographicValue ) )]
    public partial class GroupDemographicValueViewModelHelper : ViewModelHelper<GroupDemographicValue, GroupDemographicValueBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override GroupDemographicValueBag CreateViewModel( GroupDemographicValue model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class GroupDemographicValueExtensionMethods
    {
        ...
        public static GroupDemographicValueBag ToViewModel( this GroupDemographicValue model, Person currentPerson = null, bool loadAttributes = false )
        {
            var helper = new GroupDemographicValueViewModelHelper();
