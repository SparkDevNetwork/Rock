...
namespace Rock.Model
{
    ...
    [HasQueryableAttributes( typeof( EventItemOccurrenceGroupMap.EventItemOccurrenceGroupMapQueryableAttributeValue ), nameof( EventItemOccurrenceGroupMapAttributeValues ) )]
    public partial class EventItemOccurrenceGroupMap
    {
        ...
        /// </summary>
        public virtual ICollection<EventItemOccurrenceGroupMapQueryableAttributeValue> EventItemOccurrenceGroupMapAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class EventItemOccurrenceGroupMapQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
    ...
    public static partial class EventItemOccurrenceGroupMapExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this EventItemOccurrenceGroupMap object to a new EventItemOccurrenceGroupMap object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static EventItemOccurrenceGroupMap CloneWithoutIdentity( this EventItemOccurrenceGroupMap source )
        {
            var target = new EventItemOccurrenceGroupMap();
            target.CopyPropertiesFrom( source );
