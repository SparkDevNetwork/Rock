...
namespace Rock.Model
{
    ...
    public partial class ServiceJobViewModelHelper : ViewModelHelper<ServiceJob, ServiceJobBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override ServiceJobBag CreateViewModel( ServiceJob model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class ServiceJobExtensionMethods
    {
        ...
        public static ServiceJobBag ToViewModel( this ServiceJob model, Person currentPerson = null, bool loadAttributes = false )
        {
