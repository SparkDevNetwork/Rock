...
namespace Rock.Model
{
    ...
    public partial class PersonScheduleExclusionViewModelHelper : ViewModelHelper<PersonScheduleExclusion, PersonScheduleExclusionBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override PersonScheduleExclusionBag CreateViewModel( PersonScheduleExclusion model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class PersonScheduleExclusionExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this PersonScheduleExclusion object to a new PersonScheduleExclusion object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static PersonScheduleExclusion CloneWithoutIdentity( this PersonScheduleExclusion source )
        {
            var target = new PersonScheduleExclusion();
            target.CopyPropertiesFrom( source );
        ...
        public static PersonScheduleExclusionBag ToViewModel( this PersonScheduleExclusion model, Person currentPerson = null, bool loadAttributes = false )
        {
