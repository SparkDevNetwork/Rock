...
namespace Rock.Model
{
    ...
    /// </summary>
    [DefaultViewModelHelper( typeof( RestAction ) )]
    public partial class RestActionViewModelHelper : ViewModelHelper<RestAction, RestActionBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override RestActionBag CreateViewModel( RestAction model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class RestActionExtensionMethods
    {
        ...
        public static RestActionBag ToViewModel( this RestAction model, Person currentPerson = null, bool loadAttributes = false )
        {
