...
{
    /// <summary>
    /// GroupRequirementType Service class
    /// </summary>
    public partial class GroupRequirementTypeService : Service<GroupRequirementType>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupRequirementTypeService"/> class
        /// </summary>
        /// <param name="context">The context.</param>
        public GroupRequirementTypeService(RockContext context) : base(context)
        {
        }
        ...
        /// </returns>
        public bool CanDelete( GroupRequirementType item, out string errorMessage )
        {
    ...
    [HasQueryableAttributes( typeof( GroupRequirementType.GroupRequirementTypeQueryableAttributeValue ), nameof( GroupRequirementTypeAttributeValues ) )]
    public partial class GroupRequirementType
    {
        ...
        /// </summary>
        public virtual ICollection<GroupRequirementTypeQueryableAttributeValue> GroupRequirementTypeAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class GroupRequirementTypeQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
    ...
    /// </summary>
    public static partial class GroupRequirementTypeExtensionMethods
    {
        /// <summary>
        ...
        /// <summary>
        /// Clones this GroupRequirementType object to a new GroupRequirementType object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static GroupRequirementType CloneWithoutIdentity( this GroupRequirementType source )
        {
            var target = new GroupRequirementType();
            target.CopyPropertiesFrom( source );
