...
namespace Rock.Model
{
    ...
    public static partial class AuthScopeExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this AuthScope object to a new AuthScope object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static AuthScope CloneWithoutIdentity( this AuthScope source )
        {
            var target = new AuthScope();
            target.CopyPropertiesFrom( source );
