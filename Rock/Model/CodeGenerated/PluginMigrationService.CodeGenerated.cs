...
namespace Rock.Model
{
    ...
    public partial class PluginMigrationViewModelHelper : ViewModelHelper<PluginMigration, PluginMigrationBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override PluginMigrationBag CreateViewModel( PluginMigration model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class PluginMigrationExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this PluginMigration object to a new PluginMigration object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static PluginMigration CloneWithoutIdentity( this PluginMigration source )
        {
            var target = new PluginMigration();
            target.CopyPropertiesFrom( source );
        ...
        public static PluginMigrationBag ToViewModel( this PluginMigration model, Person currentPerson = null, bool loadAttributes = false )
        {
