...
namespace Rock.Model
{
    ...
    public static partial class EventItemOccurrenceExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this EventItemOccurrence object to a new EventItemOccurrence object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static EventItemOccurrence CloneWithoutIdentity( this EventItemOccurrence source )
        {
            var target = new EventItemOccurrence();
            target.CopyPropertiesFrom( source );
