...
namespace Rock.Model
{
    ...
    /// </summary>
    public partial class GroupDemographicValueViewModelHelper : ViewModelHelper<GroupDemographicValue, Rock.ViewModel.GroupDemographicValueViewModel>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.GroupDemographicValueViewModel CreateViewModel( GroupDemographicValue model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.GroupDemographicValueViewModel
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class GroupDemographicValueExtensionMethods
    {
        ...
        public static Rock.ViewModel.GroupDemographicValueViewModel ToViewModel( this GroupDemographicValue model, Person currentPerson = null, bool loadAttributes = false )
        {
