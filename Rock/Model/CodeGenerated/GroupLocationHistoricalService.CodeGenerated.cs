...
namespace Rock.Model
{
    ...
    public partial class GroupLocationHistoricalViewModelHelper : ViewModelHelper<GroupLocationHistorical, GroupLocationHistoricalBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override GroupLocationHistoricalBag CreateViewModel( GroupLocationHistorical model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class GroupLocationHistoricalExtensionMethods
    {
        ...
        public static GroupLocationHistoricalBag ToViewModel( this GroupLocationHistorical model, Person currentPerson = null, bool loadAttributes = false )
        {
