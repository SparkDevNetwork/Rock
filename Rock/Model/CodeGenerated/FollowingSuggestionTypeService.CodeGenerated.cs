...
namespace Rock.Model
{
    ...
    public partial class FollowingSuggestionTypeViewModelHelper : ViewModelHelper<FollowingSuggestionType, FollowingSuggestionTypeBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override FollowingSuggestionTypeBag CreateViewModel( FollowingSuggestionType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class FollowingSuggestionTypeExtensionMethods
    {
        ...
        public static FollowingSuggestionTypeBag ToViewModel( this FollowingSuggestionType model, Person currentPerson = null, bool loadAttributes = false )
        {
