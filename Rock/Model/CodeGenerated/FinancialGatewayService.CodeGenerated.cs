...
namespace Rock.Model
{
    ...
    [HasQueryableAttributes( typeof( FinancialGateway.FinancialGatewayQueryableAttributeValue ), nameof( FinancialGatewayAttributeValues ) )]
    public partial class FinancialGateway
    {
        /// <summary>
        ...
        /// </summary>
        public virtual ICollection<FinancialGatewayQueryableAttributeValue> FinancialGatewayAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class FinancialGatewayQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
    ...
    public static partial class FinancialGatewayExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this FinancialGateway object to a new FinancialGateway object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static FinancialGateway CloneWithoutIdentity( this FinancialGateway source )
        {
            var target = new FinancialGateway();
            target.CopyPropertiesFrom( source );
