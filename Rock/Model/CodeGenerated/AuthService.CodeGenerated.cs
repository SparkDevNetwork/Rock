...
namespace Rock.Model
{
    ...
    public partial class AuthViewModelHelper : ViewModelHelper<Auth, AuthBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override AuthBag CreateViewModel( Auth model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class AuthExtensionMethods
    {
        ...
        public static AuthBag ToViewModel( this Auth model, Person currentPerson = null, bool loadAttributes = false )
        {
