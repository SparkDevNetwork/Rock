...
namespace Rock.Model
{
    ...
    public partial class FollowingViewModelHelper : ViewModelHelper<Following, Rock.ViewModel.FollowingViewModel>
    {
        ...
        /// <returns></returns>
        public override Rock.ViewModel.FollowingViewModel CreateViewModel( Following model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.FollowingViewModel
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class FollowingExtensionMethods
    {
        ...
        public static Rock.ViewModel.FollowingViewModel ToViewModel( this Following model, Person currentPerson = null, bool loadAttributes = false )
        {
            var helper = new FollowingViewModelHelper();
