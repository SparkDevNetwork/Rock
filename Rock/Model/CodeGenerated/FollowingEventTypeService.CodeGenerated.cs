...
namespace Rock.Model
{
    ...
    public partial class FollowingEventTypeViewModelHelper : ViewModelHelper<FollowingEventType, Rock.ViewModel.FollowingEventTypeViewModel>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.FollowingEventTypeViewModel CreateViewModel( FollowingEventType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.FollowingEventTypeViewModel
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class FollowingEventTypeExtensionMethods
    {
        ...
        public static Rock.ViewModel.FollowingEventTypeViewModel ToViewModel( this FollowingEventType model, Person currentPerson = null, bool loadAttributes = false )
        {
