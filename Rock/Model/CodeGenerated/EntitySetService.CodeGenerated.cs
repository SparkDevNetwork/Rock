...
namespace Rock.Model
{
    ...
    public partial class EntitySetViewModelHelper : ViewModelHelper<EntitySet, EntitySetBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override EntitySetBag CreateViewModel( EntitySet model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class EntitySetExtensionMethods
    {
        ...
        public static EntitySetBag ToViewModel( this EntitySet model, Person currentPerson = null, bool loadAttributes = false )
        {
