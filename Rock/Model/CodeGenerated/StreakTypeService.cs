...
{
    /// <summary>
    /// StreakType Service class
    /// </summary>
    public partial class StreakTypeService : Service<StreakType>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreakTypeService"/> class
        /// </summary>
        /// <param name="context">The context.</param>
        public StreakTypeService(RockContext context) : base(context)
        {
        }
        ...
        /// </returns>
        public bool CanDelete( StreakType item, out string errorMessage )
        {
    ...
    {
        /// <summary>
        /// Clones this StreakType object to a new StreakType object
        /// </summary>
        /// <param name="source">The source.</param>
        /// <param name="deepCopy">if set to <c>true</c> a deep copy is made. If false, only the basic entity properties are copied.</param>
        /// <returns></returns>
        public static StreakType Clone( this StreakType source, bool deepCopy )
        {
            if (deepCopy)
            {
                return source.Clone() as StreakType;
            }
            else
            {
        ...
        /// <summary>
        /// Copies the properties from another StreakType object to this StreakType object
        /// </summary>
        /// <param name="target">The target.</param>
        /// <param name="source">The source.</param>
        public static void CopyPropertiesFrom( this StreakType target, StreakType source )
        {
            target.Id = source.Id;
