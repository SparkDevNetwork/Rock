...
namespace Rock.Model
{
    ...
    [HasQueryableAttributes( typeof( GroupRequirement.GroupRequirementQueryableAttributeValue ), nameof( GroupRequirementAttributeValues ) )]
    public partial class GroupRequirement
    {
        ...
        /// </summary>
        public virtual ICollection<GroupRequirementQueryableAttributeValue> GroupRequirementAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class GroupRequirementQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
    ...
    public static partial class GroupRequirementExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this GroupRequirement object to a new GroupRequirement object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static GroupRequirement CloneWithoutIdentity( this GroupRequirement source )
        {
            var target = new GroupRequirement();
            target.CopyPropertiesFrom( source );
