...
namespace Rock.Model
{
    ...
    public partial class RegistrationSessionViewModelHelper : ViewModelHelper<RegistrationSession, Rock.ViewModel.RegistrationSessionViewModel>
    {
        ...
        /// <returns></returns>
        public override Rock.ViewModel.RegistrationSessionViewModel CreateViewModel( RegistrationSession model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.RegistrationSessionViewModel
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class RegistrationSessionExtensionMethods
    {
        ...
        public static Rock.ViewModel.RegistrationSessionViewModel ToViewModel( this RegistrationSession model, Person currentPerson = null, bool loadAttributes = false )
        {
