...
namespace Rock.Model
{
    ...
    public partial class RegistrationTemplateFeeItemViewModelHelper : ViewModelHelper<RegistrationTemplateFeeItem, Rock.ViewModel.RegistrationTemplateFeeItemViewModel>
    {
        ...
        /// <returns></returns>
        public override Rock.ViewModel.RegistrationTemplateFeeItemViewModel CreateViewModel( RegistrationTemplateFeeItem model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.RegistrationTemplateFeeItemViewModel
            {
                Id = model.Id,
                Guid = model.Guid,
                Cost = model.Cost,
    ...
    public static partial class RegistrationTemplateFeeItemExtensionMethods
    {
        ...
        public static Rock.ViewModel.RegistrationTemplateFeeItemViewModel ToViewModel( this RegistrationTemplateFeeItem model, Person currentPerson = null, bool loadAttributes = false )
        {
