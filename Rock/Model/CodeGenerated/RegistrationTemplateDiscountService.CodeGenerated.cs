...
namespace Rock.Model
{
    ...
    public partial class RegistrationTemplateDiscountViewModelHelper : ViewModelHelper<RegistrationTemplateDiscount, RegistrationTemplateDiscountBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override RegistrationTemplateDiscountBag CreateViewModel( RegistrationTemplateDiscount model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class RegistrationTemplateDiscountExtensionMethods
    {
        ...
        public static RegistrationTemplateDiscountBag ToViewModel( this RegistrationTemplateDiscount model, Person currentPerson = null, bool loadAttributes = false )
        {
