...
namespace Rock.Model
{
    ...
    public partial class RegistrationSessionViewModelHelper : ViewModelHelper<RegistrationSession, RegistrationSessionBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override RegistrationSessionBag CreateViewModel( RegistrationSession model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new RegistrationSessionBag
            {
                ...
                PaymentGatewayReference = model.PaymentGatewayReference,
                ...
                SessionStatus = ( int ) model.SessionStatus,
    ...
    public static partial class RegistrationSessionExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this RegistrationSession object to a new RegistrationSession object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static RegistrationSession CloneWithoutIdentity( this RegistrationSession source )
        {
            var target = new RegistrationSession();
            target.CopyPropertiesFrom( source );
        ...
        public static RegistrationSessionBag ToViewModel( this RegistrationSession model, Person currentPerson = null, bool loadAttributes = false )
        {
            var helper = new RegistrationSessionViewModelHelper();
