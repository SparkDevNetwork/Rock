...
namespace Rock.Model
{
    ...
    /// </summary>
    public partial class WorkflowActionTypeViewModelHelper : ViewModelHelper<WorkflowActionType, Rock.ViewModel.WorkflowActionTypeViewModel>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.WorkflowActionTypeViewModel CreateViewModel( WorkflowActionType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.WorkflowActionTypeViewModel
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class WorkflowActionTypeExtensionMethods
    {
        ...
        public static Rock.ViewModel.WorkflowActionTypeViewModel ToViewModel( this WorkflowActionType model, Person currentPerson = null, bool loadAttributes = false )
        {
