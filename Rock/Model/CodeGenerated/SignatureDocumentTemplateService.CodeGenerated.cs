...
namespace Rock.Model
{
    ...
    [HasQueryableAttributes( typeof( SignatureDocumentTemplate.SignatureDocumentTemplateQueryableAttributeValue ), nameof( SignatureDocumentTemplateAttributeValues ) )]
    public partial class SignatureDocumentTemplate
    {
        ...
        /// </summary>
        public virtual ICollection<SignatureDocumentTemplateQueryableAttributeValue> SignatureDocumentTemplateAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class SignatureDocumentTemplateQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
