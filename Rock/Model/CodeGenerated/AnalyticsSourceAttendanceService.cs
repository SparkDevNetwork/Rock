...
namespace Rock.Model
{
    ...
    public static partial class AnalyticsSourceAttendanceExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this AnalyticsSourceAttendance object to a new AnalyticsSourceAttendance object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static AnalyticsSourceAttendance CloneWithoutIdentity( this AnalyticsSourceAttendance source )
        {
            var target = new AnalyticsSourceAttendance();
            target.CopyPropertiesFrom( source );
