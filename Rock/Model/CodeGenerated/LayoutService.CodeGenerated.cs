...
namespace Rock.Model
{
    ...
    public static partial class LayoutExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this Layout object to a new Layout object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static Layout CloneWithoutIdentity( this Layout source )
        {
            var target = new Layout();
            target.CopyPropertiesFrom( source );
