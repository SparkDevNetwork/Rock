...
namespace Rock.Model
{
    ...
    public partial class FieldTypeViewModelHelper : ViewModelHelper<FieldType, FieldTypeBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override FieldTypeBag CreateViewModel( FieldType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class FieldTypeExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this FieldType object to a new FieldType object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static FieldType CloneWithoutIdentity( this FieldType source )
        {
            var target = new FieldType();
            target.CopyPropertiesFrom( source );
        ...
        public static FieldTypeBag ToViewModel( this FieldType model, Person currentPerson = null, bool loadAttributes = false )
        {
