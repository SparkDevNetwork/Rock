...
namespace Rock.Model
{
    ...
    public partial class InteractionDeviceTypeViewModelHelper : ViewModelHelper<InteractionDeviceType, InteractionDeviceTypeBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override InteractionDeviceTypeBag CreateViewModel( InteractionDeviceType model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class InteractionDeviceTypeExtensionMethods
    {
        ...
        public static InteractionDeviceTypeBag ToViewModel( this InteractionDeviceType model, Person currentPerson = null, bool loadAttributes = false )
        {
