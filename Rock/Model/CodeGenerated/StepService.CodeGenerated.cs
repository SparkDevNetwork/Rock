...
namespace Rock.Model
{
    ...
    public partial class StepViewModelHelper : ViewModelHelper<Step, StepBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override StepBag CreateViewModel( Step model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class StepExtensionMethods
    {
        ...
        public static StepBag ToViewModel( this Step model, Person currentPerson = null, bool loadAttributes = false )
        {
