...
namespace Rock.Model
{
    ...
    [HasQueryableAttributes( typeof( RegistrationRegistrantFee.RegistrationRegistrantFeeQueryableAttributeValue ), nameof( RegistrationRegistrantFeeAttributeValues ) )]
    public partial class RegistrationRegistrantFee
    {
        ...
        /// </summary>
        public virtual ICollection<RegistrationRegistrantFeeQueryableAttributeValue> RegistrationRegistrantFeeAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class RegistrationRegistrantFeeQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
    ...
    public static partial class RegistrationRegistrantFeeExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this RegistrationRegistrantFee object to a new RegistrationRegistrantFee object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static RegistrationRegistrantFee CloneWithoutIdentity( this RegistrationRegistrantFee source )
        {
            var target = new RegistrationRegistrantFee();
            target.CopyPropertiesFrom( source );
