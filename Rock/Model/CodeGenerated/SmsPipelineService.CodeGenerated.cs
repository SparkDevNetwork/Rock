...
namespace Rock.Model
{
    ...
    /// </summary>
    [DefaultViewModelHelper( typeof( SmsPipeline ) )]
    public partial class SmsPipelineViewModelHelper : ViewModelHelper<SmsPipeline, SmsPipelineBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override SmsPipelineBag CreateViewModel( SmsPipeline model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class SmsPipelineExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this SmsPipeline object to a new SmsPipeline object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static SmsPipeline CloneWithoutIdentity( this SmsPipeline source )
        {
            var target = new SmsPipeline();
            target.CopyPropertiesFrom( source );
        ...
        public static SmsPipelineBag ToViewModel( this SmsPipeline model, Person currentPerson = null, bool loadAttributes = false )
        {
