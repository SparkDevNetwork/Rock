...
namespace Rock.Model
{
    ...
    public static partial class ScheduleCategoryExclusionExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this ScheduleCategoryExclusion object to a new ScheduleCategoryExclusion object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static ScheduleCategoryExclusion CloneWithoutIdentity( this ScheduleCategoryExclusion source )
        {
            var target = new ScheduleCategoryExclusion();
            target.CopyPropertiesFrom( source );
