...
namespace Rock.Model
{
    ...
    [HasQueryableAttributes( typeof( SignatureDocument.SignatureDocumentQueryableAttributeValue ), nameof( SignatureDocumentAttributeValues ) )]
    public partial class SignatureDocument
    {
        ...
        /// </summary>
        public virtual ICollection<SignatureDocumentQueryableAttributeValue> SignatureDocumentAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class SignatureDocumentQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
    ...
    public static partial class SignatureDocumentExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this SignatureDocument object to a new SignatureDocument object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static SignatureDocument CloneWithoutIdentity( this SignatureDocument source )
        {
            var target = new SignatureDocument();
            target.CopyPropertiesFrom( source );
        ...
        public static void CopyPropertiesFrom( this SignatureDocument target, SignatureDocument source )
        {
            ...
            target.CompletionEmailSentDateTime = source.CompletionEmailSentDateTime;
            ...
            target.SignedClientUserAgent = source.SignedClientUserAgent;
            target.SignedDateTime = source.SignedDateTime;
            target.SignedDocumentText = source.SignedDocumentText;
            target.SignedName = source.SignedName;
