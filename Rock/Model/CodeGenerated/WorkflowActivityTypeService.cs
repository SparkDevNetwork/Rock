...
namespace Rock.Model
{
    ...
    public partial class WorkflowActivityTypeService : Service<WorkflowActivityType>
    {
        ...
        public bool CanDelete( WorkflowActivityType item, out string errorMessage )
        {
            ...
            if ( new Service<WorkflowActivity>( Context ).Queryable().Any( a => a.ActivityTypeId == item.Id ) )
            {
    ...
    public static partial class WorkflowActivityTypeExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this WorkflowActivityType object to a new WorkflowActivityType object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static WorkflowActivityType CloneWithoutIdentity( this WorkflowActivityType source )
        {
            var target = new WorkflowActivityType();
            target.CopyPropertiesFrom( source );
