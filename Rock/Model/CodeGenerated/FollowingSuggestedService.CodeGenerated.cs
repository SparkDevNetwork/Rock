...
namespace Rock.Model
{
    ...
    public partial class FollowingSuggestedViewModelHelper : ViewModelHelper<FollowingSuggested, FollowingSuggestedBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override FollowingSuggestedBag CreateViewModel( FollowingSuggested model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new FollowingSuggestedBag
            {
                ...
                StatusChangedDateTime = model.StatusChangedDateTime,
                SuggestionTypeId = model.SuggestionTypeId,
    ...
    public static partial class FollowingSuggestedExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this FollowingSuggested object to a new FollowingSuggested object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static FollowingSuggested CloneWithoutIdentity( this FollowingSuggested source )
        {
            var target = new FollowingSuggested();
            target.CopyPropertiesFrom( source );
        ...
        public static FollowingSuggestedBag ToViewModel( this FollowingSuggested model, Person currentPerson = null, bool loadAttributes = false )
        {
