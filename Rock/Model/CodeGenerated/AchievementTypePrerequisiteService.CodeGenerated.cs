...
namespace Rock.Model
{
    ...
    public partial class AchievementTypePrerequisiteViewModelHelper : ViewModelHelper<AchievementTypePrerequisite, AchievementTypePrerequisiteBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override AchievementTypePrerequisiteBag CreateViewModel( AchievementTypePrerequisite model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class AchievementTypePrerequisiteExtensionMethods
    {
        ...
        public static AchievementTypePrerequisiteBag ToViewModel( this AchievementTypePrerequisite model, Person currentPerson = null, bool loadAttributes = false )
        {
