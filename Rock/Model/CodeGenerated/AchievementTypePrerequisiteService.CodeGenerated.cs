...
namespace Rock.Model
{
    ...
    /// <summary>
    /// AchievementTypePrerequisite View Model Helper
    /// </summary>
    [DefaultViewModelHelper( typeof( AchievementTypePrerequisite ) )]
    public partial class AchievementTypePrerequisiteViewModelHelper : ViewModelHelper<AchievementTypePrerequisite, Rock.ViewModel.AchievementTypePrerequisiteViewModel>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.AchievementTypePrerequisiteViewModel CreateViewModel( AchievementTypePrerequisite model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.AchievementTypePrerequisiteViewModel
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class AchievementTypePrerequisiteExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this AchievementTypePrerequisite object to a new AchievementTypePrerequisite object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static AchievementTypePrerequisite CloneWithoutIdentity( this AchievementTypePrerequisite source )
        {
            var target = new AchievementTypePrerequisite();
            target.CopyPropertiesFrom( source );
        ...
        public static void CopyPropertiesFrom( this AchievementTypePrerequisite target, AchievementTypePrerequisite source )
        {
            ...
            target.PrerequisiteAchievementTypeId = source.PrerequisiteAchievementTypeId;
        ...
        public static Rock.ViewModel.AchievementTypePrerequisiteViewModel ToViewModel( this AchievementTypePrerequisite model, Person currentPerson = null, bool loadAttributes = false )
        {
            var helper = new AchievementTypePrerequisiteViewModelHelper();
