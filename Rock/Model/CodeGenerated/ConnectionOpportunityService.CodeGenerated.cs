...
namespace Rock.Model
{
    ...
    [HasQueryableAttributes( typeof( ConnectionOpportunity.ConnectionOpportunityQueryableAttributeValue ), nameof( ConnectionOpportunityAttributeValues ) )]
    public partial class ConnectionOpportunity
    {
        ...
        /// </summary>
        public virtual ICollection<ConnectionOpportunityQueryableAttributeValue> ConnectionOpportunityAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class ConnectionOpportunityQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
