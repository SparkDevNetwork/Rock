...
namespace Rock.Model
{
    ...
    /// <summary>
    /// RestAction View Model Helper
    /// </summary>
    public partial class RestActionViewModelHelper : ViewModelHelper<RestAction, Rock.ViewModel.RestActionViewModel>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.RestActionViewModel CreateViewModel( RestAction model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.RestActionViewModel
            {
                Id = model.Id,
                Guid = model.Guid,
                ApiId = model.ApiId,
    ...
    public static partial class RestActionExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this RestAction object to a new RestAction object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static RestAction CloneWithoutIdentity( this RestAction source )
        {
            var target = new RestAction();
            target.CopyPropertiesFrom( source );
        ...
        public static Rock.ViewModel.RestActionViewModel ToViewModel( this RestAction model, Person currentPerson = null, bool loadAttributes = false )
        {
            var helper = new RestActionViewModelHelper();
