...
namespace Rock.Model
{
    ...
    public partial class WebFarmNodeMetricViewModelHelper : ViewModelHelper<WebFarmNodeMetric, WebFarmNodeMetricBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override WebFarmNodeMetricBag CreateViewModel( WebFarmNodeMetric model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class WebFarmNodeMetricExtensionMethods
    {
        ...
        public static WebFarmNodeMetricBag ToViewModel( this WebFarmNodeMetric model, Person currentPerson = null, bool loadAttributes = false )
        {
