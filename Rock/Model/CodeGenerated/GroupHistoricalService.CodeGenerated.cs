...
namespace Rock.Model
{
    ...
    [HasQueryableAttributes( typeof( GroupHistorical.GroupHistoricalQueryableAttributeValue ), nameof( GroupHistoricalAttributeValues ) )]
    public partial class GroupHistorical
    {
        ...
        /// </summary>
        public virtual ICollection<GroupHistoricalQueryableAttributeValue> GroupHistoricalAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class GroupHistoricalQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
    ...
    public static partial class GroupHistoricalExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this GroupHistorical object to a new GroupHistorical object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static GroupHistorical CloneWithoutIdentity( this GroupHistorical source )
        {
            var target = new GroupHistorical();
            target.CopyPropertiesFrom( source );
