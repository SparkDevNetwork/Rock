...
namespace Rock.Model
{
    ...
    public partial class CategoryService : Service<Category>
    {
        ...
        public bool CanDelete( Category item, out string errorMessage )
        {
            ...
            if ( new Service<CommunicationFlow>( Context ).Queryable().Any( a => a.CategoryId == item.Id ) )
            {
                errorMessage = string.Format( "This {0} is assigned to a {1}.", Category.FriendlyTypeName, CommunicationFlow.FriendlyTypeName );
                return false;
            }
    ...
    [HasQueryableAttributes( typeof( Category.CategoryQueryableAttributeValue ), nameof( CategoryAttributeValues ) )]
    public partial class Category
    {
        ...
        /// </summary>
        public virtual ICollection<CategoryQueryableAttributeValue> CategoryAttributeValues { get; set; } 

        /// <inheritdoc/>
        public class CategoryQueryableAttributeValue : QueryableAttributeValue
        {
        }
    }
