...
namespace Rock.Model
{
    ...
    public static partial class AnalyticsDimFamilyHeadOfHouseholdExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this AnalyticsDimFamilyHeadOfHousehold object to a new AnalyticsDimFamilyHeadOfHousehold object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static AnalyticsDimFamilyHeadOfHousehold CloneWithoutIdentity( this AnalyticsDimFamilyHeadOfHousehold source )
        {
            var target = new AnalyticsDimFamilyHeadOfHousehold();
            target.CopyPropertiesFrom( source );
