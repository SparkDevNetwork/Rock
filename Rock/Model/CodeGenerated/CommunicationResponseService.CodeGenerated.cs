...
namespace Rock.Model
{
    ...
    public partial class CommunicationResponseViewModelHelper : ViewModelHelper<CommunicationResponse, CommunicationResponseBag>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override CommunicationResponseBag CreateViewModel( CommunicationResponse model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
    ...
    public static partial class CommunicationResponseExtensionMethods
    {
        ...
        public static CommunicationResponseBag ToViewModel( this CommunicationResponse model, Person currentPerson = null, bool loadAttributes = false )
        {
