...
namespace Rock.Model
{
    ...
    public static partial class NoteAttachmentExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this NoteAttachment object to a new NoteAttachment object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static NoteAttachment CloneWithoutIdentity( this NoteAttachment source )
        {
            var target = new NoteAttachment();
            target.CopyPropertiesFrom( source );
