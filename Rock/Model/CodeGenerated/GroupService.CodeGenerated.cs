...
namespace Rock.Model
{
    ...
    public static partial class GroupExtensionMethods
    {
        ...
        public static void CopyPropertiesFrom( this Group target, Group source )
        {
            ...
            target.CanViewMembersOverride = source.CanViewMembersOverride;
            target.ChatChannelFirstEnabledDateTime = source.ChatChannelFirstEnabledDateTime;
            target.IsChatChannelAlwaysShownOverride = source.IsChatChannelAlwaysShownOverride;
            target.IsChatSearchIndexedOverride = source.IsChatSearchIndexedOverride;
