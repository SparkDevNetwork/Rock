...
namespace Rock.Model
{
    ...
    /// <summary>
    /// NoteWatch View Model Helper
    /// </summary>
    [DefaultViewModelHelper( typeof( NoteWatch ) )]
    public partial class NoteWatchViewModelHelper : ViewModelHelper<NoteWatch, Rock.ViewModel.NoteWatchViewModel>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override Rock.ViewModel.NoteWatchViewModel CreateViewModel( NoteWatch model, Person currentPerson = null, bool loadAttributes = true )
        {
            if ( model == null )
            {
                return default;
            ...
            var viewModel = new Rock.ViewModel.NoteWatchViewModel
            {
                Id = model.Id,
                Guid = model.Guid,
    ...
    public static partial class NoteWatchExtensionMethods
    {
        ...
        public static Rock.ViewModel.NoteWatchViewModel ToViewModel( this NoteWatch model, Person currentPerson = null, bool loadAttributes = false )
        {
            var helper = new NoteWatchViewModelHelper();
