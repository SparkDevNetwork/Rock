...
namespace Rock.Model
{
    ...
    {
        /// <summary>
        /// Gets the grade as a percentage for the student <see cref="LearningClassActivityCompletion">Activity</see>.
        /// If no points are configured or <see cref="LearningClassActivity" /> is null then 100 is returned.
        /// </summary>
        [NotMapped]
        public decimal? GradePercent
        {
            get
            {
                ...
                if ( LearningClassActivity == null || LearningClassActivity.Points <= 0 )
                {
                    return 100;
                }

                return Math.Round( PointsEarned.Value * 100.0m / LearningClassActivity.Points, 3 );
            }
        }
        ...
        /// <summary>
        /// Gets the <see cref="LearningGradingSystemScale"/> for the student <see cref="LearningClassActivityCompletion">Activity</see>.
        /// </summary>
        /// <param name="scales">
        ///     The list of <see cref="LearningGradingSystemScale">Scales</see> for the Activity.
        ///     Assumes the scales are ordered by ThresholdPercentage descending so the first match can be taken.
        ...
        /// </summary>
        [NotAudited]
        public bool HadExtension => LearningClassActivity?.DueDateCalculated != null && DueDate.HasValue && DueDate.Value.Date != LearningClassActivity.DueDateCalculated.Value.Date;
        ...
        public bool IsLate
        {
            get
            {
                ...
                if ( LearningClassActivity.AssignTo != AssignTo.Student || !DueDate.HasValue )
                {
                    return false;
                }
        ...
        public bool RequiresFacilitatorCompletion
        {
            get
            {
                return LearningClassActivity.Points > 0
                    && LearningClassActivity.AssignTo == AssignTo.Facilitator
        ...
        public override Security.ISecured ParentAuthority
        {
            get
            {
                if ( this.LearningClassActivity?.Id > 0 )
                {
                    return this.LearningClassActivity;
                }
                else
                {
