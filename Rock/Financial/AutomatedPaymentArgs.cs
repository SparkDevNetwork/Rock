...
namespace Rock.Financial
{
    ...
    public class AutomatedPaymentArgs
    {
        ...
        /// <summary>
        /// Intended to prevent duplicate charges where the gateway supports its use. Rock does not check these keys, but
        /// only passes them through to a supporting gateway. If omitted, a key will be generated by Rock that combines these
        /// arguments and a timestamp and then produces a SHA256 hash.
        /// </summary>
        ...
        {
            /// <summary>
            /// Gets or sets the AccountId of the <see cref="Rock.Model.FinancialAccount"/>/account that the transaction detail <see cref="Amount"/> should be directed toward.
            /// </summary>
            /// <value>
