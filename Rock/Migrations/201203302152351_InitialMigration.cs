    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        AllowOrDeny = c.String(),
                        UserOrRole = c.String(),
                        Action = c.String(maxLength: 50),
                        UserOrRoleName = c.String(maxLength: 100),
                ...
                c => new
                    {
                        ...
                        PersonId = c.Int(),
                        PersonName = c.String(maxLength: 250),
            ...
            CreateTable(
                ...
                .ForeignKey("groupsGroupRole", t => t.GroupRoleId, cascadeDelete: true)
                .Index(t => t.PersonId)
                .Index(t => t.CreatedByPersonId)
                .Index(t => t.ModifiedByPersonId)
                .Index(t => t.GroupId)
            ...
            CreateTable(
                ...
                .ForeignKey("groupsGroupType", t => t.GroupTypeId, cascadeDelete: true)
                .Index(t => t.CreatedByPersonId)
                .Index(t => t.ModifiedByPersonId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("coreDefinedType", t => t.DefinedTypeId, cascadeDelete: true)
                .ForeignKey("crmPerson", t => t.CreatedByPersonId)
                .ForeignKey("crmPerson", t => t.ModifiedByPersonId)
                ...
                c => new
                    {
                        ...
                        Name = c.String(maxLength: 100),
                        Description = c.String(),
                        Assembly = c.String(maxLength: 100),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("coreFieldType", t => t.FieldTypeId, cascadeDelete: true)
                .ForeignKey("crmPerson", t => t.CreatedByPersonId)
                .ForeignKey("crmPerson", t => t.ModifiedByPersonId)
                .Index(t => t.FieldTypeId)
                .Index(t => t.CreatedByPersonId)
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false, maxLength: 100),
                        DefaultBackgroundColor = c.String(maxLength: 20),
                        DefaultForegroundColor = c.String(maxLength: 20),
                        Title = c.String(maxLength: 100),
                        System = c.Boolean(nullable: false),
                        ParentPageId = c.Int(),
                        SiteId = c.Int(),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("cmsSite", t => t.SiteId, cascadeDelete: true)
                .ForeignKey("crmPerson", t => t.CreatedByPersonId)
                .ForeignKey("crmPerson", t => t.ModifiedByPersonId)
                .Index(t => t.SiteId)
                .Index(t => t.CreatedByPersonId)
                ...
                c => new
                    {
                        ...
                        ChangeType = c.String(maxLength: 10),
                        EntityType = c.String(maxLength: 100),
                        EntityId = c.Int(nullable: false),
                        Property = c.String(maxLength: 100),
                ...
                c => new
                    {
                        ...
                        Class = c.String(maxLength: 100),
                        CronExpression = c.String(maxLength: 120),
            ...
            CreateTable(
                ...
                .ForeignKey("cmsBlogCategory", t => t.BlogPostId, cascadeDelete: true)
                .ForeignKey("cmsBlogPost", t => t.BlogCategoryId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.BlogTagId, t.BlogPostId })
                .ForeignKey("cmsBlogPost", t => t.BlogTagId, cascadeDelete: true)
                .ForeignKey("cmsBlogTag", t => t.BlogPostId, cascadeDelete: true)
                .Index(t => t.BlogTagId)
                .Index(t => t.BlogPostId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("cmsBlogPostTag", "BlogPostId", "cmsBlogTag");
            DropForeignKey("cmsBlogPostTag", "BlogTagId", "cmsBlogPost");
            DropForeignKey("cmsBlogPostCategory", "BlogCategoryId", "cmsBlogPost");
            DropForeignKey("cmsBlogPostCategory", "BlogPostId", "cmsBlogCategory");
