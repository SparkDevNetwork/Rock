...
namespace Rock.Migrations
{
    ...
    public partial class FinancialBatchNewFields : RockMigration
    {
        ...
        public override void Up()
        {
            ...
            AddForeignKey( "dbo.FinancialBatch", "BatchTypeValueId", "dbo.DefinedValue", "Id", cascadeDelete: true );
        ...
        public override void Down()
        {
            ...
            DropForeignKey( "dbo.FinancialBatch", "BatchTypeValueId", "dbo.DefinedValue" );
