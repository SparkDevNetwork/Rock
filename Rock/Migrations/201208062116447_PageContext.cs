...
#pragma warning disable 1591
    public partial class PageContext : DbMigration
    {
        public override void Up()
        {
            ...
            AddForeignKey( "dbo.cmsPageRoute", "PageId", "cmsPage", "Id", cascadeDelete: true );
            AddForeignKey( "dbo.cmsSiteDomain", "SiteId", "cmsSite", "Id", cascadeDelete: true );
...
" );
            ...
            DropForeignKey( "dbo.cmsPageContext", "PageId", "cmsPage" );
            DropForeignKey( "dbo.cmsPageRoute", "PageId", "cmsPage" );
            DropTable( "dbo.cmsPageContext" );
            CreateIndex( "cmsSiteDomain", "SiteId" );
            CreateIndex( "cmsPageRoute", "PageId" );
            AddForeignKey( "dbo.cmsSiteDomain", "SiteId", "cmsSite", "Id" );
            AddForeignKey( "dbo.cmsPageRoute", "PageId", "cmsPage", "Id" );
        }
    }
}
