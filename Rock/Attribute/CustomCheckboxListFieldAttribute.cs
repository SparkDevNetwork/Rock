...
namespace Rock.Attribute
{
    ...
    public class CustomCheckboxListFieldAttribute : FieldAttribute
    {
        ...
        public CustomCheckboxListFieldAttribute( string name, string description, string values, bool required = false, string defaultValue = "", string category = "", int order = 0, string key = null )
