...
namespace Rock.Attribute
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegerRangeFieldAttribute"/> class.
        /// </summary>
        ...
        public IntegerRangeFieldAttribute( string name, string description = "", bool required = true, string defaultValue = ",", string category = "", int order = 0, string key = null )
            : base( SystemGuid.FieldType.INTEGER_RANGE.AsGuid(), name, description, required, defaultValue, category, order, key )
        {
        }
        ...
        /// </summary>
        /// <param name="name">The name.</param>
        public IntegerRangeFieldAttribute( string name )
            : base( SystemGuid.FieldType.INTEGER_RANGE.AsGuid(), name )
        {
        }
    }
}
