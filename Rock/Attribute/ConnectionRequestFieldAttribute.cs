...
{
    /// <summary>
    /// Field Attribute to select a single (or null) ConnectionRequest
    /// Stored as ConnectionRequest.Guid
    /// </summary>
    public class ConnectionRequestFieldAttribute : FieldAttribute
    {
        /// <summary>
        ...
        /// <param name="defaultConnectionRequestGuid">The default connection request unique identifier.</param>
