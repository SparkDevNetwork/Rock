...
namespace Rock.Attribute
{
    ...
    public class CustomDropdownListFieldAttribute : FieldAttribute
    {
        ...
        public CustomDropdownListFieldAttribute( string name, string description, string values, bool required = false, string defaultValue = "", string category = "", int order = 0, string key = null )
