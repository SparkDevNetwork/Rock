...
namespace Rock.Attribute
{
    ...
    public class ComparisonFieldAttribute : FieldAttribute
    {
        ...
        public ComparisonFieldAttribute( string name, string description = "", bool required = true, string defaultValue = "", string category = "", int order = 0, string key = null )
            : base( SystemGuid.FieldType.COMPARISON.AsGuid(), name, description, required, defaultValue, category, order, key )
        {
        }
        ...
        /// </summary>
        /// <param name="name">The name.</param>
        public ComparisonFieldAttribute( string name )
            : base( SystemGuid.FieldType.COMPARISON.AsGuid(), name )
        {
        }
    }
}
