...
namespace Rock.Attribute
{
    ...
    public class TimeFieldAttribute : FieldAttribute
    {
        ...
        public TimeFieldAttribute( string name, string description = "", bool required = true, string defaultValue = "", string category = "",
            ...
            : base( SystemGuid.FieldType.TIME.AsGuid(), name, description, required, defaultValue, category, order, key )
        {
        }
        ...
        /// </summary>
        /// <param name="name">The name.</param>
        public TimeFieldAttribute( string name )
            : base( SystemGuid.FieldType.TIME.AsGuid(), name )
        {
        }
    }
}
