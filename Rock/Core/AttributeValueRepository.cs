...
namespace Rock.Core
{
	...
	/// </summary>
    public partial class AttributeValueRepository : Repository<Rock.Core.AttributeValue>
    {
		/// <summary>
        ...
        {
            return Find( t => t.AttributeId == attributeId && ( t.EntityId == entityId || ( entityId == null && t.EntityId == null ) ) );
        }
        ...
        {
            return Find( t => ( t.EntityId == entityId || ( entityId == null && t.EntityId == null ) ) );
        }
