...
namespace Rock.Core.Automation.Triggers
{
    ...
    internal class ChatMessage : AutomationTriggerComponent
    {
        ...
        internal static class AutomationRequestValueKey
        {
            ...
            public const string SenderPerson = "SenderPerson";
            public const string Message = "Message";
            public const string SentRockDateTime = "SentRockDateTime";
            public const string EventChannelMembers = "EventChannelMembers";
        }
        ...
        public override IEnumerable<AutomationValueDefinition> GetValueTypes( Dictionary<string, string> configuration, RockContext rockContext )
        {
            return new List<AutomationValueDefinition>
            {
                new AutomationValueDefinition
                {
                    ...
                    Description = "The channel type of the channel where the chat message was sent.",
                    Type = typeof( GroupType )
                },
                new AutomationValueDefinition
                {
                    Key = AutomationRequestValueKey.Channel,
                    Description = "The channel where the chat message was sent.",
                    Type = typeof( Group )
                },
                new AutomationValueDefinition
                {
                    Key = AutomationRequestValueKey.SenderPerson,
                    Description = "The person who sent the chat message.",
                    Type = typeof( Person )
                },
                new AutomationValueDefinition
                {
                ...
                new AutomationValueDefinition
                {
                    Key = AutomationRequestValueKey.SentRockDateTime,
                    Description = "The Rock date and time the chat message was sent.",
