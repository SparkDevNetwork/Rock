...
namespace Rock.Core
{
	...
	/// </summary>
    public partial class AttributeRepository : Repository<Rock.Core.Attribute>
    {
		/// <summary>
        ...
        {
            return Find( t => ( t.Entity == entity || ( entity == null && t.Entity == null ) ) ).OrderBy( t => t.Order );
        }
        ...
        {
            return FirstOrDefault( t => ( t.Entity == entity || ( entity == null && t.Entity == null ) ) && ( t.EntityQualifierColumn == entityQualifierColumn || ( entityQualifierColumn == null && t.EntityQualifierColumn == null ) ) && ( t.EntityQualifierValue == entityQualifierValue || ( entityQualifierValue == null && t.EntityQualifierValue == null ) ) && t.Key == key );
        }
        ...
        {
            return Find( t => t.FieldTypeId == fieldTypeId ).OrderBy( t => t.Order );
        }
