...
namespace Rock.Reporting.DataFilter.Person
{
    ...
    public class InteractionDataViewFilter : DataFilterComponent
    {
        #region Settings
...
function() {
  ...
  var Interaction = $('.rock-drop-down-list,select:last', $content).find(':selected').text();
  var result = 'Interaction';
  if (Interaction) {
     result = result + ' type ""' + Interaction + "";
  }  
...
";
        ...
        public override string FormatSelection( Type entityType, string selection )
        {
            ...
            string result = "Connected to Interaction";
        ...
        public override Control[] CreateChildControls( Type entityType, FilterField filterControl )
        {
            ...
            int entityTypeId = EntityTypeCache.Get( typeof( Model.Interaction ) ).Id;
