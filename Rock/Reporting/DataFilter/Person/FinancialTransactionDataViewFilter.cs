...
namespace Rock.Reporting.DataFilter.Person
{
    ...
    public class FinancialTransactionDataViewFilter : DataFilterComponent
    {
        ...
        {
            return "Financial Transaction Data View";
        }
...
function() {
  ...
  var FinancialTransaction = $('.rock-drop-down-list,select:last', $content).find(':selected').text();
  var result = 'FinancialTransaction';
  if (FinancialTransaction) {
     result = result + ' type ""' + FinancialTransaction + "";
  }  
...
";
        ...
        public override string FormatSelection( Type entityType, string selection )
        {
            ...
            string result = "Connected to Financial Transaction";
        ...
        public override Control[] CreateChildControls( Type entityType, FilterField filterControl )
        {
            ...
            int entityTypeId = EntityTypeCache.Get( typeof( Model.FinancialTransaction ) ).Id;
