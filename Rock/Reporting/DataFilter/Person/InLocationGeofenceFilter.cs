...
";
        ...
        public override void SetSelection( Type entityType, Control[] controls, string selection )
        {
            ...
            if ( location != null )
            {
                ...
                {
                    locationPicker.CurrentPickerMode = LocationPickerMode.Named;
                }
                else if ( location.GeoFence != null )
                {
                    locationPicker.CurrentPickerMode = LocationPickerMode.Polygon;
                }
        ...
        public override Expression GetExpression( Type entityType, IService serviceInstance, ParameterExpression parameterExpression, string selection )
        {
            ...
            var geoQry = new GroupLocationService( rockContext )
                ...
                .Where( gl => gl.Group.GroupType.Guid == familyGroupTypeGuid )
