...
{
    /// <summary>
    ///     A Data Filter to select Person by their Attendace from a Attendace View..
    /// </summary>
    [Description( "Select Person by their Attendace from a Attendace View." )]
    [Export( typeof( DataFilterComponent ) )]
    [ExportMetadata( "ComponentName", "Attendance Data View" )]
    public class AttendanceDataViewFilter : DataFilterComponent
    {
        #region Settings
...
function() {
  ...
  var Attendance = $('.rock-drop-down-list,select:last', $content).find(':selected').text();
  var result = 'Attendance';
  if (Attendance) {
     result = result + ' type ""' + Attendance + "";
  }  
...
";
        ...
        public override string FormatSelection( Type entityType, string selection )
        {
            ...
            string result = "Connected to Attendance";
        ...
        public override Control[] CreateChildControls( Type entityType, FilterField filterControl )
        {
            ...
            int entityTypeId = EntityTypeCache.Get( typeof( Model.Attendance ) ).Id;
