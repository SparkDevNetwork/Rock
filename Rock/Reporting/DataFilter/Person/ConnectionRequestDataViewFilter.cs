...
{
    /// <summary>
    ///     A Data Filter to select a person by their Connection Requests from a Connection Request View.
    /// </summary>
    ...
    public class FinancialPledgeDataViewFilter : DataFilterComponent
    {
        ...
        {
            return "Connection Request Data View";
        }
...
function() {
  ...
  var ConnectionRequest = $('.rock-drop-down-list,select:last', $content).find(':selected').text();
  var result = 'ConnectionRequest';
  if (ConnectionRequest) {
     result = result + ' type ""' + ConnectionRequest + "";
  }  
...
";
        ...
        public override string FormatSelection( Type entityType, string selection )
        {
            ...
            string result = "Connected to Connection Request";
        ...
        public override Control[] CreateChildControls( Type entityType, FilterField filterControl )
        {
            ...
            int entityTypeId = EntityTypeCache.Read( typeof( Model.FinancialPledge ) ).Id;
