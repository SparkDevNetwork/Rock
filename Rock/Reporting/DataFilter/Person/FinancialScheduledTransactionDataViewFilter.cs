...
namespace Rock.Reporting.DataFilter.Person
{
    ...
    public class FinancialScheduledTransactionDataViewFilter : DataFilterComponent
    {
        #region Settings
        ...
        {
            return "Financial Scheduled Transaction Data View";
        }
...
function() {
  ...
  var FinancialScheduledTransaction = $('.rock-drop-down-list,select:last', $content).find(':selected').text();
  var result = 'FinancialScheduledTransaction';
  if (FinancialScheduledTransaction) {
     result = result + ' type ""' + FinancialScheduledTransaction + "";
  }  
...
";
        ...
        public override string FormatSelection(Type entityType, string selection)
        {
            ...
            string result = "Connected to Financial Scheduled Transaction";
        ...
        public override Control[] CreateChildControls(Type entityType, FilterField filterControl)
        {
            ...
            int entityTypeId = EntityTypeCache.Get(typeof(Model.FinancialScheduledTransaction)).Id;
