...
namespace Rock.Reporting.DataFilter.ConnectionRequest
{
    ...
    public class PlacementGroupTypeFilter : DataFilterComponent
    {
        ...
        public override DynamicComponentDefinitionBag GetComponentDefinition( Type entityType, string selection, RockContext rockContext, RockRequestContext requestContext )
        {
            ...
            {
                Url = requestContext.ResolveRockUrl( "~/Obsidian/Reporting/DataFilters/ConnectionRequest/placementGroupTypeFilter.obs" )
            };
        }
        ...
        public override Dictionary<string, string> GetObsidianComponentData( Type entityType, string selection, RockContext rockContext, RockRequestContext requestContext )
        {
            ...
            var groupType = new GroupTypeService( RockApp.Current.CreateRockContext() ).Get( selectionConfig.PlacementGroupTypeGuid.Value );
