...
namespace Rock.Reporting.DataFilter.BenevolenceRequest
{
    ...
    public class BenevolenceResultDataViewFilter : DataFilterComponent
    {
        #region Settings
        ...
        {
            get { return typeof( Model.BenevolenceRequest ).FullName; }
        }
        ...
        {
            return "Benevolence Result Data View";
        }
...
function() {
  ...
  var BenevolenceResult = $('.rock-drop-down-list,select:last', $content).find(':selected').text();
  var result = 'BenevolenceResult';
  if (BenevolenceResult) {
     result = result + ' type ""' + BenevolenceResult + "";
  }  
...
";
        ...
        public override string FormatSelection( Type entityType, string selection )
        {
            ...
            string result = "Connected to Benevolence Result";
            ...
            using ( var context = new RockContext() )
            {
                ...
                result = string.Format( "Benevolence Request in Data View \"{0}\"", ( dataView != null ? dataView.ToString() : string.Empty ) );
            }
