...
namespace Rock.Reporting.DataFilter.Step
{
    /// <summary>
    /// Filter Step records on the attribute values of a Step they have participated in.
    /// </summary>
    ...
    public class StepsAttributeValuesFilter : EntityFieldFilter
    {
        ...
        {
            get { return typeof( Rock.Model.Step ).FullName; }
        }
        ...
        /// <inheritdoc/>
        public override string ObsidianFileUrl => "~/Obsidian/Reporting/DataFilters/Steps/stepsAttributeValuesFilter.obs";
        ...
        {
            return "StepPropertySelection( $content )";
        }
        ...
        public override Expression GetExpression( Type entityType, IService serviceInstance, ParameterExpression parameterExpression, string selection )
        {
            ...
            return GetAttributeExpression( serviceInstance, parameterExpression, entityField, attributeFilterValues );
        }
