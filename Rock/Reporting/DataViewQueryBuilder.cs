...
namespace Rock.Reporting
{
    ...
    internal class DataViewQueryBuilder
    {
        ...
        /// <returns></returns>
#if REVIEW_NET5_0_OR_GREATER
        private Microsoft.EntityFrameworkCore.DbContext GetDbContextForDataView( IDataViewDefinition dataView )
#else
        ...
        /// <returns></returns>
#if REVIEW_NET5_0_OR_GREATER
        private IService GetServiceForEntityType( int? entityTypeId, Microsoft.EntityFrameworkCore.DbContext dbContext )
#else
