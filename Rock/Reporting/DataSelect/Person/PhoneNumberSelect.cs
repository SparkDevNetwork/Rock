...
namespace Rock.Reporting.DataSelect.Person
{
    ...
    public class PhoneNumberSelect : DataSelectComponent<Rock.Model.Person>
    {
        ...
        public override string GetSelection( System.Web.UI.Control[] controls )
        {
            if ( controls.Count() == 1 )
            {
                RockDropDownList phoneNumberTypeList = controls[0] as RockDropDownList;
                if ( phoneNumberTypeList != null )
                {
                    return phoneNumberTypeList.SelectedValueAsId().ToString();
                }
            }
        ...
        public override void SetSelection( System.Web.UI.Control[] controls, string selection )
        {
            if ( controls.Count() == 1 )
            {
                ...
                if ( phoneNumberTypeList != null )
                {
                    phoneNumberTypeList.SetValue( selection );
                }
            }
        }
