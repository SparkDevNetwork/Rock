...
namespace Rock.Workflow.Action.CheckIn
{
    ...
    [AttributeField( "Person Special Needs Attribute",
        Description = "Select the attribute used to filter special needs people.",
        IsRequired = true,
        AllowMultiple = false,
        EntityTypeGuid = Rock.SystemGuid.EntityType.PERSON,
        DefaultValue = "8B562561-2F59-4F5F-B7DC-92B2BB7BB7CF",
        Order = 1 )]
    [AttributeField( "Group Special Needs Attribute",
        Description = "Select the attribute used to filter special needs groups.",
        IsRequired = true,
        AllowMultiple = false,
        EntityTypeGuid = Rock.SystemGuid.EntityType.GROUP,
        DefaultValue = "9210EC95-7B85-4D11-A82E-0B677B32704E",
        Order = 2 )]
    [BooleanField( "Remove (or exclude) Special Needs Groups",
        Description = "If set to true, special-needs groups will be removed if the person is NOT special needs. This basically prevents non-special-needs kids from getting put into special needs classes.  Default true.",
        DefaultBooleanValue = true,
        Key = "RemoveSpecialNeedsGroups",
        Order = 3 )]
    [BooleanField( "Remove (or exclude) Non-Special Needs Groups",
        Description = "If set to true, non-special-needs groups will be removed if the person is special needs.  This basically prevents special needs kids from getting put into regular classes.  Default false.",
        DefaultBooleanValue = false,
        Key = "RemoveNonSpecialNeedsGroups",
        Order = 4 )]
    [BooleanField( "Remove",
        Description = "Select 'Yes' if groups should be removed.  Select 'No' if they should just be marked as excluded.",
        DefaultBooleanValue = true,
        Order = 5 )]
    [Rock.SystemGuid.EntityTypeGuid( "F940F6E5-6784-4925-8DF6-E59A911FDCBE")]
