...
namespace Rock.Workflow.Action
{
    ...
    [WorkflowAttribute( "New Workflow Attribute", "The attribute to hold the new activated workflow. ", false, "", "", 1, null, new string[] { "Rock.Field.Types.WorkflowFieldType" } )]
    public class ActivateWorkflow : ActionComponent
    {
        ...
        public override bool Execute( RockContext rockContext, WorkflowAction action, Object entity, out List<string> errorMessages )
        {
            ...
            var newWorkFlowAttr = SetWorkflowAttributeValue( action, "NewWorkflowAttribute", workflow.Guid );
