...
namespace Rock.Workflow.Action
{
    ...
    /// </summary>
    [Description( "Sets a person attribute to be a random person from a group with optional filter on a campus group member attribute. For example this could return a random person from the group with a group member attribute of 'Surprise'." )]
