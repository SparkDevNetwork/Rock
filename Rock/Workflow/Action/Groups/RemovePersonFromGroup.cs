...
namespace Rock.Workflow.Action
{
    ...
    [Rock.Attribute.GroupAndRoleFieldAttribute( "Group and Role",
        Description = "Group/Role to use for the removal. Leave role blank to remove them no matter what their role is.",
