...
{
    /// <summary>
    /// <see cref="Grid"/> Column to display an encrypted value.
    /// </summary>
    [ToolboxData( "<{0}:EncryptedField runat=server></{0}:EncryptedField>" )]
    public class EncryptedField : RockBoundField
    {
        /// <summary>
