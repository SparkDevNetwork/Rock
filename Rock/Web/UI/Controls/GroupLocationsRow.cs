...
namespace Rock.Web.UI.Controls
{
    ...
    /// </summary>
    public class GroupLocationsRow : CompositeControl
    {
        public static string FAMILY_ROLE_KEY = "GroupLocationsRow_FamilyRoles";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupLocationsRow" /> class.
        /// </summary>
        public GroupLocationsRow()
            : base()
        {
