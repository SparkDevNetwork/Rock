...
namespace Rock.Web.UI.Controls
{
    ...
    /// 
    /// </summary>
    public class MonthDayPicker : DataTextBox
    {
        /// <summary>
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            if ( string.IsNullOrWhiteSpace( this.SourceTypeName ) )
            {
                ...
                this.SourceTypeName = "Rock.Web.UI.Controls.MonthDayPicker, Rock";
        ...
        public DateTime? SelectedDate
        {
            get
            {
                if ( !string.IsNullOrWhiteSpace( this.Text ) )
                {
                    ...
                    {
                        string shortDate = string.Format( "{0}/{1}/0001", dateParts[0], dateParts[1] );
                        DateTime result;
                    ...
                    ShowErrorMessage( Rock.Constants.WarningMessage.DateTimeFormatInvalid( "Month Day" ) );                   
                }
