...
";
        ...
        private void ProcessPageInteraction()
        {
            ...
            */
            ...
            // RequestContext.SessionGuid (established in Application_BeginRequest),
            // not ASP.NET Session, which is not available that early in the
            // pipeline. It is always set, so no fallback is needed.
            var rockSessionGuid = RequestContext.SessionGuid;
