...
namespace Rock.Web.Cache
{
    ...
    public class FieldTypeCache : CachedModel<FieldType>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="FieldTypeCache"/> to <see cref="CacheFieldType"/>.
        /// </summary>
        /// <param name="c">The c.</param>
        /// <returns>
        /// The result of the conversion.
        /// </returns>
        public static implicit operator CacheFieldType( FieldTypeCache c )
        {
            return CacheFieldType.Get( c.Id );
        }
