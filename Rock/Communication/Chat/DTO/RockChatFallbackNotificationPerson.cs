...
{
    /// <summary>
    /// Represents a <see cref="Person"/> and supporting data for a <see cref="ChatUser"/> who needs to receive a
    ...
    internal class RockChatFallbackNotificationPerson
    {
        ...
        /// <summary>
        /// Gets or sets the last Rock datetime this person was sent a fallback notification.
        /// </summary>
        public DateTime? LastNotifiedRockDateTime { get; set; }
    }
}
