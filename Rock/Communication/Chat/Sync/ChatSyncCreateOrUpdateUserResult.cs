...
{
    /// <summary>
    /// Represents the result of creating or updating an individual <see cref="ChatUser"/> within the external chat system.
    /// </summary>
    internal class ChatSyncCreateOrUpdateUserResult
    {
        /// <summary>
        ...
        /// </summary>
        public ChatSyncType? SyncTypePerformed { get; set; }
    }
}
