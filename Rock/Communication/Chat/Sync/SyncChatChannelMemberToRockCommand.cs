...
{
    /// <summary>
    /// Represents a command to synchronize a chat channel member to Rock.
    /// </summary>
    internal class SyncChatChannelMemberToRockCommand : ChatToRockSyncCommand
    {
        /// <summary>
        ...
        public SyncChatChannelMemberToRockCommand( int attemptLimit, ChatSyncType chatSyncType )
