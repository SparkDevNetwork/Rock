...
{
    /// <summary>
    /// Represents a command to delete a chat user in Rock.
    /// </summary>
    /// <remarks>
    /// Subbing "user" for "person" in the class name, as this can get logged in the UI.
    /// </remarks>
    internal class DeleteChatPersonInRockCommand : ChatToRockSyncCommand
    {
        /// <summary>
