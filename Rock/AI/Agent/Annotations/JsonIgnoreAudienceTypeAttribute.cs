...
namespace Rock.AI.Agent.Annotations
{
    ...
    internal class JsonIgnoreAudienceTypeAttribute : System.Attribute
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="JsonIgnoreAudienceTypeAttribute"/>.
        /// </summary>
        /// <param name="audienceType">The type of audience that will cause the property to be ignored.</param>
        public JsonIgnoreAudienceTypeAttribute( AudienceType audienceType )
        {
