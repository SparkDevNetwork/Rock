...
{
    /// <summary>
    /// Indicates an internal error occurred while executing a Lava-based tool.
    /// This is used to ensure that the actual error message will be picked up
    /// and returned.
    /// </summary>
    internal class LavaToolException : Exception
    {
        /// <summary>
        ...
        public LavaToolException( string message )
            : base( message )
        {
        }
