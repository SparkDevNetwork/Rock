...
namespace Rock.Plugin.HotFixes
{
    ...
    [MigrationNumber( 31, "1.6.6" )]
    public class AttendanceAnalyticsGivingId : Migration
    {
        /// <summary>
        ...
        {
            // Add GivingId columns to spCheckin_AttendanceAnalyticsQuery_Attendees
            Sql( @"/*
<doc>
	<summary>
...
END" );
            ...
            // Add GivingId columns to spCheckin_AttendanceAnalyticsQuery_NonAttendees 
            Sql( @"/*
<doc>
	<summary>
