...
,[Markup] =
'{% javascript url:''~/Scripts/moment.min.js'' id:''moment''%}{% endjavascript %}
...
,[Parameters] =
'fillcolor^rgba(5%2C155%2C255%2C.6)|bordercolor^#059BFF|borderwidth^0|legendposition^bottom|legendshow^false|chartheight^400px|chartwidth^100%|tooltipshow^true|yaxislabels^#777|fontfamily^sans-serif|tooltipbackgroundcolor^#000|type^bar|pointradius^3|pointcolor^#059BFF|pointbordercolor^#059BFF|pointborderwidth^0|pointhovercolor^rgba(5%2C155%2C255%2C.6)|pointhoverbordercolor^rgba(5%2C155%2C255%2C.6)|borderdash^|pointcolor^true|pointbordercolor^#059BFF|pointborderwidth^0|pointhovercolor^rgba(5%2C155%2C255%2C.6)|pointhoverbordercolor^rgba(5%2C155%2C255%2C.6)|borderdash^linear|curvedlines^true|filllinearea^false|labels^|tooltipfontcolor^#fff|pointhoverradius^3|xaxistype^linear|yaxislabels^|yaxismin^|yaxismax^|yaxisstepsize^'
