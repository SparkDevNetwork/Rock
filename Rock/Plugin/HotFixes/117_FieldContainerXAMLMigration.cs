...
namespace Rock.Plugin.HotFixes
{
    ...
    [MigrationNumber( 117, "1.10.0" )]
    public class FieldContainerXAMLMigration : Migration
    {
...
//        <Rock:Tag Type=""Info"" Text=""{{ Request.Category.Name | Escape }}"" HorizontalOptions=""StartAndExpand"" />
...
//    <StackLayout Orientation=""Horizontal"" MarginTop=""60"">
