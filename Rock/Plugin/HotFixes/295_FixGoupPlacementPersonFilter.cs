...
namespace Rock.Plugin.HotFixes
{
    ...
    [MigrationNumber( 295, "19.1" )]
    public class FixGoupPlacementPersonFilter : Migration
    {
        /// <summary>
...
IF EXISTS (SELECT * FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[spGetGroupPlacementPeople]') AND TYPE IN (N'P', N'PC'))
    DROP PROCEDURE [dbo].[spGetGroupPlacementPeople];" );
            ...
            Sql( HotFixMigrationResource._295_FixGoupPlacementPersonFilter_spGetGroupPlacementPeople );
