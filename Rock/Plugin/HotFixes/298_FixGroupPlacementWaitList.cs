...
{
    /// <summary>
    /// Updates the [spGetGroupPlacementPeople] stored procedure so that registrants who are on a
    /// wait list are excluded from the Group Placement "People to Place" list.
    /// </summary>
    /// <seealso cref="Rock.Plugin.Migration" />
    [MigrationNumber( 298, "19.1" )]
    public class FixGroupPlacementWaitList : Migration
    {
        /// <summary>
...
IF EXISTS (SELECT * FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[spGetGroupPlacementPeople]') AND TYPE IN (N'P', N'PC'))
    DROP PROCEDURE [dbo].[spGetGroupPlacementPeople];" );
            ...
            Sql( HotFixMigrationResource._298_FixGroupPlacementWaitList_spGetGroupPlacementPeople );
