...
namespace Rock.Plugin.HotFixes
{
    ...
    /// attribute set to True are given the Secondary role. The attribute itself
    /// is removed by block type verification once the Obsidian block registers
    /// without it.
    /// </summary>
    /// <seealso cref="Rock.Plugin.Migration" />
    [MigrationNumber( 319, "20.0" )]
