...
END" );
            ...
            {
                // If the above operations fail (unexpected FK constraints, Etc.),
                // we don't want to block the rest of the migration from running.
                System.Diagnostics.Debug.WriteLine( $"Error during interim Group Member List Block Type removal: {ex.Message}" );
            }
        }
