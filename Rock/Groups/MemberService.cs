...
namespace Rock.Groups
{
	...
	/// </summary>
    public partial class MemberService : Service<Rock.Groups.Member>
    {
		/// <summary>
	    ...
	    public IEnumerable<Rock.Groups.Member> GetByGroupId( int groupId )
        {
		...
		/// <param name="groupRoleId">Group Role Id.</param>
		/// <returns>An enumerable list of Member objects.</returns>
	    public IEnumerable<Rock.Groups.Member> GetByGroupRoleId( int groupRoleId )
        {
		...
		/// <param name="personId">Person Id.</param>
		/// <returns>An enumerable list of Member objects.</returns>
	    public IEnumerable<Rock.Groups.Member> GetByPersonId( int personId )
        {
