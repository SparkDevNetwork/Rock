...
namespace Rock.Groups
{
	...
	/// </summary>
    public partial class GroupRepository : Repository<Rock.Groups.Group>
    {
		/// <summary>
        ...
        {
            return Find( t => t.GroupTypeId == groupTypeId );
        }
        ...
        {
            return Find( t => t.IsSecurityRole == isSecurityRole );
        }
        ...
        {
            return Find( t => ( t.ParentGroupId == parentGroupId || ( parentGroupId == null && t.ParentGroupId == null ) ) );
        }
        ...
        {
            return Find( t => ( t.ParentGroupId == parentGroupId || ( parentGroupId == null && t.ParentGroupId == null ) ) && t.Name == name );
        }
