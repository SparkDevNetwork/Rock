...
namespace Rock.Cache
{
    ...
    [Serializable]
    [DataContract]
    public class CacheWorkflowType : ModelCache<CacheWorkflowType, WorkflowType>
    {
        ...
        /// The defined values.
        /// </value>
        public List<CacheWorkflowActivityType> ActivityTypes
        {
            get
            {
                var activityTypes = new List<CacheWorkflowActivityType>();
                ...
                {
                    var activityType = CacheWorkflowActivityType.Get( id );
