...
namespace Rock.Cache
{
    ...
    [Serializable]
    [DataContract]
    public class CacheContentChannel : ModelCache<CacheContentChannel, ContentChannel>
    {
        #region Properties
        ...
        /// </value>
        public List<CacheContentChannel> ChildContentChannels
        {
            get
            {
                var childContentChannels = new List<CacheContentChannel>();
        ...
        /// </value>
        public List<CacheContentChannel> ParentContentChannels
        {
            get
            {
                var parentContentChannels = new List<CacheContentChannel>();
