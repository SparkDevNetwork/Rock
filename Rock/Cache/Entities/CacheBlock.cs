...
namespace Rock.Cache
{
    ...
    [Serializable]
    [DataContract]
    public class CacheBlock : ModelCache<CacheBlock, Block>
    {
        ...
        /// </value>
        public CachePage Page => PageId.HasValue ? CachePage.Get( PageId.Value ) : null;
        ...
        public CacheLayout Layout
        {
            get
            {
                ...
                {
                    return CacheLayout.Get( LayoutId.Value );
                }
        ...
        /// </value>
        public CacheSite Site
        {
            get
            {
                if ( SiteId != null && SiteId.Value != 0 )
                {
                    return CacheSite.Get( SiteId.Value );
                }
        ...
        /// Gets the block type
        /// </summary>
        public CacheBlockType BlockType => CacheBlockType.Get( BlockTypeId );
