...
namespace Rock.Cache
{
    ...
    [Serializable]
    [DataContract]
    public class CacheWorkflowActivityType : ModelCache<CacheWorkflowActivityType, WorkflowActivityType>
    {
        ...
        /// </value>
        public CacheWorkflowType WorkflowType => CacheWorkflowType.Get( WorkflowTypeId );
        ...
        /// The defined values.
        /// </value>
        public List<CacheWorkflowActionType> ActionTypes
        {
            get
            {
                var actionTypes = new List<CacheWorkflowActionType>();
                ...
                {
                    var actionType = CacheWorkflowActionType.Get( id );
                    if ( actionType != null )
                    {
        ...
        public new static void Remove( int id )
        {
            ...
            if ( activityType != null )
            {
                ...
                {
                    CacheWorkflowActionType.Remove( actionType.Id );
                }
            }
