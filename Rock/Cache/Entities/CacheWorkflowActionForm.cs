...
namespace Rock.Cache
{
    ...
    [Serializable]
    [DataContract]
    public class CacheWorkflowActionForm : ModelCache<CacheWorkflowActionForm, WorkflowActionForm>
    {
        ...
        /// The defined values.
        /// </value>
        public List<CacheWorkflowActionFormAttribute> FormAttributes
        {
            get
            {
                var formAttributes = new List<CacheWorkflowActionFormAttribute>();
                ...
                {
                    var formAttribute = CacheWorkflowActionFormAttribute.Get( id );
        ...
        public new static void Remove( int id )
        {
            ...
            if ( actionForm != null )
            {
                ...
                {
                    CacheWorkflowActionFormAttribute.Remove( formAttribute.Id );
                }
            }
