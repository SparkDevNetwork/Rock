...
namespace Rock.Cache
{
    ...
    [Serializable]
    [DataContract]
    public class CacheWorkflowActionType : ModelCache<CacheWorkflowActionType, WorkflowActionType>
    {
        ...
        /// </value>
        public CacheWorkflowActivityType ActivityType => CacheWorkflowActivityType.Get( ActivityTypeId );
        ...
        /// </value>
        public CacheEntityType EntityType => CacheEntityType.Get( EntityTypeId );
        ...
        /// </value>
        public CacheWorkflowActionForm WorkflowForm => WorkflowFormId.HasValue ? CacheWorkflowActionForm.Get( WorkflowFormId.Value ) : null;
        ...
        public new static void Remove( int id )
        {
            ...
            {
                CacheWorkflowActionForm.Remove( actionType.WorkflowFormId.Value );
            }
