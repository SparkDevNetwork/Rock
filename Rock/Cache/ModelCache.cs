...
namespace Rock.Cache
{
    ...
    /// <seealso cref="Rock.Cache.EntityCache{T, TT}" />
    /// <seealso cref="Rock.Security.ISecured" />
    /// <seealso cref="Rock.Data.IHasAttributes" />
        ...
        where TT : Model<TT>, new()
    {
        ...
        /// </value>
        [LavaIgnore]
        public Dictionary<string, CacheAttribute> Attributes
        {
            get
            {
        ...
        [DataMember]
        [LavaIgnore]
        public virtual Dictionary<string, CacheAttributeValue> AttributeValues { get; set; }
