    ...
    public class ConnectionStatusFieldType : FieldType, IEntityFieldType, IEntityReferenceFieldType
    {
        ...
        internal override FieldTypeHints GetFieldHints( Dictionary<string, string> privateConfigurationValues )
        {
            ...
            return new FieldTypeHints
            {
                ...
                ValueFormat = "The guid of a row in the ConnectionStatus table. Not its id or idKey.",
                Instructions = "To find the correct value, look up the connection statuses for the connection type you want and take the guid of the one you want."
            };
        }
