    ...
    public class ReminderTypeFieldType : FieldType, IEntityFieldType, IEntityReferenceFieldType
    {
        ...
        internal override FieldTypeHints GetFieldHints( Dictionary<string, string> privateConfigurationValues )
        {
            ...
            return new FieldTypeHints
            {
                ...
                ValueFormat = "The guid of a row in the ReminderType table. Not its id or idKey.",
                Instructions = "To find the correct value, look up the reminder types for the entity type you are reminding against and take the guid of the one you want."
            };
        }
