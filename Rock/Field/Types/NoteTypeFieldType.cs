    ...
    public class NoteTypeFieldType : FieldType, IEntityFieldType, IEntityReferenceFieldType
    {
        ...
        internal override FieldTypeHints GetFieldHints( Dictionary<string, string> privateConfigurationValues )
        {
            ...
            return new FieldTypeHints
            {
                ...
                ValueFormat = "The guid of a row in the NoteType table. Not its id or idKey.",
                Instructions = "To find the correct value, look up the note types for the entity type you are noting against and take the guid of the one you want."
            };
        }
