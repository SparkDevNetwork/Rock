...
namespace Rock.Field.Types
{
    ...
    [IconSvg( @"<svg xmlns=""http://www.w3.org/2000/svg"" viewBox=""0 0 16 16""><defs><style>.cls-1{fill:#343a40;}</style></defs><g id=""Layer_12"" data-name=""Layer 12""><path class=""cls-1"" d=""M12.81,2.75H11.5V1.44A.44.44,0,0,0,11.06,1h-.87a.44.44,0,0,0-.44.44V2.75H6.25V1.44A.44.44,0,0,0,5.81,1H4.94a.44.44,0,0,0-.44.44V2.75H3.19A1.31,1.31,0,0,0,1.88,4.06v9.63A1.31,1.31,0,0,0,3.19,15h9.62a1.31,1.31,0,0,0,1.31-1.31V4.06A1.31,1.31,0,0,0,12.81,2.75Zm0,10.77a.17.17,0,0,1-.16.17H3.35a.17.17,0,0,1-.16-.17V5.38h9.62Z""/><rect class=""cls-1"" x=""4.04"" y=""5.85"" width=""1.87"" height=""7.33"" rx=""0.3""/></g></svg>" )]
