...
namespace com.lcbcchurch.Workflow.Migrations
{
    ...
    public class GeneralContactWorkflow : Migration
    {
        public override void Up()
        {
            ...
            RockMigrationHelper.AddActionTypeAttributeValue("448A26ED-5AC0-4FA1-9124-ACDC3A3C7DA0","F1F6F9D6-FDC5-489C-8261-4B9F45B3EED4",@"{% assign group = Workflow | Attribute:'AdminGroup','Object' %} {% assign personGuid = '' %} {% for gm in group.Members %}     {% if personGuid == '' %}         {% assign memberCampuses = gm | Attribute:'Campus','RawValue' %}         {% assign requestCampusGuid = Workflow | Attribute:'Campus','Guid' %}          {% if requestCampusGuid != '' %}             {% if memberCampuses contains requestCampusGuid %}                 {% assign personGuid = gm.Person.PrimaryAlias.Guid %}             {% elseif campuses == '' %}                 {% assign personGuid = gm.Person.PrimaryAlias.Guid %}             {% endif %}         {% else %}             {% assign personGuid = gm.Person.PrimaryAlias.Guid %}         {% endif %}     {% endif %} {% endfor %} {{personGuid}} "); // General Contact:Request:Get Initial Worker Guid:Lava
