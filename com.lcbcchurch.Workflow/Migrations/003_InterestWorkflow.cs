...
namespace com.lcbcchurch.Workflow.Migrations
{
    ...
    public class InterestWorkflow : Migration
    {
        ...
        {           
            ...
            RockMigrationHelper.AddAttributeQualifier( "E33F3584-79CF-485F-9F4F-CBF73CEADB21", "EnableSelfSelection", @"False", "4E2CBE7B-150F-47FD-8D48-9965EC6CE342" ); // Ministry Interest:Person:EnableSelfSelection
            RockMigrationHelper.AddAttributeQualifier( "7023A115-4AEC-4C34-8CEA-0E0C69149FCF", "enhancedselection", @"False", "DAF14094-F365-4359-9E0A-73EA1DC42E25" ); // Ministry Interest:Interests:enhancedselection
            RockMigrationHelper.AddAttributeQualifier( "7023A115-4AEC-4C34-8CEA-0E0C69149FCF", "values", @"FirstSteps^First Steps, Journey^Growth Track: Journey, Discovery^Growth Track: Discovery, Story^Growth Track: Story, Baptism^Baptism, Serving^Serving, LifeGroups^LIFE Groups", "E4EBAEBC-EDF9-430E-9ECF-281666117985" ); // Ministry Interest:Interests:values
            ...
            RockMigrationHelper.UpdateWorkflowActionType( "7637F475-7693-44B4-9FCF-3CF73EAD790B", "Test for First Steps", 1, "38907A90-1634-4A93-8017-619326A4A582", true, true, "", "7023A115-4AEC-4C34-8CEA-0E0C69149FCF", 8, "FirstSteps", "508BC653-3A91-4CDC-84CC-63F0BA55FB65" ); // Ministry Interest:Request:Test for First Steps
            RockMigrationHelper.UpdateWorkflowActionType( "7637F475-7693-44B4-9FCF-3CF73EAD790B", "Test for Journey", 2, "38907A90-1634-4A93-8017-619326A4A582", true, true, "", "7023A115-4AEC-4C34-8CEA-0E0C69149FCF", 8, "Journey", "C3179102-C552-4CAB-B188-3D0F47EEC134" ); // Ministry Interest:Request:Test for Journey
            RockMigrationHelper.UpdateWorkflowActionType( "7637F475-7693-44B4-9FCF-3CF73EAD790B", "Test for Discovery", 3, "38907A90-1634-4A93-8017-619326A4A582", true, true, "", "7023A115-4AEC-4C34-8CEA-0E0C69149FCF", 8, "Discovery", "5E289A4F-B85E-47BA-A5B5-32FDF45723DD" ); // Ministry Interest:Request:Test for Discovery
            RockMigrationHelper.UpdateWorkflowActionType( "7637F475-7693-44B4-9FCF-3CF73EAD790B", "Test for Story", 4, "38907A90-1634-4A93-8017-619326A4A582", true, true, "", "7023A115-4AEC-4C34-8CEA-0E0C69149FCF", 8, "Story", "98D8D786-5C98-4A3B-997E-39A4A3AD0838" ); // Ministry Interest:Request:Test for Story
            RockMigrationHelper.UpdateWorkflowActionType( "7637F475-7693-44B4-9FCF-3CF73EAD790B", "Test for Baptism", 5, "38907A90-1634-4A93-8017-619326A4A582", true, true, "", "7023A115-4AEC-4C34-8CEA-0E0C69149FCF", 8, "Baptism", "C42552AC-903C-443F-A558-547BFB111E21" ); // Ministry Interest:Request:Test for Baptism
            RockMigrationHelper.UpdateWorkflowActionType( "7637F475-7693-44B4-9FCF-3CF73EAD790B", "Test for Serving", 6, "38907A90-1634-4A93-8017-619326A4A582", true, true, "", "7023A115-4AEC-4C34-8CEA-0E0C69149FCF", 8, "Serving", "7EB5DF56-FFA7-4DC8-9F52-50AA8BB2FD55" ); // Ministry Interest:Request:Test for Serving
            RockMigrationHelper.UpdateWorkflowActionType( "7637F475-7693-44B4-9FCF-3CF73EAD790B", "Test for LIFE Groups", 7, "38907A90-1634-4A93-8017-619326A4A582", true, true, "", "7023A115-4AEC-4C34-8CEA-0E0C69149FCF", 8, "LifeGroups", "D76DAFC6-710F-463A-9A96-E8877C5EA7B3" ); // Ministry Interest:Request:Test for LIFE Groups
            ...
            RockMigrationHelper.AddActionTypePersonAttributeValue( "AB0609C5-3D7D-470A-921D-07FFA66D8D38", "5C803BD1-40FA-49B1-AE7E-68F43D3687BB", @"36c2aba2-27e5-4652-9c96-ce504139e8f6" ); // Ministry Interest:First Steps:Assign Worker:Person
            ...
            RockMigrationHelper.AddActionTypePersonAttributeValue( "2156B090-E72C-48D7-B262-4BCCDC29F07B", "5C803BD1-40FA-49B1-AE7E-68F43D3687BB", @"36c2aba2-27e5-4652-9c96-ce504139e8f6" ); // Ministry Interest:Growth Track: Journey:Assign Worker:Person
            ...
            RockMigrationHelper.AddActionTypePersonAttributeValue( "3BCA3F89-4D34-4682-B494-AA6361BF5DF8", "5C803BD1-40FA-49B1-AE7E-68F43D3687BB", @"36c2aba2-27e5-4652-9c96-ce504139e8f6" ); // Ministry Interest:Growth Track: Bible Discovery:Assign Worker:Person
            ...
            RockMigrationHelper.AddActionTypePersonAttributeValue( "0B875C73-729F-40E2-BFA6-77555A73E11A", "5C803BD1-40FA-49B1-AE7E-68F43D3687BB", @"36c2aba2-27e5-4652-9c96-ce504139e8f6" ); // Ministry Interest:Growth Track: Story:Assign Worker:Person
            ...
            RockMigrationHelper.AddActionTypePersonAttributeValue( "FBA8D1C3-C899-483C-98CB-0DB618A9B171", "5C803BD1-40FA-49B1-AE7E-68F43D3687BB", @"36c2aba2-27e5-4652-9c96-ce504139e8f6" ); // Ministry Interest:Baptism:Assign Worker:Person
            ...
            RockMigrationHelper.AddActionTypePersonAttributeValue( "A2CE1D4F-A398-4D13-9E1E-84741A54390A", "5C803BD1-40FA-49B1-AE7E-68F43D3687BB", @"36c2aba2-27e5-4652-9c96-ce504139e8f6" ); // Ministry Interest:Serving:Assign Worker:Person
            ...
            RockMigrationHelper.AddActionTypePersonAttributeValue( "DED53947-A2A3-4071-B160-C96A0F3B3E8C", "5C803BD1-40FA-49B1-AE7E-68F43D3687BB", @"36c2aba2-27e5-4652-9c96-ce504139e8f6" ); // Ministry Interest:LIFE Groups:Assign Worker:Person
