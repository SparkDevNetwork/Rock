...
CREATE TABLE #businessTypeName (
        TypeName NVARCHAR(23) NOT NULL
        );

    INSERT INTO #businessTypeName
    VALUES (N'Sandwich Shop')
        ,(N'Pet Supplies')
        ,(N'Grocery Store')
        ,(N'Car Repair')
        ,(N'Sports')
    ...
    declare @businessTypeName varchar(max);
    ...
    BEGIN
        ...
        VALUES (
            0
            ,@firstName
            ,Concat(@lastName,' ', @businessTypeName)           
            ,@email
            ,1
            ,0
            ,@personGuid
...
select lastname, count(*) from Person group by lastname order by count(*) desc