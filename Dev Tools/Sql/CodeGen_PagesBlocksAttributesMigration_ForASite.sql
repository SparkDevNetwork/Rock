...
create table #codeTable (
    ...
    left outer join [Page] [p] on [p].[Id] = [b].[PageId] --was left outer
	left outer join [Layout] [l] on [l].[Id] = [b].[LayoutId]--was left outer
	left outer join [Layout] [pl] on [pl].[Id] = [p].[LayoutId]--was left outer
