...
namespace church.ccv.Authentication
{
    ...
    /// </summary>
    [Description( "Facebook Authentication Provider with CCV Customizations" )]
    [Export( typeof( AuthenticationComponent ) )]
    [ExportMetadata( "ComponentName", "Facebook - CCV" )]
            ...
            using ( var rockContext = new RockContext() )
            {
                ...
                if ( user == null )
                {
                    ...
                    rockContext.WrapTransaction( () =>
                    {
                        ...
                        if ( person != null )
                        {
                            int typeId = EntityTypeCache.Read( typeof( Rock.Security.ExternalAuthentication.Facebook ) ).Id;
