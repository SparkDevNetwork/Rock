...
namespace Subtext.TestLibrary
{
    ...
    public class HttpSimulator : IDisposable
    {
        ...
        private string _ua = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36";
        ...
        protected virtual HttpSimulator SimulateRequest(Uri url, HttpVerb httpVerb, NameValueCollection formVariables, NameValueCollection headers)
        {
            ...
            if (_ua != null)
                this.workerRequest.SetUserAgent(_ua);
		...
		private void InitializeSession()
		{
            ...
            {
                Capabilities = new System.Collections.Generic.Dictionary<string, string>
                {
                    {"majorversion", "8"},
                    {"browser", "IE"},
        ...
        /// <summary>
        /// Sets the user agent for the request. Uses a fluent interface.
        /// </summary>
        /// <param name="ua"></param>
        /// <returns></returns>
