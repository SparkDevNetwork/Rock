...
namespace Rock.Tests.Slingshot
{
    ...
    {
        private readonly Dictionary<string, object> csvEntry = new Dictionary<string, object>();
        private readonly Dictionary<string, string> headerMapper = new Dictionary<string, string>();
