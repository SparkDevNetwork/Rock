...
namespace org.newpointe.ExtraActions
{
    ...
    public class CustomFilterByAge : CheckInActionComponent
    {
        /// <summary>
                ...
                if ( family != null )
                {
                    ...
                    foreach ( var person in family.People )
                    {
                        ...
                        foreach ( var groupType in person.GroupTypes.ToList() )
                        {
                            ...
                            bool? groupAgeRequired = groupType.GroupType.GetAttributeValue( "AgeRequired" ).AsBooleanOrNull();
                            ...
                            if ( minAge.HasValue || maxAge.HasValue )
                            {
                                ...
                                {
                                    if ( groupAgeRequired.HasValue ? groupAgeRequired.Value : ageRequired )
                                    {
                                        ageMatch = false;
                                    }
                                }
