...
namespace OfficeOpenXml
{
	...
	public class ExcelPackage : IDisposable
	{
        ...
        // Edits to the ExcelPackage to support MemoryStreams 
        // JME 2/24/12 from http://excelpackage.codeplex.com/discussions/234877
        ...
        public ExcelPackage( Stream outputStream )
        {
            _outputStream = outputStream;
            _memoryStream = new MemoryStream();
        ...
        /* Commented Out by JME 2/24/12 for memory stream support
