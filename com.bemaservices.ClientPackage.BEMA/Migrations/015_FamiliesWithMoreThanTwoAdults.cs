...
namespace com.bemaservices.ClientPackage.BEMA
{
    ...
    public class FamiliesWithMoreThanTwoAdults : Migration
    {
        ...
        public override void Up()
        {
            ...
            // Add Block to Page: Families with More Than Two Adults, Site: Rock RMS
            RockMigrationHelper.AddBlock( true, "8032F679-68C5-4168-AE4F-7376FCD87E07", "", "19B61D65-37E3-459F-A44F-DEF0089118A3", "HTML Content", "Feature", "", "", 0, "E3775ABA-3CE6-4B78-8B86-3B8B9697EEEB" );
            ...
            RockMigrationHelper.UpdateHtmlContentBlock( "E3775ABA-3CE6-4B78-8B86-3B8B9697EEEB", @"<div class='alert alert-info'>
    Shows a list of families with more than 2 adult people as group members.
</div>"
           , "4844D705-B4E5-44CA-917E-A18F0EB9BF6B" );
