...
namespace com.bemaservices.ClientPackage.BEMA
{
    ...
    public class FamiliesWithMultipleMailingAddress : Migration
    {
        /// <summary>
        ...
        {
            // Page: Families with More Than One Mailing Address
            RockMigrationHelper.AddPage( "2571CBBD-7CCA-4B24-AAAB-107FD136298B", "D65F783D-87A9-4CC9-8110-E83466A0EADB", "Families with More Than One Mailing Address", "Shows Family Groups That Have More Than One Mailing Addressed Marked", "86043E5A-FB51-4483-A90D-D88DCA75E03C", "fa fa-home" ); // Site:Rock RMS
            ...
            // Add Block to Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlock( true, "86043E5A-FB51-4483-A90D-D88DCA75E03C", "", "E31E02E9-73F6-4B3E-98BA-E0E4F86CA126", "dyn", "Main", "", "", 0, "46DB2968-1B1F-4202-8122-3341E424BA7B" );
            // Add Block to Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlock( true, "86043E5A-FB51-4483-A90D-D88DCA75E03C", "", "19B61D65-37E3-459F-A44F-DEF0089118A3", "HTML Content", "Feature", "", "", 0, "24FE8DE8-FAC8-4DF8-9401-846BA2C6B518" );
            ...
            // Attrib Value for Block:dyn, Attribute:Update Page Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "230EDFE8-33CA-478D-8C9A-572323AF3466", @"True" );
            // Attrib Value for Block:dyn, Attribute:Query Params Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "B0EC41B9-37C0-48FD-8E4E-37A8CA305012", @"" );
            // Attrib Value for Block:dyn, Attribute:Columns Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "90B0E6AF-B2F4-4397-953B-737A40D4023B", @"Id" );
            // Attrib Value for Block:dyn, Attribute:Query Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "71C8BA4E-8EF2-416B-BFE9-D1D88D9AA356", @" {% include '~/Plugins/com_bemaservices/CustomBlocks/BEMA/Assets/Sql/FamiliesWithMoreThanOneAddress.sql' %} " );
            // Attrib Value for Block:dyn, Attribute:Url Mask Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "B9163A35-E09C-466D-8A2D-4ED81DF0114C", @"/Person/{Id}" );
            // Attrib Value for Block:dyn, Attribute:Show Columns Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "202A82BF-7772-481C-8419-600012607972", @"False" );
            // Attrib Value for Block:dyn, Attribute:Merge Fields Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "8EB882CE-5BB1-4844-9C28-10190903EECD", @"" );
            // Attrib Value for Block:dyn, Attribute:Formatted Output Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "6A233402-446C-47E9-94A5-6A247C29BC21", @"" );
            // Attrib Value for Block:dyn, Attribute:Person Report Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "8104CE53-FDB3-4E9F-B8E7-FD9E06E7551C", @"False" );
            // Attrib Value for Block:dyn, Attribute:Show Excel Export Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "E11B57E5-EC7D-4C42-9ADA-37594D71F145", @"True" );
            // Attrib Value for Block:dyn, Attribute:Show Communicate Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "5B2C115A-C187-4AB3-93AE-7010644B39DA", @"False" );
            // Attrib Value for Block:dyn, Attribute:Show Merge Person Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "8762ABE3-726E-4629-BD4D-3E42E1FBCC9E", @"False" );
            // Attrib Value for Block:dyn, Attribute:Show Bulk Update Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "D01510AA-1B8D-467C-AFC6-F7554CB7CF78", @"False" );
            // Attrib Value for Block:dyn, Attribute:Stored Procedure Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "A4439703-5432-489A-9C14-155903D6A43E", @"False" );
            // Attrib Value for Block:dyn, Attribute:Show Merge Template Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "6697B0A2-C8FE-497A-B5B4-A9D459474338", @"True" );
            // Attrib Value for Block:dyn, Attribute:Paneled Grid Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "5449CB61-2DFC-4B55-A697-38F1C2AF128B", @"False" );
            // Attrib Value for Block:dyn, Attribute:Show Grid Filter Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "E582FD3C-9990-47D1-A57F-A3DB753B1D0C", @"True" );
            // Attrib Value for Block:dyn, Attribute:Timeout Page: Families with More Than One Mailing Address, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "46DB2968-1B1F-4202-8122-3341E424BA7B", "BEEE38DD-2791-4242-84B6-0495904143CC", @"30" );

            RockMigrationHelper.AddSecurityAuthForPage( "86043E5A-FB51-4483-A90D-D88DCA75E03C", 0, "View", false, "", 1, "21A2D37E-EAA5-4B62-B78F-5BF1A98D2635" );
            RockMigrationHelper.UpdateHtmlContentBlock( "24FE8DE8-FAC8-4DF8-9401-846BA2C6B518", @"<div class='alert alert-info'>
    Shows family groups with more than one Home location set as a mailing location.
</div>"
           , "14D5A22A-0FE1-4403-9F0E-408F342E3EAB" );
        ...
        public override void Down()
        {
            ...
            RockMigrationHelper.DeleteBlock( "46DB2968-1B1F-4202-8122-3341E424BA7B" );
            RockMigrationHelper.DeleteBlockType( "E31E02E9-73F6-4B3E-98BA-E0E4F86CA126" );
            RockMigrationHelper.DeletePage( "86043E5A-FB51-4483-A90D-D88DCA75E03C" ); // Page: Families with More Than One Mailing Address
        }
    }
}
