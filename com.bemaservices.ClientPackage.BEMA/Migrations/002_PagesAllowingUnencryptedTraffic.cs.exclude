...
namespace com.bemaservices.ClientPackage.BEMA
{
    ...
    public class PagesAllowingUnencryptedTraffic : Migration
    {
        ...
        public override void Up()
        {
            ...
            RockMigrationHelper.UpdateHtmlContentBlock( "CD84D302-D9D6-495B-857C-BD83054353B0", @"<div class='alert alert-info'>
    <p>
        This report displays a list of pages that allow unencrypted traffic to access them. It does this by pulling all pages that neither require encryption themselves nor are on a site that forces SSL. We highly recommend requiring all your pages to require encrypted traffic by either setting 'Force SSL' on your sites or by checking 'Requires Encryption' on your individual pages.
    </p>
</div>", "F454DEAA-041F-40D6-8A29-1DD88CA59002" );
