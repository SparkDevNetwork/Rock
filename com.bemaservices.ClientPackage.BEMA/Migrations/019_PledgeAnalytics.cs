...
namespace com.bemaservices.ClientPackage.BEMA
{
    ...
    public class PledgeAnalytics : Migration
    {
        /// <summary>
        ...
        public override void Up()
        {
            ...
            RockMigrationHelper.AddPage("2571CBBD-7CCA-4B24-AAAB-107FD136298B","D65F783D-87A9-4CC9-8110-E83466A0EADB","Pledge Analytics","An alternate Pledge Analytics view with more columns","A680E701-377D-4E13-938B-6FED3576406D",""); // Site:Rock RMS
            ...
            RockMigrationHelper.AddBlock( true, "A680E701-377D-4E13-938B-6FED3576406D","","19B61D65-37E3-459F-A44F-DEF0089118A3","HTML","Main","","",0,"281C8959-E5EE-467D-A18B-16A35120AC38");   
            // Add Block to Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlock( true, "A680E701-377D-4E13-938B-6FED3576406D","","E31E02E9-73F6-4B3E-98BA-E0E4F86CA126","Dynamic Data","Main","","",1,"9E3D270C-71E2-4B5A-9D96-31C78F781B47");   
            ...
            // Attrib Value for Block:Dynamic Data, Attribute:Update Page Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","230EDFE8-33CA-478D-8C9A-572323AF3466",@"True");  
            // Attrib Value for Block:Dynamic Data, Attribute:Show Columns Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","202A82BF-7772-481C-8419-600012607972",@"False");  
            // Attrib Value for Block:Dynamic Data, Attribute:Person Report Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","8104CE53-FDB3-4E9F-B8E7-FD9E06E7551C",@"False");  
            // Attrib Value for Block:Dynamic Data, Attribute:Show Excel Export Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","E11B57E5-EC7D-4C42-9ADA-37594D71F145",@"True");  
            // Attrib Value for Block:Dynamic Data, Attribute:Show Communicate Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","5B2C115A-C187-4AB3-93AE-7010644B39DA",@"False");  
            // Attrib Value for Block:Dynamic Data, Attribute:Show Merge Person Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","8762ABE3-726E-4629-BD4D-3E42E1FBCC9E",@"False");  
            // Attrib Value for Block:Dynamic Data, Attribute:Show Bulk Update Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","D01510AA-1B8D-467C-AFC6-F7554CB7CF78",@"False");  
            // Attrib Value for Block:Dynamic Data, Attribute:Stored Procedure Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","A4439703-5432-489A-9C14-155903D6A43E",@"False");  
            // Attrib Value for Block:Dynamic Data, Attribute:Show Merge Template Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","6697B0A2-C8FE-497A-B5B4-A9D459474338",@"True");  
            // Attrib Value for Block:Dynamic Data, Attribute:Paneled Grid Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","5449CB61-2DFC-4B55-A697-38F1C2AF128B",@"False");  
            // Attrib Value for Block:Dynamic Data, Attribute:Show Grid Filter Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","E582FD3C-9990-47D1-A57F-A3DB753B1D0C",@"True");  
            // Attrib Value for Block:Dynamic Data, Attribute:Timeout Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","BEEE38DD-2791-4242-84B6-0495904143CC",@"30");  
            // Attrib Value for Block:Dynamic Data, Attribute:Enabled Lava Commands Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","824634D6-7F75-465B-A2D2-BA3CE1662CAC",@"All");  
            // Attrib Value for Block:Dynamic Data, Attribute:Query Params Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","B0EC41B9-37C0-48FD-8E4E-37A8CA305012",@"");  
            // Attrib Value for Block:Dynamic Data, Attribute:Columns Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","90B0E6AF-B2F4-4397-953B-737A40D4023B",@"");  
            // Attrib Value for Block:Dynamic Data, Attribute:Query Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","71C8BA4E-8EF2-416B-BFE9-D1D88D9AA356",@"{% include '~/Plugins/com_bemaservices/CustomBlocks/BEMA/Assets/Sql/PledgeAnalytics.sql' %}");  
            // Attrib Value for Block:Dynamic Data, Attribute:Url Mask Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","B9163A35-E09C-466D-8A2D-4ED81DF0114C",@"");  
            // Attrib Value for Block:Dynamic Data, Attribute:Merge Fields Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","8EB882CE-5BB1-4844-9C28-10190903EECD",@"");  
            // Attrib Value for Block:Dynamic Data, Attribute:Formatted Output Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","6A233402-446C-47E9-94A5-6A247C29BC21",@"");  
            // Attrib Value for Block:Dynamic Data, Attribute:Communication Recipient Person Id Columns Page: Pledge Analytics, Site: Rock RMS              
            RockMigrationHelper.AddBlockAttributeValue("9E3D270C-71E2-4B5A-9D96-31C78F781B47","75DDB977-9E71-44E8-924B-27134659D3A4",@"");  

            RockMigrationHelper.UpdateHtmlContentBlock( "281C8959-E5EE-467D-A18B-16A35120AC38", @"<div class='alert alert-info'>Requires a Sliding Date Range and Account(Pledge) selector. To enable Sliding Date Range picker, make sure lava's Execute method is enabled</div>"
            , "c9c1cff8-9d33-4682-ae25-b2bd2b7549b6" );

            RockMigrationHelper.AddSecurityAuthForPage( "A680E701-377D-4E13-938B-6FED3576406D", 0, "View", false, "", 1, "6c5ca9c6-a3bc-4354-912c-0c33a54b1ed0" );
        ...
        public override void Down()
        {
            ...
            RockMigrationHelper.DeleteBlock("9E3D270C-71E2-4B5A-9D96-31C78F781B47");
            RockMigrationHelper.DeleteBlock("281C8959-E5EE-467D-A18B-16A35120AC38");
            ...
            RockMigrationHelper.DeletePage("A680E701-377D-4E13-938B-6FED3576406D"); //  Page: Pledge Analytics
        }
    }
}
