...
namespace com.bemaservices.ClientPackage.BEMA
{
    ...
    public class FamilyCampusNotLastTransaction : Migration
    {
        /// <summary>
        ...
        {
            // Page: Family Campus Not Last Transaction
            RockMigrationHelper.AddPage( "2571CBBD-7CCA-4B24-AAAB-107FD136298B", "D65F783D-87A9-4CC9-8110-E83466A0EADB", "Family Campus Not Last Transaction", "Lists out families and their campuses that do not match most recent transaction's campus.", "F89E8A6B-8BBC-4F4B-9AFE-CC025AFF01D0", "fa fa-money" ); // Site:Rock RMS
            ...
            // Add Block to Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlock( true, "F89E8A6B-8BBC-4F4B-9AFE-CC025AFF01D0", "", "E31E02E9-73F6-4B3E-98BA-E0E4F86CA126", "Dynamic Data", "Main", "", "", 0, "D4928DA6-8722-43E3-B144-A504F9FE8C68" );
            // Add Block to Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlock( true, "F89E8A6B-8BBC-4F4B-9AFE-CC025AFF01D0", "", "19B61D65-37E3-459F-A44F-DEF0089118A3", "HTML Content", "Feature", "", "", 0, "63BDA643-74F3-4F61-910A-D68D2B841468" );
            ...
            // Attrib Value for Block:Dynamic Data, Attribute:Update Page Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "230EDFE8-33CA-478D-8C9A-572323AF3466", @"True" );
            // Attrib Value for Block:Dynamic Data, Attribute:Query Params Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "B0EC41B9-37C0-48FD-8E4E-37A8CA305012", @"" );
            // Attrib Value for Block:Dynamic Data, Attribute:Columns Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "90B0E6AF-B2F4-4397-953B-737A40D4023B", @"" );
            // Attrib Value for Block:Dynamic Data, Attribute:Query Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "71C8BA4E-8EF2-416B-BFE9-D1D88D9AA356", @"{% include '~/Plugins/com_bemaservices/CustomBlocks/BEMA/Assets/Sql/FamilyCampusNotLastTransaction.sql' %}" );
            // Attrib Value for Block:Dynamic Data, Attribute:Url Mask Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "B9163A35-E09C-466D-8A2D-4ED81DF0114C", @"" );
            // Attrib Value for Block:Dynamic Data, Attribute:Show Columns Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "202A82BF-7772-481C-8419-600012607972", @"False" );
            // Attrib Value for Block:Dynamic Data, Attribute:Merge Fields Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "8EB882CE-5BB1-4844-9C28-10190903EECD", @"" );
            // Attrib Value for Block:Dynamic Data, Attribute:Formatted Output Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "6A233402-446C-47E9-94A5-6A247C29BC21", @"" );
            // Attrib Value for Block:Dynamic Data, Attribute:Person Report Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "8104CE53-FDB3-4E9F-B8E7-FD9E06E7551C", @"False" );
            // Attrib Value for Block:Dynamic Data, Attribute:Show Excel Export Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "E11B57E5-EC7D-4C42-9ADA-37594D71F145", @"True" );
            // Attrib Value for Block:Dynamic Data, Attribute:Show Communicate Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "5B2C115A-C187-4AB3-93AE-7010644B39DA", @"False" );
            // Attrib Value for Block:Dynamic Data, Attribute:Show Merge Person Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "8762ABE3-726E-4629-BD4D-3E42E1FBCC9E", @"False" );
            // Attrib Value for Block:Dynamic Data, Attribute:Show Bulk Update Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "D01510AA-1B8D-467C-AFC6-F7554CB7CF78", @"False" );
            // Attrib Value for Block:Dynamic Data, Attribute:Stored Procedure Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "A4439703-5432-489A-9C14-155903D6A43E", @"False" );
            // Attrib Value for Block:Dynamic Data, Attribute:Show Merge Template Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "6697B0A2-C8FE-497A-B5B4-A9D459474338", @"True" );
            // Attrib Value for Block:Dynamic Data, Attribute:Paneled Grid Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "5449CB61-2DFC-4B55-A697-38F1C2AF128B", @"False" );
            // Attrib Value for Block:Dynamic Data, Attribute:Show Grid Filter Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "E582FD3C-9990-47D1-A57F-A3DB753B1D0C", @"True" );
            // Attrib Value for Block:Dynamic Data, Attribute:Timeout Page: Family Campus Not Last Transaction, Site: Rock RMS
            RockMigrationHelper.AddBlockAttributeValue( "D4928DA6-8722-43E3-B144-A504F9FE8C68", "BEEE38DD-2791-4242-84B6-0495904143CC", @"30" );


            RockMigrationHelper.AddSecurityAuthForPage( "F89E8A6B-8BBC-4F4B-9AFE-CC025AFF01D0", 0, "View", false, "", 1, "B6C0A58F-9924-4F2D-8511-B905A7A9A23D" );
             RockMigrationHelper.UpdateHtmlContentBlock( "63BDA643-74F3-4F61-910A-D68D2B841468", @"<div class='alert alert-info'>
    Lists out families whose campus does not match the campus tied to their last financial transaction ( via the financial account's campus ).
</div>", "A47929B4-EE3C-4E0E-BB9F-4758D1036B93" ); // Report
        }
        ...
        public override void Down()
        {
            ...
            RockMigrationHelper.DeleteBlock( "D4928DA6-8722-43E3-B144-A504F9FE8C68" );
            RockMigrationHelper.DeleteBlockType( "E31E02E9-73F6-4B3E-98BA-E0E4F86CA126" );
            RockMigrationHelper.DeletePage( "F89E8A6B-8BBC-4F4B-9AFE-CC025AFF01D0" ); // Page: Family Campus Not Last Transaction
        }
    }
}
