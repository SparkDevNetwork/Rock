...
namespace com.centralaz.RoomManagement.Migrations
{
    ...
    public class PerformanceImprovements : Migration
    {
        ...
        {
            Sql( @"
                ALTER TABLE [dbo].[_com_centralaz_RoomManagement_Reservation] ADD [FirstOccurrenceStartDateTime] [datetime] NULL
                ALTER TABLE [dbo].[_com_centralaz_RoomManagement_Reservation] ADD [LastOccurrenceEndDateTime] [datetime] NULL
                " );
    ...
    INSERT INTO [dbo].[ServiceJob]
     ...
     VALUES
        (0	
         ...
         ,'com.centralaz.RoomManagement.Jobs.PopulateFirstLastOccurrenceDateTimes'
         ,'0 0 21 1/1 * ? *'
         ,3
        ...
        {
            Sql( @"
                ALTER TABLE [dbo].[_com_centralaz_RoomManagement_Reservation] DROP COLUMN [FirstOccurrenceStartDateTime]
                ALTER TABLE [dbo].[_com_centralaz_RoomManagement_Reservation] DROP COLUMN [LastOccurrenceEndDateTime]
                " );
        }
    }
}
