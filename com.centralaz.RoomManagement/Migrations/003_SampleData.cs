    ...
    public class SampleData : Migration
    {
        public override void Up()
        {
            ...
            Sql( @"
                    ...
                    INSERT [dbo].[_com_centralaz_RoomManagement_Resource] ( [Name], [CategoryId], [CampusId], [Quantity], [Note], [Guid], [CreatedDateTime], [ModifiedDateTime], [CreatedByPersonAliasId], [ModifiedByPersonAliasId], [ForeignKey], [ForeignGuid], [ForeignId]) VALUES ( N'Lobby Tables', @TablesId, @CampusId, 12, N'', N'0180e05c-8dbb-44fc-875e-435a81bd994c', CAST(N'2016-06-08 09:04:38.640' AS DateTime), CAST(N'2016-06-08 09:04:38.640' AS DateTime), 10, 10, NULL, NULL, NULL)
                    " );
            Sql( @"
                    DECLARE @CampusId int = (SELECT TOP 1 [Id] FROM [Campus] ORDER BY [Id])
