...
namespace com.centralaz.RoomManagement.DataFilter.Reservation
{
    ...
    public class ReservationInDateRangeFilter : DataFilterComponent
    {
        ...
        {
            get { return typeof( com.centralaz.RoomManagement.Model.Reservation ).FullName; }
        }
...
"; // TODO: add some form of 'starting in' thing
        ...
        public override Expression GetExpression( Type entityType, IService serviceInstance, ParameterExpression parameterExpression, string selection )
        {
            ...
            Expression extractedFilterExpression = FilterExpressionExtractor.Extract<com.centralaz.RoomManagement.Model.Reservation>( qry, parameterExpression, "r" );
