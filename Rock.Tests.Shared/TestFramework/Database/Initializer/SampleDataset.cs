...
namespace Rock.Tests.Shared.TestFramework.Database.Initializer
{
    ...
    public class SampleDataset : ITestDatabaseInitializer
    {
        ...
        public string DatasetIdentifier => "sample14";
        ...
        private static void AddSampleDataForActiveDatabase( string sampleDataUrl )
        {
        ...
        /// </summary>
        private static void RunRockJobsForDataInitialization()
        {
