...
namespace Rock.Tests.Shared.TestFramework
{
    ...
    public class LocalDatabaseManager
    {
        ...
        private DatabaseRefreshStrategySpecifier _databaseDeleteStrategy = DatabaseRefreshStrategySpecifier.Verified;

        public string DatabaseCreatorKey = "RockIntegrationTestProject";
        public bool DatabaseMigrateIsAllowed = false;
        public string ConnectionString = null;
        public string SampleDataUrl = null;
        public ITestDatabaseInitializer DatabaseInitializer = null;
        public string DefaultSnapshotName = null;

        #region Public Properties and Methods

        public DatabaseRefreshStrategySpecifier DatabaseRefreshStrategy
        {
            get
            {
        ...
        /// </summary>
        public bool InitializeTestDatabase( string snapshotName = null )
        {
            ...
            //{
                var success = InitializeSqlServerDatabaseForLocal( forceReplaceExisting, snapshotName );
            //}
            //else
            //{
        ...
        /// </summary>
        public void CreateSnapshot( string snapshotName, bool overwriteExisting = false )
        {
            //if ( !IsLocalDbInstance() )
            //{
        ...
        /// Resets the database by using a previously stored snapshot.
        /// </summary>
        public void RestoreSnapshot( string snapshotName = "default" )
        {
            //if ( !IsLocalDbInstance() )
            //{
            //    throw new NotImplementedException( "Reset is not available for a remote database." );
        ...
        private bool ValidateSampleDataForActiveDatabase( string sampleDataUrl )
        {
        ...
        /// Resets the database by using the default data source.
        /// </summary>
        private bool InitializeSqlServerDatabaseForLocal( bool recreateArchive, string snapshotName = null )
        {
            var restoreDatabase = ( DatabaseRefreshStrategy != DatabaseRefreshStrategySpecifier.Never );
...
DROP DATABASE [{name}];";
        ...
        /// </summary>
        private void CleanupLocalDatabaseArchiveCache( int retentionDays = 90 )
        {
        ...
        private string GetArchiveFileNameForCurrentMigration()
        {
            return GetArchiveFileName( GetTargetMigration() );
        }

        private string GetArchiveFileName( string archiveName )
        {
        ...
        private string GetOrGenerateLocalDatabaseArchive( string connectionString, string snapshotName, string sampleDataUrl )
        {
...
EXEC sp_detach_db '{dbName}', 'true';";
        ...
        /// </summary>
        /// <returns>A string containing the path to the archive.</returns>
        private string CreateLocalDatabaseArchive( string connectionString, string snapshotName, bool overwrite = false ) //, string sampleDataUrl )
        {
