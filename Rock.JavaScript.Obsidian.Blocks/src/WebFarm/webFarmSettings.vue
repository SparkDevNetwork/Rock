...
<template>
    ...
    <DetailBlock v-if="!blockError"
                 ...
                 :labels="blockLabels"
                 :entityKey="entityKey"
                 entityTypeName="Web Farm Settings"
                 :isAuditHidden="false"
...
<script setup lang="ts">
    ...
    import EditPanel from "./WebFarmSettings/editPanel.partial.vue";
    import ViewPanel from "./WebFarmSettings/viewPanel.partial.vue";
    import { getSecurityGrant, provideSecurityGrant, refreshDetailAttributes, useConfigurationValues, useInvokeBlockAction } from "@Obsidian/Utility/block";
    import { debounce } from "@Obsidian/Utility/util";
    import { NavigationUrlKey } from "./WebFarmSettings/types";
    ...
    async function onCancelEdit(): Promise<boolean | string> {
        if (!webFarmSettingsEditBag.value?.idKey) {
