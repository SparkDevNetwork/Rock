...
<script setup lang="ts">
    ...
    import LiveQuestionsTab from "./ExperienceManager/liveQuestionsTab.partial.vue";
    import ModerationTab from "./ExperienceManager/moderationTab.partial.vue";
    ...
    async function startRealTime(): Promise<void> {
        ...
        topic.onReconnect(async server => {
            if (config.experienceToken) {
                const response = await server.joinExperience(config.experienceToken);
