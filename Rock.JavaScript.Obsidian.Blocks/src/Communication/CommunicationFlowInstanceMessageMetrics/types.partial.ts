...
export class BarChartDataBuilder {
    private labelOrderBy: ((labelA: string, labelB: string) => number) | undefined;
    ...
    public withLabelOrder(labelOrderBy: (labelA: string, labelB: string) => number): BarChartDataBuilder {
        this.labelOrderBy = labelOrderBy;
        return this;
    }
    ...
    public build(): ChartData<"bar"> {
        ...
        const labels = dataPointsEnumerable
            ...
            .distinct()
            .orderBy(label => label, this.labelOrderBy || ((_labelA, _labelB) => 0))
            .toArray();
        ...
        const groupedBySeries = dataPointsEnumerable
            ...
            // Order by series name alphabetically by default.
            .orderBy(group => group.key, this.seriesNameOrderBy || ((seriesNameA, seriesNameB) => seriesNameA.localeCompare(seriesNameB)));
