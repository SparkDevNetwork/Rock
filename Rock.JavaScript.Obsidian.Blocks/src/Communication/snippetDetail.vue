...
<template>
    <Alert v-if="blockError" alertType="warning" v-html="blockError"></Alert>

    <Alert v-if="errorMessage" alertType="danger" v-html="errorMessage"></Alert>
...
<script setup lang="ts">
    ...
    import EditPanel from "./SnippetDetail/editPanel.partial.vue";
    import ViewPanel from "./SnippetDetail/viewPanel.partial.vue";
    import { getSecurityGrant, provideSecurityGrant, refreshDetailAttributes, useConfigurationValues, useInvokeBlockAction } from "@Obsidian/Utility/block";
    import { debounce } from "@Obsidian/Utility/util";
    import { NavigationUrlKey } from "./SnippetDetail/types";
    ...
    const options = computed((): SnippetDetailOptionsBag => {
        return config.options ?? { isAuthorizedToEdit: false };
    });
