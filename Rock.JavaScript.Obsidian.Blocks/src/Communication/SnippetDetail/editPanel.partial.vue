...
<template>
    <fieldset>
        ...
        <div class="row">
            <div class="col-md-3 mt-4" v-if="isAuthorizedToEdit">
...
<script setup lang="ts">
    ...
    const isLava = ref(props.modelValue.content?.includes('{'));
    const isAuthorizedToEdit = ref(props.options.isAuthorizedToEdit);
    const ownerPersonAlias = propertyRef(props.modelValue.ownerPersonAlias ?? null, "OwnerPersonAlias");
    ...
    watch(() => props.modelValue, () => {
        ...
        updateRefValue(ownerPersonAlias, props.modelValue.ownerPersonAlias ?? null);
