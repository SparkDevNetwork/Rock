...
import { CSSStyleDeclarationKebabKey, DirectionalConstituentProperty, StandardDirectionalShorthandProps } from "./types.partial";
...
export function useReactiveDirectionalShorthandProperties(component: Ref<InstanceType<typeof DirectionalShorthandToolBase> | undefined>): ReactiveDirectionalShorthandProperties {
