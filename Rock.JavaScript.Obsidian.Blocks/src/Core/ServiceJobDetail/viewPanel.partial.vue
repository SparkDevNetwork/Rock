...
<template>
    <fieldset>
        ...
        <Alert v-if="jobTypeErrorMessage" alertType="danger">{{ jobTypeErrorMessage }}</Alert>
...
<script setup lang="ts">
    ...
    const jobTypeErrorMessage = computed((): string => {
        ...
        if (props.modelValue?.class && !jobTypeOptions.some(l => areEqual(l.value, props.modelValue?.class))) {
