    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <RockLabel>Cron Description</RockLabel>
                <p>{{cronDescription}}</p>
...
<script setup lang="ts">
    ...
    import { extendedRef, propertyRef, updateRefValue } from "@Obsidian/Utility/component";
    ...
    //const notificationSatatus = propertyRef(props.modelValue.name ?? "", "Name");
    ...
    let cronDescription = ref(props.modelValue.cronDescription);
    ...
    const propRefs = [description, isActive, name, cronExpression, historyCount, notificationEmails, jobTypeClass];
    ...
    async function getCronDescription(cronExpression: string) {
