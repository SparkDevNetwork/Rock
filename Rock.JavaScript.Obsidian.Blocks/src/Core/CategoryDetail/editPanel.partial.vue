...
<script setup lang="ts">
    ...
    const entityTypeQualifierColumn = ref(props.modelValue.entityTypeQualifierColumn);
    const entityTypeQualifierValue = ref(props.modelValue.entityTypeQualifierValue);
    const rootCategoryGuid = ref(props.modelValue.rootCategoryGuid);
