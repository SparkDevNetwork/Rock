...
<script setup lang="ts">
    ...
    import EditPanel from "./SignatureDocumentTemplateDetail/editPanel.partial.vue";
    import ViewPanel from "./SignatureDocumentTemplateDetail/viewPanel.partial.vue";
    import { getSecurityGrant, provideSecurityGrant, refreshDetailAttributes, useConfigurationValues, useInvokeBlockAction } from "@Obsidian/Utility/block";
    import { debounce } from "@Obsidian/Utility/util";
    import { NavigationUrlKey } from "./SignatureDocumentTemplateDetail/types";
