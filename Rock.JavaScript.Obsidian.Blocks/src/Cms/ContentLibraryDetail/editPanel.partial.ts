...
export default defineComponent({
    name: "Cms.ContentLibraryDetail.EditPanel",
    ...
    props: {
        /** The content library that is being edited. */
        modelValue: {
    ...
    setup(props, { emit }) {
        ...
        const libraryKey = propertyRef(props.modelValue.libraryKey ?? "", "LibraryKey");
        ...
        // Set some sane defaults if this is a new library.
        ...
        const propRefs = [description, name, libraryKey, trendingEnabled, trendingWindowDay, trendingMaxItems, trendingGravity, enableSegments, enableRequestFilters];
        ...
        watch(() => props.modelValue, () => {
            ...
            updateRefValue(libraryKey, props.modelValue.libraryKey ?? "");
        ...
        watch([attributeValues, ...propRefs], () => {
            const newValue: ContentLibraryBag = {
                ...props.modelValue,
                attributeValues: attributeValues.value,
                description: description.value,
                name: name.value,
                libraryKey: libraryKey.value,
...
<fieldset>
    ...
    <div class="row">
        <div class="col-md-6">
            <TextBox v-model="libraryKey"
                label="Key"
                help="The unique key that will identify this library."
                rules="required" />
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <CheckBox v-model="trendingEnabled"
                ...
                help="Determines if trending metrics should be calculated on each run of the library update job." />
