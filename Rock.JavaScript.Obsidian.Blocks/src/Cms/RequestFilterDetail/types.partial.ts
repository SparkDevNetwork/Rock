...
export type IQueryStringRequestFilter = {
    queryStringRequestFilterExpressionType?: number;
    queryStringRequestFilters?: QueryStringRequestFilterBag[];
};

export type ICookieRequestFilter = {
    cookieRequestFilterExpressionType?: number;
    cookieRequestFilters?: CookieRequestFilterBag[];
};

export type IBrowserRequestFilter = {
    browserRequestFilters?: BrowserRequestFilterBag[];
};

export type IIpAddressRequestFilter = {
    ipAddressRequestFilters?: IPAddressRequestFilterBag[];
};

export type IGeolocationRequestFilter = {
    geolocationRequestFilters?: GeolocationRequestFilterBag[];
};
