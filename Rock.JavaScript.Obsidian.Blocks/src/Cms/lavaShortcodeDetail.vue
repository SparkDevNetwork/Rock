...
<script setup lang="ts">
    ...
    import EditPanel from "./LavaShortcodeDetail/editPanel.partial.vue";
    import ViewPanel from "./LavaShortcodeDetail/viewPanel.partial.vue";
    import { getSecurityGrant, provideSecurityGrant, refreshDetailAttributes, useConfigurationValues, useInvokeBlockAction } from "@Obsidian/Utility/block";
    import { debounce } from "@Obsidian/Utility/util";
    import { NavigationUrlKey } from "./LavaShortcodeDetail/types";
    ...
    const isEditable = computed((): boolean => {
        return config.isEditable === true && lavaShortcodeViewBag.value?.isSystem !== true;
    });
    ...
    async function onCancelEdit(): Promise<boolean | string> {
        if (!lavaShortcodeEditBag.value?.idKey) {
    ...
    async function onEdit(): Promise<boolean> {
        const result = await invokeBlockAction<DetailBlockBox<LavaShortcodeBag, LavaShortcodeDetailOptionsBag>>("Edit", {
            key: lavaShortcodeViewBag.value?.idKey
        });
    ...
    async function onSave(): Promise<boolean | string> {
        ...
        const result = await invokeBlockAction<LavaShortcodeBag | string>("Save", {
            box: data
        });
