...
namespace com.bemaservices.RoomManagement.Web.UI.Controls
{
    ...
    /// 
    /// </summary>
    [ToolboxData( "<{0}:ResourcePicker runat=server></{0}:ResourcePicker>" )]
    public class ResourcePicker : Rock.Web.UI.Controls.ItemPicker
    {
        /// <summary>
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            ItemRestUrlExtraParams += "&entityTypeId=" + EntityTypeCache.Get( com.bemaservices.RoomManagement.SystemGuid.EntityType.RESOURCE.AsGuid() ).Id;
