...
namespace com.bemaservices.RoomManagement.Migrations
{
    ...
    public class ResourceApproval : Migration
    {
        ...
        public override void Up()
        {
            ...
            Sql( @"
                ALTER TABLE [_com_bemaservices_RoomManagement_Resource] ADD ApprovalGroupId [int] NULL;

                ALTER TABLE [dbo].[_com_bemaservices_RoomManagement_Resource] WITH CHECK ADD CONSTRAINT [FK__com_bemaservices_RoomManagement_Resource_ApprovalGroup] FOREIGN KEY([ApprovalGroupId])
                REFERENCES [dbo].[Group] ([Id])

                ALTER TABLE [dbo].[_com_bemaservices_RoomManagement_Resource] CHECK CONSTRAINT [FK__com_bemaservices_RoomManagement_Resource_ApprovalGroup]
                " );

            Sql( @"
            ALTER TABLE [_com_bemaservices_RoomManagement_ReservationResource] DROP COLUMN IsApproved;
                ALTER TABLE [_com_bemaservices_RoomManagement_ReservationResource] ADD ApprovalState [int] NOT NULL DEFAULT 1;
                " );

            Sql( @"
                ALTER TABLE [_com_bemaservices_RoomManagement_ReservationLocation] DROP COLUMN IsApproved;
                ALTER TABLE [_com_bemaservices_RoomManagement_ReservationLocation] ADD ApprovalState [int] NOT NULL DEFAULT 1;
                " );

            Sql( @"
                ALTER TABLE [_com_bemaservices_RoomManagement_Reservation] ADD ApprovalState [int] NOT NULL DEFAULT 1;
                " );
            ...
            RockMigrationHelper.UpdateAttributeQualifier( "4E365CE8-242A-4F05-B953-EA9DEFF470EE", "EnableSelfSelection", @"False", "1D9E7B5A-2998-4D69-87A2-983B4447A7DC" ); // Room Reservation Approval Notification:Requester:EnableSelfSelection
...
<br/>
Schedule: {% execute import:'com.bemaservices.RoomManagement.Model'%} 
...
{% endexecute %}<br/>
Event Duration: {% execute import:'com.bemaservices.RoomManagement.Model'%} 
var reservation = new ReservationService( new RockContext()).Get({{reservation.Id}});
...
INSERT [dbo].[_com_bemaservices_RoomManagement_ReservationWorkflowTrigger] ([WorkflowTypeId], [TriggerType], [QualifierValue], [CreatedDateTime], [ModifiedDateTime], [CreatedByPersonAliasId], [ModifiedByPersonAliasId], [Guid], [ForeignKey], [ForeignGuid], [ForeignId]) VALUES (@WorkflowId, 0, N'|||', CAST(N'2017-03-20 14:02:11.953' AS DateTime), CAST(N'2017-03-20 14:02:11.953' AS DateTime), NULL, NULL, N'5339e1c4-ac09-4bd5-9416-628dba200ba5', NULL, NULL, NULL)
INSERT [dbo].[_com_bemaservices_RoomManagement_ReservationWorkflowTrigger] ([WorkflowTypeId], [TriggerType], [QualifierValue], [CreatedDateTime], [ModifiedDateTime], [CreatedByPersonAliasId], [ModifiedByPersonAliasId], [Guid], [ForeignKey], [ForeignGuid], [ForeignId]) VALUES (@WorkflowId, 2, N'|||', CAST(N'2017-03-20 14:02:11.953' AS DateTime), CAST(N'2017-03-20 14:02:11.953' AS DateTime), NULL, NULL, N'68f6de62-cdbb-4ec0-8440-8b1740c21e65', NULL, NULL, NULL)
