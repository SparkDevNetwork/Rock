    ...
    public class NewBlockSettings : Migration
    {
        ...
        public override void Up()
        {
            ...
            catch ( Exception )
            {
                ...
                //DropForeignKey( "[dbo].[_com_bemaservices_RoomManagement_Reservation]", "FK__com_bemaservices_RoomManagement_Reservation_ContactPersonAliasId" );
                //DropColumn( "[dbo].[_com_bemaservices_RoomManagement_Reservation]", "ContactPersonAliasId" );
                //DropColumn( "[dbo].[_com_bemaservices_RoomManagement_Reservation]", "ContactPhone" );
                //DropColumn( "[dbo].[_com_bemaservices_RoomManagement_Reservation]", "ContactEmail" );

                //AddColumn( "[dbo].[_com_bemaservices_RoomManagement_Reservation]", "EventContactPersonAliasId", c => c.Int() );
                //AddColumn( "[dbo].[_com_bemaservices_RoomManagement_Reservation]", "EventContactPhone", c => c.String( maxLength: 50 ) );
                //AddColumn( "[dbo].[_com_bemaservices_RoomManagement_Reservation]", "EventContactEmail", c => c.String( maxLength: 400 ) );
                ...
                //AddColumn( "[dbo].[_com_bemaservices_RoomManagement_Reservation]", "AdministrativeContactPersonAliasId", c => c.Int() );
                //AddColumn( "[dbo].[_com_bemaservices_RoomManagement_Reservation]", "AdministrativeContactPhone", c => c.String( maxLength: 50 ) );
                //AddColumn( "[dbo].[_com_bemaservices_RoomManagement_Reservation]", "AdministrativeContactEmail", c => c.String( maxLength: 400 ) );
