...
namespace Rock.ViewModels.Blocks.Mobile.MobileApplicationDetail
{
    ...
    /// Deploy action. Carries the refreshed deploy-badge values plus the
    /// updated application summary HTML so the view-mode UI can reflect
    /// the new deploy timestamp without a full block reload.
    /// </summary>
    public class MobileApplicationDeployResponseBag
    {
        /// <summary>
