...
{
    /// <summary>
    /// A bag that contains information needed to get the selected person's additional time sign-ups for the group schedule toolbox block.
    /// </summary>
    public class GetSignUpsRequestBag
    {
        /// <summary>
