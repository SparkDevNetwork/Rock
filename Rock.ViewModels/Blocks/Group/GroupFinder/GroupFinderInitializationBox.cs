...
namespace Rock.ViewModels.Blocks.Group.GroupFinder
{
    ...
    public class GroupFinderInitializationBox
    {
        ...
        /// <summary>
        /// Gets or sets the lead message shown above the block: an everyone-visible message when no group types are selected, an administrator-only lead when a Google key is missing or a visible filter segment has no filters (its specifics listed in ConfigurationWarningItems), or null when nothing needs saying.
        /// </summary>
        public string ConfigurationWarning { get; set; }

        /// <summary>
        /// Gets or sets the specific configuration issues listed as bullets under the not-fully-configured warning (administrator only), or null when there are none.
        /// </summary>
        public List<string> ConfigurationWarningItems { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether the block is unconfigured (no group types selected), in which case only the configuration message renders and the finder is hidden.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the campuses offered by the Campus filter, each with its name and unique identifier.
        /// </summary>
