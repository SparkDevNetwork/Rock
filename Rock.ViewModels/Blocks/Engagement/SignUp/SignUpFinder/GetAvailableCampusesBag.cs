...
namespace Rock.ViewModels.Blocks.Engagement.SignUp.SignUpFinder
{
    ...
    /// </summary>
    public class GetAvailableCampusesBag
    {
        /// <summary>
        /// Gets or sets the selected campus type guid strings.
        /// </summary>
        /// <value>
        /// The selected campus type guid strings.
        /// </value>
        public List<string> SelectedCampusTypes { get; set; }

        /// <summary>
        /// Gets or sets the selected campus status guid strings.
        /// </summary>
        /// <value>
        /// The selected campus status guid strings.
        /// </value>
        public List<string> SelectedCampusStatuses { get; set; }
    }
}
