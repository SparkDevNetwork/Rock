...
{
    /// <summary>
    /// Represents a request to get email configuration details for sending communications to a set of connection requests.
    /// </summary>
    public class GetEmailConfigurationRequestBag
    {
        /// <summary>
