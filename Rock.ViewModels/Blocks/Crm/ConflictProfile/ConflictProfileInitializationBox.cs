...
namespace Rock.ViewModels.Blocks.Crm.ConflictProfile
{
    ...
    /// </summary>
    public class ConflictProfileInitializationBox : BlockBox
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the scored results of the most recent assessment. This is <c>null</c> until the assessment is completed.
        /// </summary>
        public ConflictProfileResultBag Results { get; set; }
    }
}
