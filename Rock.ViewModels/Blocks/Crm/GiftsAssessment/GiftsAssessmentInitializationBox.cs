...
namespace Rock.ViewModels.Blocks.Crm.GiftsAssessment
{
    ...
    /// </summary>
    public class GiftsAssessmentInitializationBox : BlockBox
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the results of the most recent assessment. This is <c>null</c> until the assessment is completed.
        /// </summary>
        public SpiritualGiftsResultBag Results { get; set; }
    }
}
