...
{
    /// <summary>
    /// The data required to render the edit view of the person's bookmarked
    /// attributes. Editable attributes are shown as editors while attributes
    /// the person may only view are shown as read-only formatted values, both
    /// interleaved in bookmarked order.
    /// </summary>
    public class KeyAttributesEditBag
    {
        /// <summary>
        /// Gets or sets the ordered list of fields to render. Editable fields
        /// always appear; view-only fields appear only when they have a value.
        /// </summary>
        public List<KeyAttributeFieldBag> Fields { get; set; }
