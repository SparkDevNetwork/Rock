...
{
    /// <summary>
    /// A bag that contains grid data and an updated, matching grid definition for the Communication Detail block's
    /// recipient grid.
    /// </summary>
    public class CommunicationRecipientGridDataBag
    {
        /// <summary>
