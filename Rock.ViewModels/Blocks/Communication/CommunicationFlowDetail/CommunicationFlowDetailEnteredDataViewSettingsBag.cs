...
{
    /// <summary>
    /// The conversion goal settings for the Communication Flow Detail block when the conversion goal type is "Entered Data View".
    /// </summary>
    public class CommunicationFlowDetailEnteredDataViewSettingsBag
    {
        /// <summary>
