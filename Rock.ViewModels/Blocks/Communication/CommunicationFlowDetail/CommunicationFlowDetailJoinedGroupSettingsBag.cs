...
{
    /// <summary>
    /// The conversion goal settings for the Communication Flow Detail block when the conversion goal type is "Joined Specific Group".
    /// </summary>
    public class CommunicationFlowDetailJoinedGroupSettingsBag
    {
        /// <summary>
