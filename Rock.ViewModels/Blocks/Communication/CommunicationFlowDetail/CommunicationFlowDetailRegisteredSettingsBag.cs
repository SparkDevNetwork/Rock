...
{
    /// <summary>
    /// The conversion goal settings for the Communication Flow Detail block when the conversion goal type is "Registered".
    /// </summary>
    public class CommunicationFlowDetailRegisteredSettingsBag
    {
        /// <summary>
