...
{
    /// <summary>
    /// Bag containing the information for the Communication Entry Wizard block to save a metrics reminder.
    /// </summary>
    public class CommunicationEntryWizardSaveMetricsReminderRequestBag
    {
        /// <summary>
