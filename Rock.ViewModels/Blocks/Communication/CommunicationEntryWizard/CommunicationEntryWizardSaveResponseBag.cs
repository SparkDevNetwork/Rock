...
{
    /// <summary>
    /// Bag containing the response information from saving a communication in the Communication Entry Wizard block.
    /// </summary>
    public class CommunicationEntryWizardSaveResponseBag
    {
        /// <summary>
