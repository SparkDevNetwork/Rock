...
namespace Rock.ViewModels.Blocks.Event.RegistrationInstanceWaitList
{
    /// <summary>
    /// The additional configuration options for the Registration Instance - Wait List block.
    /// </summary>
    public class RegistrationInstanceWaitListOptionsBag
    {
        /// <summary>
