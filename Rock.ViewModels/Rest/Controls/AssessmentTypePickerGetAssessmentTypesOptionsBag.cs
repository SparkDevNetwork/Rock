...
{
    /// <summary>
    /// The options that can be passed to the GetAssessmentTypes API action of
    /// the AssessmentTypePicker control.
    /// </summary>
    public class AssessmentTypePickerGetAssessmentTypesOptionsBag
    {
        /// <summary>
