...
using Rock.Data;
using Rock.Model;
using Rock.ViewModels.Blocks.Communication.EmailPreferenceEntryLegacy;
...
namespace Rock.Blocks.Communication
{
    ...
    /// </remarks>
    [DisplayName( "Email Preference Entry (Legacy)" )]
    ...
    public class EmailPreferenceEntryLegacy : RockBlockType
    {
        #region Keys
