...
namespace Rock.Blocks.Cms
{
    ...
    [Rock.SystemGuid.EntityTypeGuid( "e5a07e07-5aa9-4d20-ad4a-26ce31d9cfa4" )]
    [Rock.SystemGuid.BlockTypeGuid( "ccaf62a9-923a-429c-b88a-a2df0dcd52ec" )]
    public class LavaShortcodeDetail : RockObsidianDetailBlockType
    {
        #region Keys
        ...
        public override object GetObsidianBlockInitialization()
        {
            using ( var rockContext = new RockContext() )
            {
                ...
                box.QualifiedAttributeProperties = GetAttributeQualifiedColumns<LavaShortcode>();
        ...
        private bool UpdateEntityFromBox( LavaShortcode entity, DetailBlockBox<LavaShortcodeBag, LavaShortcodeDetailOptionsBag> box, RockContext rockContext )
        {
            ...
            var categoryIds = box.Entity.Categories.Select( c => c.GetEntityId<Category>( rockContext ).Value ).ToList();
            box.IfValidProperty( nameof( box.Entity.Categories ),
                () => entity.Categories = categoryService.GetByIds( categoryIds ).ToList() );//.ForEach(.GetEntityId<Category>(rockContext)/* TODO: Unknown property type 'ICollection<Category>' for conversion to bag. */ );
