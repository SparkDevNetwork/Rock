...
namespace Rock.Blocks.Cms
{
    ...
    public class LavaShortcodeList : RockBlockType
    {
        ...
        private Dictionary<string, string> GetBoxNavigationUrls()
        {
            ...
            {
                [NavigationUrlKey.DetailPage] = this.GetLinkedPageUrl( AttributeKey.DetailPage, new Dictionary<string, string> { ["LavaShortcodeId"] = "((Key))", ["autoEdit"] = "true", ["returnUrl"] = this.GetCurrentPageUrl() } ),
            };
        }
