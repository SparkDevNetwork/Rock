...
<div class='alert alert-success'>
    ...
    public class GroupRegistration : RockObsidianBlockType
    {
        ...
        private Group GetGroup( RockContext rockContext )
        {
            if ( _group == null )
            {
                ...
                if ( currentPerson != null && box.AutoFill )
                {
                    ...
                    if ( box.Mode != "Simple" )
                    {
                        ...
                        if ( cellPhone != null )
                        {
                            ...
                            box.Entity.EnableSms = cellPhone.IsMessagingEnabled;
                        }
                        ...
                        if ( box.Mode == "FullSpouse" )
                        {
                            ...
                            if ( spouse != null )
                            {
                                ...
                                if ( spouseCellPhone != null )
                                {
                                    ...
                                    box.Entity.EnableSpouseSms = spouseCellPhone.IsMessagingEnabled;
                                }
                            }
                        }
                    }
