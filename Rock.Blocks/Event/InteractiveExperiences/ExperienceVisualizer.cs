...
namespace Rock.Blocks.Event.InteractiveExperiences
{
    ...
    public class ExperienceVisualizer : RockObsidianBlockType
    {
        #region Keys
        ...
        private VisualizerOccurrenceBag GetCurrentOccurrence( RockContext rockContext )
        {
            ...
            {
                ExperienceToken = Rock.Security.Encryption.EncryptString( experienceToken.ToJson() ),
        ...
        {
            var experienceToken = Rock.Security.Encryption.DecryptString( token ).FromJsonOrNull<ExperienceToken>();
