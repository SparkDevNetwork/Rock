...
{
    /// <summary>
    /// Displays a list of signal types.
    /// </summary>
    ...
    [Rock.SystemGuid.EntityTypeGuid( "2d9562d6-d28d-4515-8ca6-a2955e0ace23" )]
    [Rock.SystemGuid.BlockTypeGuid( "770d3039-3f07-4d6f-a64e-c164acce93e1" )]
    [CustomizedGrid]
    public class SignalTypeList : RockEntityListBlockType<SignalType>
    {
        #region Keys
        ...
        {
            var box = new ListBlockBox<SignalTypeListOptionsBag>();
        ...
        private SignalTypeListOptionsBag GetBoxOptions()
        {
            var options = new SignalTypeListOptionsBag();
        ...
        protected override GridBuilder<SignalType> GetGridBuilder()
        {
            return new GridBuilder<SignalType>()
                ...
                .AddTextField( "signalColor", a => a.SignalColor )
        ...
        public BlockActionResult Delete( string key )
        {
            using ( var rockContext = new RockContext() )
            {
                ...
                if ( entity == null )
                {
                    return ActionBadRequest( $"{SignalType.FriendlyTypeName} not found." );
                }

                if ( !entity.IsAuthorized( Authorization.EDIT, RequestContext.CurrentPerson ) )
                {
                    return ActionBadRequest( $"Not authorized to delete {SignalType.FriendlyTypeName}." );
                }
