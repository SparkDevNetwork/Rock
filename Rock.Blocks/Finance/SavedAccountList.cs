...
namespace Rock.Blocks.Finance
{
    ...
    public class SavedAccountList : RockEntityListBlockType<FinancialPersonSavedAccount>
    {
        ...
        public BlockActionResult AddSavedAccountFromToken( SavedAccountTokenBag options )
        {
            ...
            var savedAccount = financialPersonSavedAccountService.CreateAccountFromToken( MyWellGateway, options, RequestContext.CurrentPerson, transactionTypeId, options.AdditionalParameters, out var errorMessage );
