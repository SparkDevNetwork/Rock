...
internal sealed partial class SystemUtilitySkill
{
    ...
    public AgentToolResult Sum( List<double> numbers )
    {
    ...
    public AgentToolResult Subtract( double a, double b )
    {
        return Success( a - b );
    }
    ...
    public AgentToolResult Multiply( double a, double b )
    {
        return Success( a * b );
    }
    ...
    public AgentToolResult Divide( double a, double b )
    {
        if ( b == 0 )
        {
    ...
    public AgentToolResult Average( List<double> numbers )
    {
        if ( numbers == null || numbers.Count == 0 )
        {
            return Error( "The list of numbers cannot be null or empty." );
    ...
    public AgentToolResult Max( List<double> numbers )
    {
        if ( numbers == null || numbers.Count == 0 )
        {
            return Error( "The list of numbers cannot be null or empty." );
    ...
    public AgentToolResult Min( List<double> numbers )
    {
        if ( numbers == null || numbers.Count == 0 )
        {
            return Error( "The list of numbers cannot be null or empty." );
    ...
    public AgentToolResult Median( List<double> numbers )
    {
        if ( numbers == null || numbers.Count == 0 )
        {
            return Error( "The list of numbers cannot be null or empty." );
    ...
    public AgentToolResult StandardDeviation( List<double> numbers )
    {
        if ( numbers == null || numbers.Count == 0 )
        {
            return Error( "The list of numbers cannot be null or empty." );
