...
- Skip this function if information is incomplete — it is designed to provide what’s needed." )]
        ...
        public AgentToolResult GroupMemberOperations(
            string personIdKey,
            string groupIdKey,
...
[
  ...
  {{
    ...
    ""GroupFilterMatchType"": ""Equals""
        ...
        /// <returns></returns>
        private AgentToolResult AddPersonToGroup( RockContext rockContext, Rock.Model.Person person, Group group, GroupTypeRole groupTypeRole, GroupMember groupMember = null )
        {
            if ( groupMember != null )
            {
        ...
        /// <param name="groupTypeRole"></param>
        /// <returns></returns>
        private AgentToolResult UpdatePersonInGroup( RockContext rockContext, GroupMember groupMember, GroupTypeRole groupTypeRole )
        {
            if ( groupMember == null )
            {
        ...
        /// <param name="group"></param>
        /// <returns></returns>
        private AgentToolResult DeletePersonFromGroup( RockContext rockContext, Rock.Model.Person person, Group group )
        {
            var groupMemberService = new GroupMemberService( rockContext );
