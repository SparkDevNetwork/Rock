...
internal sealed partial class CustomComponentSkill
{
    ...
    [Description( "Reads the current authored source of a Custom Component block placement so it can be iterated on." )]
        ...
        string blockId )
    {
        ...
        var content = new CustomComponentService( rockContext ).GetByBlockId( block.Id );
