...
internal sealed partial class ReminderSkill
{
    ...
    [Description( "Lists the reminders for the current person that match the filters." )]
        ...
        int pageNumber = 1 )
    {
        ...
        {
            return Error( "You must be logged in to list your reminders." );
        }
        ...
        qry = helper.WhereRequiredProperty( qry, r => r.PersonAlias.PersonId, currentPerson?.Id );
