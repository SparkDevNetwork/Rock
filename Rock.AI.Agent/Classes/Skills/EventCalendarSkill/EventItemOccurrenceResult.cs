...
internal class EventItemOccurrenceResult : EntityResultBase
{
    ...
    /// <summary>
    /// The list of linkages that associate this event item occurrence with
    /// specific groups and registration instances.
    /// </summary>
    public List<RegistrationInstanceLinkageResult> Linkages { get; set; }
}
