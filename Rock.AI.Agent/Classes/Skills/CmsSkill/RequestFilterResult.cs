...
/// <summary>
/// A single request filter as it appears in a lookup. Identity only; the filter
/// criteria come from the detail tool.
/// </summary>
internal class RequestFilterResult : EntityResultBase
{
    /// <summary>
